...
function oe(f, n) {
  ...
  if (n === Q || n === he) {
    ...
    const s = e.count - 2,
      t = [];
    if (n === Q)
      for (let r = 1; r <= s; r++) (t.push(e.getX(0)), t.push(e.getX(r)), t.push(e.getX(r + 1)));
    else
      for (let r = 0; r < s; r++)
        r % 2 === 0
    ...
    return (
      console.error('THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:', n),
      f
    );
}
function un(f) {
...
function _e(f, n, e) {
  e(f, n);
  for (let s = 0; s < f.children.length; s++) _e(f.children[s], n.children[s], e);
}
class qn extends Se {
  constructor(n) {
    (super(n),
      ...
      case 'spot':
        ((c = new ye(u)),
          ...
          (o.spot.outerConeAngle =
            o.spot.outerConeAngle !== void 0 ? o.spot.outerConeAngle : Math.PI / 4),
...
class dn {
  ...
  extendMaterialParams(n, e) {
    ...
    return (
      s === null || (s.emissiveStrength !== void 0 && (e.emissiveIntensity = s.emissiveStrength)),
      Promise.resolve()
    );
  }
}
class pn {
  ...
  getMaterialType(n) {
    return A(this.parser, n, this.name) !== null ? w : null;
  }
  extendMaterialParams(n, e) {
    const s = A(this.parser, n, this.name);
    ...
    if (
      ...
      s.clearcoatTexture !== void 0 &&
        t.push(this.parser.assignTexture(e, 'clearcoatMap', s.clearcoatTexture)),
      s.clearcoatRoughnessFactor !== void 0 && (e.clearcoatRoughness = s.clearcoatRoughnessFactor),
      s.clearcoatRoughnessTexture !== void 0 &&
        t.push(this.parser.assignTexture(e, 'clearcoatRoughnessMap', s.clearcoatRoughnessTexture)),
      s.clearcoatNormalTexture !== void 0 &&
        (t.push(this.parser.assignTexture(e, 'clearcoatNormalMap', s.clearcoatNormalTexture)),
  ...
  extendMaterialParams(n, e) {
    ...
    return (
      ...
      s.iridescenceTexture !== void 0 &&
        t.push(this.parser.assignTexture(e, 'iridescenceMap', s.iridescenceTexture)),
      s.iridescenceIor !== void 0 && (e.iridescenceIOR = s.iridescenceIor),
      e.iridescenceThicknessRange === void 0 && (e.iridescenceThicknessRange = [100, 400]),
      ...
      s.iridescenceThicknessTexture !== void 0 &&
        t.push(
          this.parser.assignTexture(e, 'iridescenceThicknessMap', s.iridescenceThicknessTexture),
        ),
      Promise.all(t)
    );
  }
...
class Tn {
  ...
  extendMaterialParams(n, e) {
    ...
    return (
      s.sheenRoughnessFactor !== void 0 && (e.sheenRoughness = s.sheenRoughnessFactor),
      s.sheenColorTexture !== void 0 &&
        t.push(this.parser.assignTexture(e, 'sheenColorMap', s.sheenColorTexture, U)),
      s.sheenRoughnessTexture !== void 0 &&
        t.push(this.parser.assignTexture(e, 'sheenRoughnessMap', s.sheenRoughnessTexture)),
      Promise.all(t)
    );
  }
}
class Rn {
  ...
  extendMaterialParams(n, e) {
    ...
    const t = [];
    return (
      s.transmissionFactor !== void 0 && (e.transmission = s.transmissionFactor),
      s.transmissionTexture !== void 0 &&
        t.push(this.parser.assignTexture(e, 'transmissionMap', s.transmissionTexture)),
      Promise.all(t)
    );
  }
}
  ...
  extendMaterialParams(n, e) {
    ...
    ((e.thickness = s.thicknessFactor !== void 0 ? s.thicknessFactor : 0),
      s.thicknessTexture !== void 0 &&
        t.push(this.parser.assignTexture(e, 'thicknessMap', s.thicknessTexture)),
...
class xn {
  ...
  extendMaterialParams(n, e) {
    const s = A(this.parser, n, this.name);
    return (
      s === null || ((e.ior = s.ior !== void 0 ? s.ior : 1.5), e.ior === 0 && (e.ior = 1e3)),
      Promise.resolve()
    );
  }
}
  ...
  extendMaterialParams(n, e) {
    ...
    ((e.specularIntensity = s.specularFactor !== void 0 ? s.specularFactor : 1),
      s.specularTexture !== void 0 &&
        t.push(this.parser.assignTexture(e, 'specularIntensityMap', s.specularTexture)));
    const i = s.specularColorFactor || [1, 1, 1];
    return (
      (e.specularColor = new F().setRGB(i[0], i[1], i[2], b)),
      s.specularColorTexture !== void 0 &&
        t.push(this.parser.assignTexture(e, 'specularColorMap', s.specularColorTexture, U)),
      Promise.all(t)
    );
  }
}
class An {
  ...
  extendMaterialParams(n, e) {
    ...
    return (
      ...
      s.bumpTexture !== void 0 && t.push(this.parser.assignTexture(e, 'bumpMap', s.bumpTexture)),
      Promise.all(t)
    );
  }
}
class Mn {
  ...
  extendMaterialParams(n, e) {
    ...
    return (
      ...
      s.anisotropyRotation !== void 0 && (e.anisotropyRotation = s.anisotropyRotation),
      s.anisotropyTexture !== void 0 &&
        t.push(this.parser.assignTexture(e, 'anisotropyMap', s.anisotropyTexture)),
      Promise.all(t)
    );
  }
}
    ...
    if (s.extensions && s.extensions[this.name]) {
      ...
      return i.then(function (a) {
        ...
        return r.decodeGltfBufferAsync
          ? r.decodeGltfBufferAsync(u, l, h, t.mode, t.filter).then(function (d) {
              return d.buffer;
            })
...
function y(f, n) {
  n.extras !== void 0 &&
    (typeof n.extras == 'object'
      ...
      : console.warn('THREE.GLTFLoader: Ignoring primitive type .extras, ' + n.extras));
}
function Hn(f, n, e) {
  let s = !1,
    t = !1,
  ...
  for (let c = 0, u = n.length; c < u; c++) {
    ...
    if (s) {
      const h =
        l.POSITION !== void 0 ? e.getDependency('accessor', l.POSITION) : f.attributes.position;
      r.push(h);
    }
    if (t) {
  ...
  return Promise.all([Promise.all(r), Promise.all(a), Promise.all(o)]).then(function (c) {
    const u = c[0],
      l = c[1],
      h = c[2];
    return (
...
function Dn(f, n) {
  if ((f.updateMorphTargets(), n.weights !== void 0))
    for (let e = 0, s = n.weights.length; e < s; e++) f.morphTargetInfluences[e] = n.weights[e];
  if (n.extras && Array.isArray(n.extras.targetNames)) {
    ...
    if (f.morphTargetInfluences.length === e.length) {
      ...
      for (let s = 0, t = e.length; s < t; s++) f.morphTargetDictionary[e[s]] = s;
...
function Gn(f) {
  ...
  if (
    ...
    for (let s = 0, t = f.targets.length; s < t; s++) n += ':' + Y(f.targets[s]);
  return n;
}
function Y(f) {
  let n = '';
...
class Bn {
    ...
    return (
      ...
      Promise.all(i).then(function (r) {
        const a = r[0],
          ...
          l = u * o,
          h = t.byteOffset || 0,
          d = t.bufferView !== void 0 ? s.bufferViews[t.bufferView].byteStride : void 0,
          p = t.normalized === !0;
        let R, m;
        if (d && d !== l) {
          const T = Math.floor(h / d),
            _ =
              'InterleavedBuffer:' + t.bufferView + ':' + t.componentType + ':' + T + ':' + t.count;
          let x = e.cache.get(_);
          (x ||
            ((R = new c(a, T * d, (t.count * d) / u)), (x = new Fe(R, d / u)), e.cache.add(_, x)),
            (m = new sn(x, o, (h % d) / u, p)));
        } else
          (a === null ? (R = new c(t.count * o)) : (R = new c(a, h, t.count * o)),
            (m = new V(R, o, p)));
        if (t.sparse !== void 0) {
          const T = q.SCALAR,
          ...
          for (let S = 0, H = M.length; S < H; S++) {
            ...
            if (
              (m.setX(P, N[S * o]),
              o >= 2 && m.setY(P, N[S * o + 1]),
              o >= 3 && m.setZ(P, N[S * o + 2]),
              o >= 4 && m.setW(P, N[S * o + 3]),
              o >= 5)
            )
    ...
    const c = this.loadImageSource(e, s)
      .then(function (u) {
        ...
        return (
          ...
          (u.generateMipmaps = !u.isCompressedTexture && u.minFilter !== Re && u.minFilter !== J),
  ...
  loadImageSource(n, e) {
    const s = this,
      t = this.json,
      i = this.options;
    if (this.sourceCache[n] !== void 0) return this.sourceCache[n].then((l) => l.clone());
    const r = t.images[n],
    ...
    const u = Promise.resolve(o)
      ...
      .then(function (l) {
        return (
          ...
          y(l, r),
          (l.userData.mimeType = r.mimeType || vn(r.uri)),
          l
        );
      })
      .catch(function (l) {
  ...
  assignTexture(n, e, s, t) {
    ...
    return this.getDependency('texture', s.index).then(function (r) {
      if (!r) return null;
      if (
        (s.texCoord !== void 0 && s.texCoord > 0 && ((r = r.clone()), (r.channel = s.texCoord)),
  ...
  loadMaterial(n) {
    ...
    if (o[g.KHR_MATERIALS_UNLIT]) {
      ...
      (l.baseColorTexture !== void 0 && c.push(e.assignTexture(a, 'map', l.baseColorTexture, U)),
        ...
        l.metallicRoughnessTexture !== void 0 &&
          (c.push(e.assignTexture(a, 'metalnessMap', l.metallicRoughnessTexture)),
          c.push(e.assignTexture(a, 'roughnessMap', l.metallicRoughnessTexture))),
    ...
    if (
      (u === W.BLEND
        ...
        : ((a.transparent = !1),
          u === W.MASK && (a.alphaTest = i.alphaCutoff !== void 0 ? i.alphaCutoff : 0.5)),
    ...
    if (
      (i.occlusionTexture !== void 0 &&
        ...
        i.occlusionTexture.strength !== void 0 && (a.aoMapIntensity = i.occlusionTexture.strength)),
      i.emissiveFactor !== void 0 && r !== G)
    ) {
  ...
  loadMesh(n) {
    ...
    for (let o = 0, c = r.length; o < c; o++) {
      const u =
        r[o].material === void 0 ? kn(this.cache) : this.getDependency('material', r[o].material);
      a.push(u);
    }
    return (
  ...
  loadCamera(n) {
    ...
    return (
      s.type === 'perspective'
        ? (e = new Qe(Je.radToDeg(t.yfov), t.aspectRatio || 1, t.znear || 1, t.zfar || 2e6))
        : s.type === 'orthographic' &&
  ...
  loadSkin(n) {
    const e = this.json.skins[n],
      s = [];
    for (let t = 0, i = e.joints.length; t < i; t++) s.push(this._loadNodeShallow(e.joints[t]));
    return (
  ...
  loadAnimation(n) {
    ...
    return Promise.all([
      ...
      for (let x = 0, E = h.length; x < E; x++) {
        ...
        if (K) for (let j = 0; j < K.length; j++) T.push(K[j]);
      }
  ...
  loadNode(n) {
    const e = this.json,
      ...
      r = [],
      a = t.children || [];
    for (let c = 0, u = a.length; c < u; c++) r.push(s.getDependency('node', a[c]));
  ...
  loadScene(n) {
    ...
    const r = s.nodes || [],
      a = [];
    for (let o = 0, c = r.length; o < c; o++) a.push(t.getDependency('node', r[o]));
    return Promise.all(a).then(function (o) {
      ...
      const c = (u) => {
        const l = new Map();
        for (const [h, d] of t.associations) (h instanceof X || h instanceof ne) && l.set(h, d);
        return (
          u.traverse((h) => {
...
function Kn(f, n, e) {
  ...
  if (s.POSITION !== void 0) {
    ...
    if (o !== void 0 && c !== void 0) {
      if ((t.set(new C(o[0], o[1], o[2]), new C(c[0], c[1], c[2])), a.normalized)) {
