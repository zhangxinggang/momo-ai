...
var u = {
    ...
    lineEditor: { edit: 'تحرير السطر', exit: 'الخروج من المُحرر' },
    elementLock: { lock: 'قفل', unlock: 'فتح', lockAll: 'قفل الكل', unlockAll: 'فتح الكل' },
  ...
  a = {
    ...
    uploadedSecurly:
      'تم تأمين التحميل بتشفير النهاية إلى النهاية، مما يعني أن خادوم Excalidraw والأطراف الثالثة لا يمكنها قراءة المحتوى.',
    loadSceneOverridePrompt:
      'تحميل الرسم الخارجي سيحل محل المحتوى الموجود لديك. هل ترغب في المتابعة؟',
...
(إذا كنت ترغب في الاحتفاظ برسمك المخزن داخليا، ببساطة أغلق علامة تبويب المتصفح بدلاً من ذلك.)`,
    ...
    imageDoesNotContainScene:
      'يبدو أن هذه الصورة لا تحتوي على أي بيانات مشهد. هل قمت بتمكين تضمين المشهد أثناء التصدير؟',
    cannotRestoreFromImage: 'تعذر استعادة المشهد من ملف الصورة',
    invalidSceneUrl:
      'تعذر استيراد المشهد من عنوان URL المتوفر. إما أنها مشوهة، أو لا تحتوي على بيانات Excalidraw JSON صالحة.',
...
لن يتم حفظ التغييرات التي قمت بها!`,
  ...
  r = {
    ...
    cannotResolveCollabServer:
      'تعذر الاتصال بخادم التعاون. الرجاء إعادة تحميل الصفحة والمحاولة مرة أخرى.',
    importLibraryError: 'تعذر تحميل المكتبة',
    collabSaveFailed:
      'تعذر الحفظ في قاعدة البيانات. إذا استمرت المشاكل، يفضل أن تحفظ ملفك محليا كي لا تفقد عملك.',
    collabSaveFailed_sizeExceeded:
      'تعذر الحفظ في قاعدة البيانات، يبدو أن القماش كبير للغاية، يفضّل حفظ الملف محليا كي لا تفقد عملك.',
    ...
    brave_measure_text_error: {
      ...
      line4:
        'إذا لم يصلح تعطيل هذا الإعداد طريقة عرض النصوص، الرجاء كتابة <issueLink>بلاغ</issueLink> على حسابنا في GitHub، أو راسلنا على <discordLink>Discord</discordLink>',
    },
  ...
  i = {
    canvasPanning:
      'لتحريك القماش، اضغط على عجلة الفأرة أو مفتاح المسافة أثناء السحب، أو استخدم أداة اليد',
...
اضغط بأستمرار على ALT أيضا لتغيير الحجم من المركز`,
    ...
    lineEditor_info:
      'اضغط على مفتاح (Ctrl أو Cmd) و انقر بشكل مزدوج، أو اضغط على مفتاحي (Ctrl أو Cmd) و (Enter) لتعديل النقاط',
    lineEditor_pointSelected:
      'اضغط على حذف لإزالة النقطة (النِّقَاط)، Ctrl/Cmd+D للتكرار، أو اسحب للانتقال',
...
أو اضغط على ALT و انقر بالفأرة لإضافة نِقَاط جديدة`,
    ...
    firefox_clipboard_write:
      'يمكن على الأرجح تمكين هذه الميزة عن طريق تعيين علم "dom.events.asyncClipboard.clipboardItem" إلى "true". لتغيير أعلام المتصفح في Firefox، قم بزيارة صفحة "about:config".',
  ...
  F = {
    ...
    openIssueMessage:
      'حرصنا على عدم إضافة معلومات المشهد في بلاغ الخطأ. في حال كون مشهدك لا يحمل أي معلومات خاصة نرجو المتابعة على <button>نظام تتبع الأخطاء</button>. نرجو إضافة المعلومات أدناه بنسخها ولصقها في محتوى البلاغ على GitHub.',
    sceneContent: 'محتوى المشهد:',
  },
  n = {
    desc_intro: 'يمكنك دعوة الآخرين لمشاركتك نفس الجلسة التي تعمل عليها.',
    desc_privacy:
      'لا تقلق، الجلسة تستخدم التشفير من النهاية إلى النهاية، لذلك فإن أي شيء ترسمه سيبقى خاصاً. لن يتمكن حتى الخادوم الخاص بنا من رؤية ما توصلت إليه.',
    ...
    desc_exitSession:
      'إيقاف الجلسة سيؤدي إلى قطع الاتصال الخاص بك من الغرفة، ولكن ستتمكن من مواصلة العمل مع المشهد، محليا. لاحظ أن هذا لن يؤثر على الأشخاص الآخرين، و سيظلون قادرين على التعاون في إصدارهم.',
  ...
  C = {
    ...
    placeholder: {
      ...
      twitterHandle:
        'اسم مستخدم تويتر (اختياري)، حتى نعرف من الذي سيتم الإشارة إليه عند الترويج عبر تويتر',
      website: 'رابط إلى موقعك الشخصي أو في مكان آخر (اختياري)',
    },
    errors: { required: 'مطلوب', website: 'أدخل عنوان URL صالح' },
    noteDescription:
      'تقديم مكتبتك لتضمينها في مستودع المكتبة العامة <link></link> لأشخاص آخرين لاستخدامها في رسومهم.',
    noteGuidelines:
      'تحتاج المكتبة إلى الموافقة أولا. يرجى قراءة <link>المعايير</link> قبل تقديمها. سوف تحتاج إلى حساب GitHub للتواصل وإجراء التغييرات عند الطلب، ولكن ليس مطلوبا بشكل صارم.',
    noteLicense:
      'تقديمك يعني موافقتك على نشر المكتبة المقدمة تحت <link>MIT ترخيص</link>، ما يعني أن لأي أحد الحق في استخدامها دون قيود.',
    noteItems:
      'يجب أن يكون لكل عنصر مكتبة اسمه الخاص حتى يكون قابلاً للتصفية. سيتم تضمين عناصر المكتبة التالية:',
    atleastOneLibItem: 'يرجى تحديد عنصر مكتبة واحد على الأقل للبدء',
    republishWarning:
      'ملاحظة: بعض العناصر المحددة معينة على أنه نشرها أو تقديمها من قبل. يجب عليك فقط إعادة إرسال العناصر عند تحديث مكتبة موجودة أو إرسالها.',
  },
  E = {
    title: 'تم إرسال المكتبة',
    content: 'شكرا لك {{authorName}}. لقد تم إرسال مكتبتك للمراجعة. يمكنك تتبع الحالة',
  },
  m = { resetLibrary: 'إعادة ضبط المكتبة', removeItemsFromLib: 'إزالة العناصر المحددة من المكتبة' },
  b = {
    header: 'تصدير الصورة',
    label: {
...
سيزيد حجم الملف المصدر.`,
    ...
    button: { exportToPng: 'PNG', exportToSvg: 'SVG', copyPngToClipboard: 'نسخ إلى الحافظة' },
  },
  p = {
...
أو لصق في محرر نص موجود`,
    unableToEmbed:
      'تضمين هذا الرابط غير مسموح حاليًا. افتح بلاغاً على GitHub لطلب عنوان Url القائمة البيضاء',
    unrecognizedLinkFormat:
      "الرابط الذي ضمنته لا يتطابق مع التنسيق المتوقع. الرجاء محاولة لصق النص 'المضمن' المُزوَد من موقع المصدر",
  },
  S = {
    transparent: 'شفاف',
    black: 'أسود',
  ...
  x = {
    ...
    modal: {
      loadFromFile: {
        ...
        button: 'تحميل من ملف',
        description:
          'سيتم التحميل من الملف <bold>استبدال المحتوى الموجود</bold>.<br></br>يمكنك النسخ الاحتياطي لرسمك أولاً باستخدام أحد الخيارات أدناه.',
      },
      shareableLink: {
        title: 'تحميل من رابط',
        button: 'استبدال محتواي',
        description:
          'سيتسبب تحميل رسمة خارجية <bold>باستبدال محتواك الموجود حالياً</bold>.<br></br>بإمكانك إجراء النسخ الاحتياطي لرسمتك الحالية باستخدام أحد الخيارات أدناه.',
      },
    },
  },
