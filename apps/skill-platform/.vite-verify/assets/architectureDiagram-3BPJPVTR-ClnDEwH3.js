import { p as hr } from './chunk-4BX2VUAB-T0fy3fOG.js';
import { c as Se } from './cytoscape.esm-DH6-wILU.js';
import { s as cr } from './markdown-it-vendor-DL4wSELR.js';
...
import { g as fr } from './ui-vendor-C-FKu2uc.js';
import { p as lr } from './wardley-L42UT6IY-PPlg582g.js';
var he = { exports: {} },
  le = { exports: {} },
  fe = { exports: {} },
  gr = fe.exports,
        ...
        (function (G, N) {
          ...
          return (function (A) {
            ...
            return (
              ...
              (N.d = function (g, h, a) {
                N.o(g, h) ||
                  Object.defineProperty(g, h, { configurable: !1, enumerable: !0, get: a });
              }),
              (N.n = function (g) {
                var h =
                  g && g.__esModule
            ...
            function (A, G, N) {
              ...
              ((r.prototype.getEdges = function () {
                ...
                (r.prototype.scatter = function () {
                  ...
                  ((s = e.WORLD_CENTER_Y + i.nextDouble() * (T - l) + l),
                    (this.rect.x = t),
                    (this.rect.y = s));
                }),
              ...
              ((s.prototype.getNodes = function () {
                ...
                (s.prototype.remove = function (c) {
                  ...
                  if (c instanceof i) {
                    ...
                    var C = u.source.edges.indexOf(u),
                      S = u.target.edges.indexOf(u);
                    if (!(C > -1 && S > -1)) throw "Source and/or target doesn't know this edge!";
                    (u.source.edges.splice(C, 1),
                      u.target != u.source && u.target.edges.splice(S, 1));
                ...
                (s.prototype.updateLeftTop = function () {
                  for (
                    ...
                    var S = L[C];
                    ((T = S.getTop()), (u = S.getLeft()), c > T && (c = T), l > u && (l = u));
                  }
              ...
              ((a.prototype.addRoot = function () {
                ...
                (a.prototype.add = function (e, i, f, r, d) {
                  if (f == null && r == null && d == null) {
                    ...
                    if (t == s) return ((f.isInterGraph = !1), t.add(f, r, d));
                    if (
                      ((f.isInterGraph = !0),
                      (f.source = r),
                      (f.target = d),
                ...
                (a.prototype.remove = function (e) {
                  if (e instanceof g) {
                    ...
                    if (
                      !(i == this.rootGraph || (i.parent != null && i.parent.graphManager == this))
                    )
                      throw 'Invalid parent node!';
                    var f = [];
                    f = f.concat(i.getEdges());
                    for (var r, d = f.length, t = 0; t < d; t++) ((r = f[t]), i.remove(r));
                    var s = [];
                    s = s.concat(i.getNodes());
                    var o;
                    d = s.length;
                    for (var t = 0; t < d; t++) ((o = s[t]), i.remove(o));
                    ...
                    if (
                      (r.source.edges.splice(c, 1),
                      (c = r.target.edges.indexOf(r)),
                      r.target.edges.splice(c, 1),
                ...
                (a.prototype.includesInvalidEdge = function () {
                  for (var e, i = [], f = this.edges.length, r = 0; r < f; r++)
                    ((e = this.edges[r]),
                      this.isOneAncestorOfOther(e.source, e.target) && i.push(e));
            ...
            function (A, G, N) {
              ...
              ((h.calcSeparationAmount = function (a, e, i, f) {
                ...
                var r = new Array(2);
                (this.decideDirectionsForOverlappingNodes(a, e, r),
                  (i[0] = Math.min(a.getRight(), e.getRight()) - Math.max(a.x, e.x)),
                  (i[1] = Math.min(a.getBottom(), e.getBottom()) - Math.max(a.y, e.y)),
                  a.getX() <= e.getX() && a.getRight() >= e.getRight()
                    ? (i[0] += Math.min(e.getX() - a.getX(), a.getRight() - e.getRight()))
                    : e.getX() <= a.getX() &&
                      e.getRight() >= a.getRight() &&
                      (i[0] += Math.min(a.getX() - e.getX(), e.getRight() - a.getRight())),
                  a.getY() <= e.getY() && a.getBottom() >= e.getBottom()
                    ? (i[1] += Math.min(e.getY() - a.getY(), a.getBottom() - e.getBottom()))
                    : e.getY() <= a.getY() &&
                      e.getBottom() >= a.getBottom() &&
                      (i[1] += Math.min(a.getY() - e.getY(), e.getBottom() - a.getBottom())));
                var d = Math.abs(
                ...
                (h.decideDirectionsForOverlappingNodes = function (a, e, i) {
                  (a.getCenterX() < e.getCenterX() ? (i[0] = -1) : (i[0] = 1),
                    a.getCenterY() < e.getCenterY() ? (i[1] = -1) : (i[1] = 1));
                }),
                (h.getIntersection2 = function (a, e, i) {
                  var f = a.getCenterX(),
                    ...
                    d = e.getCenterX(),
                    t = e.getCenterY();
                  if (a.intersects(e)) return ((i[0] = f), (i[1] = r), (i[2] = d), (i[3] = t), !0);
                  var s = a.getX(),
                    o = a.getY(),
                    c = a.getRight(),
                    l = a.getX(),
                    ...
                    m = !1;
                  if (f === d) {
                    if (r > t) return ((i[0] = f), (i[1] = o), (i[2] = d), (i[3] = X), !1);
                    if (r < t) return ((i[0] = f), (i[1] = T), (i[2] = d), (i[3] = C), !1);
                  } else if (r === t) {
                    if (f > d) return ((i[0] = s), (i[1] = r), (i[2] = S), (i[3] = t), !1);
                    if (f < d) return ((i[0] = c), (i[1] = r), (i[2] = P), (i[3] = t), !1);
                  } else {
                    ...
                    if (
                      ...
                      switch (R) {
                        case 1:
                          ...
                          break;
                        case 2:
                          ((F = u), (W = r + v * y), (i[0] = F), (i[1] = W));
                          break;
                        case 3:
                          ((W = T), (F = f + L / y), (i[0] = F), (i[1] = W));
                          break;
                        case 4:
                          ((F = l), (W = r + -v * y), (i[0] = F), (i[1] = W));
                          break;
                      }
                    if (!m)
                      switch (w) {
                ...
                (h.getIntersection = function (a, e, i, f) {
                  if (f == null) return this.getIntersection2(a, e, i);
                  var r = a.x,
                    d = a.y,
                    t = e.x,
                    s = e.y,
                  ...
                  return (
                    ...
                    Z === 0
                      ? null
                      : ((u = (C * X - S * V) / Z), (v = (P * V - L * X) / Z), new g(u, v))
                  );
                }),
                (h.angleOfVector = function (a, e, i, f) {
                  ...
                  return (
                    a !== i
                      ? ((r = Math.atan((f - e) / (i - a))),
                        i < a ? (r += Math.PI) : f < e && (r += this.TWO_PI))
                      : f < e
              ...
              function g(h, a, e, i) {
                ((this.x = 0),
                  ...
                  h != null &&
                    ...
                    e != null &&
                    i != null &&
                    ((this.x = h), (this.y = a), (this.width = e), (this.height = i)));
              }
              ((g.prototype.getX = function () {
                return this.x;
              }),
            ...
            function (A, G, N) {
              function g(o) {
                if (Array.isArray(o)) {
                  for (var c = 0, l = Array(o.length); c < o.length; c++) l[c] = o[c];
                  return l;
              ...
              ((s.RANDOM_SEED = 1),
                ...
                (s.prototype.transform = function (o) {
                  if (o == null) this.transform(new r(0, 0));
                  else {
                    var c = new d(),
                ...
                (s.prototype.getFlatForest = function () {
                  for (
                    var o = [], c = !0, l = this.graphManager.getRoot().getNodes(), T = !0, u = 0;
                    u < l.length;
                    u++
                  )
                  ...
                  for (C = C.concat(l); C.length > 0 && c; ) {
                    for (L.push(C[0]); L.length > 0 && c; ) {
                      var S = L[0];
                      (L.splice(0, 1), v.add(S));
                      for (var V = S.getEdges(), u = 0; u < V.length; u++) {
                        var X = V[u].getOtherEnd(S);
                        if (P.get(S) != X)
                          if (!v.has(X)) (L.push(X), P.set(X, S));
                          else {
                            c = !1;
                            break;
                          }
                ...
                (s.prototype.createDummyNodesForBendpoints = function (o) {
                  ...
                  var L = this.newEdge(null);
                  return (
                    this.graphManager.add(L, l, o.target),
                  ...
                  for (var c = 0; c < o.length; c++) {
                    ...
                    if (l.bendpoints.length > 0) {
                      for (var T = this.edgeToDummyNodes.get(l), u = 0; u < T.length; u++) {
                        var v = T[u],
                          L = new r(v.getCenterX(), v.getCenterY()),
                          P = l.bendpoints.get(u);
                ...
                (s.findCenterOfTree = function (o) {
                  ...
                  for (S = S.concat(l); !u; ) {
                    ...
                    ((l = l.concat(S)), (c.length == 1 || c.length == 2) && ((u = !0), (v = c[0])));
                  }
                  return v;
                }),
            ...
            function (A, G, N) {
              ...
              ((h.prototype.getWorldOrgX = function () {
                ...
                (h.prototype.transformX = function (a) {
                  ...
                  return (
                    i != 0 &&
                      (e = this.ldeviceOrgX + ((a - this.lworldOrgX) * this.ldeviceExtX) / i),
                    e
                  );
                }),
                (h.prototype.transformY = function (a) {
                  ...
                  return (
                    i != 0 &&
                      (e = this.ldeviceOrgY + ((a - this.lworldOrgY) * this.ldeviceExtY) / i),
                    e
                  );
                }),
                (h.prototype.inverseTransformX = function (a) {
                  ...
                  return (
                    i != 0 &&
                      (e = this.lworldOrgX + ((a - this.ldeviceOrgX) * this.lworldExtX) / i),
                    e
                  );
                }),
                (h.prototype.inverseTransformY = function (a) {
                  ...
                  return (
                    i != 0 &&
                      (e = this.lworldOrgY + ((a - this.ldeviceOrgY) * this.lworldExtY) / i),
                    e
                  );
                }),
            ...
            function (A, G, N) {
              ...
              ((r.prototype.initParameters = function () {
                ...
                (r.prototype.calcIdealEdgeLengths = function () {
                  for (
                    var t, s, o, c, l, T, u, v = this.getGraphManager().getAllEdges(), L = 0;
                    L < v.length;
                    L++
                  )
                    ((t = v[L]),
                      ...
                      t.isInterGraph &&
                        ...
                        this.useSmartIdealEdgeLengthCalculation &&
                          (t.idealLength += T + u - 2 * e.SIMPLE_NODE_SIZE),
                        (o = t.getLca().getInclusionTreeDepth()),
                        (t.idealLength +=
                          s *
                          a.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR *
                          (c.getInclusionTreeDepth() + l.getInclusionTreeDepth() - 2 * o))));
                }),
                ...
                (r.prototype.calcRepulsionForce = function (t, s) {
                  var o = t.getRect(),
                    ...
                    V;
                  if (o.intersects(c)) {
                    (i.calcSeparationAmount(o, c, l, a.DEFAULT_EDGE_LENGTH / 2),
                      (S = 2 * l[0]),
                      (V = 2 * l[1]));
                    var X = (t.noOfChildren * s.noOfChildren) / (t.noOfChildren + s.noOfChildren);
                    ((t.repulsionForceX -= X * S),
                      (t.repulsionForceY -= X * V),
                      (s.repulsionForceX += X * S),
                      (s.repulsionForceY += X * V));
                  } else
                    (this.uniformLeafNodeSizes && t.getChild() == null && s.getChild() == null
                      ? ((u = c.getCenterX() - o.getCenterX()),
                        (v = c.getCenterY() - o.getCenterY()))
                      : (i.getIntersection(o, c, T), (u = T[2] - T[0]), (v = T[3] - T[1])),
                      Math.abs(u) < a.MIN_REPULSION_DIST && (u = f.sign(u) * a.MIN_REPULSION_DIST),
                  ...
                  ((s = t.getOwner()),
                    ...
                    t.getOwner() == this.graphManager.getRoot()
                      ...
                      : ((L = s.getEstimatedSize() * this.compoundGravityRangeFactor),
                        (u > L || v > L) &&
                          ((t.gravitationForceX =
                            -this.gravityConstant * l * this.compoundGravityConstant),
                          (t.gravitationForceY =
                ...
                (r.prototype.calcGrid = function (t) {
                  ...
                  for (var c = new Array(s), l = 0; l < s; l++) c[l] = new Array(o);
                  for (var l = 0; l < s; l++) for (var T = 0; T < o; T++) c[l][T] = new Array();
                  return c;
                }),
                      ...
                      for (var L = t.startY - 1; L < t.finishY + 2; L++)
                        if (!(v < 0 || L < 0 || v >= u.length || L >= u[0].length)) {
                          for (var P = 0; P < u[v][L].length; P++)
                            if (
                              ((T = u[v][L][P]),
                              !(t.getOwner() != T.getOwner() || t == T) && !s.has(T) && !l.has(T))
                            ) {
                              var C =
                              ...
                              C <= this.repulsionRange && S <= this.repulsionRange && l.add(T);
                            }
                        }
              ...
              ((g.multMat = function (h, a) {
                for (var e = [], i = 0; i < h.length; i++) {
                  ...
                  for (var f = 0; f < a[0].length; f++) {
                    e[i][f] = 0;
                    for (var r = 0; r < h[0].length; r++) e[i][f] += h[i][r] * a[r][f];
                  }
                }
                return e;
              }),
                (g.transpose = function (h) {
                  for (var a = [], e = 0; e < h[0].length; e++) {
                    a[e] = [];
                    for (var i = 0; i < h.length; i++) a[e][i] = h[i][e];
                  }
                  return a;
                }),
                (g.multCons = function (h, a) {
                  for (var e = [], i = 0; i < h.length; i++) e[i] = h[i] * a;
                  return e;
                }),
                (g.minusOp = function (h, a) {
                  for (var e = [], i = 0; i < h.length; i++) e[i] = h[i] - a[i];
                  return e;
                }),
                (g.dotProduct = function (h, a) {
                  for (var e = 0, i = 0; i < h.length; i++) e += h[i] * a[i];
                  return e;
                }),
                (g.mag = function (h) {
                ...
                (g.normalize = function (h) {
                  for (var a = [], e = this.mag(h), i = 0; i < h.length; i++) a[i] = h[i] / e;
                  return a;
                }),
                (g.multGamma = function (h) {
                  for (var a = [], e = 0, i = 0; i < h.length; i++) e += h[i];
                  e *= -1 / h.length;
                  for (var f = 0; f < h.length; f++) a[f] = e + h[f];
                  return a;
                }),
                (g.multL = function (h, a, e) {
                  for (var i = [], f = [], r = [], d = 0; d < a[0].length; d++) {
                    for (var t = 0, s = 0; s < a.length; s++) t += -0.5 * a[s][d] * h[s];
                    f[d] = t;
                  }
                  for (var o = 0; o < e.length; o++) {
                    for (var c = 0, l = 0; l < e.length; l++) c += e[o][l] * f[l];
                    r[o] = c;
                  }
                  for (var T = 0; T < a.length; T++) {
                    for (var u = 0, v = 0; v < a[0].length; v++) u += a[T][v] * r[v];
                    i[T] = u;
                  }
                  return i;
                }),
              ...
              var a = N(11),
                e = (function () {
                  function i(f, r) {
                    ...
                    var d = void 0;
                    (f instanceof a ? (d = f.size()) : (d = f.length),
                      this._quicksort(f, 0, d - 1));
                  }
                  return (
                    g(i, [
                      {
                      ...
                      },
                      {
                        ...
                        value: function (r, d, t) {
                          for (var s = this._get(r, d), o = d, c = t; ; ) {
                            for (; this.compareFunction(s, this._get(r, c)); ) c--;
                            for (; this.compareFunction(this._get(r, o), s); ) o++;
                            if (o < c) (this._swap(r, o, c), o++, c--);
                            else return c;
                          }
                        },
                      },
            ...
            function (A, G, N) {
              ...
              ((g.svd = function (h) {
                ...
                ((this.s = (function (Tt) {
                  ...
                  (this.U = (function (Tt) {
                    var Ct = function Bt(bt) {
                      ...
                      for (var zt = [], Ft = 0; Ft < bt[0]; Ft++) zt.push(Bt(bt.slice(1)));
                      return zt;
                    };
                    return Ct(Tt);
                  })([this.m, a])),
                ...
                for (
                  ...
                  if (t < r) {
                    this.s[t] = 0;
                    for (var s = t; s < this.m; s++) this.s[t] = g.hypot(this.s[t], h[s][t]);
                    if (this.s[t] !== 0) {
                      h[t][t] < 0 && (this.s[t] = -this.s[t]);
                      for (var o = t; o < this.m; o++) h[o][t] /= this.s[t];
                      h[t][t] += 1;
                    }
                    this.s[t] = -this.s[t];
                  }
                  for (var c = t + 1; c < this.n; c++) {
                    if (
                      ...
                      l = -l / h[t][t];
                      for (var u = t; u < this.m; u++) h[u][c] += l * h[u][t];
                    }
                    e[c] = h[t][c];
                  }
                  if (
                  ...
                  if (t < d) {
                    e[t] = 0;
                    for (var L = t + 1; L < this.n; L++) e[t] = g.hypot(e[t], e[L]);
                    if (e[t] !== 0) {
                      e[t + 1] < 0 && (e[t] = -e[t]);
                      for (var P = t + 1; P < this.n; P++) e[P] /= e[t];
                      e[t + 1] += 1;
                    }
                    if (
                      ((e[t] = -e[t]),
                      ...
                      for (var S = t + 1; S < this.n; S++)
                        for (var V = t + 1; V < this.m; V++) i[V] += e[S] * h[V][S];
                      for (var X = t + 1; X < this.n; X++)
                        for (var Z = -e[X] / e[t + 1], D = t + 1; D < this.m; D++)
                          h[D][X] += Z * i[D];
                    }
                    for (var _ = t + 1; _ < this.n; _++) this.V[_][t] = e[_];
                  }
                }
                ...
                for (var z = this.n - 1; z >= 0; z--) {
                  if (
                    ...
                    for (var Y = z + 1; Y < a; Y++) {
                      ...
                      rt = -rt / this.V[z + 1][z];
                      for (var M = z + 1; M < this.n; M++) this.V[M][Y] += rt * this.V[M][z];
                    }
                ...
                for (var $ = n - 1, tt = Math.pow(2, -52), ht = Math.pow(2, -966); n > 0; ) {
                  ...
                  if (J === n - 2) It = 4;
                    ...
                    for (Nt = n - 1; Nt >= J && Nt !== J; Nt--) {
                      var vt =
                        (Nt !== n ? Math.abs(e[Nt]) : 0) + (Nt !== J + 1 ? Math.abs(e[Nt - 1]) : 0);
                    ...
                    case 1:
                      {
                        ...
                        for (var gt = n - 2; gt >= J; gt--) {
                          var mt = g.hypot(this.s[gt], it),
                            ...
                            Ot = it / mt;
                          ((this.s[gt] = mt),
                            gt !== J && ((it = -Ot * e[gt - 1]), (e[gt - 1] = At * e[gt - 1])));
                    ...
                    case 2:
                      {
                        ...
                        for (var Rt = J; Rt < n; Rt++) {
                          ...
                          for (var St = 0; St < this.m; St++)
                            ((Ht = Ut * this.U[St][Rt] + Pt * this.U[St][J - 1]),
                              (this.U[St][J - 1] = -Pt * this.U[St][Rt] + Ut * this.U[St][J - 1]),
                              (this.U[St][Rt] = Ht));
                        }
                      }
                      break;
                    case 3:
                      {
                        ...
                        (function (Tt, Ct) {
                          ...
                          ((ct = Math.sqrt(q * q + at)), q < 0 && (ct = -ct), (ct = at / (q + ct)));
                        for (var nt = (k + Vt) * (k - Vt) + ct, et = k * K, j = J; j < n - 1; j++) {
                          var ut = g.hypot(nt, et),
                            wt = nt / ut,
                            pt = et / ut;
                          (j !== J && (e[j - 1] = ut),
                    ...
                    case 4:
                      {
                        if (this.s[J] <= 0) {
                          ...
                          for (var ot = 0; ot <= $; ot++) this.V[ot][J] = -this.V[ot][J];
                        }
                ...
                return (
                  g(e, [
                        ...
                        for (var d = 1; d < this.iMax; d++)
                          for (var t = 1; t < this.jMax; t++) {
                            ...
                            this.sequence1[d - 1] === this.sequence2[t - 1]
                              ? (s = this.grid[d - 1][t - 1] + this.match_score)
                              : (s = this.grid[d - 1][t - 1] + this.mismatch_penalty);
                            var o = this.grid[d - 1][t] + this.gap_penalty,
                              c = this.grid[d][t - 1] + this.gap_penalty,
                              l = [s, o, c],
                              T = this.arrayAllMaxIndexes(l);
                            ((this.grid[d][t] = l[T[0]]),
                              (this.tracebackGrid[d][t] = [
                                T.includes(0),
                                T.includes(1),
                                T.includes(2),
                              ]));
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        for (
                          ...
                          var r = f[0],
                            d = this.tracebackGrid[r.pos[0]][r.pos[1]];
                          (d[0] &&
                            f.push({
                    ...
                    },
                    {
                      key: 'getAllIndexes',
                      value: function (f, r) {
                        for (var d = [], t = -1; (t = f.indexOf(r, t + 1)) !== -1; ) d.push(t);
                        return d;
                      },
                    },
                    {
            ...
            function (A, G, N) {
              ...
              ((g.FDLayout = N(18)),
                ...
                (g.LNode = N(3)),
                (g.Layout = N(15)),
                (g.LayoutConstants = N(0)),
                (g.NeedlemanWunsch = N(27)),
                (g.Matrix = N(24)),
                (g.SVD = N(26)),
                (A.exports = g));
            },
                ...
                765: (a, e, i) => {
                  ...
                  ((D.prototype.newGraphManager = function () {
                    ...
                    (D.prototype.tick = function () {
                      ...
                      if (this.isGrowthFinished) {
                        ...
                        (this.afterGrowthIterations % 10 == 0 &&
                          ...
                          o.PURE_INCREMENTAL
                            ? (this.coolingFactor =
                                (l.DEFAULT_COOLING_FACTOR_INCREMENTAL / 2) *
                        ...
                        if (o.RELAX_MOVEMENT_ON_CONSTRAINTS)
                          ...
                          this.constraints.relativePlacementConstraint.forEach(function (M) {
                            if (M.left) {
                              ...
                              var tt = F.has(M.top) ? F.get(M.top) : M.top,
                                ht = F.has(M.bottom) ? F.get(M.bottom) : M.bottom;
                              (z.has(tt) ? z.get(tt).push(ht) : z.set(tt, [ht]),
                                z.has(ht) ? z.get(ht).push(tt) : z.set(ht, [tt]));
                            }
                          });
                          var Y = function (H, $) {
                              var tt = [],
                            ...
                            this.nodesInRelativeHorizontal.forEach(function (B) {
                              if (!n.fixedNodesOnHorizontal.has(B)) {
                                ...
                                (n.dummyToNodeForVerticalAlignment.has(B)
                                  ? (M = n.idToNodeMap.get(
                                      n.dummyToNodeForVerticalAlignment.get(B)[0],
                                    ).displacementX)
                                  : (M = n.idToNodeMap.get(B).displacementX),
                                  n.nodeToRelativeConstraintMapHorizontal
                                    .get(B)
                                    .forEach(function (H) {
                                      if (H.right) {
                                  ...
                                  n.nodeToTempPositionMapHorizontal.set(
                                    B,
                                    n.nodeToTempPositionMapHorizontal.get(B) + M,
                                  ),
                                  n.dummyToNodeForVerticalAlignment.has(B)
                            ...
                            this.nodesInRelativeVertical.forEach(function (B) {
                              if (!n.fixedNodesOnHorizontal.has(B)) {
                                ...
                                (n.dummyToNodeForHorizontalAlignment.has(B)
                                  ? (M = n.idToNodeMap.get(
                                      n.dummyToNodeForHorizontalAlignment.get(B)[0],
                                    ).displacementY)
                                  : (M = n.idToNodeMap.get(B).displacementY),
                                  n.nodeToRelativeConstraintMapVertical
                                    .get(B)
                                    .forEach(function (H) {
                                      if (H.bottom) {
                                        var $ =
                                          ...
                                          n.nodeToTempPositionMapVertical.get(B) -
                                          M;
                                        $ < H.gap && (M -= H.gap - $);
                                      } else {
                                        var $ =
                                  ...
                                  n.nodeToTempPositionMapVertical.set(
                                    B,
                                    n.nodeToTempPositionMapVertical.get(B) + M,
                                  ),
                                  n.dummyToNodeForHorizontalAlignment.has(B)
                              ...
                              for (var Q = 0, z = 0, y = 0; y < x.length; y++)
                                if (this.dummyToNodeForVerticalAlignment.has(x[y])) {
                                  ...
                                  ((Q += Y.length * this.idToNodeMap.get(Y[0]).displacementX),
                                    (z += Y.length));
                                } else ((Q += this.idToNodeMap.get(x[y]).displacementX), z++);
                              ...
                              for (var Q = 0, z = 0, y = 0; y < x.length; y++)
                                if (this.dummyToNodeForHorizontalAlignment.has(x[y])) {
                                  ...
                                  ((Q += Y.length * this.idToNodeMap.get(Y[0]).displacementY),
                                    (z += Y.length));
                                } else ((Q += this.idToNodeMap.get(x[y]).displacementY), z++);
                              for (var rt = Q / z, y = 0; y < x.length; y++)
                                this.dummyToNodeForHorizontalAlignment.has(x[y])
                                  ? this.dummyToNodeForHorizontalAlignment
                                      .get(x[y])
                    ...
                    (D.prototype.positionNodesRadially = function (n) {
                      for (
                        ...
                        F % p == 0 &&
                          ...
                          (E = 0));
                        var W = n[F],
                          x = P.findCenterOfTree(W);
                        ((m.x = R),
                          (m.y = y),
                          (w = D.radialLayout(W, x, m)),
                          w.y > E && (E = Math.floor(w.y)),
                          (R = Math.floor(w.x + o.DEFAULT_COMPONENT_SEPERATION)));
                      }
                      ...
                      Object.keys(m).forEach(function (W) {
                        if (m[W].length > 1) {
                          ...
                          ((z.id = x),
                            ...
                            (n.idToDummyNode[x] = z));
                          var Y = n.getGraphManager().add(n.newGraph(), z),
                            rt = Q.getChild();
                          rt.add(z);
                    ...
                    (D.prototype.tileNodesByFavoringDim = function (n, m, p) {
                      ...
                      for (var z = 0; z < n.length; z++) {
                        ...
                        if (w.rows.length == 0) this.insertNodeToRow(w, Y, 0, m);
                          ...
                          (w.idealRowWidth || (rt = this.getShortestRowIndex(w)),
                            this.insertNodeToRow(w, Y, rt, m));
                    ...
                    (D.prototype.insertNodeToRow = function (n, m, p, E) {
                      ...
                      var W = 0;
                      (F > n.rowHeight[p] &&
                        ((W = n.rowHeight[p]), (n.rowHeight[p] = F), (W = n.rowHeight[p] - W)),
                        (n.height += W),
                        n.rows[p].push(m));
                    }),
                  ...
                  ((d.prototype.calculateDisplacement = function () {
                    ...
                    (this.getChild() != null && this.fixedNodeWeight
                      ...
                      Math.abs(this.displacementX) > s.coolingFactor * s.maxNodeDisplacement &&
                        (this.displacementX =
                          s.coolingFactor * s.maxNodeDisplacement * r.sign(this.displacementX)),
                      Math.abs(this.displacementY) > s.coolingFactor * s.maxNodeDisplacement &&
                        (this.displacementY =
                          s.coolingFactor * s.maxNodeDisplacement * r.sign(this.displacementY)),
                      this.child &&
                    ...
                    (d.prototype.propogateDisplacementToChildren = function (s, o) {
                      for (var c = this.getChild().getNodes(), l, T = 0; T < c.length; T++)
                        ((l = c[T]),
                          l.getChild() == null
                            ? ((l.displacementX += s), (l.displacementY += o))
                            : l.propogateDisplacementToChildren(s, o));
                    }),
                  ...
                  ((o.handleConstraints = function (c) {
                        ...
                        (nt.forEach(function (lt, ot) {
                          (lt == 0
                            ? (ut.push(ot),
                              K ||
                                (k == 'horizontal'
                                  ? et.set(ot, u.has(ot) ? v[u.get(ot)] : q.get(ot))
                            ...
                            at.forEach(function (lt) {
                              ...
                              if (
                                ...
                                (ot.forEach(function (st) {
                                  k == 'horizontal'
                                    ? (et.set(st, u.has(st) ? v[u.get(st)] : q.get(st)),
                                      (Lt += et.get(st)))
                                    : (et.set(st, u.has(st) ? L[u.get(st)] : q.get(st)),
                                      (Lt += et.get(st)));
                                }),
                                  (Lt = Lt / ot.length),
                                  lt.forEach(function (st) {
                                ...
                                (lt.forEach(function (st) {
                                  k == 'horizontal'
                                    ? (ft += u.has(st) ? v[u.get(st)] : q.get(st))
                            ...
                            Lt.forEach(function (ft) {
                              if (et.get(ft.id) < et.get(ot) + ft.gap)
                                if (K && K.has(ft.id)) {
                                  ...
                                  if (
                                    (k == 'horizontal'
                                      ? (st = u.has(ft.id) ? v[u.get(ft.id)] : q.get(ft.id))
                          ...
                          (j.forEach(function (lt, ot) {
                            if (pt.has(ot)) {
                              ...
                              if (!Lt) {
                                var bt = !1,
                                  zt = void 0;
                                (xt.forEach(function (Ft, kt) {
                                  Ft.has([].concat(f(lt))[0]) && ((bt = !0), (zt = kt));
                                }),
                                  bt
                                    ? lt.forEach(function (Ft) {
                                        xt[zt].add(Ft);
                              ...
                              try {
                                for (
                                  ...
                                  var Ft = zt.value,
                                    kt = void 0;
                                  k == 'horizontal'
                                    ? (kt = u.has(Ft) ? v[u.get(Ft)] : q.get(Ft))
                                    : (kt = u.has(Ft) ? L[u.get(Ft)] : q.get(Ft));
                                  var Kt = et.get(Ft);
                                  (kt < Lt && (Lt = kt),
                                    kt > st && (st = kt),
                                    Kt < ft && (ft = Kt),
                      ...
                      _ = function (U) {
                        ...
                        if (
                          (U.forEach(function (j) {
                            j.left
                              ? v[u.get(j.left)] - v[u.get(j.right)] >= 0
                                ? k++
                                : K++
                              : L[u.get(j.top)] - L[u.get(j.bottom)] >= 0
                                ? q++
                                : at++;
                          }),
                          k > K && q > at)
                        ...
                        else if (k > K) for (var nt = 0; nt < u.size; nt++) v[nt] = -1 * v[nt];
                    ...
                    if (
                      ...
                      if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 1)
                              ...
                              var U = l.alignmentConstraint.vertical,
                                k = function (et) {
                                  ...
                                  var ut = new Set(
                                    ...
                                    wt = void 0;
                                  (ut.size > 0
                                    ? (wt = v[u.get(ut.values().next().value)])
                                    : (wt = Z(j).x),
                                    U[et].forEach(function (pt) {
                                      ((E[b] = [wt, L[u.get(pt)]]),
                        ...
                        if (z < x.size / 2) (_(l.relativePlacementConstraint), (R = !1), (w = !1));
                        else {
                          var B = new Map(),
                            M = new Map(),
                            H = [];
                          ...
                          (Q[Y].forEach(function (b, U) {
                            ((y[U] = [v[u.get(b)], L[u.get(b)]]),
                              (E[U] = []),
                              $.has(b) ? (E[U][0] = $.get(b)) : (E[U][0] = v[u.get(b)]),
                              tt.has(b) ? (E[U][1] = tt.get(b)) : (E[U][1] = L[u.get(b)]));
                          }),
                            (R = !0));
                        }
                      }
                      if (R) {
                        for (
                          var ht = void 0, J = t.transpose(E), It = t.transpose(y), Nt = 0;
                          Nt < J.length;
                          Nt++
                        )
                    ...
                    if (r.ENFORCE_CONSTRAINTS) {
                      if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 0) {
                        var Et = { x: 0, y: 0 };
                        (l.fixedNodeConstraint.forEach(function (b, U) {
                          var k = { x: v[u.get(b.nodeId)], y: L[u.get(b.nodeId)] },
                            K = b.position,
                            q = X(K, k);
                          ((Et.x += q.x), (Et.y += q.y));
                        }),
                      ...
                      l.relativePlacementConstraint &&
                        (function () {
                          ...
                          if (
                            ...
                            if (l.alignmentConstraint.horizontal)
                              for (
                                var wt = l.alignmentConstraint.horizontal,
                                  pt = function (yt) {
                                    (K.set('dummy' + yt, []),
                          ...
                          var _t = D(lt, 'horizontal', ct, q, Qt),
                ...
                658: (a) => {
                  a.exports =
                    Object.assign != null
                      ...
                      : function (e) {
                          for (
                            var i = arguments.length, f = Array(i > 1 ? i - 1 : 0), r = 1;
                            r < i;
                            r++
                          )
                            f[r - 1] = arguments[r];
                      ...
                      function t(s, o) {
                        ...
                        try {
                          for (
                            ...
                            !(l = (L = v.next()).done) && (c.push(L.value), !(o && c.length === o));
                            l = !0
                          );
                        } catch (P) {
                          ((T = !0), (u = P));
                  ...
                  ((d.getTopMostNodes = function (t) {
                    ...
                    (d.relocateComponent = function (t, s, o) {
                      if (!o.fixedNodeConstraint) {
                        ...
                        if (o.quality == 'draft') {
                          ...
                          try {
                            for (
                              var C = s.nodeIndexes[Symbol.iterator](), S;
                              !(v = (S = C.next()).done);
                              v = !0
                            ) {
                              var V = S.value,
                    ...
                    (d.calcBoundingBox = function (t, s, o, c) {
                      for (
                        ...
                        var D = V[Z];
                        ((L = s[c.get(D.id())] - D.width() / 2),
                          (P = s[c.get(D.id())] + D.width() / 2),
                          (C = o[c.get(D.id())] - D.height() / 2),
                          (S = o[c.get(D.id())] + D.height() / 2),
                          l > L && (l = L),
                          T < P && (T = P),
                          u > C && (u = C),
                          v < S && (v = S));
                  ...
                  var f = i(548),
                    ...
                    T = function (v, L) {
                            ...
                            if (M.outerWidth() != null && M.outerHeight() != null)
                              if (Y.randomize)
                                ...
                                $ = x.add(
                                  new d(
                                    z.graphManager,
                                    new t(M.position('x') - tt.w / 2, M.position('y') - tt.h / 2),
                                    new s(parseFloat(tt.w), parseFloat(tt.h)),
                                  ),
                                );
                            else $ = x.add(new d(this.graphManager));
                            if (
                              (($.id = M.data('id')),
                              ($.nodeRepulsion = m(Y.nodeRepulsion, M)),
                        ...
                        y = function (x, Q, z) {
                          for (var Y = 0, rt = 0, B = 0; B < z.length; B++) {
                            ...
                            if (H && $ && H !== $ && H.getEdgesBetween($).length == 0) {
                              ...
                              ((tt.id = M.id()),
                                (tt.idealLength = m(v.idealEdgeLength, M)),
                                (tt.edgeElasticity = m(v.edgeElasticity, M)),
                                (Y += tt.idealLength),
                                rt++);
                            }
                          }
                          v.idealEdgeLength != null &&
                            (rt > 0
                              ? (l.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = Y / rt)
                              : n(v.idealEdgeLength)
                                ? (l.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH = 50)
                                : (l.DEFAULT_EDGE_LENGTH = c.DEFAULT_EDGE_LENGTH =
                                    v.idealEdgeLength),
                            (l.MIN_REPULSION_DIST = c.MIN_REPULSION_DIST =
                      ...
                      (v.nestingFactor != null &&
                        (l.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
                          c.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
                            v.nestingFactor),
                        v.gravity != null &&
                          (l.DEFAULT_GRAVITY_STRENGTH = c.DEFAULT_GRAVITY_STRENGTH = v.gravity),
                        v.numIter != null && (l.MAX_ITERATIONS = c.MAX_ITERATIONS = v.numIter),
                        v.gravityRange != null &&
                          (l.DEFAULT_GRAVITY_RANGE_FACTOR = c.DEFAULT_GRAVITY_RANGE_FACTOR =
                            v.gravityRange),
                        ...
                        (l.DEFAULT_INCREMENTAL =
                          ...
                          o.DEFAULT_INCREMENTAL =
                            !v.randomize),
                        (l.ANIMATE = c.ANIMATE = o.ANIMATE = v.animate),
                        (l.TILE = v.tile),
                      ...
                      var w = new r(),
                        F = w.newGraphManager();
                      return (
                        E(F.addRoot(), f.getTopMostNodes(S), w, v),
                        y(w, F, V),
                        R(w, v),
                        w.runLayout(),
                        _
                        ...
                        f(v, [
                          {
                            ...
                            value: function () {
                              ...
                              if (
                                (S.layoutUtilities &&
                                  C.packComponents &&
                                  ((m = S.layoutUtilities('get')),
                                  m || (m = S.layoutUtilities()),
                                  (p = !0)),
                                V.nodes().length > 0)
                              )
                                if (p) {
                                  ...
                                  if (
                                    ((D = t.connectComponents(S, C.eles, R)),
                                    ...
                                    if (C.tile) {
                                      var F = new Map(),
                                        ...
                                        x = [],
                                        Q = 0,
                                        z = { nodeIndexes: F, xCoords: W, yCoords: x },
                                        Y = [];
                                      if (
                                        (D.forEach(function (vt, it) {
                                          vt.edges().length == 0 &&
                                            (vt.nodes().forEach(function (gt, mt) {
                                              (w.merge(vt.nodes()[mt]),
                                                gt.isParent() ||
                                                  (z.nodeIndexes.set(vt.nodes()[mt].id(), Q++),
                                                  z.xCoords.push(vt.nodes()[0].position().x),
                                                  z.yCoords.push(vt.nodes()[0].position().y)));
                                            }),
                                            Y.push(it));
                                        }),
                                        w.length > 1)
                                        ...
                                        (_.push({ x: rt.x1 + rt.w / 2, y: rt.y1 + rt.h / 2 }),
                                          D.push(w),
                                          X.push(z));
                                    ...
                                    D.forEach(function (vt, it) {
                                      ((C.eles = vt),
                                        Z.push(l(C, X[it])),
                                        t.relocateComponent(_[it], Z[it], C));
                                    });
                                  } else
                                    D.forEach(function (vt, it) {
                                        ...
                                        (vt
                                          ...
                                          .forEach(function (Ot) {
                                            if (C.quality == 'draft')
                                              ...
                                              Z[it][Ot.id()] &&
                                                mt.nodes.push({
                                                  x: Z[it][Ot.id()].getLeft(),
                                                  y: Z[it][Ot.id()].getTop(),
                                                  width: Z[it][Ot.id()].getWidth(),
                                                  height: Z[it][Ot.id()].getHeight(),
                                                });
                                          }),
                                            ...
                                            if (
                                              ...
                                              if (C.quality == 'draft') {
                                                var Rt = gt.get(Et.id()),
                                                  ...
                                                  Pt = [];
                                                if (Et.isParent()) {
                                                  var St = t.calcBoundingBox(
                                                    Et,
                                                    X[it].xCoords,
                                                    X[it].yCoords,
                                                    gt,
                                                  );
                                                  (Ut.push(St.topLeftX + St.width / 2),
                                                    Ut.push(St.topLeftY + St.height / 2));
                                                } else
                                                ...
                                                Z[it][Et.id()] &&
                                                  Z[it][Dt.id()] &&
                                                  mt.edges.push({
                                                    startX: Z[it][Et.id()].getCenterX(),
                                                    startY: Z[it][Et.id()].getCenterY(),
                                                    endX: Z[it][Dt.id()].getCenterX(),
                                                    endY: Z[it][Dt.id()].getCenterY(),
                                                  });
                                          }),
                                    ...
                                    if (C.quality == 'draft')
                                      ...
                                      M.forEach(function (vt) {
                                        (Object.keys(Z[vt]).forEach(function (it) {
                                          var gt = Z[vt][it];
                                          gt.setCenter(
                                            gt.getCenterX() + tt[ht].dx,
                                            gt.getCenterY() + tt[ht].dy,
                                          );
                                        }),
                                          ht++);
                                      });
                                  ...
                                  if (
                                    (_.push({ x: E.x1 + E.w / 2, y: E.y1 + E.h / 2 }), C.randomize)
                                  ) {
                                    var y = o(C);
                                    X.push(y);
                                  }
                                  C.quality == 'default' || C.quality == 'proof'
                                    ? (Z.push(l(C, X[0])), t.relocateComponent(_[0], Z[0], C))
                                    : t.relocateComponent(_[0], X[0], C);
                                }
                              var J = function (it, gt) {
                                if (C.quality == 'default' || C.quality == 'proof') {
                                      ...
                                      At.labelHeight &&
                                        (At.labelPosVertical == 'top'
                                          ...
                                          : At.labelPosVertical == 'bottom' &&
                                            (mt.y -= At.labelHeight / 2))),
                                    mt == null &&
                                      (mt = { x: it.position('x'), y: it.position('y') }),
                                    { x: mt.x, y: mt.y }
                                  );
                                } else {
                                  var Et = void 0;
                                  return (
                                    ...
                                    Et == null &&
                                      (Et = { x: it.position('x'), y: it.position('y') }),
                                    { x: Et.x, y: Et.y }
                                  );
                                }
                              };
                              if (C.quality == 'default' || C.quality == 'proof' || C.randomize) {
                                var It = t.calcParentsWithoutChildren(S, V),
                                  Nt = V.filter(function (vt) {
                                    return vt.css('display') == 'none';
                                  });
                                ((C.eles = V.not(Nt)),
                                  V.nodes().not(':parent').not(Nt).layoutPositions(P, C, J),
                                  It.length > 0 &&
                ...
                657: (a, e, i) => {
                  var f = i(548),
                    ...
                    t = function (o) {
                        ...
                        x = function (U, k, K) {
                          ...
                          for (q[ct] = U, j[U] = 0; ct >= at; ) {
                            ...
                            for (var xt = C[nt], lt = 0; lt < xt.length; lt++)
                              ((et = L.get(xt[lt])),
                                j[et] == p && ((j[et] = j[nt] + 1), (q[++ct] = et)));
                            D[nt][k] = j[nt] * w;
                          }
                          if (K) {
                            for (var ot = 0; ot < m; ot++) D[ot][k] < Z[ot] && (Z[ot] = D[ot][k]);
                            for (var Lt = 0; Lt < m; Lt++) Z[Lt] > ut && ((ut = Z[Lt]), (wt = Lt));
                          }
                          return wt;
                        },
                        Q = function (U) {
                          ...
                          if (U) {
                            ...
                            for (var q = 0; q < m; q++) Z[q] = p;
                            for (var at = 0; at < F; at++) ((X[at] = k), (k = x(k, at, U)));
                          } else {
                            W();
                            for (var K = 0; K < F; K++) x(X[K], K, U);
                          }
                          for (var ct = 0; ct < m; ct++)
                            for (var nt = 0; nt < F; nt++) D[ct][nt] *= D[ct][nt];
                          for (var et = 0; et < F; et++) _[et] = [];
                          for (var j = 0; j < F; j++)
                            for (var ut = 0; ut < F; ut++) _[j][ut] = D[X[ut]][j];
                        },
                        z = function () {
                          for (
                            var U = d.svd(_),
                            ...
                            for (var et = 0; et < F; et++)
                              ((ct[nt][et] = 0),
                                nt == et &&
                                  (ct[nt][et] = k[nt] / (k[nt] * k[nt] + at / (k[nt] * k[nt]))));
                          }
                          n = r.multMat(r.multMat(q, ct), r.transpose(K));
                        },
                        Y = function () {
                          for (
                            var U = void 0, k = void 0, K = [], q = [], at = [], ct = [], nt = 0;
                            nt < m;
                            nt++
                          )
                          ...
                          for (var et = E, j = E, ut = void 0; ; ) {
                            ...
                            if (
                              ((K = r.multGamma(r.multL(r.multGamma(at), D, n))),
                              (U = r.dotProduct(at, K)),
                              (K = r.normalize(K)),
                              (et = r.dotProduct(at, K)),
                              (ut = Math.abs(et / j)),
                              ut <= 1 + y && ut >= 1)
                            )
                              break;
                          ...
                          for (j = E; ; ) {
                            for (var xt = 0; xt < m; xt++) ct[xt] = q[xt];
                            if (
                              ((ct = r.minusOp(ct, r.multCons(at, r.dotProduct(at, ct)))),
                              (q = r.multGamma(r.multL(r.multGamma(ct), D, n))),
                              (k = r.dotProduct(ct, q)),
                              (q = r.normalize(q)),
                              (et = r.dotProduct(ct, q)),
                              (ut = Math.abs(et / j)),
                              ut <= 1 + y && ut >= 1)
                            )
                              break;
                          ...
                          for (var lt = 0; lt < m; lt++) ct[lt] = q[lt];
                          ((S = r.multCons(at, Math.sqrt(Math.abs(U)))),
                            (V = r.multCons(ct, Math.sqrt(Math.abs(k)))));
                        };
                      (f.connectComponents(c, l, f.getTopMostNodes(T), v),
                        u.forEach(function (b) {
                          f.connectComponents(
                            c,
                            l,
                            f.getTopMostNodes(b.descendants().intersection(l)),
                            v,
                          );
                        }));
                      ...
                      (u.forEach(function (b) {
                        for (
                          var U = b.children().intersection(l);
                        ...
                        (U.nodes(':childless').forEach(function (q, at) {
                          q.connectedEdges().length < K &&
                            ((K = q.connectedEdges().length), (k = at));
                        }),
                          P.set(b.id(), U.nodes(':childless')[k].id()));
                      }),
                        T.forEach(function (b) {
                          var U = void 0;
                          (b.isParent() ? (U = L.get(P.get(b.id()))) : (U = L.get(b.id())),
                            b
                              .neighborhood()
                              .nodes()
                              .forEach(function (k) {
                                l.intersection(b.edgesWith(k)).length > 0 &&
                                  (k.isParent() ? C[U].push(P.get(k.id())) : C[U].push(k.id()));
                              }));
                        }));
                      var Nt = function (U) {
                          var k = L.get(U),
                          ...
                          v.get(U).forEach(function (q) {
                            (c.getElementById(q).isParent() ? (K = P.get(q)) : (K = q),
                              C[k].push(K),
                              C[L.get(K)].push(U));
                          });
                        },
                      ...
                      if (m > 2) {
                        ...
                        return (
                          o.quality == 'draft' || o.step == 'all'
                            ? (Q(R), z(), Y(), (Et = { nodeIndexes: L, xCoords: S, yCoords: V }))
                            : (L.forEach(function (b, U) {
                                (S.push(c.getElementById(U).position('x')),
                                  V.push(c.getElementById(U).position('y')));
                              }),
                              (Et = { nodeIndexes: L, xCoords: S, yCoords: V })),
                          Et
                        );
                      } else {
                        var Ht = L.keys(),
                        ...
                        if ((S.push(Pt.x), V.push(Pt.y), m == 2)) {
                          var Yt = c.getElementById(Ht.next().value),
                            Vt = Yt.outerWidth();
                          (S.push(Pt.x + St / 2 + Vt / 2 + o.idealEdgeLength), V.push(Pt.y));
                        }
                        return ((Et = { nodeIndexes: L, xCoords: S, yCoords: V }), Et);
                      }
                    };
...
var xe = { L: 'left', R: 'right', T: 'top', B: 'bottom' },
  ...
  Pe =
    ((ae = class {
      ...
      addService({ id: O, icon: A, in: G, title: N, iconText: g }) {
        if (this.registeredIds[O] !== void 0)
          throw new Error(
            `The service id [${O}] is already in use by another ${this.registeredIds[O]}`,
          );
        if (G !== void 0) {
          if (O === G) throw new Error(`The service [${O}] cannot be placed within itself`);
      ...
      addJunction({ id: O, in: A }) {
        ...
        if (A !== void 0) {
          if (O === A) throw new Error(`The junction [${O}] cannot be placed within itself`);
        ...
        ((this.registeredIds[O] = 'node'),
          (this.nodes[O] = { id: O, type: 'junction', edges: [], in: A }));
      }
      getJunctions() {
      ...
      addGroup({ id: O, icon: A, in: G, title: N }) {
        ...
        if (G !== void 0) {
          if (O === G) throw new Error(`The group [${O}] cannot be placed within itself`);
          if (this.registeredIds?.[G] === void 0)
            throw new Error(
        ...
        ((this.registeredIds[O] = 'group'), (this.groups[O] = { id: O, icon: A, title: N, in: G }));
      }
      getGroups() {
      ...
      addEdge({
        ...
        (this.edges.push(d),
          this.nodes[O] &&
            this.nodes[A] &&
            (this.nodes[O].edges.push(this.edges[this.edges.length - 1]),
        ...
        if (this.dataStructures === void 0) {
          const O = {},
            A = Object.entries(this.nodes).reduce(
              (e, [i, f]) => (
                (e[i] = f.edges.reduce((r, d) => {
                  const t = this.getNode(d.lhsId)?.in,
                    s = this.getNode(d.rhsId)?.in;
                  if (t && s && t !== s) {
            ...
            G = Object.keys(A)[0],
            N = { [G]: 1 },
            g = Object.keys(A).reduce((e, i) => (i === G ? e : { ...e, [i]: 1 }), {}),
            h = dt((e) => {
              const i = { [e]: [0, 0] },
                f = [e];
              for (; f.length > 0; ) {
            ...
            a = [h(G)];
          for (; Object.keys(g).length > 0; ) a.push(h(Object.keys(g)[0]));
          this.dataStructures = { adjList: A, spatialMaps: a, groupAlignments: O };
        }
  ...
  xr = dt((I, O) => {
    (hr(I, O),
      I.groups.map((A) => O.addGroup(A)),
      I.services.map((A) => O.addService({ ...A, type: 'service' })),
      I.junctions.map((A) => O.addJunction({ ...A, type: 'junction' })),
      I.edges.map((A) => O.addEdge(A)));
  }, 'populateDb'),
  Ge = {
    parser: { yy: void 0 },
    parse: dt(async (I) => {
...
`,
  ...
  Fr = dt(async function (I, O, A, G) {
    const N = A.getConfigField('padding'),
    ...
    await Promise.all(
      O.edges().map(async (i) => {
        ...
        let { x: C, y: S } = i[0].targetEndpoint();
        const V = N + 4;
        if (
          (t && (Wt(r) ? (u += r === 'L' ? -V : V) : (v += r === 'T' ? -V : V + 18)),
          l && (Wt(o) ? (C += o === 'L' ? -V : V) : (S += o === 'T' ? -V : V + 18)),
          !t &&
            A.getNode(f)?.type === 'junction' &&
            (Wt(r) ? (u += r === 'L' ? h : -h) : (v += r === 'T' ? h : -h)),
          !l &&
            A.getNode(s)?.type === 'junction' &&
            (Wt(o) ? (C += o === 'L' ? h : -h) : (S += o === 'T' ? h : -h)),
          i[0]._private.rscratch)
        ) {
          const X = I.insert('g');
          if (
            (X.insert('path')
              .attr('d', `M ${u},${v} L ${L},${P} L${C},${S} `)
              .attr('class', 'edge')
              .attr('id', `${G}-${nr(f, s, { prefix: 'L' })}`),
            d)
          ) {
            const Z = Wt(r) ? se[r](u, a) : u - e,
              D = qt(r) ? se[r](v, a) : v - e;
            X.insert('polygon')
              .attr('points', Ie[r](a))
          ...
          if (T) {
            ...
            else if (Z === 'Y') _.attr('transform', 'translate(' + L + ', ' + P + ') rotate(-90)');
            else if (Z === 'XY') {
              const n = ye(r, o);
              if (n && Nr(n)) {
                const m = _.node().getBoundingClientRect(),
                  [p, E] = Ar(n);
  ...
  Sr = dt(async function (I, O, A, G) {
    const g = A.getConfigField('padding') * 0.75,
      h = A.getConfigField('fontSize'),
      e = A.getConfigField('iconSize') / 2;
    await Promise.all(
      O.nodes().map(async (i) => {
        const f = ie(i);
        if (f.type === 'group') {
          const { h: r, w: d, x1: t, y1: s } = i.boundingBox(),
            o = I.append('rect');
          o.attr('id', `${G}-group-${f.id}`)
            .attr('x', t + e)
            .attr('y', s + e)
            .attr('width', d)
            .attr('height', r)
          ...
          if (f.icon) {
            ...
            (u.html(
              ...
              u.attr('transform', 'translate(' + (l + e + 1) + ', ' + (T + e + 1) + ')'),
              (l += g),
              (T += h / 2 - 1 - 2));
          }
          if (f.label) {
            ...
            (await me(
              ...
              u.attr('transform', 'translate(' + (l + e + 4) + ', ' + (T + e + 2) + ')'));
          }
      ...
      if (g.title) {
        ...
        (await me(
          ...
          r
            ...
            .attr('dominant-baseline', 'middle')
            .attr('text-anchor', 'middle'),
          r.attr('transform', 'translate(' + a / 2 + ', ' + a + ')'));
      }
      const e = h.append('g');
      if (g.icon)
        e.html(`<g>${await pe(g.icon, { height: a, width: a, fallbackPrefix: ne.prefix })}</g>`);
      else if (g.iconText) {
...
function Xe(I, O) {
  O.nodes().map((A) => {
    ...
    ((G.x = A.position().x),
      (G.y = A.position().y),
      I.getElementById(G.id).attr('transform', 'translate(' + (G.x || 0) + ',' + (G.y || 0) + ')'));
  });
}
dt(Xe, 'positionNodes');
function He(I, O) {
  ...
  I.forEach((A) => {
    const {
      ...
      t = {
        ...
        targetGroup: f,
        targetEndpoint:
          i === 'L' ? '0 50%' : i === 'R' ? '100% 50%' : i === 'T' ? '50% 0' : '50% 100%',
      };
    O.add({ group: 'edges', data: t, classes: d });
  });
}
dt(We, 'addEdges');
function Ve(I, O, A) {
  const G = dt(
      (a, e) =>
        Object.entries(a).reduce((i, [f, r]) => {
          let d = 0;
          const t = Object.entries(r);
          if (t.length === 1) return ((i[f] = t[0][1]), i);
          for (let s = 0; s < t.length - 1; s++)
            for (let o = s + 1; o < t.length; o++) {
              const [c, l] = t[s],
                [T, u] = t[o];
              if (A[c]?.[T] === e) ((i[f] ??= []), (i[f] = [...i[f], ...l, ...u]));
    ...
    N = O.map((a) => {
      const e = {},
        i = {};
      return (
        Object.entries(a).forEach(([f, [r, d]]) => {
        ...
        {
          horiz: Object.values(G(e, 'horizontal')).filter((f) => f.length > 1),
          vert: Object.values(G(i, 'vertical')).filter((f) => f.length > 1),
        }
      );
    }),
    [g, h] = N.reduce(
  ...
  return { horizontal: g, vertical: h };
}
dt(Ve, 'getAlignments');
function ze(I, O) {
  const A = [],
    G = dt((g) => `${g[0]},${g[1]}`, 'posToStr'),
    N = dt((g) => g.split(',').map((h) => parseInt(h)), 'strToPos');
  return (
    I.forEach((g) => {
      const h = Object.fromEntries(Object.entries(g).map(([f, r]) => [G(r), f])),
        a = [G([0, 0])],
        e = {},
        i = { L: [-1, 0], R: [1, 0], T: [0, 1], B: [0, -1] };
      for (; a.length > 0; ) {
        const f = a.shift();
        if (f) {
          e[f] = 1;
          ...
          if (r) {
            ...
            Object.entries(i).forEach(([t, s]) => {
              const o = G([d[0] + s[0], d[1] + s[1]]),
                c = h[o];
              c &&
                !e[o] &&
                (a.push(o),
                A.push({ [xe[t]]: c, [xe[Tr(t)]]: r, gap: 1.5 * O.getConfigField('iconSize') }));
            });
          }
        }
      }
...
function Be(I, O, A, G, N, { spatialMaps: g, groupAlignments: h }) {
  return new Promise((a) => {
    ...
    const f = Ve(N, g, h),
      r = ze(g, N),
      d = N.getConfigField('iconSize'),
      t = N.getConfigField('idealEdgeLengthMultiplier') * d,
      s = 0.5 * d,
      o = N.getConfigField('edgeElasticity'),
      c = i.layout({
        name: 'fcose',
        quality: 'proof',
    ...
    (c.one('layoutstop', () => {
      function l(T, u, v, L) {
        ...
        const { x: S, y: V } = T,
          { x: X, y: Z } = u;
        ((C =
          (L - V + ((S - v) * (V - Z)) / (S - X)) / Math.sqrt(1 + Math.pow((V - Z) / (S - X), 2))),
          (P = Math.sqrt(Math.pow(L - V, 2) + Math.pow(v - S, 2) - Math.pow(C, 2))));
        const D = Math.sqrt(Math.pow(X - S, 2) + Math.pow(Z - V, 2));
        P = P / D;
        let _ = (X - S) * (L - V) - (Z - V) * (v - S);
        switch (!0) {
          case _ >= 0:
            _ = 1;
            break;
        ...
        return ((C = Math.abs(C) * _), (P = P * n), { distances: C, weights: P });
      }
      (dt(l, 'getSegmentWeights'), i.startBatch());
      for (const T of Object.values(i.edges()))
        if (T.data?.()) {
          const { x: u, y: v } = T.source().position(),
            { x: L, y: P } = T.target().position();
          if (u !== L && v !== P) {
            const C = T.sourceEndpoint(),
              S = T.targetEndpoint(),
              { sourceDir: V } = be(T),
              [X, Z] = qt(V) ? [C.x, S.y] : [S.x, C.y],
              { weights: D, distances: _ } = l(C, S, X, Z);
...
var Gr = dt(async (I, O, A, G) => {
    const N = G.db;
    N.setDiagramId(O);
    const g = N.getServices(),
      h = N.getJunctions(),
      a = N.getGroups(),
      e = N.getEdges(),
    ...
    (await Fr(r, s, N, O),
      await Sr(t, s, N, O),
      Xe(N, s),
      Ze(void 0, f, N.getConfigField('padding'), N.getConfigField('useMaxWidth')));
  }, 'draw'),
  Ur = { draw: Gr },
  $r = {
    parser: Ge,
