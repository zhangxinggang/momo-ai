...
var u = {
  ...
  D = {
    ...
    couldNotCreateShareableLinkTooBig:
      'Не може да се създаде връзка за споделяне: сцената е твърде голяма',
    ...
    uploadedSecurly:
      'Качването е защитено с криптиране от край до край, което означава, че сървърът Excalidraw и трети страни не могат да четат съдържанието.',
    loadSceneOverridePrompt:
      'Зареждането на външна рисунка ще презапише настоящото ви съдържание. Желаете ли да продължите?',
...
(Ако искате да продължите с локалната рисунка, просто затворете таба на браузъра.)`,
    ...
    confirmAddLibrary:
      'Ще се добавят {{numShapes}} фигура(и) във вашата библиотека. Сигурни ли сте?',
  ...
  a = {
    ...
    brave_measure_text_error: {
      ...
      line2: '',
      line3:
        'Силно препоръчваме да изключите тази настройка. Можете да следвате <link>тези стъпки</link> за това как да го направите.',
      line4: '',
    },
  ...
  t = {
    ...
    text_editing: '',
    linearElementMulti:
      'Кликнете върху последната точка или натиснете Escape или Enter, за да завършите',
...
задръжте ALT за преоразмерите през центъра`,
    ...
    lineEditor_pointSelected:
      'Натиснете Delete за да изтриете точка(и), CtrlOrCmd+D за дуплициране, или извлачете за да преместите',
  ...
  A = {
    ...
    clearCanvasMessage:
      'Ако презареждането не работи, опитайте <button>изчистване на платното.</button>',
    ...
    openIssueMessage:
      'Бяхме много предпазливи да не включите информацията за вашата сцена при грешката. Ако сцената ви не е частна, моля, помислете за последващи действия на нашата <button>тракер за грешки.</button> Моля, включете информация по-долу, като я копирате и добавите в GitHub.',
    sceneContent: 'Съдържание на сцената:',
  },
  l = {
    desc_intro: 'Можете да поканите хора на текущата си сцена да си сътрудничат с вас.',
    desc_privacy:
      'Не се притеснявайте, сесията използва криптиране от край до край, така че каквото нарисувате ще остане частно. Дори нашият сървър няма да може да види какво предлагате.',
    ...
    desc_exitSession:
      'Спирането на сесията ще ви изключи от стаята, но ще можете да продължите да работите със сцената, локално. Имайте предвид, че това няма да засегне други хора и те все още ще могат да си сътрудничат с тяхната версия.',
    shareTitle: '',
  },
  n = { title: 'Грешка' },
  F = {
  ...
  d = {
    ...
    placeholder: {
      ...
      libraryDesc:
        'Описание на библиотеката ви, за да помогнете на хората да разберат приложенията ѝ',
      githubHandle: '',
      twitterHandle: '',
      website: '',
    },
    errors: { required: 'Задължително', website: 'Въведете валиден URL адрес' },
    noteDescription: '',
    noteGuidelines: '',
    noteLicense: '',
    noteItems: '',
  ...
  c = { title: '', content: '' },
  C = { resetLibrary: 'Нулирай библиотека', removeItemsFromLib: '' },
  m = {
    header: '',
    label: {
      withBackground: 'Фон',
    ...
    button: { exportToPng: 'PNG', exportToSvg: 'SVG', copyPngToClipboard: 'Копиране в клипборда' },
  },
  p = {
    tooltip:
      'Вашите рисунки са криптирани от край до край, така че сървърите на Excalidraw няма да могат да ги виждат.',
    link: '',
  },
  b = {
    angle: 'Ъгъл',
...
({{exportColorScheme}})`,
  ...
  v = {
    action: {
      ...
      saveToDisk: { title: 'Запази към диск', button: 'Запази към диск', description: '' },
      excalidrawPlus: {
        title: 'Excalidraw+',
    ...
    modal: {
      loadFromFile: { title: 'Зареди от файл', button: 'Зареди от файл', description: '' },
      shareableLink: {
