...
var e = {
    ...
    lineEditor: { edit: 'Editar línia', exit: "Sortir de l'editor de línia" },
    elementLock: {
      lock: 'Bloca',
      unlock: 'Desbloca',
  ...
  a = {
    ...
    hint_emptyLibrary:
      'Trieu un element o un llenç per a afegir-lo aquí, o instal·leu una biblioteca del repositori públic, més avall.',
  ...
  l = {
    ...
    couldNotCreateShareableLinkTooBig:
      'No s’ha pogut crear un enllaç per a compartir: l’escena és massa gran',
    ...
    uploadedSecurly:
      "La càrrega s'ha assegurat amb xifratge punta a punta, cosa que significa que el servidor Excalidraw i tercers no poden llegir el contingut.",
    loadSceneOverridePrompt:
      'Si carregas aquest dibuix extern, substituirá el que tens. Vols continuar?',
...
(Si voleu conservar el dibuix local, tanqueu la pentanya del navegador en comptes d'aturar la sessió).`,
    ...
    imageDoesNotContainScene:
      "Aquesta imatge no sembla contenir cap dada d'escena. Heu activat l'incrustació de l'escena durant l'exportació?",
    cannotRestoreFromImage: 'L’escena no s’ha pogut restaurar des d’aquest fitxer d’imatge',
    invalidSceneUrl:
      "No s'ha pogut importar l'escena des de l'adreça URL proporcionada. Està malformada o no conté dades Excalidraw JSON vàlides.",
    ...
    invalidEncryptionKey:
      "La clau d'encriptació ha de tenir 22 caràcters. La col·laboració en directe està desactivada.",
...
Els vostres canvis no seran guardats!`,
  ...
  i = {
    ...
    svgImageInsertError:
      'No ha estat possible inserir la imatge SVG. Les marques SVG semblen invàlides.',
    failedToFetchImage: '',
    invalidSVGString: 'SVG no vàlid.',
    cannotResolveCollabServer:
      'No ha estat possible connectar amb el servidor collab. Si us plau recarregueu la pàgina i torneu a provar.',
    importLibraryError: "No s'ha pogut carregar la biblioteca",
    collabSaveFailed:
      "No s'ha pogut desar a la base de dades de fons. Si els problemes persisteixen, hauríeu de desar el fitxer localment per assegurar-vos que no perdeu el vostre treball.",
    collabSaveFailed_sizeExceeded:
      "No s'ha pogut desar a la base de dades de fons, sembla que el llenç és massa gran. Hauríeu de desar el fitxer localment per assegurar-vos que no perdeu el vostre treball.",
  ...
  n = {
    canvasPanning:
      "Per moure el llenç, manteniu premuda la roda del ratolí o la barra espaiadora mentre arrossegueu o utilitzeu l'eina manual",
    ...
    resize:
      'Per restringir les proporcions mentres es canvia la mida, mantenir premut el majúscul (SHIFT); per canviar la mida des del centre, mantenir premut ALT',
...
selecció múltiple), o manteniu Alt i feu clic per a afegir més punts`,
    placeImage:
      'Feu clic per a col·locar la imatge o clic i arrossegar per a establir-ne la mida manualment',
    ...
    firefox_clipboard_write:
      'És probable que aquesta funció es pugui activar posant la marca "dom.events.asyncClipboard.clipboardItem" a "true". Per canviar les marques del navegador al Firefox, visiteu la pàgina "about:config".',
    disableSnapping: '',
  },
  s = {
  ...
  c = {
    ...
    openIssueMessage:
      "Anàvem amb molta cura de no incloure la informació de la vostra escena en l'error. Si l'escena no és privada, podeu fer-ne el seguiment al nostre <button>rastrejador d'errors.</button> Incloeu la informació a continuació copiant i enganxant a GitHub Issues.",
    sceneContent: "Contingut de l'escena:",
  },
  d = {
    desc_intro: 'Podeu convidar persones a la vostra escena actual a col·laborar amb vós.',
    desc_privacy:
      'No us preocupeu, la sessió utilitza el xifratge de punta a punta, de manera que qualsevol cosa que dibuixeu romandrà privada. Ni tan sols el nostre servidor podrà veure què feu.',
    ...
    desc_exitSession:
      'Si atureu la sessió, us desconectareu de la sala, però podreu continuar treballant amb el dibuix localment. Tingues en compte que això no afectarà a altres persones, i encara podran col·laborar en la seva versió.',
  ...
  b = {
    ...
    placeholder: {
      ...
      libraryDesc:
        "Descripció de la biblioteca per a ajudar a la gent a entendre'n el funcionament",
      githubHandle:
        'Identificador de GitHub (opcional), per tal que pugueu editar la biblioteca una vegada enviada per a ser revisada',
      twitterHandle:
        'Usuari de twitter (opcional), per tal que puguem donar-vos crèdit quan fem la promoció a Twitter',
      website: 'Enllaç al vostre lloc web personal o a qualsevol altre (opcional)',
    },
    errors: { required: 'Requerit', website: 'Introduïu una URL vàlida' },
    noteDescription:
      'Envieu la vostra biblioteca perquè sigui inclosa al <link>repositori públic</link>per tal que altres persones puguin fer-ne ús en els seus dibuixos.',
    noteGuidelines:
      "La biblioteca ha de ser aprovada manualment. Si us plau, llegiu les <link>directrius</link> abans d'enviar-hi res. Necessitareu un compte de GitHub per a comunicar i fer-hi canvis si cal, però no és requisit imprescindible.",
    noteLicense:
      "Quan l'envieu, accepteu que la biblioteca sigui publicada sota la <link>llicència MIT, </link>que, en resum, vol dir que qualsevol persona pot fer-ne ús sense restriccions.",
    noteItems:
      "Cada element de la biblioteca ha de tenir el seu propi nom per tal que sigui filtrable. S'hi inclouran els elements següents:",
    atleastOneLibItem:
      'Si us plau, seleccioneu si més no un element de la biblioteca per a començar',
    republishWarning:
      "Nota: alguns dels elements seleccionats s'han marcat com a publicats/enviats. Només hauríeu de reenviar elements quan actualitzeu una biblioteca existent.",
  },
  g = {
    title: 'Biblioteca enviada',
    content:
      "Gràcies, {{authorName}}. La vostra biblioteca ha estat enviada per a ser revisada. Podeu comprovar-ne l'estat<link>aquí</link>",
  },
  E = {
    resetLibrary: 'Restableix la biblioteca',
...
o enganxeu-lo en un editor de text existent`,
  ...
  C = { mostUsedCustomColors: '', colors: '', shades: '', hexCode: '', noShades: '' },
  A = {
    action: {
      exportToImage: {
      ...
      saveToDisk: { title: 'Desa al disc', button: 'Desa al disc', description: '' },
    ...
    modal: {
      ...
      shareableLink: { title: "Carrega des d'un enllaç", button: '', description: '' },
    },
  },
  w = {
