const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      './icons-B5Lu0sqU.js',
      './index-DUUm-ELF.css',
      './gitBundle-MKUwQS6T.js',
      './pako.esm-D9qDZ2Eh.js',
    ]),
) => i.map((i) => d[i]);
import './icons-B5Lu0sqU.js';
import { b5 as L, ad as P, aO as w, aQ as y } from './index-C2avURFS.js';
...
const O = {
  ...
  T = {
    bash: () => e(() => import('./bash-I8pq0VWm.js'), [], import.meta.url),
    cpp: () => e(() => import('./cpp-Bm3ii6kY.js'), [], import.meta.url),
    csharp: () => e(() => import('./csharp-BNpuYZMG.js'), [], import.meta.url),
    css: () => e(() => import('./css-DazXZka4.js'), [], import.meta.url),
    diff: () => e(() => import('./diff-DiTmLxSS.js'), [], import.meta.url),
    go: () => e(() => import('./go-BPx_y7j8.js'), [], import.meta.url),
    http: () => e(() => import('./http-B1m0cdo-.js'), [], import.meta.url),
    ini: () => e(() => import('./ini-B3BVgEsG.js'), [], import.meta.url),
    java: () => e(() => import('./java-B5VKqtH2.js'), [], import.meta.url),
    javascript: () => e(() => import('./javascript-BKRaQes9.js'), [], import.meta.url),
    json: () => e(() => import('./json-DIYVocXf.js'), [], import.meta.url),
    kotlin: () => e(() => import('./kotlin-Cw-eF_bm.js'), [], import.meta.url),
    latex: () => e(() => import('./latex-lHs7bxnR.js'), [], import.meta.url),
    markdown: () => e(() => import('./markdown-BrP960CR.js'), [], import.meta.url),
    php: () => e(() => import('./php-CRdd4dfS.js'), [], import.meta.url),
    protobuf: () => e(() => import('./protobuf-C6VLidOE.js'), [], import.meta.url),
    python: () => e(() => import('./python-kSlZHhJb.js'), [], import.meta.url),
    ruby: () => e(() => import('./ruby-7T4ktxyv.js'), [], import.meta.url),
    rust: () => e(() => import('./rust-HC3MBUhY.js'), [], import.meta.url),
    sql: () => e(() => import('./sql-BC88IN-V.js'), [], import.meta.url),
    swift: () => e(() => import('./swift-Dn8kKO_1.js'), [], import.meta.url),
    typescript: () => e(() => import('./typescript-C2FFdlUC.js'), [], import.meta.url),
    xml: () => e(() => import('./xml-BXBhIUeX.js'), [], import.meta.url),
    yaml: () => e(() => import('./yaml-drsDnIKT.js'), [], import.meta.url),
  },
  V = `
...
const j = new Set(),
  d = (t, o, i) => {
    ...
    return (o && (r.className = o), typeof i == 'string' && (r.textContent = i), r);
  },
  I = () => {
    const t = document.createElement('style');
    return ((t.textContent = V), t);
  },
  R = (t) => O[t.trim().toLowerCase()] || 'plaintext',
  h = (t) =>
    t.replace(
      /[&<>"']/g,
      (o) => ({ '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;' })[o],
  ...
  D = async (t, o) => {
    ...
    return (t.registerLanguage(o, r), j.add(o), !0);
  },
  k = (t) => Math.min(2.6, Math.max(0.6, Number(t.toFixed(2)))),
  z = (t) => t.split(/\r\n|\r|\n/).length;
async function $(t, o, i) {
  const r = i || 'txt',
    _ = r.trim().toLowerCase();
  if (_ === 'patch') {
    const { default: n } = await e(
      async () => {
        const { default: p } = await import('./patch-Dar0z-ut.js');
        return { default: p };
      },
      __vite__mapDeps([5, 6, 2, 1, 3, 4, 7, 8]),
      import.meta.url,
    );
    return n(t, o, r);
  }
  if (_ === 'bundle' || _ === 'bdl') {
    const { default: n } = await e(
      async () => {
        const { default: p } = await import('./gitBundle-MKUwQS6T.js');
        return { default: p };
      },
      __vite__mapDeps([9, 6, 2, 1, 3, 4, 7, 8, 10]),
      import.meta.url,
    );
    return n(t, o, r);
  }
  ...
  const f = P(),
    c = d('div', 'code-viewer');
  c.dataset.viewerZoomProvider = 'code';
  const v = d('div', 'code-toolbar');
  v.append(d('span', '', r.toUpperCase()), d('strong', '', `${z(l)} lines`));
  const E = d('pre', 'code-area'),
    m = d('code', `hljs language-${s}`);
  ((m.innerHTML = s === 'plaintext' ? h(l) : '正在加载高亮...'),
    E.append(m),
    c.append(v, E),
    c.style.setProperty('--code-font-size', `${13 * a}px`),
    o.replaceChildren(I(), c),
    (async () => {
      if (s !== 'plaintext')
        try {
          const n = await A(),
            p = await D(n, s);
          if (b) return;
          m.innerHTML = p ? n.highlight(l, { language: s, ignoreIllegals: !0 }).value : h(l);
        } catch {
          b || (m.innerHTML = h(l));
        }
    })());
  const x = () => ({
    ...
    u = (n) => ((a = k(n)), c.style.setProperty('--code-font-size', `${13 * a}px`), f.emit(), x());
  return (
    y(c, {
      zoomIn: () => u(a + 0.1),
      zoomOut: () => u(a - 0.1),
