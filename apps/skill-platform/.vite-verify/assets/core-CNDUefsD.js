...
import { g as Kt } from './ui-vendor-C-FKu2uc.js';
var re, ve;
function Ft() {
  if (ve) return re;
  ve = 1;
  ...
  function T(e, ...t) {
    ...
    for (const u in e) i[u] = e[u];
    return (
      t.forEach(function (u) {
        for (const b in u) i[b] = u[b];
      }),
      i
    );
  }
  ...
  class He {
    ...
    openNode(t) {
      if (!le(t)) return;
      const i = Le(t.scope, { prefix: this.classPrefix });
      this.span(i);
    }
    closeNode(t) {
      le(t) && (this.buffer += Ce);
  ...
  const Ke = /\b\B/,
    ...
    V = '[a-zA-Z_]\\w*',
    pe = '\\b\\d+(\\.\\d+)?',
    de = '(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)',
    Ee = '\\b(0b[01]+)',
    Fe =
      '!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~',
    ze = (e = {}) => {
    ...
    Xe = { scope: 'string', begin: "'", end: "'", illegal: '\\n', contains: [P] },
    Ye = { scope: 'string', begin: '"', end: '"', illegal: '\\n', contains: [P] },
    Ze = {
      begin:
        /\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/,
    },
    $ = function (e, t, i = {}) {
      const u = T({ scope: 'comment', begin: e, end: t, contains: [] }, i);
      u.contains.push({
        scope: 'doctag',
      ...
      return (u.contains.push({ begin: D(/[ ]+/, '(', b, /[.]?[:]?([.][ ]|[ ])/, '){3}') }), u);
    },
    Je = $('//', '$'),
    qe = $('/\\*', '\\*/'),
    Ve = $('#', '$'),
    Qe = { scope: 'number', begin: pe, relevance: 0 },
    me = { scope: 'number', begin: de, relevance: 0 },
    et = { scope: 'number', begin: Ee, relevance: 0 },
    tt = {
      scope: 'regexp',
      begin: /\/(?=[^/\n]*\/)/,
      end: /\/[gimuy]*/,
    ...
    nt = { scope: 'title', begin: he, relevance: 0 },
    it = { scope: 'title', begin: V, relevance: 0 },
    st = { begin: '\\.\\s*' + V, relevance: 0 };
  var G = Object.freeze({
    __proto__: null,
    APOS_STRING_MODE: Xe,
    BACKSLASH_ESCAPE: P,
  ...
  const ft = (e, t) => {
      ...
      (Object.keys(e).forEach((u) => {
        ...
        (e.begin = D(i.beforeMatch, fe(i.begin))),
        (e.starts = { relevance: 0, contains: [Object.assign(i, { endsParent: !0 })] }),
        (e.relevance = 0),
        delete i.beforeMatch);
    },
    gt = ['of', 'and', 'for', 'in', 'not', 'or', 'if', 'then', 'parent', 'list', 'value'],
    ht = 'keyword';
  ...
  function xe(e, t, { key: i }) {
    ...
    const b = e[i],
      _ = {},
      c = {};
    for (let r = 1; r <= t.length; r++) ((c[r + u] = b[r]), (_[r + u] = !0), (u += ge(t[r - 1])));
  ...
  function xt(e) {
    ...
    class i {
      ...
      exec(r) {
        ...
        if (!l) return null;
        const w = l.findIndex((U, m) => m > 0 && U !== void 0),
          M = this.matchIndexes[w];
    ...
    class u {
      ...
      getMatcher(r) {
        ...
        const l = new i();
        return (
          this.rules.slice(r).forEach(([w, M]) => l.addRule(w, M)),
          l.compile(),
    ...
    function _(c, r) {
      ...
      ([ct, lt, Mt, ft].forEach((M) => M(c, r)),
        e.compilerExtensions.forEach((M) => M(c, r)),
        (c.__beforeBegin = null),
        [ot, at, ut].forEach((M) => M(c, r)),
        (c.isCompiled = !0));
      let w = null;
      return (
    ...
    return ((e.classNameAliases = T(e.classNameAliases || {})), _(e));
  }
  function we(e) {
    ...
    ye = function (e) {
      ...
      function M(n, a, h) {
        let d = '',
          x = '';
        (typeof a == 'object'
          ? ((d = n), (h = a.ignoreIllegals), (x = a.language))
      ...
      function U(n, a, h, d) {
        ...
        function B() {
          ...
          for (; o; ) {
            ...
            const p = A.case_insensitive ? o[0].toLowerCase() : o[0],
              R = S(f, p);
            if (R) {
              const [k, Gt] = R;
              if (
        ...
        function z() {
          ...
          if (typeof f.subLanguage == 'string') {
            ...
            ((s = U(f.subLanguage, E, !0, De[f.subLanguage])), (De[f.subLanguage] = s._top));
          } else s = ee(E, f.subLanguage.length ? f.subLanguage : null);
        ...
        function ke(s, o) {
          ...
          for (; g <= p; ) {
            ...
            const R = A.classNameAliases[s[g]] || s[g],
              k = o[g];
            (R ? N(k, R) : ((E = k), B(), (E = '')), g++);
          }
        }
          ...
          return (
            ...
            s.beginScope &&
              (s.beginScope._wrap
                ...
                : s.beginScope._multi && (ke(s.beginScope, o), (E = ''))),
        ...
        function Ie(s, o, g) {
          ...
          if (s.endsWithParent) return Ie(s.parent, o, g);
        }
        function Ht(s) {
        ...
        function jt(s) {
          const o = s[0],
            g = s.rule,
            p = new oe(g),
            R = [g.__beforeBegin, g['on:begin']];
          for (const k of R) if (k && (k(s, p), p.isMatchIgnored)) return Ht(o);
          return (
            g.skip
              ? (E += o)
              : (g.excludeBegin && (E += o), y(), !g.returnBegin && !g.excludeBegin && (E = o)),
            Te(g, s),
        ...
        function Pt(s) {
          ...
          f.endScope && f.endScope._wrap
            ? (y(), N(o, f.endScope._wrap))
            : f.endScope && f.endScope._multi
              ? (y(), ke(f.endScope, s))
              : R.skip
                ? (E += o)
                : (R.returnEnd || R.excludeEnd || (E += o), y(), R.excludeEnd && (E = o));
          do
            (f.scope && O.closeNode(),
              !f.skip && !f.subLanguage && (Y += f.relevance),
              (f = f.parent));
          while (f !== p.parent);
        ...
        function Be(s, o) {
          ...
          if (((X = o), o.type === 'begin')) return jt(o);
          if (o.type === 'illegal' && !h) {
            const p = new Error(
...
`),
        ...
        try {
          ...
          return (
            O.finalize(),
            (ne = O.toHTML()),
            { language: n, value: ne, relevance: Y, illegal: !1, _emitter: O, _top: f }
          );
        } catch (s) {
      ...
      function m(n) {
        const a = { value: Q(n), illegal: !1, relevance: 0, _top: c, _emitter: new r.__emitter(r) };
      ...
      function ee(n, a) {
        ...
        const x = d.sort((y, N) => {
            ...
            if (y.language && N.language) {
              if (I(y.language).supersetOf === N.language) return 1;
              if (I(N.language).supersetOf === y.language) return -1;
            }
            return 0;
          }),
          [S, B] = x,
      ...
      function te(n) {
        ...
        const h = w(n);
        if (l(h)) return;
        if ((F('before:highlightElement', { el: n, language: h }), n.dataset.highlighted)) {
          console.log(
        ...
        if (
          ...
          throw new Rt('One of your code blocks includes unescaped HTML.', n.innerHTML);
        a = n;
        const d = a.textContent,
          x = h ? M(d, { language: h, ignoreIllegals: !0 }) : ee(d);
        ((n.innerHTML = x.value),
          (n.dataset.highlighted = 'yes'),
          St(n, h, x.language),
          (n.result = { language: x.language, re: x.relevance, relevance: x.relevance }),
          x.secondBest &&
            (n.secondBest = { language: x.secondBest.language, relevance: x.secondBest.relevance }),
      ...
      function Tt(n, a) {
        ...
        (h.name || (h.name = n),
          ...
          h.aliases && Ne(h.aliases, { languageName: n }));
      }
      function It(n) {
        delete t[n];
        for (const a of Object.keys(i)) i[a] === n && delete i[a];
      }
      function Bt() {
      ...
      (Object.assign(e, {
        ...
        (e.versionString = Ot),
        (e.regex = { concat: D, lookahead: fe, either: J, optional: Ue, anyNumberOfTimes: Pe }));
      for (const n in G) typeof G[n] == 'object' && ce(G[n]);
...
var zt = Ft();
const qt = Kt(zt);
export { qt as default, qt as HighlightJS };
