import { c as tt } from './cytoscape.esm-DH6-wILU.js';
import { s as gt } from './markdown-it-vendor-DL4wSELR.js';
import './markdown-vendor-DldLOD9R.js';
import { _ as V, l as k } from './mermaid.core-Cs_8gTP_.js';
import { g as lt } from './ui-vendor-C-FKu2uc.js';
var Z = { exports: {} },
  $ = { exports: {} },
  Q = { exports: {} },
  ut = Q.exports,
...
async function st(G, b) {
  ...
  try {
    ...
    const N = await it(G),
      ...
      L = ot(N);
    return (
      k.debug(`Layout completed: ${I.length} nodes, ${L.length} edges`),
      { nodes: I, edges: L }
    );
  } catch (N) {
