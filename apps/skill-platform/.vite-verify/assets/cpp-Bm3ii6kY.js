function v(e) {
  const n = e.regex,
    ...
    _ = 'decltype\\(auto\\)',
    c = '[a-zA-Z_]\\w*::',
    p = '(?!struct)(' + _ + '|' + n.optional(c) + '[a-zA-Z_]\\w*' + n.optional('<[^<>]+>') + ')',
    ...
    m = { className: 'title', begin: n.optional(c) + e.IDENT_RE, relevance: 0 },
    ...
    l = [d, o, r, a, e.C_BLOCK_COMMENT_MODE, i, s],
    N = {
      variants: [
        { begin: /=/, end: /;/ },
        { begin: /\(/, end: /\)/ },
      ...
      keywords: t,
      contains: l.concat([
        { begin: /\(/, end: /\)/, keywords: t, contains: l.concat(['self']), relevance: 0 },
      ]),
      relevance: 0,
    },
    T = {
      ...
      illegal: /[^\w\s\*&:<>.]/,
      contains: [
        { begin: _, keywords: t, relevance: 0 },
        { begin: u, returnBegin: !0, contains: [m], relevance: 0 },
        { begin: /::/, relevance: 0 },
        { begin: /:/, endsWithParent: !0, contains: [s, i] },
        { relevance: 0, match: /,/ },
        {
          className: 'params',
          begin: /\(/,
          ...
          contains: [
            ...
            r,
            {
              ...
              keywords: t,
              relevance: 0,
              contains: ['self', a, e.C_BLOCK_COMMENT_MODE, s, i, r],
            },
          ],
        },
        r,
