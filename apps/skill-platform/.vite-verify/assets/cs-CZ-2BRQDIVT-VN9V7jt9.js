...
var e = {
    ...
    lineEditor: { edit: 'Upravit čáru', exit: 'Ukončit editor řádků' },
    elementLock: {
      lock: 'Uzamknout',
      unlock: 'Odemknout',
  ...
  o = {
    ...
    hint_emptyLibrary:
      'Vyberte položku na plátně a přidejte ji sem nebo nainstalujte knihovnu z veřejného úložiště níže.',
  ...
  a = {
    ...
    couldNotCreateShareableLinkTooBig:
      'Nepodařilo se vytvořit sdílený odkaz: scéna je příliš velká',
    ...
    uploadedSecurly:
      'Nahrávání je zabezpečeno koncovým šifrováním, což znamená, že server Excalidraw ani třetí strany nemohou obsah přečíst.',
    loadSceneOverridePrompt:
      'Načítání externího výkresu nahradí váš existující obsah. Přejete si pokračovat?',
...
(Pokud chcete zachovat místní kresbu, jednoduše zavřete kartu prohlížeče)`,
    ...
    imageDoesNotContainScene:
      'Zdá se, že tento obrázek neobsahuje žádná data o scéně. Zapnuli jste při exportu vkládání scény?',
    cannotRestoreFromImage: 'Scénu nelze obnovit z tohoto souboru obrázku',
    invalidSceneUrl:
      'Nelze importovat scénu z zadané URL. Je buď poškozená, nebo neobsahuje platná JSON data Excalidraw.',
...
Vaše změny nebudou uloženy!`,
  ...
  n = {
    ...
    cannotResolveCollabServer:
      'Nelze se připojit ke sdílenému serveru. Prosím obnovte stránku a zkuste to znovu.',
    importLibraryError: 'Nelze načíst knihovnu',
    collabSaveFailed:
      'Nelze uložit do databáze na serveru. Pokud problémy přetrvávají, měli byste uložit soubor lokálně, abyste se ujistili, že neztratíte svou práci.',
    collabSaveFailed_sizeExceeded:
      'Nelze uložit do databáze na serveru, plátno se zdá být příliš velké. Měli byste uložit soubor lokálně, abyste se ujistili, že neztratíte svou práci.',
    imageToolNotSupported: '',
    brave_measure_text_error: {
      line1:
        'Vypadá to, že používáte Brave prohlížeč s povoleným nastavením <bold>Aggressively Block Fingerprinting</bold>.',
      line2: 'To by mohlo vést k narušení <bold>Textových elementů</bold> ve vašich výkresech.',
      line3:
        'Důrazně doporučujeme zakázat toto nastavení. Můžete sledovat <link>tyto kroky</link> jak to udělat.',
      line4:
        'Pokud vypnutí tohoto nastavení neopravuje zobrazení textových prvků, prosím, otevřete <issueLink>problém</issueLink> na našem GitHubu, nebo nám napište na <discordLink>Discord</discordLink>',
    },
  ...
  i = {
    canvasPanning:
      'Chcete-li přesunout plátno, podržte kolečko nebo mezerník při tažení nebo použijte nástroj Ruka',
...
podržením klávesy ALT změníte velikosti od středu`,
    ...
    lineEditor_info:
      'Podržte Ctrl/Cmd a dvakrát klikněte nebo stiskněte Ctrl/Cmd + Enter pro úpravu bodů',
...
nebo podržením klávesy Alt a kliknutím přidáte nové body`,
    placeImage:
      'Kliknutím umístěte obrázek, nebo klepnutím a přetažením ručně nastavíte jeho velikost',
  ...
  x = {
    ...
    openIssueMessage:
      'Byli jsme velmi opatrní, abychom neuváděli informace o Vaší scéně. Pokud vaše scéna není soukromá, zvažte prosím sledování na našem <button>bug trackeru</button>. Uveďte prosím níže uvedené informace kopírováním a vložením do problému na GitHubu.',
    sceneContent: 'Obsah scény:',
  },
  l = {
    desc_intro: 'Můžete pozvat lidi na vaši aktuální scénu ke spolupráci s vámi.',
    desc_privacy:
      'Nebojte se, relace používá end-to-end šifrování, takže cokoliv nakreslíte zůstane soukromé. Ani náš server nebude schopen vidět, s čím budete pracovat.',
    ...
    desc_exitSession:
      'Zastavením relace se odpojíte od místnosti, ale budete moci pokračovat v práci s touto scénou lokálně. Všimněte si, že to nebude mít vliv na ostatní lidi a budou stále moci spolupracovat na jejich verzi.',
  ...
  D = {
    ...
    placeholder: {
      ...
      githubHandle:
        'Github uživatelské jméno (nepovinné), abyste mohli upravovat knihovnu poté co je odeslána ke kontrole',
      twitterHandle:
        'Twitter uživatelské jméno (nepovinné), abychom věděli koho označit při propagaci na Twitteru',
      website: 'Odkaz na Vaši osobní webovou stránku nebo jinam (nepovinné)',
    },
    errors: { required: 'Povinné', website: 'Zadejte platnou URL adresu' },
    noteDescription:
      'Odešlete svou knihovnu, pro zařazení do <link>veřejného úložiště knihoven</link>, odkud ji budou moci při kreslení využít i ostatní uživatelé.',
    noteGuidelines:
      'Knihovna musí být nejdříve ručně schválena. Přečtěte si prosím <link>pokyny</link>',
    noteLicense:
      'Odesláním souhlasíte s tím, že knihovna bude zveřejněna pod <link>MIT licencí</link>, stručně řečeno, kdokoli ji může používat bez omezení.',
    noteItems:
      'Každá položka knihovny musí mít svůj vlastní název, aby byla filtrovatelná. Následující položky knihovny budou zahrnuty:',
    atleastOneLibItem: 'Vyberte alespoň jednu položku knihovny, kterou chcete začít',
    republishWarning:
      'Poznámka: některé z vybraných položek jsou označeny jako již zveřejněné/odeslané. Položky byste měli znovu odeslat pouze při aktualizaci existující knihovny nebo podání.',
  },
  k = {
    title: 'Knihovna byla odeslána',
    content:
      'Děkujeme vám {{authorName}}. Vaše knihovna byla odeslána k posouzení. Stav můžete sledovat <link>zde</link>',
  },
  c = {
...
Zvýší se velikost exportovaného souboru.`,
    ...
    button: { exportToPng: 'PNG', exportToSvg: 'SVG', copyPngToClipboard: 'Kopírovat do schránky' },
  },
  b = {
