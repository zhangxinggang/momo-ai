function C(e) {
  const d = [
    ...
    n = { keyword: O.concat(N), built_in: d, literal: g },
  ...
  ((r.contains = [o, s, t, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, i, e.C_BLOCK_COMMENT_MODE]),
    (c.contains = [
      M,
      s,
      b,
  ...
  const _ = { variants: [T, o, s, t, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE] },
  ...
  return {
    ...
    contains: [
      ...
      { beginKeywords: 'new return throw await else', relevance: 0 },
      {
        ...
        keywords: n,
        contains: [
          { beginKeywords: l.join(' '), relevance: 0 },
          {
          ...
          { match: /\(\)/ },
          {
            ...
            keywords: n,
            relevance: 0,
            contains: [_, i, e.C_BLOCK_COMMENT_MODE],
          },
          e.C_LINE_COMMENT_MODE,
          e.C_BLOCK_COMMENT_MODE,
        ],
