...
var e = {
    ...
    elementLock: { lock: 'Lås', unlock: 'Lås op', lockAll: 'Lås alle', unlockAll: 'Lås alle op' },
  ...
  r = {
    ...
    hint_emptyLibrary:
      'Vælg et element på lærred for at tilføje det her, eller installer et bibliotek fra det offentlige arkiv, nedenfor.',
  ...
  i = {
    ...
    uploadedSecurly:
      'Upload er blevet sikret med ende-til-ende kryptering, hvilket betyder, at Excalidraw server og tredjeparter ikke kan læse indholdet.',
    loadSceneOverridePrompt:
      'Indlæsning af ekstern tegning erstatter dit eksisterende indhold. Ønsker du at fortsætte?',
...
Dine ændringer vil ikke blive gemt!`,
  ...
  l = {
    ...
    cannotResolveCollabServer:
      'Kunne ikke oprette forbindelse til samarbejdsserveren. Genindlæs siden og prøv igen.',
    importLibraryError: 'Biblioteket kunne ikke indlæses',
    collabSaveFailed:
      'Kunne ikke gemme i databasen. Hvis problemerne fortsætter, bør du gemme din fil lokalt for at sikre, at du ikke mister dit arbejde.',
    collabSaveFailed_sizeExceeded:
      'Kunne ikke gemme i databasen, lærredet lader til at være for stort. Du bør gemme filen lokalt for at sikre, at du ikke mister dit arbejde.',
    ...
    brave_measure_text_error: {
      ...
      line3:
        'Vi anbefaler kraftigt at deaktivere denne indstilling. Du kan følge <link>disse trin</link> om, hvordan du gør det.',
      line4:
        'Hvis deaktivering af denne indstilling ikke løser visning af tekstelementer, åbn venligst et <issueLink>issue</issueLink> på vores GitHub, eller skriv os på <discordLink>Discord</discordLink>',
    },
  ...
  o = {
    canvasPanning:
      'For at flytte lærred, hold musehjulet eller mellemrumstasten mens du trækker, eller brug håndværktøjet',
  ...
  d = {
    ...
    trackedToSentry: '',
    openIssueMessage:
      '<button></button> Kopiere og indsæt venligst oplysningerne nedenfor i et GitHub problem.',
    sceneContent: 'Scene indhold:',
  },
  k = {
    desc_intro: 'Du kan invitere folk til din nuværende scene, så de kan samarbejde med dig.',
    desc_privacy:
      'Bare rolig, sessionen bruger end-to-end kryptering, så uanset hvad du tegner vil det forblive privat. Ikke engang vores server vil kunne se, hvad du kommer op med.',
  ...
  u = { title: '', content: '' },
  x = { resetLibrary: '', removeItemsFromLib: '' },
  v = {
    header: '',
    label: {
      withBackground: '',
...
({{exportColorScheme}})`,
  ...
  S = { mostUsedCustomColors: '', colors: '', shades: '', hexCode: '', noShades: '' },
  L = {
    action: {
