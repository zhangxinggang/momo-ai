...
var e = {
  ...
  n = {
    ...
    hint_emptyLibrary:
      'Wähle ein Element auf der Zeichenfläche, um es hier hinzuzufügen. Oder installiere eine Bibliothek aus dem öffentlichen Verzeichnis.',
  ...
  r = {
    ...
    couldNotCreateShareableLinkTooBig:
      'Konnte keinen teilbaren Link erstellen: Die Zeichnung ist zu groß',
    ...
    uploadedSecurly:
      'Der Upload wurde mit Ende-zu-Ende-Verschlüsselung gespeichert. Weder Excalidraw noch Dritte können den Inhalt einsehen.',
    loadSceneOverridePrompt:
      'Das Laden einer externen Zeichnung ersetzt den vorhandenen Inhalt. Möchtest du fortfahren?',
...
(Wenn du deine lokale Zeichnung behalten möchtest, schließe stattdessen den Browser-Tab.)`,
    ...
    confirmAddLibrary:
      'Dies fügt {{numShapes}} Form(en) zu deiner Bibliothek hinzu. Bist du dir sicher?',
    imageDoesNotContainScene:
      'Dieses Bild scheint keine Szenendaten zu enthalten. Hast Du das Einbetten der Szene während des Exports aktiviert?',
    cannotRestoreFromImage:
      'Die Zeichnung konnte aus dieser Bilddatei nicht wiederhergestellt werden',
    invalidSceneUrl:
      'Die Szene konnte nicht von der angegebenen URL importiert werden. Sie ist entweder fehlerhaft oder enthält keine gültigen Excalidraw JSON-Daten.',
    ...
    invalidEncryptionKey:
      'Verschlüsselungsschlüssel muss 22 Zeichen lang sein. Die Live-Zusammenarbeit ist deaktiviert.',
...
Deine Änderungen werden nicht gespeichert!`,
  ...
  t = {
    ...
    svgImageInsertError:
      'SVG-Bild konnte nicht eingefügt werden. Das SVG-Markup sieht ungültig aus.',
    ...
    collabSaveFailed:
      'Keine Speicherung in der Backend-Datenbank möglich. Wenn die Probleme weiterhin bestehen, solltest Du Deine Datei lokal speichern, um sicherzustellen, dass Du Deine Arbeit nicht verlierst.',
    collabSaveFailed_sizeExceeded:
      'Keine Speicherung in der Backend-Datenbank möglich, die Zeichenfläche scheint zu groß zu sein. Du solltest Deine Datei lokal speichern, um sicherzustellen, dass Du Deine Arbeit nicht verlierst.',
    imageToolNotSupported: 'Bilder sind deaktiviert.',
    brave_measure_text_error: {
      line1:
        'Sieht so aus, als ob Du den Brave-Browser verwendest und die <bold>aggressive Blockierung von Fingerabdrücken</bold> aktiviert hast.',
      line2:
        'Dies könnte dazu führen, dass die <bold>Textelemente</bold> in Ihren Zeichnungen zerstört werden.',
      line3:
        'Wir empfehlen dringend, diese Einstellung zu deaktivieren. Dazu kannst Du <link>diesen Schritten</link> folgen.',
      line4:
        'Wenn die Deaktivierung dieser Einstellung die fehlerhafte Anzeige von Textelementen nicht behebt, öffne bitte ein <issueLink>Ticket</issueLink> auf unserem GitHub oder schreibe uns auf <discordLink>Discord</discordLink>',
    },
    ...
    asyncPasteFailedOnRead:
      'Einfügen fehlgeschlagen (konnte aus der Zwischenablage des Systems nicht gelesen werden).',
  ...
  s = {
    canvasPanning:
      'Um die Zeichenfläche zu verschieben, halte das Mausrad oder die Leertaste während des Ziehens, oder verwende das Hand-Werkzeug',
    ...
    linearElementMulti:
      'Zum Beenden auf den letzten Punkt klicken oder Escape oder Eingabe drücken',
    lockAngle: 'Du kannst Winkel einschränken, indem du SHIFT gedrückt hältst',
    resize:
      'Du kannst die Proportionen einschränken, indem du SHIFT während der Größenänderung gedrückt hältst. Halte ALT gedrückt, um die Größe vom Zentrum aus zu ändern',
    resizeImage:
      'Du kannst die Größe frei ändern, indem du SHIFT gedrückt hältst; halte ALT, um die Größe vom Zentrum aus zu ändern',
    rotate: 'Du kannst Winkel einschränken, indem du SHIFT während der Drehung gedrückt hältst',
    lineEditor_info:
      'CtrlOrCmd halten und Doppelklick oder CtrlOrCmd + Eingabe drücken, um Punkte zu bearbeiten',
    lineEditor_pointSelected:
      'Drücke Löschen, um Punkt(e) zu entfernen, CtrlOrCmd+D zum Duplizieren oder ziehe zum Verschieben',
...
oder halte Alt gedrückt und klicke um neue Punkte hinzuzufügen`,
    placeImage:
      'Klicken, um das Bild zu platzieren oder klicken und ziehen um seine Größe manuell zu setzen',
    publishLibrary: 'Veröffentliche deine eigene Bibliothek',
    bindTextToElement: 'Zum Hinzufügen Eingabetaste drücken',
    deepBoxSelect:
      'Halte CtrlOrCmd gedrückt, um innerhalb der Gruppe auszuwählen, und um Ziehen zu vermeiden',
    eraserRevert: 'Halte Alt gedrückt, um die zum Löschen markierten Elemente zurückzusetzen',
    firefox_clipboard_write:
      'Diese Funktion kann wahrscheinlich aktiviert werden, indem die Einstellung "dom.events.asyncClipboard.clipboardItem" auf "true" gesetzt wird. Um die Browsereinstellungen in Firefox zu ändern, besuche die Seite "about:config".',
  ...
  d = {
    ...
    clearCanvasMessage:
      'Wenn das Neuladen nicht funktioniert, versuche <button>die Zeichenfläche zu löschen.</button>',
  ...
  u = {
    ...
    desc_privacy:
      'Keine Sorge, die Sitzung nutzt eine Ende-zu-Ende-Verschlüsselung. Alles was du zeichnest, bleibt privat. Auch unser Server sieht nicht, was du dir einfallen lässt.',
    ...
    desc_exitSession:
      'Wenn du die Sitzung beendest, wird deine Verbindung zum Raum getrennt. Du kannst jedoch lokal weiter an der Zeichnung arbeiten. Beachte, dass dies keine Auswirkungen auf andere hat und diese weiterhin gemeinsam an ihrer Version arbeiten können.',
  ...
  b = {
    ...
    placeholder: {
      ...
      githubHandle:
        'GitHub-Handle (optional), damit du die Bibliothek bearbeiten kannst, wenn sie zur Überprüfung eingereicht wurde',
      twitterHandle:
        'Twitter-Benutzername (optional), damit wir wissen, wen wir bei Werbung über Twitter nennen können',
      website: 'Link zu deiner persönlichen Webseite oder zu anderer Seite (optional)',
    },
    errors: { required: 'Erforderlich', website: 'Gültige URL eingeben' },
    noteDescription:
      'Sende deine Bibliothek ein, um in die <link>öffentliche Bibliotheks-Repository aufgenommen zu werden</link>damit andere Nutzer sie in ihren Zeichnungen verwenden können.',
    noteGuidelines:
      'Die Bibliothek muss zuerst manuell freigegeben werden. Bitte lies die <link>Richtlinien</link> vor dem Absenden. Du benötigst ein GitHub-Konto, um zu kommunizieren und Änderungen vorzunehmen, falls erforderlich, aber es ist nicht unbedingt erforderlich.',
    noteLicense:
      'Mit dem Absenden stimmst du zu, dass die Bibliothek unter der <link>MIT-Lizenz, </link>die zusammengefasst beinhaltet, dass jeder sie ohne Einschränkungen nutzen kann.',
    noteItems:
      'Jedes Bibliothekselement muss einen eigenen Namen haben, damit es gefiltert werden kann. Die folgenden Bibliothekselemente werden hinzugefügt:',
    atleastOneLibItem: 'Bitte wähle mindestens ein Bibliothekselement aus, um zu beginnen',
    republishWarning:
      'Hinweis: Einige der ausgewählten Elemente sind bereits als veröffentlicht/eingereicht markiert. Du solltest Elemente nur erneut einreichen, wenn Du eine existierende Bibliothek oder Einreichung aktualisierst.',
  },
  x = {
    title: 'Bibliothek übermittelt',
    content:
      'Vielen Dank {{authorName}}. Deine Bibliothek wurde zur Überprüfung eingereicht. Du kannst den Status verfolgen<link>hier</link>',
  },
  k = {
    resetLibrary: 'Bibliothek zurücksetzen',
...
Dieses wird die exportierte Datei vergrößern.`,
  ...
  F = {
    tooltip:
      'Da deine Zeichnungen Ende-zu-Ende verschlüsselt werden, sehen auch unsere Excalidraw-Server sie niemals.',
...
einzufügen oder in einen existierenden Texteditor einzufügen`,
    unableToEmbed:
      'Einbetten dieser URL ist derzeit nicht zulässig. Erstelle einen Issue auf GitHub, um die URL freigeben zu lassen',
    unrecognizedLinkFormat:
      "Der Link, den Du eingebettet hast, stimmt nicht mit dem erwarteten Format überein. Bitte versuche den 'embed' String einzufügen, der von der Quellseite zur Verfügung gestellt wird",
  },
  w = {
  ...
  C = {
    action: {
      exportToImage: {
        ...
        description:
          'Exportiere die Zeichnungsdaten als ein Bild, von dem Du später importieren kannst.',
      },
      saveToDisk: {
        title: 'Auf Festplatte speichern',
        button: 'Auf Festplatte speichern',
        description:
          'Exportiere die Zeichnungsdaten in eine Datei, von der Du später importieren kannst.',
      },
      excalidrawPlus: {
        title: 'Excalidraw+',
  ...
  S = {
    ...
    button: 'Einfügen',
    description:
      'Derzeit werden nur <flowchartLink>Flussdiagramme</flowchartLink>, <sequenceLink>Sequenzdiagramme</sequenceLink> und <classLink>Klassendiagramme</classLink> unterstützt. Die anderen Typen werden als Bild in Excalidraw dargestellt.',
