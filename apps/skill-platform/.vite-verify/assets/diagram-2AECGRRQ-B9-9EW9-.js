import { p as H } from './chunk-4BX2VUAB-T0fy3fOG.js';
...
import { p as V } from './wardley-L42UT6IY-PPlg582g.js';
var x = { showLegend: !0, ticks: 5, max: null, min: 0, graticule: 'circle' },
  w = { axes: [], curves: [], options: x },
  m = structuredClone(w),
  j = G.radar,
  N = l(() => y({ ...j, ...C().radar }), 'getConfig'),
  b = l(() => m.axes, 'getAxes'),
  U = l(() => m.curves, 'getCurves'),
  X = l(() => m.options, 'getOptions'),
  Y = l((a) => {
