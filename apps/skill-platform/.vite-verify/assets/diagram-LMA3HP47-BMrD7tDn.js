import { p as _ } from './chunk-4BX2VUAB-T0fy3fOG.js';
...
import { p as N } from './wardley-L42UT6IY-PPlg582g.js';
var L = E.packet,
  u,
  v =
    ((u = class {
  ...
  Y = b((e, t) => {
    ...
    for (let { start: a, end: i, bits: d, label: c } of e.blocks) {
      ...
      for (
        ...
        const [p, s] = I({ start: a, end: i, bits: d, label: c }, n, l);
        if ((o.push(p), p.end + 1 === n * l && (t.pushWord(o), (o = []), n++), !s)) break;
  ...
  O = b((e, t, r, o) => {
    ...
    for (const [y, $] of p.entries()) j(f, $, y, l);
    f.append('text')
      .text(s)
      .attr('x', k / 2)
      .attr('y', g - h / 2)
