...
var u = {
    ...
    lineEditor: { edit: 'Επεξεργασία γραμμής', exit: 'Έξοδος επεξεργαστή κειμένου' },
    elementLock: {
      lock: 'Κλείδωμα',
      unlock: 'Ξεκλείδωμα',
...
ή κρατήστε πατημένο το Alt και κάντε κλικ για να προσθέσετε νέα σημεία`,
  ...
  s = {
    ...
    errors: { required: 'Απαιτείται', website: 'Εισάγετε μια έγκυρη διεύθυνση URL' },
    noteDescription:
