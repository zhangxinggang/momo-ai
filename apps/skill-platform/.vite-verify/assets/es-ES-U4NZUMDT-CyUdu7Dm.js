...
var e = {
    ...
    lineEditor: { edit: 'Editar línea', exit: 'Salir del editor en línea' },
    elementLock: {
      lock: 'Bloquear',
      unlock: 'Desbloquear',
  ...
  a = {
    ...
    hint_emptyLibrary:
      'Seleccione un elemento en el lienzo para añadirlo aquí, o instale una biblioteca del repositorio público, a continuación.',
  ...
  r = {
    ...
    loadSceneOverridePrompt:
      'Si carga este dibujo externo, reemplazará el que tiene. ¿Desea continuar?',
...
(Si desea mantener su dibujo local, simplemente cierre la pestaña del navegador.)`,
    ...
    imageDoesNotContainScene:
      'Esta imagen no parece contener datos de escena. ¿Ha habilitado la inserción de la escena durante la exportación?',
    cannotRestoreFromImage: 'No se pudo restaurar la escena desde este archivo de imagen',
    invalidSceneUrl:
      'No se ha podido importar la escena desde la URL proporcionada. Está mal formada, o no contiene datos de Excalidraw JSON válidos.',
    ...
    invalidEncryptionKey:
      'La clave de cifrado debe tener 22 caracteres. La colaboración en vivo está deshabilitada.',
...
¡No se guardarán los cambios!`,
  ...
  i = {
    ...
    cannotResolveCollabServer:
      'No se pudo conectar al servidor colaborador. Por favor, vuelva a cargar la página y vuelva a intentarlo.',
    importLibraryError: 'No se pudo cargar la librería',
    collabSaveFailed:
      'No se pudo guardar en la base de datos del backend. Si los problemas persisten, debería guardar su archivo localmente para asegurarse de que no pierde su trabajo.',
    ...
    brave_measure_text_error: {
      line1:
        'Parece que estás usando el navegador Brave con el ajuste <bold>Forzar el bloqueo de huellas digitales</bold> habilitado.',
      line2:
        'Esto podría resultar en errores en los <bold>Elementos de Texto</bold> en tus dibujos.',
      line3:
        'Recomendamos fuertemente deshabilitar esta configuración. Puedes seguir <link>estos pasos</link> sobre cómo hacerlo.',
      line4: '',
    },
  ...
  l = {
    canvasPanning:
      'Para mover el lienzo, mantenga la rueda del ratón o la barra espaciadora mientras arrastra o utilice la herramienta de mano',
...
pulse ALT para redimensionar desde el centro`,
    ...
    lineEditor_pointSelected:
      'Presione Suprimir para eliminar el/los punto(s), CtrlOrCmd+D para duplicarlo, o arrástrelo para moverlo',
...
o mantenga pulsado Alt y haga click para añadir nuevos puntos`,
    placeImage:
      'Haga clic para colocar la imagen o haga click y arrastre para establecer su tamaño manualmente',
    ...
    firefox_clipboard_write:
      'Esta característica puede ser habilitada estableciendo la bandera "dom.events.asyncClipboard.clipboardItem" a "true". Para cambiar las banderas del navegador en Firefox, visite la página "about:config".',
  ...
  d = {
    ...
    openIssueMessage:
      'Fuimos muy cautelosos de no incluir la información de tu escena en el error. Si tu escena no es privada, por favor considera seguir nuestro <button>rastreador de errores.</button> Por favor, incluya la siguiente información copiándola y pegándola en el issue de GitHub.',
  ...
  c = {
    ...
    desc_privacy:
      'No te preocupes, la sesión usa encriptación de punta a punta, por lo que todo lo que se dibuje se mantendrá privadamente. Ni siquiera nuestro servidor podrá ver lo que haces.',
    ...
    desc_exitSession:
      'Detener la sesión te desconectará de la sala, pero podrás seguir trabajando con la escena en su computadora, esto es de modo local. Ten en cuenta que esto no afectará a otras personas, y que las mismas seguirán siendo capaces de colaborar en tu escena.',
  ...
  x = {
    ...
    placeholder: {
      ...
      githubHandle:
        'Nombre de usuario de GitHub (opcional), así podrá editar la biblioteca una vez enviada para su revisión',
      twitterHandle:
        'Nombre de usuario de Twitter (opcional), así sabemos a quién acreditar cuando se promociona en Twitter',
      website: 'Enlace a su sitio web personal o en cualquier otro lugar (opcional)',
    },
    errors: { required: 'Requerido', website: 'Introduce una URL válida' },
    noteDescription:
      'Envía tu biblioteca para ser incluida en el <link>repositorio de librería pública</link>para que otras personas utilicen en sus dibujos.',
    noteGuidelines:
      'La biblioteca debe ser aprobada manualmente primero. Por favor, lea la <link>pautas</link> antes de enviar. Necesitará una cuenta de GitHub para comunicarse y hacer cambios si se solicita, pero no es estrictamente necesario.',
    noteLicense:
      'Al enviar, usted acepta que la biblioteca se publicará bajo el <link>Licencia MIT </link>que en breve significa que cualquiera puede utilizarlos sin restricciones.',
    noteItems:
      'Cada elemento de la biblioteca debe tener su propio nombre para que sea filtrable. Los siguientes elementos de la biblioteca serán incluidos:',
    atleastOneLibItem: 'Por favor, seleccione al menos un elemento de la biblioteca para empezar',
    republishWarning:
      'Nota: algunos de los elementos seleccionados están marcados como ya publicados/enviados. Sólo debería volver a enviar elementos cuando se actualice una biblioteca o envío.',
  },
  g = {
    title: 'Biblioteca enviada',
    content:
      'Gracias {{authorName}}. Su biblioteca ha sido enviada para ser revisada. Puede seguir el estado<link>aquí</link>',
  },
  E = {
    resetLibrary: 'Reiniciar biblioteca',
  ...
  h = {
    tooltip:
      'Tus dibujos están cifrados de punto a punto, por lo que los servidores de Excalidraw nunca los verán.',
  ...
  D = {
    action: {
      ...
      saveToDisk: {
        ...
        description:
          'Exporta los datos de la escena a un archivo desde el cual podrás importar más tarde.',
      },
      excalidrawPlus: { title: '', button: 'Exportar a Excalidraw+', description: '' },
    },
    modal: {
      loadFromFile: {
      ...
      shareableLink: {
        ...
        description:
          'Cargar un dibujo externo <bold>reemplazará tu contenido existente</bold>.<br></br>Puedes primero hacer una copia de seguridad de tu dibujo usando una de las opciones de abajo.',
      },
    },
  },
  T = {
    ...
    button: 'Insertar',
    description:
      'Actualmente sólo <flowchartLink>Flowchart</flowchartLink>,<sequenceLink> Secuencia, </sequenceLink> y <classLink>Class </classLink>Diagramas son soportados. Los otros tipos se renderizarán como imagen en Excalidraw.',
