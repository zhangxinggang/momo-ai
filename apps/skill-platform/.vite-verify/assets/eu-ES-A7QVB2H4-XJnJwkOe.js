...
Esportatutako fitxategien tamaina handituko da.`,
    ...
    button: { exportToPng: 'PNG', exportToSvg: 'SVG', copyPngToClipboard: 'Kopiatu arbelean' },
  },
  E = {
    tooltip:
...
edo itsatsi lehendik dagoen testu-editore batean`,
  ...
  v = { title: '', button: 'Txertatu', description: '', syntax: '', preview: 'Aurrebista' },
  _ = {
    labels: a,
    library: e,
    buttons: t,
