...
var u = {
    ...
    lineEditor: { edit: 'ویرایش لینک', exit: 'خروج از ویرایشگر' },
    elementLock: {
      lock: 'قفل',
      unlock: 'باز کردن',
      lockAll: 'قفل همه',
  ...
  C = {
    ...
    hint_emptyLibrary:
      'یک آیتم روی بوم را برای اضافه شده به اینجا انتخاب کنید، یا یک کتابخانه از مخزن عمومی در بخش پایین را نصب کنید.',
  ...
  F = {
    ...
    couldNotCreateShareableLinkTooBig:
      'لینک قابل اشتراک گذاری ایجاد نشد: محتوای صحنه بسیار بزرگ است',
    ...
    uploadedSecurly:
      'آپلود با رمزگذاری دو طرفه انجام میشود، به این معنی که سرور Excalidraw و اشخاص ثالث نمی توانند مطالب شما را بخوانند.',
    loadSceneOverridePrompt:
      'بارگزاری یک طرح خارجی محتوای فعلی رو از بین میبرد. آیا میخواهید ادامه دهید؟',
...
(اگر می خواهید نقاشی محلی خود را حفظ کنید، به سادگی برگه مرورگر را ببندید.)`,
    ...
    imageDoesNotContainScene:
      'به نظر نمی رسد این تصویر حاوی داده های بوم نقاشی باشد. آیا جاسازی صحنه را در حین خروجی فعال کرده اید?',
    cannotRestoreFromImage: 'صحنه را نمی توان از این فایل تصویری بازیابی کرد',
    invalidSceneUrl:
      'بوم نقاشی از آدرس ارائه شده وارد نشد. این یا نادرست است، یا حاوی داده Excalidraw JSON معتبر نیست.',
...
تغییرات شما ذخیره نمی شود!`,
  ...
  e = {
    ...
    cannotResolveCollabServer:
      'به سرور collab متصل نشد. لطفا صفحه را مجددا بارگذاری کنید و دوباره تلاش کنید.',
    ...
    collabSaveFailed_sizeExceeded:
      'در پایگاه داده بکند ذخیره نشد. اگر مشکلات همچنان ادامه داشت، باید فایل خود را به صورت محلی ذخیره کنید تا مطمئن شوید کار خود را از دست نمی دهید.',
    imageToolNotSupported: '',
    brave_measure_text_error: {
      line1:
        'به نظر می‌رسد از مرورگر Brave با تنظیم <bold> مسدود کردن شدید اثرانگشت</bold> استفاده می‌کنید.',
      line2: 'این می تواند منجر به شکستن <bold>عناصر متن</bold> در نقاشی های شما شود.',
      line3:
        'اکیداً توصیه می کنیم این تنظیم را غیرفعال کنید. برای نحوه انجام این کار می‌توانید <link>این مراحل</link> را دنبال کنید.',
      line4:
        'اگر غیرفعال کردن این تنظیم نمایش عناصر متنی را برطرف نکرد، لطفاً یک <issueLink>مشکل</issueLink> را در GitHub ما باز کنید یا برای ما در <discordLink>Discord</discordLink> بنویسید.',
    },
  ...
  o = {
    canvasPanning:
      'برای حرکت دادن بوم، چرخ ماوس یا فاصله را در حین کشیدن نگه دارید یا از ابزار دستی استفاده کنید',
    ...
    linearElementMulti:
      'روی آخرین نقطه کلیک کنید یا کلید ESC را بزنید یا کلید Enter را بزنید برای اتمام کار',
    lockAngle: 'با نگه داشتن SHIFT هنگام چرخش می توانید زاویه ها را محدود کنید',
    resize:
      'می توانید با نگه داشتن SHIFT در هنگام تغییر اندازه، نسبت ها را محدود کنید،ALT را برای تغییر اندازه از مرکز نگه دارید',
...
برای تغییر اندازه از مرکز، ALT را نگه دارید`,
    ...
    lineEditor_info:
      'CtrlOrCmd را نگه دارید و دوبار کلیک کنید یا CtrlOrCmd + Enter را فشار دهید تا نقاط را ویرایش کنید.',
    lineEditor_pointSelected:
      'برای حذف نقطه Delete برای کپی زدن Ctrl یا Cmd+D را بزنید و یا برای جابجایی بکشید',
...
یا Alt را نگه دارید و برای افزودن نقاط جدید کلیک کنید`,
    placeImage:
      'برای قرار دادن تصویر کلیک کنید، یا کلیک کنید و بکشید تا اندازه آن به صورت دستی تنظیم شود',
    ...
    firefox_clipboard_write:
      'احتمالاً می‌توان این ویژگی را با تنظیم پرچم «dom.events.asyncClipboard.clipboardItem» روی «true» فعال کرد. برای تغییر پرچم های مرورگر در فایرفاکس، از صفحه "about:config" دیدن کنید.',
    disableSnapping: '',
  },
  t = {
  ...
  l = {
    ...
    desc_privacy:
      'نگران نباشید، این جلسه از رمزگذاری دوطرفه استفاده می کند، پس هر چیزی بکشید خصوصی خواهد ماند. حتی سرور ما نمیتواند ببیند چیزی که شما طراحی میکنید.',
    ...
    desc_exitSession:
      'با پایان دادن جلسه، شما از اتاق حذف میکند، اما می توانید به صورت محلی کار خود را با بوم ادامه دهید. توجه داشته باشید که این مورد بر سایر افراد تأثیر نمی گذارد و همچنان می توانند در نسخه خود همکاری کنند.',
  ...
  c = {
    ...
    placeholder: {
      ...
      githubHandle:
        'دسته GitHub (اختیاری)، بنابراین می توانید پس از ارسال برای بررسی، کتابخانه را ویرایش کنید',
      twitterHandle:
        'نام کاربری توییتر (اختیاری)، بنابراین می دانیم هنگام تبلیغ در توییتر به چه کسی اعتبار دهیم',
      website: 'پیوند به وب سایت شخصی شما یا هر جای دیگر (اختیاری)',
    },
    errors: { required: 'لازم', website: 'وارد کردن آدرس درست' },
    noteDescription: '',
    noteGuidelines: '',
    noteLicense: '',
    noteItems:
      'هر مورد کتابخانه باید نام خاص خود را داشته باشد تا قابل فیلتر باشد. اقلام کتابخانه زیر شامل خواهد شد:',
    atleastOneLibItem: 'لطفاً حداقل یک مورد از کتابخانه را برای شروع انتخاب کنید',
    republishWarning:
      'توجه: برخی از موارد انتخاب شده به عنوان قبلاً منتشر شده/ارسال شده علامت گذاری شده اند. شما فقط باید هنگام به‌روزرسانی یک کتابخانه موجود یا ارسال، موارد را دوباره ارسال کنید.',
  },
  m = {
    title: 'کتابخانه ارسال شد',
    content:
      'تشکر از شما {{authorName}}. کتابخانه شما برای بررسی ارسال شده است. می توانید وضعیت را پیگیری کنید',
  },
  p = {
    resetLibrary: 'تنظیم مجدد کتابخانه',
  ...
  b = {
    ...
    button: { exportToPng: 'PNG', exportToSvg: 'SVG', copyPngToClipboard: 'کپی در کلیپ‌بورد' },
  },
  g = {
    tooltip:
      'شما در یک محیط رمزگزاری شده دو طرفه در حال طراحی هستید پس Excalidraw هرگز طرح های شما را نمیبند.',
...
یا در یک ویرایشگر متن موجود جایگذاری کنید`,
  ...
  x = {
    action: {
      ...
      saveToDisk: { title: 'ذخیره در دیسک', button: 'ذخیره در دیسک', description: '' },
      excalidrawPlus: { title: '', button: '', description: '' },
    },
    modal: {
      loadFromFile: { title: 'بارگذاری از فایل', button: 'بارگذاری از فایل', description: '' },
      shareableLink: { title: '', button: '', description: '' },
    },
  },
  w = { title: '', button: '', description: '', syntax: '', preview: 'پیش‌نمایش' },
  P = {
    labels: u,
    library: C,
    buttons: A,
