...
var a = {
    ...
    lineEditor: { edit: 'Muokkaa riviä', exit: 'Poistu rivieditorista' },
    elementLock: {
      lock: 'Lukitse',
  ...
  t = {
    ...
    uploadedSecurly:
      'Lähetys on turvattu päästä-päähän-salauksella. Excalidrawin palvelin ja kolmannet osapuolet eivät voi lukea sisältöä.',
    loadSceneOverridePrompt:
      'Ulkopuolisen piirroksen lataaminen korvaa nykyisen sisältösi. Jatketaanko?',
...
(Jos haluat säilyttää paikallisesti tallennetun piirustuksen, sulje selaimen välilehti lopettamisen sijaan.)`,
    ...
    imageDoesNotContainScene:
      'Tämä kuva ei näytä sisältävän piirrostietoja. Oletko ottanut käyttöön piirroksen tallennuksen viennin aikana?',
    ...
    invalidEncryptionKey:
      'Salausavaimen on oltava 22 merkkiä pitkä. Live-yhteistyö ei ole käytössä.',
...
Muutoksiasi ei tallenneta!`,
  ...
  o = {
    ...
    svgImageInsertError:
      'SVG- kuvaa ei voitu lisätä. Tiedoston SVG-sisältö näyttää virheelliseltä.',
    failedToFetchImage: '',
    invalidSVGString: 'Virheellinen SVG.',
    cannotResolveCollabServer:
      'Yhteyden muodostaminen collab-palvelimeen epäonnistui. Virkistä sivu ja yritä uudelleen.',
  ...
  l = {
    canvasPanning:
      'Piirtoalueen liikuttamiseksi pidä hiiren pyörää tai välilyöntiä pohjassa tai käytä käsityökalua',
    ...
    linearElementMulti:
      'Lopeta klikkaamalla viimeistä pistettä, painamalla Escape- tai Enter-näppäintä',
    ...
    resizeImage:
      'Voit muuttaa kokoa vapaasti pitämällä SHIFTiä pohjassa, pidä ALT pohjassa muuttaaksesi kokoa keskipisteen ympäri',
    rotate: 'Voit rajoittaa kulman pitämällä SHIFT pohjassa pyörittäessäsi',
    lineEditor_info:
      'Pidä CtrlOrCmd pohjassa ja kaksoisnapsauta tai paina CtrlOrCmd + Enter muokataksesi pisteitä',
    lineEditor_pointSelected:
      'Poista piste(et) painamalla delete, monista painamalla CtrlOrCmd+D, tai liikuta raahaamalla',
    lineEditor_nothingSelected:
      'Valitse muokattava piste (monivalinta pitämällä SHIFT pohjassa), tai paina Alt ja klikkaa lisätäksesi uusia pisteitä',
    placeImage:
    ...
    firefox_clipboard_write:
      'Tämä ominaisuus voidaan todennäköisesti ottaa käyttöön asettamalla "dom.events.asyncClipboard.clipboardItem" kohta "true":ksi. Vaihtaaksesi selaimen kohdan Firefoxissa, käy "about:config" sivulla.',
    disableSnapping: '',
  },
  r = {
  ...
  x = {
    ...
    clearCanvasMessage:
      'Mikäli sivun lataaminen uudelleen ei auta, yritä <button>tyhjentää piirtoalue.</button>',
    clearCanvasCaveat: ' Tämä johtaa työn menetykseen ',
    trackedToSentry: 'Virhe tunnisteella {{eventId}} tallennettiin järjestelmäämme.',
    openIssueMessage:
      'Olimme varovaisia emmekä sisällyttäneet tietoa piirroksestasi virheeseen. Mikäli piirroksesi ei ole yksityinen, harkitsethan kertovasi meille <button>virheenseurantajärjestelmässämme.</button> Sisällytä alla olevat tiedot kopioimalla ne GitHub-ongelmaan.',
    sceneContent: 'Piirroksen tiedot:',
  },
  E = {
    desc_intro: 'Voit kutsua ihmisiä piirrokseesi tekemään yhteistyötä kanssasi.',
    desc_privacy:
      'Älä huoli, istunto käyttää päästä-päähän-salausta, joten mitä tahansa piirrätkin, se pysyy salassa. Edes palvelimemme eivät näe mitä keksit.',
    ...
    desc_exitSession:
      'Istunnon pysäyttäminen katkaisee yhteyden huoneeseen, mutta voit vielä jatkaa työskentelyä paikallisesti. Huomaa, että tämä ei vaikuta muihin käyttäjiin ja he voivat jatkaa oman versionsa parissa työskentelyä.',
  ...
  p = {
    ...
    placeholder: {
      ...
      githubHandle:
        'GitHub-tunnuksesi (valinnainen), jotta voit muokata kirjastoa sen jälkeen kun se on lähetetty tarkastettavaksi',
      twitterHandle:
        'Twitter-tunnus (valinnainen), jotta tiedämme ketä kiittää kun viestimme Twitterissä',
      website: 'Linkki henkilökohtaiselle verkkosivustollesi tai muualle (valinnainen)',
    },
    errors: { required: 'Pakollinen', website: 'Syötä oikeamuotoinen URL-osoite' },
    noteDescription:
      'Lähetä kirjastosi, jotta se voidaan sisällyttää <link>julkisessa kirjastolistauksessa</link>muiden käyttöön omissa piirrustuksissaan.',
    noteGuidelines:
      'Kirjasto on ensin hyväksyttävä manuaalisesti. Ole hyvä ja lue <link>ohjeet</link> ennen lähettämistä. Tarvitset GitHub-tilin, jotta voit viestiä ja tehdä muutoksia pyydettäessä, mutta se ei ole ehdottoman välttämätöntä.',
    noteLicense:
      'Lähettämällä hyväksyt että kirjasto julkaistaan <link>MIT-lisenssin </link>alla, mikä lyhyesti antaa muiden käyttää sitä ilman rajoituksia.',
    noteItems:
      'Jokaisella kirjaston kohteella on oltava oma nimensä suodatusta varten. Seuraavat kirjaston kohteet sisältyvät:',
    atleastOneLibItem: 'Valitse vähintään yksi kirjaston kohde aloittaaksesi',
    republishWarning:
      'Huom! Osa valituista kohteista on merkitty jo julkaistu/lähetetyiksi. Lähetä kohteita uudelleen vain päivitettäessä olemassa olevaa kirjastoa tai ehdotusta.',
  },
  v = {
    title: 'Kirjasto lähetetty',
    content:
      'Kiitos {{authorName}}. Kirjastosi on lähetetty tarkistettavaksi. Voit seurata sen tilaa<link>täällä</link>',
  },
  y = {
    resetLibrary: 'Tyhjennä kirjasto',
  ...
  h = {
    tooltip:
      'Piirroksesi ovat päästä-päähän-salattuja, joten Excalidrawin palvelimet eivät koskaan näe niitä.',
...
tai liittääksesi olemassa olevaan tekstieditoriin`,
  ...
  F = { mostUsedCustomColors: '', colors: '', shades: '', hexCode: '', noShades: '' },
  S = {
    action: {
