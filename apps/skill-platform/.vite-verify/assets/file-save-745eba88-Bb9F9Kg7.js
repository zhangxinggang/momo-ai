var y = async (e, t = [{}], s = null, p = !1, o = null) => {
  ...
  if (
    (e instanceof Blob && e.type
      ? (i = e.type)
      : e.headers && e.headers.get('content-type') && (i = e.headers.get('content-type')),
    t.forEach((a, r) => {
      ((n[r] = { description: a.description || '', accept: {} }),
        a.mimeTypes
          ? (r === 0 && i && a.mimeTypes.push(i),
            a.mimeTypes.map((d) => {
  ...
  return 'stream' in e
    ? (await e.stream().pipeTo(l), c)
    : 'body' in e
      ? (await e.body.pipeTo(l), c)
      : (await l.write(await e), await l.close(), c);
};
export { y as default };
