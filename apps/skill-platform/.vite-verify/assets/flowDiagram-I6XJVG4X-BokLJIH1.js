import { s as ht } from './chunk-2J33WTMH-CGvQ9bSc.js';
import { g as ct } from './chunk-55IACEB6-BTq3bZL5.js';
import { g as He } from './chunk-FMBD7UC4-B08AeLCH.js';
import { c as lt } from './chunk-ND2GUHAM-TMCKCFt-.js';
import { p as dt, c as ft, s as ie, r as pt } from './markdown-it-vendor-DL4wSELR.js';
    ...
    ((R1 = class {
      ...
      lookUpDomId(i) {
        for (const a of this.vertices.values())
          if (a.id === i) return this.diagramId ? `${this.diagramId}-${a.domId}` : a.domId;
...
` +
        ...
        if (k) {
          const T = u;
          (T?.animate !== void 0 && (k.animate = T.animate),
            T?.animation !== void 0 && (k.animation = T.animation),
            T?.curve !== void 0 && (k.interpolate = T.curve));
          return;
        }
        let F,
        ...
        if (
          ...
          (u?.label &&
            ((g.text = u?.label), (g.labelType = this.sanitizeNodeLabelType(u?.labelType))),
            u?.icon && ((g.icon = u?.icon), !u.label?.trim() && g.text === i && (g.text = '')),
            u?.form && (g.form = u?.form),
            u?.pos && (g.pos = u?.pos),
            u?.img && ((g.img = u?.img), !u.label?.trim() && g.text === i && (g.text = '')),
      ...
      addSingleLink(i, a, r, n) {
        ...
        if (
          (A !== void 0 &&
            ((l.text = this.sanitizeText(A.text.trim())),
            l.text.startsWith('"') &&
              l.text.endsWith('"') &&
              (l.text = l.text.substring(1, l.text.length - 1)),
            (l.labelType = this.sanitizeNodeLabelType(A.type))),
          r !== void 0 &&
          ...
          u.length === 0
            ? (l.id = se(l.start, l.end, { counter: 0, prefix: 'L' }))
            : (l.id = se(l.start, l.end, { counter: u.length + 1, prefix: 'L' }));
        }
...
You have to call mermaid.initialize.`);
      ...
      addClass(i, a) {
        ...
        i.split(',').forEach((n) => {
          ...
          (c === void 0 && ((c = { id: n, styles: [], textStyles: [] }), this.classes.set(n, c)),
            r?.forEach((p) => {
              if (/color/.exec(p)) {
      ...
      setClickFun(i, a, r) {
        if (g1().securityLevel !== 'loose' || a === void 0) return;
        let n = [];
        if (typeof r == 'string') {
          n = r.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
        ...
        ie(i)
          ...
          .on('mouseover', (c) => {
            ...
            (a.transition().duration(200).style('opacity', '.9'),
              ...
              a.html(dt.sanitize(l)),
              p.classed('hover', !0));
          })
          .on('mouseout', (c) => {
            (a.transition().duration(500).style('opacity', 0),
              ie(c.currentTarget).classed('hover', !1));
          });
      }
      clear(i = 'gen-2') {
        ((this.vertices = new Map()),
      ...
      addSubGraph(i, a, r) {
        ...
        if (
          ((u = u ?? (k.inheritDir ? (this.getDirection() ?? g1().direction ?? void 0) : void 0)),
          this.version === 'gen-1')
        )
          for (let g = 0; g < A.length; g++) A[g] = this.lookUpDomId(A[g]);
        ...
        return (
          J.info('Adding', F.id, F.nodes, F.dir),
      ...
      addNodeFromVertex(i, a, r, n, c, p) {
        ...
        if (u)
          ...
          A
            ? a.push({ ...k, isGroup: !0, shape: 'rect' })
            : a.push({ ...k, isGroup: !1, shape: this.getTypeFromVertex(i) });
        }
      }
      getCompiledStyles(i) {
        let a = [];
        for (const r of i) {
          ...
          (n?.styles && (a = [...a, ...(n.styles ?? [])].map((c) => c.trim())),
            n?.textStyles && (a = [...a, ...(n.textStyles ?? [])].map((c) => c.trim())));
        }
        return a;
      }
      getData() {
        ...
        for (let u = n.length - 1; u >= 0; u--) {
          ...
          for (const F of k.nodes) c.set(F, k.id);
        }
        for (let u = n.length - 1; u >= 0; u--) {
          const k = n[u];
          a.push({
        ...
        return (
          A.forEach((u, k) => {
            const { arrowTypeStart: F, arrowTypeEnd: g } = this.destructEdgeType(u.type),
              T = [...(A.defaultStyle ?? [])];
  ...
  kt = b(async function (s, i, a, r) {
    ...
    (re.insertTitle(A, 'flowchartTitleText', c?.titleTopMargin || 0, r.db.getDiagramTitle()),
      ht(A, k, 'flowchart', c?.useMaxWidth || !1));
  }, 'draw'),
  mt = { getClasses: At, draw: kt },
  ae = (function () {
    var s = b(function (f1, h, d, f) {
      ...
      J1 = {
        ...
        performAction: b(function (h, d, f, o, x, e, G1) {
          var t = e.length - 1;
          switch (x) {
            case 2:
              this.$ = [];
        ...
        table: [
          ...
          s(S, [2, 7]),
          s(S, [2, 8]),
          { 8: $, 9: e1, 11: t1, 21: 59, 41: 60, 72: 64, 75: [1, 65], 77: [1, 67], 78: [1, 66] },
          { 8: $, 9: e1, 11: t1, 21: 68 },
          { 8: $, 9: e1, 11: t1, 21: 69 },
          { 8: $, 9: e1, 11: t1, 21: 70 },
          { 8: $, 9: e1, 11: t1, 21: 71 },
          { 8: $, 9: e1, 11: t1, 21: 72 },
          { 8: $, 9: e1, 10: [1, 73], 11: t1, 21: 74 },
          s(S, [2, 36]),
          { 35: [1, 75] },
          { 37: [1, 76] },
          s(S, [2, 39]),
          s(m1, [2, 50], { 18: 77, 39: 78, 10: d1, 40: ne }),
          { 10: [1, 80] },
          { 10: [1, 81] },
          { 10: [1, 82] },
          { 10: [1, 83] },
          ...
          { 76: 120, 79: 121, 80: oe, 81: le, 116: j1, 119: Y1 },
          { 75: [1, 126], 77: [1, 127] },
          s(ce, [2, 83]),
          s(S, [2, 28]),
          s(S, [2, 29]),
          ...
          { 30: 171, 67: m, 80: W, 81: K, 82: 172, 116: C, 117: D, 118: E },
          { 30: 179, 67: m, 80: W, 81: K, 82: 172, 116: C, 117: D, 118: E },
          { 30: 181, 50: [1, 180], 67: m, 80: W, 81: K, 82: 172, 116: C, 117: D, 118: E },
          { 30: 182, 67: m, 80: W, 81: K, 82: 172, 116: C, 117: D, 118: E },
          { 30: 183, 67: m, 80: W, 81: K, 82: 172, 116: C, 117: D, 118: E },
          { 30: 184, 67: m, 80: W, 81: K, 82: 172, 116: C, 117: D, 118: E },
          { 109: [1, 185] },
          { 30: 186, 67: m, 80: W, 81: K, 82: 172, 116: C, 117: D, 118: E },
          { 30: 187, 65: [1, 188], 67: m, 80: W, 81: K, 82: 172, 116: C, 117: D, 118: E },
          { 30: 189, 67: m, 80: W, 81: K, 82: 172, 116: C, 117: D, 118: E },
          { 30: 190, 67: m, 80: W, 81: K, 82: 172, 116: C, 117: D, 118: E },
          { 30: 191, 67: m, 80: W, 81: K, 82: 172, 116: C, 117: D, 118: E },
          s(q, [2, 182]),
          s(n, [2, 20]),
          s(ue, [2, 25]),
          s(m1, [2, 46], { 39: 192, 18: 193, 10: d1, 40: ne }),
          s(L1, [2, 73], { 10: [1, 194] }),
          { 10: [1, 195] },
          { 30: 196, 67: m, 80: W, 81: K, 82: 172, 116: C, 117: D, 118: E },
          ...
          s(V1, [2, 168]),
          s(V1, [2, 169]),
          { 76: 199, 79: 121, 80: oe, 81: le, 116: j1, 119: Y1 },
          s(ce, [2, 84]),
          {
            8: $,
            9: e1,
          ...
          { 31: [1, 218], 67: m, 82: 219, 116: C, 117: D, 118: E },
          s(p1, [2, 86]),
          s(p1, [2, 88]),
          s(p1, [2, 89]),
          s(p1, [2, 153]),
          ...
          s(p1, [2, 155]),
          s(p1, [2, 156]),
          { 49: [1, 220], 67: m, 82: 219, 116: C, 117: D, 118: E },
          { 30: 221, 67: m, 80: W, 81: K, 82: 172, 116: C, 117: D, 118: E },
          { 51: [1, 222], 67: m, 82: 219, 116: C, 117: D, 118: E },
          { 53: [1, 223], 67: m, 82: 219, 116: C, 117: D, 118: E },
          { 55: [1, 224], 67: m, 82: 219, 116: C, 117: D, 118: E },
          { 57: [1, 225], 67: m, 82: 219, 116: C, 117: D, 118: E },
          { 60: [1, 226] },
          { 64: [1, 227], 67: m, 82: 219, 116: C, 117: D, 118: E },
          { 66: [1, 228], 67: m, 82: 219, 116: C, 117: D, 118: E },
          { 30: 229, 67: m, 80: W, 81: K, 82: 172, 116: C, 117: D, 118: E },
          { 31: [1, 230], 67: m, 82: 219, 116: C, 117: D, 118: E },
          { 67: m, 69: [1, 231], 71: [1, 232], 82: 219, 116: C, 117: D, 118: E },
          { 67: m, 69: [1, 234], 71: [1, 233], 82: 219, 116: C, 117: D, 118: E },
          s(m1, [2, 45], { 18: 156, 10: d1, 40: Ie }),
          s(m1, [2, 47], { 44: Ve }),
          s(L1, [2, 75]),
          s(L1, [2, 74]),
          { 62: [1, 235], 67: m, 82: 219, 116: C, 117: D, 118: E },
          s(L1, [2, 77]),
          s(V1, [2, 80]),
          { 77: [1, 236], 79: 198, 116: j1, 119: Y1 },
          { 30: 237, 67: m, 80: W, 81: K, 82: 172, 116: C, 117: D, 118: E },
          s(Q1, c, { 5: 238 }),
          s(y, [2, 102]),
          s(S, [2, 35]),
          {
          ...
          s(p1, [2, 87]),
          s(z, [2, 57]),
          { 51: [1, 263], 67: m, 82: 219, 116: C, 117: D, 118: E },
          s(z, [2, 64]),
          s(z, [2, 59]),
          s(z, [2, 60]),
          s(z, [2, 61]),
          ...
          s(z, [2, 63]),
          s(z, [2, 65]),
          { 66: [1, 265], 67: m, 82: 219, 116: C, 117: D, 118: E },
          s(z, [2, 67]),
          s(z, [2, 68]),
          s(z, [2, 70]),
          s(z, [2, 69]),
          ...
          s(L1, [2, 78]),
          { 31: [1, 266], 67: m, 82: 219, 116: C, 117: D, 118: E },
          {
            6: 11,
            7: 12,
            8: p,
          ...
          s(B, [2, 120]),
          s(z, [2, 58]),
          { 30: 283, 67: m, 80: W, 81: K, 82: 172, 116: C, 117: D, 118: E },
          s(z, [2, 66]),
          s(Q1, c, { 5: 284 }),
          s(Re, [2, 131], {
            108: 270,
          ...
          s(B, [2, 114]),
          { 31: [1, 287], 67: m, 82: 219, 116: C, 117: D, 118: E },
          {
            6: 11,
            7: 12,
            8: p,
          ...
          for (var Y, k1, Q, ee, w1 = {}, H1, c1, Oe, X1; ; ) {
            if (
              ...
              this.defaultActions[k1]
                ...
                : ((Y === null || typeof Y > 'u') && (Y = Pe()), (Q = G1[k1] && G1[k1][Y])),
            ...
            switch (Q[0]) {
              ...
              case 2:
                if (
                  ...
                  Ye &&
                    (w1._$.range = [e[e.length - (c1 || 1)].range[0], e[e.length - 1].range[1]]),
                  (ee = this.performAction.apply(w1, [t, Ne, L, A1.yy, Q[1], x, e].concat(je))),
                  typeof ee < 'u')
                )
                  return ee;
                (c1 &&
                  ...
                  x.push(w1.$),
                  e.push(w1._$),
                  (Oe = G1[f[f.length - 2]][f[f.length - 1]]),
                  f.push(Oe));
                break;
              case 3:
                return !0;
...
` +
          ...
          next: b(function () {
            ...
            for (var x = this._currentRules(), e = 0; e < x.length; e++)
              if (
                ((f = this._input.match(this.rules[x[e]])), f && (!d || f[0].length > d[0].length))
              ) {
            ...
            return d
              ? ((h = this.test_match(d, x[o])), h !== !1 ? h : !1)
              : this._input === ''
                ? this.EOF
                : this.parseError(
                    'Lexical error on line ' +
...
` +
          ...
          options: {},
          performAction: b(function (d, f, o, x) {
            switch (o) {
              case 0:
