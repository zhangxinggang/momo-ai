...
var e = {
    ...
    lineEditor: { edit: 'Modifier la ligne', exit: "Quitter l'éditeur de ligne" },
    elementLock: {
      lock: 'Verrouiller',
  ...
  r = {
    ...
    hint_emptyLibrary:
      "Sélectionnez un élément sur le canevas pour l'ajouter ici ou installez une bibliothèque depuis le dépôt public, ci-dessous.",
  ...
  o = {
    ...
    couldNotCreateShareableLinkTooBig:
      'Impossible de créer un lien de partage : la scène est trop volumineuse',
    ...
    uploadedSecurly:
      "Le téléchargement a été sécurisé avec un chiffrement de bout en bout, ce qui signifie que ni Excalidraw ni personne d'autre ne peut en lire le contenu.",
...
(Si vous voulez garder votre dessin local, fermez simplement l'onglet du navigateur à la place.)`,
    ...
    confirmAddLibrary:
      'Cela va ajouter {{numShapes}} forme(s) à votre bibliothèque. Êtes-vous sûr·e ?',
    imageDoesNotContainScene:
      "Cette image ne semble pas contenir de données de scène. Avez-vous activé l'intégration de scène lors de l'exportation ?",
    cannotRestoreFromImage: 'Impossible de restaurer la scène depuis ce fichier image',
    invalidSceneUrl:
      "Impossible d'importer la scène depuis l'URL fournie. Elle est soit incorrecte, soit ne contient pas de données JSON Excalidraw valides.",
    ...
    invalidEncryptionKey:
      'La clé de chiffrement doit comporter 22 caractères. La collaboration en direct est désactivée.',
...
Vos modifications ne seront pas enregistrées !`,
  ...
  t = {
    ...
    cannotResolveCollabServer:
      'Impossible de se connecter au serveur collaboratif. Veuillez recharger la page et réessayer.',
    importLibraryError: 'Impossible de charger la bibliothèque',
    collabSaveFailed:
      "Impossible d'enregistrer dans la base de données en arrière-plan. Si des problèmes persistent, vous devriez enregistrer votre fichier localement pour vous assurer de ne pas perdre votre travail.",
    collabSaveFailed_sizeExceeded:
      "Impossible d'enregistrer dans la base de données en arrière-plan, le tableau semble trop grand. Vous devriez enregistrer le fichier localement pour vous assurer de ne pas perdre votre travail.",
    imageToolNotSupported: 'Les images sont désactivées.',
    brave_measure_text_error: {
      line1:
        "On dirait que vous utilisez le navigateur Brave avec l'option <bold>Bloquer agressivement le fichage</bold> activée.",
      line2:
        'Cela pourrait entraîner des problèmes avec les <bold>Éléments Textuels</bold> dans vos dessins.',
      line3:
        'Nous recommandons fortement de désactiver cette option. Vous pouvez suivre <link>ces instructions</link> pour savoir comment faire.',
      line4:
        "Si désactiver cette option de résout pas le problème d'affichage des éléments textuels, veuillez ouvrir un <issueLink>ticket</issueLink> sur notre GitHub, ou écrivez-nous sur notre <discordLink>Discord</discordLink>",
    },
...
maintenez ALT pour redimensionner depuis le centre`,
    ...
    lineEditor_info:
      'Maintenez CtrlOrCmd et Double-cliquez ou appuyez sur CtrlOrCmd + Entrée pour modifier les points',
    lineEditor_pointSelected:
      'Appuyer sur Suppr. pour supprimer des points, Ctrl ou Cmd+D pour dupliquer, ou faire glisser pour déplacer',
...
ou maintenir la touche Alt enfoncée et cliquer pour ajouter de nouveaux points`,
    placeImage:
      "Cliquez pour placer l'image, ou cliquez et faites glisser pour définir sa taille manuellement",
    publishLibrary: 'Publier votre propre bibliothèque',
    bindTextToElement: 'Appuyer sur Entrée pour ajouter du texte',
    deepBoxSelect:
      'Maintenir Ctrl ou Cmd pour sélectionner dans les groupes et empêcher le déplacement',
  ...
  u = {
    ...
    clearCanvasMessage:
      "Si le rechargement ne résout pas l'erreur, essayez <button>effacement du canevas.</button>",
    clearCanvasCaveat: ' Cela entraînera une perte du travail ',
    trackedToSentry:
      "L'erreur avec l'identifiant {{eventId}} a été enregistrée dans notre système.",
    openIssueMessage:
      "Nous avons fait très attention à ne pas inclure les informations de votre scène dans l'erreur. Si votre scène n'est pas privée, veuillez envisager de poursuivre sur notre <button>outil de suivi des bugs.</button> Veuillez inclure les informations ci-dessous en les copiant-collant dans le ticket GitHub.",
    sceneContent: 'Contenu de la scène :',
  },
  d = {
    desc_intro:
      'Vous pouvez inviter des personnes à collaborer avec vous sur votre scène actuelle.',
    desc_privacy:
      "Pas d'inquiétude, la session utilise le chiffrement de bout en bout, donc tout ce que vous dessinez restera privé. Même notre serveur ne pourra voir ce que vous faites.",
    ...
    desc_exitSession:
      "Arrêter la session vous déconnectera de la salle, mais vous pourrez continuer à travailler avec la scène, localement. Notez que cela n'affectera pas les autres personnes, et ils pourront toujours collaborer sur leur version.",
  ...
  E = { title: 'Effacer la zone de dessin' },
  m = {
    ...
    placeholder: {
      ...
      githubHandle:
        "Nom d'utilisateur GitHub (optionnel), pour que tu puisses modifier la bibliothèque une fois soumise pour vérification",
      twitterHandle:
        "Nom d'utilisateur Twitter (optionnel), pour savoir qui créditer lors de la promotion sur Twitter",
      website: 'Lien vers votre site web personnel ou autre (optionnel)',
    },
    errors: { required: 'Requis', website: 'Entrer une URL valide' },
    noteDescription:
      "Soumets ta bibliothèque pour l'inclure au <link>dépôt de bibliothèque publique</link>pour permettre son utilisation par autrui dans leurs dessins.",
    noteGuidelines:
      "La bibliothèque doit d'abord être approuvée manuellement. Veuillez lire les <link>lignes directrices</link> avant de la soumettre. Vous aurez besoin d'un compte GitHub pour communiquer et apporter des modifications si demandé, mais ce n'est pas obligatoire.",
    noteLicense:
      "En soumettant, vous acceptez que la bibliothèque soit publiée sous la <link>Licence MIT, </link>ce qui en gros signifie que tout le monde peut l'utiliser sans restrictions.",
    noteItems:
      "Chaque élément de la bibliothèque doit avoir son propre nom afin qu'il soit filtrable. Les éléments de bibliothèque suivants seront inclus :",
    atleastOneLibItem: 'Veuillez sélectionner au moins un élément de bibliothèque pour commencer',
    republishWarning:
      "Remarque : certains des éléments sélectionnés sont marqués comme étant déjà publiés/soumis. Vous devez uniquement resoumettre des éléments lors de la mise à jour d'une bibliothèque ou d'une soumission existante.",
  },
  b = {
    title: 'Bibliothèque soumise',
    content:
      'Merci {{authorName}}. Votre bibliothèque a été soumise pour examen. Vous pouvez suivre le statut<link>ici</link>',
  },
  g = {
    resetLibrary: 'Réinitialiser la bibliothèque',
...
Cela augmentera la taille du fichier exporté.`,
  ...
  h = {
    tooltip:
      "Vos dessins sont chiffrés de bout en bout, les serveurs d'Excalidraw ne les verront jamais.",
...
ou coller dans un éditeur de texte existant`,
    unableToEmbed:
      "Intégrer cet URL n'est actuellement pas autorisé. Ouvrez un ticket sur GitHub pour demander son ajout à la liste blanche",
    unrecognizedLinkFormat:
      "Le lien que vous avez intégré ne correspond pas au format attendu. Veuillez essayer de coller la chaîne d'intégration fournie par le site source",
  },
  S = {
  ...
  A = {
    action: {
      exportToImage: {
        ...
        description:
          'Exporter les données de la scène comme une image que vous pourrez importer ultérieurement.',
      },
      saveToDisk: {
