...
var e = {
    ...
    lineEditor: { edit: 'Editar liña', exit: 'Saír do editor de liñas' },
    elementLock: {
      lock: 'Bloquear',
      unlock: 'Desbloquear',
  ...
  a = {
    ...
    hint_emptyLibrary:
      'Seleccione un elemento no lenzo para engadilo aquí, ou instale unha biblioteca dende o repositorio público, como se detalla a continuación.',
  ...
  r = {
    ...
    couldNotCreateShareableLinkTooBig:
      'Non se puido crear a ligazón para compartir: a escena é demasiado grande',
    ...
    loadSceneOverridePrompt:
      'A carga dun debuxo externo substituirá o contido existente. Desexa continuar?',
...
(Se quere manter o seu debuxo local, simplemente peche a lapela do navegador.)`,
    ...
    imageDoesNotContainScene:
      'Esta imaxe non parece conter ningún dato da escena. Activou a inserción de escenas durante a exportación?',
    ...
    invalidEncryptionKey:
      'A clave de cifrado debe ter 22 caracteres. A colaboración en directo está desactivada.',
...
Os teus cambios non serán gardados!`,
  ...
  i = {
    ...
    cannotResolveCollabServer:
      'Non se puido conectar ao servidor de colaboración. Por favor recargue a páxina e probe de novo.',
    importLibraryError: 'Non se puido cargar a biblioteca',
    collabSaveFailed:
      'Non se puido gardar na base de datos. Se o problema persiste, deberías gardar o teu arquivo de maneira local para asegurarte de non perdelo teu traballo.',
    collabSaveFailed_sizeExceeded:
      'Non se puido gardar na base de datos, o lenzo semella demasiado grande. Deberías gardar o teu arquivo de maneira local para asegurarte de non perdelo teu traballo.',
  ...
  s = {
    canvasPanning:
      'Para mover o lenzo, manteña pulsada a roda do rato ou a barra de espazo mentres arrastra, ou utilice a ferramenta da man',
...
manteña ALT para axustalo dende o centro`,
    ...
    lineEditor_info:
      'Manteña pulsado CtrlOrCmd e faga dobre clic ou prema CtrlOrCmd + Enter para editar puntos',
...
ou manteña pulsado Alt e faga clic para engadir novos puntos`,
    placeImage:
      'Faga clic para colocar a imaxe, ou faga clic e arrastre para establecer o seu tamaño manualmente',
    ...
    firefox_clipboard_write:
      'Esta función pódese activar establecendo a opción "dom.events.asyncClipboard.clipboardItem" a "true". Para cambiar as opcións do navegador en Firefox, visita a páxina "about:config".',
    disableSnapping: '',
  },
  l = {
  ...
  d = {
    ...
    openIssueMessage:
      'Fomos moi cautelosos de non incluír a información da súa escena no erro. Se a súa escena non é privada, por favor, considere o seguimento do noso <button>rastrexador de erros.</button> Por favor inclúa a seguinte información copiándoa e pegándoa na issue de Github.',
    sceneContent: 'Contido da escena:',
  },
  c = {
    desc_intro: 'Podes invitar xente a colaborar contigo na túa escena actual.',
    desc_privacy:
      'Non te preocupes, a sesión usa cifrado de punto a punto, polo que calquera cousa que debuxes mantense privada. Nin tan sequera o noso servidor será capaz de ver o que fas.',
    ...
    desc_exitSession:
      'Deter a sesión desconectarao da sala, pero poderá seguir traballando coa escena de maneira local. Teña en conta que isto non afectará a outras persoas, que poderán seguir colaborando na súa versión.',
  ...
  b = {
    ...
    placeholder: {
      ...
      githubHandle:
        'Nome de usuario de GitHub (opcional), así poderás editar a biblioteca unha vez enviada para a súa revisión',
      twitterHandle:
        'Nome de usuario en Twitter(opcional), así sabemos a quen darlle crédito cando se lle de promoción a través de Twitter',
      website: 'Ligazón ao teu sitio web persoal ou a outro sitio (opcional)',
    },
    errors: { required: 'Obrigatorio', website: 'Introduza unha URL válida' },
    noteDescription:
      'Envíe a súa biblioteca para que sexa incluída no <link>repositorio público de bibliotecas</link>para que outra xente a poida usar nos seus debuxos.',
    noteGuidelines:
      'A biblioteca necesita ser aprobada manualmente primeiro. Por favor, lea as <link>normas</link> antes de ser enviado. Necesitarás unha conta de GitHub para comunicarte ou facer cambios se se solicitan, pero non é estritamente necesario.',
    noteLicense:
      'Ao enviar, estás de acordo con que a biblioteca sexa publicada baixo a <link>Licenza MIT, </link>o cal significa que, en resumo, calquera pode usalo sen restricións.',
    noteItems:
      'Cada elemento da biblioteca debe ter o seu nome propio para que se poida filtrar. Os seguintes elementos da biblioteca serán incluídos:',
    atleastOneLibItem: 'Por favor seleccione polo menos un elemento da biblioteca para comezar',
    republishWarning:
      'Nota: algúns dos elementos seleccionados están marcados como xa publicados/enviados. Só deberías reenviar elementos cando se actualice unha biblioteca ou envío.',
  },
  g = {
    title: 'Biblioteca enviada',
    content:
      'Grazas {{authorName}}. A súa biblioteca foi enviada para ser revisada. Pode seguir o estado<link>aquí</link>',
  },
  E = {
  ...
  F = {
    ...
    button: { exportToPng: 'PNG', exportToSvg: 'SVG', copyPngToClipboard: 'Copiar ao portapapeis' },
  },
  v = {
    tooltip:
      'Os teus debuxos están cifrados de punto a punto, polo que os servidores de Excalidraw nunca os verán.',
...
ou pega nun editor de texto existente`,
  ...
  C = { mostUsedCustomColors: '', colors: 'Cores', shades: '', hexCode: '', noShades: '' },
  y = {
    action: {
      exportToImage: {
      ...
      saveToDisk: { title: 'Gardar no disco', button: 'Gardar no disco', description: '' },
      excalidrawPlus: { title: 'Excalidraw+', button: 'Exportar a Excalidraw+', description: '' },
    },
    modal: {
      loadFromFile: {
