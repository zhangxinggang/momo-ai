...
class N {
  constructor(e = {}) {
    ((this._isDirected = Object.prototype.hasOwnProperty.call(e, 'directed') ? e.directed : !0),
      ...
      (this._nodes = {}),
      this._isCompound && ((this._parent = {}), (this._children = {}), (this._children[u] = {})),
      (this._in = {}),
      (this._preds = {}),
      (this._out = {}),
      (this._sucs = {}),
  ...
  setNode(e, t) {
    return Object.prototype.hasOwnProperty.call(this._nodes, e)
      ...
      : ((this._nodes[e] = arguments.length > 1 ? t : this._defaultNodeLabelFn(e)),
        this._isCompound &&
          ((this._parent[e] = u), (this._children[e] = {}), (this._children[u][e] = !0)),
        (this._in[e] = {}),
        (this._preds[e] = {}),
        (this._out[e] = {}),
        (this._sucs[e] = {}),
  ...
  filterNodes(e) {
    ...
    var s = this;
    (o(this._nodes, function (n, h) {
      e(h) && t.setNode(h, n);
    }),
      o(this._edgeObjs, function (n) {
  ...
  setEdge() {
    ...
    var a = P(this._isDirected, e, t, s);
    return (
      (e = a.v),
      (t = a.w),
      Object.freeze(a),
