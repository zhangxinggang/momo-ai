...
var u = {
    ...
    lineEditor: { edit: 'ערוך קו', exit: 'צא מעורך הקו' },
    elementLock: {
      lock: 'נעילה',
      unlock: 'ביטול נעילה',
      lockAll: 'לנעול הכל',
...
או החזק Alt והקלק להוספת נקודות חדשות`,
  ...
  c = {
    ...
    errors: { required: 'נדרש', website: 'הזינו כתובת URL תקינה' },
    noteDescription: '',
    noteGuidelines: '',
    noteLicense: '',
    noteItems:
  ...
  B = { resetLibrary: 'איפוס ספריה', removeItemsFromLib: 'הסר את הפריטים הנבחרים מהספריה' },
  p = {
    header: '',
    label: {
      withBackground: '',
