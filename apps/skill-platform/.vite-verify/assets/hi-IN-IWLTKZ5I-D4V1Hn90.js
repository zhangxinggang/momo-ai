...
var u = {
    ...
    lineEditor: { edit: 'रेखा संपादित करे', exit: 'रेखा संपादक के बाहर' },
    elementLock: {
      lock: 'ताले में रखें',
      unlock: 'ताले से बाहर',
  ...
  E = {
    ...
    hint_emptyLibrary:
      'यहाँ जोड़ने के लिए पटल से एक वस्तु चुने, अथवा जन कोष से एक संग्रह नीचे स्थापित करें.',
  ...
  e = {
    ...
    uploadedSecurly:
      'अपलोड को एंड-टू-एंड एन्क्रिप्शन के साथ सुरक्षित किया गया है, जिसका मतलब है कि एक्सक्लूसिव सर्वर और थर्ड पार्टी कंटेंट नहीं पढ़ सकते हैं।',
    loadSceneOverridePrompt:
      'लोड हो रहा है बाहरी ड्राइंग आपके मौजूदा सामग्री को बदल देगा। क्या आप जारी रखना चाहते हैं?',
    collabStopOverridePrompt:
      'चालू सत्र समाप्ति से आपका संग्रहित पूर्व स्थानीय अधिलेखन नष्ट होकर पुनः अधिलेखित होगा, क्या आपको यक़ीन हैं? ( यदी आपको पूर्व स्थापित अधिलेखन सुरक्षित चाहिये तो बस ब्राउज़र टैब बंद करे)',
    ...
    imageDoesNotContainScene:
      'ऐसा लगता है कि इस छवि में कोई दृश्य डेटा नहीं है। क्या आपने निर्यात के दौरान दृश्य एम्बेडिंग अनुमतित की है?',
    cannotRestoreFromImage: 'छवि फ़ाइल बहाल दृश्य नहीं है',
    invalidSceneUrl:
      'दिये गये युआरेल से दृश्य आयात नहीं किया जा सका. यह या तो अनुचित है, या इसमें उचित Excalidraw JSON डेटा नहीं है।',
...
आपके बदलाव सहेजे नहीं जाएंगे!`,
  ...
  D = {
    ...
    cannotResolveCollabServer:
      'कॉलेब सर्वर से कनेक्शन नहीं हो पा रहा. कृपया पृष्ठ को पुनः लाने का प्रयास करे.',
    importLibraryError: 'संग्रह प्रतिष्ठापित नहीं किया जा सका',
    collabSaveFailed:
      'किसी कारण वश अंदरूनी डेटाबेस में सहेजा नहीं जा सका। यदि समस्या बनी रहती है, तो किये काम को खोने न देने के लिये अपनी फ़ाइल को स्थानीय रूप से सहेजे।',
    collabSaveFailed_sizeExceeded:
      'लगता है कि पृष्ठ तल काफ़ी बड़ा है, इस्कारण अंदरूनी डेटाबेस में सहेजा नहीं जा सका। किये काम को खोने न देने के लिये अपनी फ़ाइल को स्थानीय रूप से सहेजे।',
    imageToolNotSupported: 'प्रतिमायें अक्षम की गयी हैं',
    brave_measure_text_error: {
      line1:
        'लगता है कि आप Brave ब्राउज़र का उपयोग कर रहे और साथ में <bold>आक्रामक उँगलियो के छाप </bold> का चयन किया हुवा है',
      line2: 'यह आपके चित्रों के <bold>पाठ तत्वों</bold>को खंडित कर सकता हैं',
      line3:
        'हमें आपसे ठोस आग्रह है की आप सेट्टिंग में इस विकल्प का चयन ना करे.<link> इस अनुक्रम </link> का पालन करके इसका पता लगा सकते हैं',
      line4:
        'यदि इस सेटिंग्स को अक्षम करने पर भी पृष्ठ ठीक नहीं दिखता हो तो, हमारे GitHub पर एक <issueLink>मुद्दा प्रस्तुत</issueLink> करे, या हमें <discordLink>डिस्कोर्ड</discordLink> पर लिखित सम्पर्क करें',
    },
  ...
  a = {
    canvasPanning:
      'कैनवास को सरकाने के लिए, ड्रैग करते समय माउस व्हील को पकड़े रखे या स्पेसबार को दबाए रखे, अथवा हाथ वाले औज़ार का उपयोग करें',
...
केंद्र से आकार बदलने के लिए ALT दबाए रखें`,
    ...
    lineEditor_info:
      'बिंदुओं को सम्पादित करने के लिए CtrlOrCmd को दबायें रखते हुये डबल क्लिक करे, अथवा CtrlOrCmd + Enter साथ दबाये',
    ...
    firefox_clipboard_write:
      '"dom.events.asyncClipboard.clipboardItem" फ़्लैग को "true" पर सेट करके इस सुविधा को संभवतः सक्षम किया जा सकता है। Firefox में ब्राउज़र फ़्लैग बदलने के लिए, "about:config" पृष्ठ पर जाएँ।',
  ...
  i = {
    ...
    clearCanvasMessage:
      'यदि पुनः लोड करना काम नहीं करता है, तो प्रयास करें <button>कैनवास साफ करना।</button>',
    clearCanvasCaveat: ' इससे काम का नुकसान होगा ',
    trackedToSentry: 'पहचानकर्ता के साथ त्रुटि {{eventId}} हमारे सिस्टम पर नज़र रखी गई थी।',
    openIssueMessage:
      'हम बहुत सतर्क थे कि त्रुटि पर आपकी दृश्य जानकारी शामिल न करें। यदि आपका दृश्य निजी नहीं है, तो कृपया हमारे बारे में विचार करें <button>बग ट्रैकर</button> कृपया GitHub मुद्दे को कॉपी और पेस्ट करके नीचे दी गई जानकारी शामिल करें।',
    sceneContent: 'दृश्य सामग्री:',
  },
  A = {
    desc_intro:
      'आप अपने वर्तमान दृश्य के लोगों को अपने साथ सहयोग करने के लिए आमंत्रित कर सकते हैं।',
    desc_privacy:
      'चिंता न करें, सत्र अंत-से-अंत एन्क्रिप्शन का उपयोग करता है, इसलिए आप जो भी ड्रा करेंगे वह निजी रहेगा। यहां तक कि हमारा सर्वर भी नहीं देख पाएगा कि आप क्या कर रहे हैं।',
    ...
    desc_exitSession:
      'सत्र रोकना आपको रूम से बाहर कर देगा, लेकिन आप स्थानीय स्तर पर दृश्य के साथ काम करना जारी रख पाएंगे। ध्यान दें कि यह अन्य लोगों को प्रभावित नहीं करेगा, और वे अभी भी अपने संस्करण पर सहयोग करने में सक्षम होंगे।',
    shareTitle: '',
  },
  l = { title: 'गलती' },
  n = {
  ...
  B = {
    ...
    errors: { required: '', website: 'मान्य URL प्रविष्ट करें' },
    noteDescription:
      'संग्रह सम्मिलित करने हेतु प्रस्तुत करें <link>सार्वजनिक संग्रहालय</link>अन्य वक्तियों को उनके चित्रकारी में उपयोग के लिये',
    noteGuidelines: 'संग्रह को पहले स्वीकृति आवश्यक कृपया यह पढ़ें <link>दिशा-निर्देश</link>',
    noteLicense:
      'जमा करके, आप सहमत हैं कि संग्रहण को <link>MIT लाइसेंस</link> के तहत प्रकाशित किया जाएगा, जिसका संक्षिप्त अर्थ है कि कोई भी बिना किसी प्रतिबंध के उनका उपयोग कर सकता है।',
    noteItems: '',
    atleastOneLibItem: '',
    republishWarning:
      'टिप्पणी: कुछ चुने हुवे आइटम पहले ही प्रकाशित/प्रस्तुत किए जा चुके हैं। किसी प्रकाशित संग्रह को अद्यतन करते समय या पहले से प्रस्तुत आइटम को पुन्हा प्रस्तुत करते समय, आप बस उसे केवल अद्यतन करें ।',
  },
  d = {
    title: '',
    content:
      '{{authorName}} धन्यवाद. आपका संग्रहण समीक्षा के लिए दर्ज हो चुका है. समीक्षा स्थिति <link>यहाँ</link>जान सकते हैं.',
  },
  c = { resetLibrary: '', removeItemsFromLib: '' },
  m = {
    header: '',
    label: {
      withBackground: '',
  ...
  b = {
    tooltip:
      'आपके चित्र अंत-से-अंत एन्क्रिप्टेड हैं, इसलिए एक्सक्लूसिव्रॉव के सर्वर उन्हें कभी नहीं देखेंगे।',
    link: '',
  },
  p = {
    angle: 'कोण',
  ...
  S = {
    action: {
      exportToImage: {
        ...
        description:
          'दृष्य डेटा छवि स्वरूप में निर्यात करे, उस स्वरूप से आप उसे पुनः आयात कर सकते हो',
      },
      saveToDisk: {
    ...
    modal: {
      loadFromFile: {
        ...
        description:
          'फ़ाइल से लोड करने पर <bold>यह आपके कार्य की जगह लेलेगा </bold><br></br>आपकी ड्रॉइंग निम्न दर्शित विकल्पो में से एक चुनके और उपयोग करके सम्हाल सकते हैं',
      },
      shareableLink: {
        title: 'लिंक से लोड करें:',
        button: 'इस जगह प्रतिस्थापित करे',
        description:
          'बाहर का चित्र लोड करने पर <bold>यह आपके कार्य की जगह लेलेगा </bold><br></br>आप आपकी ड्रॉइंग पहले निम्न दर्शित विकल्पो में से एक चुनके और उपयोग करके सम्हाल सकते हों.',
      },
    },
  },
  k = {
