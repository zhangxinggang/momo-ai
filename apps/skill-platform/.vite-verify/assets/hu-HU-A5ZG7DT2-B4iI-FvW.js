...
var e = {
  ...
  a = {
    ...
    couldNotCreateShareableLinkTooBig:
      'Nem sikerült megosztható linket látrehozni: túl nagy a jelenet',
    ...
    uploadedSecurly:
      'A feltöltést végpontok közötti titkosítással biztosítottuk, ami azt jelenti, hogy egy harmadik fél nem tudja megnézni a tartalmát, beleértve az Excalidraw szervereit is.',
    loadSceneOverridePrompt:
      'A betöltött külső rajz felül fogja írnia meglévőt. Szeretnéd folytatni?',
...
(Ha meg akarod tartani a helyben tárolt rajzot, egyszerűen csak zárd be a böngésző fület)`,
    ...
    confirmAddLibrary:
      'Ez a művelet {{numShapes}} formát fog hozzáadni a könyvtáradhoz. Biztos vagy benne?',
    imageDoesNotContainScene:
      'Úgy tűnik, hogy ez a kép nem tartalmaz jelenetadatokat. Engedélyezted a jelenetbeágyazást az exportálás során?',
    cannotRestoreFromImage: 'A jelenet visszaállítása nem sikerült ebből a kép fájlból',
    invalidSceneUrl:
      'Nem sikerült importálni a jelenetet a megadott URL-ről. Rossz formátumú, vagy nem tartalmaz érvényes Excalidraw JSON-adatokat.',
    resetLibrary: 'Ezzel törlöd a könyvtárát. biztos vagy ebben?',
    removeItemsFromsLibrary: '{{count}} elemet törölsz a könyvtárból?',
    invalidEncryptionKey:
      'A titkosítási kulcsnak 22 karakterből kell állnia. Az élő együttműködés le van tiltva.',
  ...
  l = {
    ...
    svgImageInsertError:
      'Nem sikerült beszúrni az SVG-képet. Az SVG szintaktika érvénytelennek tűnik.',
    failedToFetchImage: '',
  ...
  r = {
    ...
    text_editing:
      'Nyomjd meg az Escape vagy a Ctrl/Cmd+ENTER billentyűkombinációt a szerkesztés befejezéséhez',
    linearElementMulti:
      'Kattints a következő ív pozíciójára, vagy fejezd be a nyilat az Escape vagy Enter megnyomásával',
...
vagy Alt, és kattintson az új pontok hozzáadásához`,
    ...
    deepBoxSelect:
      'Tartsd lenyomva a Ctrl/Cmd billentyűt a mély kijelöléshez és a húzás megakadályozásához',
    eraserRevert: '',
  ...
  n = {
    ...
    clearCanvasMessage:
      'Ha az újratöltés nem működik, próbáld <button>letörölni a vászont.</button>',
    ...
    openIssueMessage:
      'Vigyáztunk arra, hogy a jelenthez tartozó információ ne jelenjen meg a hibaüzenetben. Ha a jeleneted nem bizalmas, kérjük add hozzá a <button>hibakövető rendszerünkhöz.</button> Kérjük, másolja be az alábbi információkat a GitHub problémába.',
    sceneContent: 'Jelenet tartalma:',
  },
  i = {
    desc_intro: 'Meghívhat embereket a jelenlegi jelenetbe, hogy együttműködjenek önnel.',
    desc_privacy:
      'Ne aggódj, a munkamenet végpontok közötti titkosítást használ, tehát bármit rajzolsz, privát marad. Még a szerverünkről se lehet belenézni.',
    ...
    desc_exitSession:
      'Az munkamenet leállítása kilépteti önt a szobából, de folytathatja a munkát a saját gépén. Vegye figyelembe, hogy ez nem érinti más emberek munkáját és ők továbbra is együttműködhetnek a saját változatukon.',
  ...
  k = { title: 'Rajzvászon alaphelyzetbe' },
  m = {
    ...
    placeholder: {
      ...
      githubHandle:
        'GitHub-handle(opcionális), így szerkesztheted a könyvtárat, miután elküldted ellenőrzésre',
      twitterHandle:
        'Twitter-felhasználónév (opcionális), így tudjuk, kinek kell jóváírni a Twitteren keresztüli reklámozást',
      website: 'Hivatkozás személyes webhelyedre vagy máshová (nem kötelező)',
    },
    errors: { required: 'Kötelező', website: 'Adj meg egy érvényes URL-t' },
    noteDescription:
      'Küld be könyvtáradat, hogy bekerüljön a <link>nyilvános könyvtár tárolóba</link>hogy mások is felhasználhassák a rajzaikban.',
    noteGuidelines:
      'A könyvtárat először manuálisan kell jóváhagyni. Kérjük, olvassa el a <link>segédletet</link> benyújtása előtt. Szüksége lesz egy GitHub-fiókra a kommunikációhoz és a módosításokhoz, ha kérik, de ez nem feltétlenül szükséges.',
    noteLicense:
      'A beküldéssel elfogadja, hogy a könyvtár a következő alatt kerül közzétételre <link>MIT Licensz </link>ami röviden azt jelenti, hogy bárki korlátozás nélkül használhatja őket.',
    noteItems:
      'Minden könyvtárelemnek saját nevével kell rendelkeznie, hogy szűrhető legyen. A következő könyvtári tételek kerülnek bele:',
  ...
  g = {
    ...
    content:
      'Köszönjük {{authorName}}. Könyvtáradat elküldtük felülvizsgálatra. Nyomon követheted az állapotot<link>itt</link>',
  },
  b = {
    resetLibrary: 'Könyvtár alaphelyzetbe állítása',
  ...
  v = {
    ...
    button: { exportToPng: 'PNG', exportToSvg: 'SVG', copyPngToClipboard: 'Vágólapra másolás' },
  },
  y = {
    tooltip:
      'A rajzaidat végpontok közötti titkosítással tároljuk, tehát az Excalidraw szervereiről se tud más belenézni.',
...
({{exportColorScheme}})`,
  ...
  h = {
    ...
    defaults: { menuHint: '', center_heading: '', toolbarHint: '', helpHint: '' },
  },
  D = {
  ...
  C = {
    action: {
      exportToImage: { title: 'Exportálás képként', button: 'Exportálás képként', description: '' },
      saveToDisk: { title: 'Mentés a lemezre', button: 'Mentés a lemezre', description: '' },
      excalidrawPlus: { title: 'Excalidraw+', button: '', description: '' },
    },
    modal: {
      loadFromFile: { title: 'Betöltés fájlból', button: 'Betöltés fájlból', description: '' },
      shareableLink: { title: 'Feltöltás linkből', button: '', description: '' },
    },
  },
  j = { title: '', button: '', description: '', syntax: '', preview: '' },
  N = {
    labels: e,
    library: t,
    buttons: x,
