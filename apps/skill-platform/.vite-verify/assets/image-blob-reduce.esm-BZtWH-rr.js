var K = function (I) {
  for (var d, h = 1; h < arguments.length; h++) {
    ...
    for (var x in d) Object.prototype.hasOwnProperty.call(d, x) && (I[x] = d[x]);
  }
  return I;
};
function N(A, I) {
...
function V(A) {
  return N(A, ['alpha', 'unsharpAmount', 'unsharpRadius', 'unsharpThreshold', 'cancelToken']);
}
var J = N,
  $ = V,
  W = { assign: K, pick: J, pick_pica_resize_options: $ };
function q(A) {
  var I = { exports: {} };
      ...
      })()(
        {
          1: [
            function (d, h, x) {
              ...
              function e(i) {
                var a = i || [],
                  n = { js: a.indexOf('js') >= 0, wasm: a.indexOf('wasm') >= 0 };
                (c.call(this, n),
                  (this.features = { js: n.js, wasm: n.wasm && this.has_wasm() }),
                  this.use(r),
                  this.use(t));
              }
              (g(e, c),
          ...
          5: [
            function (d, h, x) {
              ...
              function t(e, i, a) {
                for (var n = 3, s = (i * a * 4) | 0; n < s; ) ((e[n] = 255), (n = (n + 4) | 0));
              }
            ...
            function (d, h, x) {
              ...
              h.exports = function (e, i, a, n, s) {
                ...
                for (m = 0; m < a; m++) {
                  ...
                  for (j = 0, D = 0; D < O.length; D++) ((G = O[D] / k), (j += G), (E[D] = r(G)));
                  for (E[a >> 1] += r(1 - j), o = 0; o < E.length && E[o] === 0; ) o++;
                  if (o < E.length) {
          ...
          8: [
            function (d, h, x) {
              var g = d('./resize_filter_gen');
              function c(i, a, n) {
                for (var s = 3, f = (a * n * 4) | 0; s < f; ) ((i[s] = 255), (s = (s + 4) | 0));
              }
              function r(i) {
            ...
            function (d, h, x) {
              ...
              h.exports = function (t, e, i, a, n, s) {
                ...
                if (!(a === 0 || n < 0.5)) {
                  ...
                  g(B, e, i, n);
                  for (
                    var C = ((a / 100) * 4096 + 0.5) | 0, F = s << 8, O = e * i, E = 0;
                    E < O;
                    E++
                  )
                    ((f = b[E]),
              ...
              h.exports = function (c, r, t, e, i, a) {
                if (!(e === 0 || i < 0.5)) {
                  ...
                  var n = r * t,
                    ...
                    F = C + u,
                    O = F + l,
                    E = this.__instance('unsharp_mask', s + f + u * 2 + l + y, { exp: Math.exp }),
          ...
          14: [
            function (d, h, x) {
              ...
              h.exports = function (r, t, e, i, a, n) {
                ...
                if (l <= 1) return [[e, i]];
                for (var y = [], m = 0; m < l; m++) {
                  var b = Math.round(Math.pow(Math.pow(r, l - m - 1) * Math.pow(e, m + 1), 1 / l)),
                    B = Math.round(Math.pow(Math.pow(t, l - m - 1) * Math.pow(i, m + 1), 1 / l));
                  y.push([b, B]);
                }
                return y;
              };
            ...
            function (d, h, x) {
              h.exports = function () {
                ...
                onmessage = function (t) {
                  ...
                  if (i) {
                    var f = new ImageData(new Uint8ClampedArray(s), e.toWidth, e.toHeight),
            ...
            function (d, h, x) {
              ...
              ((e.prototype.has_wasm = r),
                  ...
                  return (
                    (this.__init_promise = Promise.all(
                      Object.keys(i.__modules).map(function (a) {
                        var n = i.__modules[a];
                        return !i.options.wasm || !i.has_wasm() || !n.wasm_fn || i.__wasm[a]
                          ? null
                          : WebAssembly.compile(i.__base64decode(n.wasm_src)).then(function (s) {
                              i.__wasm[a] = s;
                            });
                      }),
                    ).then(function () {
                ...
                (e.prototype.__reallocate = function (a) {
                  ...
                  return (
                    n < a && this.__memory.grow(Math.ceil((a - n) / (64 * 1024))),
                    this.__memory
                  );
                }),
            ...
            function (d, h, x) {
              ...
              h.exports = function (r) {
                for (
                  ...
                  (s % 4 === 0 &&
                    s &&
                    ((i[n++] = (a >> 16) & 255), (i[n++] = (a >> 8) & 255), (i[n++] = a & 255)),
              ...
              h.exports = function () {
                ...
                try {
                  var r = new Uint8Array([
                      0, 97, 115, 109, 1, 0, 0, 0, 1, 6, 1, 96, 1, 127, 1, 127, 3, 2, 1, 0, 5, 3, 1,
                      0, 1, 7, 8, 1, 4, 116, 101, 115, 116, 0, 0, 10, 16, 1, 14, 0, 32, 0, 65, 1,
                      54, 2, 0, 32, 0, 40, 2, 0, 11,
                    ]),
            ...
            function (d, h, x) {
              ...
              function e() {
                try {
                  ...
                  for (var a = {}, n = 0; n < 10; n++) a['_' + String.fromCharCode(n)] = n;
              ...
              h.exports = e()
                ...
                : function (i, a) {
                    for (var n, s = t(i), f, u = 1; u < arguments.length; u++) {
                      ...
                      if (g) {
                        f = g(n);
                        for (var y = 0; y < f.length; y++) r.call(n, f[y]) && (s[f[y]] = n[f[y]]);
                      }
                    }
                    return s;
                  };
            ...
            function (d, h, x) {
              ...
              h.exports = function (e, i) {
                ...
                if (!a) {
                  ...
                  c[a] = ['function(require,module,exports){' + e + '(self); }', y];
                }
                ...
                var F =
                    ...
                    t(m) +
                    '])',
                  O = window.URL || window.webkitURL || window.mozURL || window.msURL,
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
              ...
              function r(o, p) {
                if (o) {
                  ...
                  if (
                    (_ === 'Object' && o.constructor && (_ = o.constructor.name),
                    _ === 'Map' || _ === 'Set')
                  )
                    return Array.from(o);
              ...
              function e(o, p) {
                var _ =
                  o == null ? null : (typeof Symbol < 'u' && o[Symbol.iterator]) || o['@@iterator'];
                if (_ != null) {
                  var v = [],
                    w = !0,
                    U = !1,
                  ...
                  try {
                    for (
                      _ = _.call(o);
                      !(w = (Q = _.next()).done) && (v.push(Q.value), !(p && v.length === p));
                      w = !0
                    );
                  } catch (P) {
                    ((U = !0), (M = P));
              ...
              ((G.prototype.init = function () {
                ...
                if (
                  ...
                  p.indexOf('ww') >= 0 && typeof window < 'u' && 'Worker' in window)
                )
                  try {
                    ...
                    b[v]
                      ...
                      : ((this.__workersPool = new f(j, this.options.idle)),
                ...
                var w = this.__mathlib.init().then(function (P) {
                  ...
                  U;
                (k
                  ? (U = u.cib_support(this.options.createCanvas).then(function (P) {
                ...
                return (
                  (this.__initPromise = Promise.all([w, U, Q, M]).then(function () {
                    return o;
                  })),
                  this.__initPromise
                );
                ...
                (G.prototype.__extractTileData = function (o, p, _, v, w) {
                  if (this.features.ww && D && (u.isCanvas(p) || S))
                    return (
                      ...
                      createImageBitmap(v.srcImageBitmap || p, o.x, o.y, o.width, o.height).then(
                        function (M) {
                  ...
                  if (u.isCanvas(p))
                    return (
                      v.srcCtx || (v.srcCtx = p.getContext('2d', { alpha: !!_.alpha })),
                      this.debug('Get tile pixel data'),
                      (w.src = v.srcCtx.getImageData(o.x, o.y, o.width, o.height).data),
                      w
                    );
                ...
                (G.prototype.__landTileData = function (o, p, _) {
                  ...
                  if (E) v = new ImageData(new Uint8ClampedArray(p.data), o.toWidth, o.toHeight);
                  else if (((v = _.toCtx.createImageData(o.toWidth, o.toHeight)), v.data.set))
                    v.data.set(p.data);
                  else for (var w = v.data.length - 1; w >= 0; w--) v.data[w] = p.data[w];
                  return (
                ...
                (G.prototype.__tileAndResize = function (o, p, _) {
                        ...
                        return (
                          ...
                          Promise.resolve(P)
                            ...
                            .then(function (T) {
                              return _.canceled
                                ? _.cancelToken
                                : ((w.srcImageData = null), v.__landTileData(M, T, w));
                            })
                        );
                      });
                    };
                  return Promise.resolve()
                    .then(function () {
                      if (((w.toCtx = p.getContext('2d', { alpha: !!_.alpha })), u.isCanvas(o)))
                        return null;
                ...
                (G.prototype.__processStages = function (o, p, _, v) {
                  ...
                  var z;
                  return (
                    T || (z = this.options.createCanvas(M, P)),
                    this.__tileAndResize(p, T ? _ : z, v)
                      .then(function () {
                        return T
                          ? _
                          : ((v.width = M), (v.height = P), w.__processStages(o, z, _, v));
                      })
                      .then(function (Z) {
                ...
                (G.prototype.resize = function (o, p, _) {
                  ...
                  if (
                    ...
                    return Promise.reject(
                      new Error('Invalid output size: '.concat(p.width, 'x').concat(p.height)),
                    );
                  ...
                  var U = 3;
                  return (
                    (w.__destTileBorder = Math.ceil(Math.max(U, (2.5 * w.unsharpRadius) | 0))),
                    this.init().then(function () {
                      if (w.canceled) return w.cancelToken;
                      if (v.features.cib) return v.__resizeViaCreateImageBitmap(o, p, w);
                      if (!R) {
                        var Q = new Error(
  ...
  Y = q(function (A) {
    ...
    function c(r, t, e) {
      ...
      if (i !== 'II*\0' && i !== 'MM\0*') throw I('invalid TIFF signature', 'EBADDATA');
    ...
    ((c.prototype.each = function (r) {
        ...
        ((t.ifd0 = { id: 0, entries: [] }),
          this.each(function (n) {
            (r(n) === !1 && !n.is_subifd_link) ||
              ...
              (t['ifd' + n.ifd] || (t['ifd' + n.ifd] = { id: n.ifd, entries: [] }),
              ...
              t[n].entries
                ...
                .forEach(function (l, y) {
                  ...
                  (a.write_uint16(m, l.tag),
                    ...
                    l.is_subifd_link
                      ? t['ifd' + l.tag] && (t['ifd' + l.tag].link_offset = m + 8)
                      : l.data_length <= 4
                        ? a.output.set(
      ...
      (c.prototype.is_subifd_link = function (r, t) {
        return (r === 0 && t === 34665) || (r === 0 && t === 34853) || (r === 34665 && t === 40965);
      }),
      ...
      (c.prototype.scan_ifd = function (r, t, e) {
        ...
        r === 0 && this.ifds_to_read.push({ id: 1, offset: this.read_uint32(t) });
      }),
      (A.exports.is_jpeg = function (r) {
        return r.length >= 4 && r[0] === 255 && r[1] === 216 && r[2] === 255;
      }),
      (A.exports.jpeg_segments_each = function (r, t) {
        if (!g(r)) throw I('Invalid argument (jpeg_bin), Uint8Array expected', 'EINVAL');
        ...
        for (var e = 0, i = r.length, a = !1; ; ) {
          ...
          if (f === 255 && u === 255) ((n = 255), (s = 1));
            ...
            throw I(
              'Unexpected byte at segment start: ' + d(f) + ' (offset ' + d(e) + ')',
              'EBADDATA',
            );
  ...
  return this._getUint8Array(A.blob).then(function (I) {
    ...
    try {
      ...
      if (
        ...
        A.blob = new Blob([I.slice(0, h), x, I.slice(h + 2)], { type: 'image/jpeg' });
      }
    } catch {}
    return A;
  });
...
function et(A) {
  ...
  var d;
  I & 4
    ? (d = this.pica.options.createCanvas(A.out_canvas.height, A.out_canvas.width))
    : (d = this.pica.options.createCanvas(A.out_canvas.width, A.out_canvas.height));
...
function rt(A) {
  return A.is_jpeg
    ? Promise.all([this._getUint8Array(A.blob), this._getUint8Array(A.out_blob)]).then(
        function (I) {
          var d = I[0],
            h = I[1];
          ...
          return (
            ...
            (A.out_blob = new Blob([h.slice(0, 2)].concat(x).concat([h.slice(20)]), {
              type: 'image/jpeg',
            })),
            A
          );
...
L.prototype._transform = function (A) {
  ((A.out_canvas = this.pica.options.createCanvas(A.transform_width, A.transform_height)),
