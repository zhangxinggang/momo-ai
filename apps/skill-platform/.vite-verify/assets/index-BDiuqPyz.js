...
const tO = 1,
  ...
  ae = 117,
  ne = 85,
  re = new Set([pO, qO, gO, NO, zO, DO, mO, $O, WO, XO, yO, Y, JO, AO, cO, fO, LO, HO, BO, IO]);
function X(O) {
  return O == p || O == q;
}
function y(O) {
...
export { ce as globalCompletion, me as localCompletionSource, ze as python, v as pythonLanguage };
