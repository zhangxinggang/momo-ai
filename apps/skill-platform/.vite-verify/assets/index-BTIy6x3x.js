...
const cO = new B({
  ...
  shift(O, e, a, r) {
    ...
    if (e == G && O.type == m) return O.parent;
    if (e == sO) {
...
const fO = new i(
    (O, e) => {
      ...
      if ((P(a) || a < 0) && e.context.type != d) {
        ...
        (r < e.context.depth ||
          (r == e.context.depth && e.context.type == p && (O.next != 45 || !l(O.peek(1))))) &&
          O.next != -1 &&
          !P(O.next) &&
          O.next != 35 &&
          O.acceptToken(c, -r);
  ...
  XO = new i(
    (O, e) => {
      ...
      if (O.next == 45)
        (O.advance(),
          l(O.next) &&
            O.acceptToken(e.context.type == p && e.context.depth == X(O, O.pos - 1) ? H : y));
      else if (O.next == 63)
        (O.advance(),
          l(O.next) &&
...
export { vO as yaml, DO as yamlFrontmatter, L as yamlLanguage };
