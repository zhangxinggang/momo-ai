...
function n(O, e, a) {
  return new p((t) => {
    ...
    for (
      ;
      t.next != O && t.next >= 0 && (a || (t.next != 38 && (t.next != 123 || t.peek(1) != 123)));
    )
      t.advance();
...
const d = n(39, $, !1),
  ...
  o = { parser: V },
  w = { parser: i.parser },
  U = Q.configure({ wrap: l((O, e) => (O.name == 'InterpolationContent' ? o : null)) }),
  y = Q.configure({
    wrap: l((O, e) => {
      var a;
...
const N = S(s.language);
function z(O, e) {
  switch (O.name) {
    case 'Attribute':
      return /^[*#(\[]|\{\{/.test(e.read(O.from, O.to)) ? k : null;
    case 'Text':
      return E;
  }
  return null;
...
function Z(O = {}) {
  ...
  return new P(e.language == s.language ? N : S(e.language), [
    e.support,
    e.language.data.of({
...
export { Z as angular, N as angularLanguage };
