const o = [
  ...
  t = (() => {
    ...
    for (const n of o)
      if (n?.[1] in document) {
        for (const [s, u] of n.entries()) r[e[s]] = u;
        return r;
      }
    return !1;
  })(),
  i = { change: t.fullscreenchange, error: t.fullscreenerror };
let l = {
...
Object.defineProperties(l, {
  isFullscreen: { get: () => !!document[t.fullscreenElement] },
  element: { enumerable: !0, get: () => document[t.fullscreenElement] ?? void 0 },
  isEnabled: { enumerable: !0, get: () => !!document[t.fullscreenEnabled] },
});
t || (l = { isEnabled: !1 });
const f = l;
export { f as default };
