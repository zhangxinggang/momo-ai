import { k as bt } from './markdown-it-vendor-DL4wSELR.js';
...
var J = (function () {
  var e = o(function (T, t, s, i) {
    ...
    D = {
      ...
      performAction: o(function (t, s, i, c, p, n, v) {
        var w = n.length - 1;
        switch (p) {
          case 6:
          case 7:
      ...
      parse: o(function (t) {
        ...
        o(tt, 'lex');
        for (var M, F, N, K, W = {}, U, V, et, Z; ; ) {
          if (
            ((F = i[i.length - 1]),
            this.defaultActions[F]
              ? (N = this.defaultActions[F])
              : ((M === null || typeof M > 'u') && (M = tt()), (N = v[F] && v[F][M])),
            typeof N > 'u' || !N.length || !N[0])
          ) {
            var q = '';
            Z = [];
            for (U in v[F]) this.terminals_[U] && U > L && Z.push("'" + this.terminals_[U] + "'");
            (b.showPosition
              ? (q =
                  'Parse error on line ' +
                  (I + 1) +
...
Expecting ` +
          ...
          if (N[0] instanceof Array && N.length > 1)
            throw new Error(
              'Parse Error: multiple actions possible at state: ' + F + ', token: ' + M,
            );
          switch (N[0]) {
            case 1:
              (i.push(M),
            ...
            case 2:
              if (
                ...
                G && (W._$.range = [n[n.length - (V || 1)].range[0], n[n.length - 1].range[1]]),
                (K = this.performAction.apply(W, [w, $, I, S.yy, N[1], p, n].concat(C))),
                typeof K < 'u')
              )
                return K;
              (V &&
...
` +
        ...
        next: o(function () {
          ...
          return s
            ? ((t = this.test_match(s, p[c])), t !== !1 ? t : !1)
            : this._input === ''
              ? this.EOF
              : this.parseError(
                  'Lexical error on line ' +
...
` +
        ...
        performAction: o(function (s, i, c, p) {
          switch (c) {
            case 0:
              return 6;
            case 1:
...
var xt = J,
  ...
  at = o((e, h, r) => {
    const a = e.node().getBBox(),
      l = a.width + h * 2,
      y = a.height + h * 2;
    (_t(e, y, l, r), e.attr('viewBox', `${a.x - h} ${a.y - h} ${l} ${y}`));
  }, 'applyPaddedViewBox'),
  It = o((e, h, r, a) => {
    const y = a.db.getRoot();
    if (!y) return;
    const f = ot(),
      { look: d, handDrawnSeed: m, themeVariables: u } = f,
      k = ut(f.fontSize)[0] ?? St,
      g = d === 'handDrawn',
      _ = y.children ?? [],
      x = f.ishikawa?.diagramPadding ?? 20,
      D = f.ishikawa?.useMaxWidth ?? !1,
      O = dt(h),
      E = O.append('g').attr('class', 'ishikawa'),
      T = g ? bt.svg(O.node()) : void 0,
      t = T
        ? {
            roughSvg: T,
            seed: m ?? 0,
    ...
    if (g) z(E, i, c, 0, c, 'ishikawa-spine', t);
    else {
      p.attr('x1', i);
      const S = `url(#${s})`;
  ...
  Lt = o((e, h, r, a, l, y) => {
    const f = Math.max(6, Math.floor(110 / (l * 0.6))),
      ...
      m = X(d, ct(a, f), 0, 0, 'ishikawa-head-label', 'start', l),
      u = m.node().getBBox(),
    ...
    const r = [],
      ...
      l = o((y, f, d) => {
        ...
        for (const u of m) {
          const k = r.length,
            g = u.children ?? [];
          (r.push({ depth: d, text: ct(u.text, 15), parentIndex: f, childCount: g.length }),
            d % 2 === 0
  ...
  Mt = o((e, h, r, a, l, y, f) => {
    const d = e.append('g').attr('class', 'ishikawa-label-group'),
      u = X(d, h, r, a + 11 * l, 'ishikawa-label cause', 'middle', y)
        .node()
        .getBBox();
    if (f) {
      const k = f.roughSvg.rectangle(u.x - 20, u.y - 2, u.width + 40, u.height + 4, {
        roughness: 1.5,
        seed: f.seed,
        fill: f.fillColor,
        fillStyle: 'hachure',
  ...
  Pt = o((e, h, r, a, l, y, f, d) => {
    ...
    const { entries: D, yOrder: O } = Tt(m, l),
      E = D.length,
      T = new Array(E);
    for (const [p, n] of O.entries()) T[n] = a + g * ((p + 1) / (E + 1));
    const t = new Map();
    ...
    for (const [p, n] of D.entries()) {
      ...
      if (n.depth % 2 === 0) {
        ...
        (($ = lt(w.x0, w.x1, C ? (v - w.y0) / C : 0.5)),
          ...
          z(I, $, v, A, v, 'ishikawa-sub-branch', d),
          d && Q(I, $, v, 1, 0, d),
          X(I, n.text, A, v, 'ishikawa-label align', 'end', f));
      } else {
        const C = w.childrenDrawn++;
        (($ = lt(w.x0, w.x1, (w.childCount - C) / (w.childCount + 1))),
          (L = w.y0),
          (A = $ + s * ((v - L) / i)),
          z(I, $, L, A, v, 'ishikawa-sub-branch', d),
          d && Q(I, $, L, $ - A, L - v, d),
          X(I, n.text, A, v, c, 'end', f));
      }
      n.childCount > 0 &&
        t.set(p, { x0: $, y0: L, x1: A, y1: v, childCount: n.childCount, childrenDrawn: 0 });
    }
  }, 'drawBranch'),
  Bt = o((e) => e.split(/<br\s*\/?>|\n/), 'splitLines'),
  ct = o((e, h) => {
