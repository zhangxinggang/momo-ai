...
var e = {
  ...
  o = {
    ...
    couldNotCreateShareableLinkTooBig:
      'Impossibile creare il link condivisibile: la scena è troppo grande',
    ...
    uploadedSecurly:
      "L'upload è stato protetto con la crittografia end-to-end, il che significa che il server Excalidraw e terze parti non possono leggere il contenuto.",
    loadSceneOverridePrompt:
      'Se carichi questo disegno esterno, sostituirà quello che hai. Vuoi continuare?',
...
(Se vuoi mantenere il tuo disegno locale, chiudi semplicemente la scheda del browser.)`,
    ...
    invalidEncryptionKey:
      'La chiave di cifratura deve essere composta da 22 caratteri. La collaborazione live è disabilitata.',
...
Le tue modifiche non verranno salvate!`,
  ...
  r = {
    ...
    brave_measure_text_error: {
      ...
      line2:
        'Ciò potrebbe causare la rottura degli <bold>Elementi di testo</bold> nei tuoi disegni.',
      line3:
    ...
    asyncPasteFailedOnRead:
      'Impossibile incollare (non è possibile leggere dagli appunti di sistema).',
...
oppure tieni premuto Alt e fai clic per aggiungere nuovi punti`,
    ...
    deepBoxSelect:
      'Tieni premuto CtrlOCmd per selezionare in profondità e per impedire il trascinamento',
    eraserRevert:
      "Tieni premuto Alt per ripristinare gli elementi contrassegnati per l'eliminazione",
    firefox_clipboard_write:
      'Questa funzione può essere abilitata impostando il flag "dom.events.asyncClipboard.clipboardItem" su "true". Per modificare i flag del browser in Firefox, visitare la pagina "about:config".',
  ...
  c = {
    ...
    trackedToSentry:
      "L'errore con identificativo {{eventId}} è stato tracciato nel nostro sistema.",
    openIssueMessage:
      "Siamo stati molto cauti nel non includere informazioni della scena nell'errore. Se la tua scena non è privata, ti preghiamo di considerare la sua inclusione nel nostro <button>bug tracker.</button> Per favore includi le informazioni riportate qui sotto copiandole e incollandole nella issue di GitHub.",
    sceneContent: 'Contenuto della scena:',
  },
  d = {
    desc_intro: 'Puoi invitare persone nella tua scena attuale per collaborare con te.',
    desc_privacy:
      'Non preoccuparti, la sessione utilizza la crittografia end-to-end, quindi qualsiasi cosa disegni rimarrà privata. Nemmeno il nostro server sarà in grado di vedere cosa hai creato.',
    ...
    desc_exitSession:
      'Interrompere la sessione scollegherà la tua stanza ma potrai continuare a lavorare con la scena, localmente. Tieni presente che questo non influirà sulle altre persone, e che saranno ancora in grado di collaborare alla loro versione.',
  ...
  m = {
    ...
    excalidrawplus_exportError:
      'Non è stato possibile esportare su Excalidraw+ al questo momento...',
  },
  u = {
  ...
  b = {
    ...
    placeholder: {
      ...
      githubHandle:
        'Handle di GitHub (opzionale), così che tu possa modificare la libreria una volta inviata per la revisione',
      twitterHandle:
        'Nome utente di Twitter (opzionale), così che sappiamo chi accreditare promuovendo su Twitter',
      website: 'Link al tuo sito web personale o altro (opzionale)',
    },
    errors: { required: 'Obbligatorio', website: 'Inserisci un URL valido' },
    noteDescription:
      'Invia la tua libreria da includere nella <link>repository della libreria pubblica</link>perché sia usata da altri nei loro disegni.',
    noteGuidelines:
      "La libreria dev'esser prima approvata manualmente. Sei pregato di leggere le <link>linee guida</link> prima di inviarla. Necessiterai di un profilo di GitHub per comunicare ed effettuare modifiche se richiesto, ma non è strettamente necessario.",
    noteLicense:
      'Inviando, acconsenti che la libreria sarà pubblicata sotto la <link>Licenza MIT, </link>che in breve significa che chiunque possa usarla senza restrizioni.',
    noteItems:
      'Ogni elemento della libreria deve avere il proprio nome, così che sia filtrabile. Gli elementi della seguente libreria saranno inclusi:',
    atleastOneLibItem: 'Sei pregato di selezionare almeno un elemento della libreria per iniziare',
    republishWarning:
      'Nota: alcuni degli elementi selezionati sono contrassegnati come già pubblicati/presentati. È necessario reinviare gli elementi solo quando si aggiorna una libreria o una presentazione esistente.',
  },
  v = {
    title: 'Libreria inviata',
    content:
      'Grazie {{authorName}}. La tua libreria è stata inviata per la revisione. Puoi monitorarne lo stato<link>qui</link>',
  },
  S = {
...
Questo aumenterà la dimensione del file esportato.`,
    ...
    button: { exportToPng: 'PNG', exportToSvg: 'SVG', copyPngToClipboard: 'Copia negli appunti' },
  },
  z = {
    tooltip:
...
o incollare in un editor di testo esistente`,
    unableToEmbed:
      "Incorporare questo url non è permesso. Crea una issue su GitHub per richiedere che l'url sia autorizzato",
  ...
  I = {
    ...
    modal: {
      loadFromFile: {
        ...
        description:
          'Il caricamento da file sostituirà <bold>il contenuto esistente</bold>.<br></br>Puoi salvare il tuo disegno prima usando una delle opzioni qui sotto.',
      },
      shareableLink: {
  ...
  y = { title: '', button: 'Inserisci', description: '', syntax: '', preview: 'Anteprima' },
  N = {
    labels: e,
    library: i,
    buttons: a,
