...
var e = {
    ...
    lineEditor: { edit: 'Ẓreg izirig', exit: 'Ffeɣ seg umaẓrag n yizirig' },
    elementLock: {
      lock: 'Sekkeṛ',
      unlock: 'Serreḥ',
      lockAll: 'Sekkeṛ akk',
...
({{exportColorScheme}})`,
  ...
  T = { mostUsedCustomColors: '', colors: '', shades: '', hexCode: '', noShades: '' },
  A = {
    action: {
  ...
  h = { title: '', button: '', description: '', syntax: '', preview: '' },
  C = {
    labels: e,
    library: a,
    buttons: u,
