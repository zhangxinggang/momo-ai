import { g as Se } from './chunk-FMBD7UC4-B08AeLCH.js';
import { i as Ne, h as ce, j as le } from './markdown-it-vendor-DL4wSELR.js';
...
var $ = (function () {
  var e = o(function (O, i, n, r) {
    ...
    T = {
      ...
      performAction: o(function (i, n, r, a, u, t, M) {
        var c = t.length - 1;
        switch (u) {
          case 6:
          case 7:
      ...
      table: [
        ...
        e(D, [2, 4]),
        e(D, [2, 5]),
        { 1: [2, 6], 6: p, 12: 21, 13: s, 14: 14, 16: d, 17: _, 18: 17, 19: 18, 20: b, 23: l },
        { 6: p, 9: 22, 12: 11, 13: s, 14: 14, 16: d, 17: _, 18: 17, 19: 18, 20: b, 23: l },
        { 6: I, 7: g, 10: 23, 11: w },
        e(k, [2, 24], { 18: 17, 19: 18, 14: 27, 16: [1, 28], 17: [1, 29], 20: b, 23: l }),
        e(k, [2, 19]),
        e(k, [2, 21], { 15: 30, 24: G }),
        e(k, [2, 22]),
        e(k, [2, 23]),
        ...
        { 21: [1, 33] },
        { 6: I, 7: g, 10: 34, 11: w },
        { 1: [2, 7], 6: p, 12: 21, 13: s, 14: 14, 16: d, 17: _, 18: 17, 19: 18, 20: b, 23: l },
        e(V, [2, 14], { 7: f, 11: A }),
        e(L, [2, 8]),
        e(L, [2, 9]),
        e(L, [2, 10]),
        ...
        for (var E, P, x, Q, j = {}, z, C, oe, X; ; ) {
          if (
            ...
            this.defaultActions[P]
              ...
              : ((E === null || typeof E > 'u') && (E = ae()), (x = M[P] && M[P][E])),
          ...
          switch (x[0]) {
            ...
            case 2:
              if (
                ...
                (Q = this.performAction.apply(j, [c, se, W, R.yy, x[1], u, t].concat(ge))),
                typeof Q < 'u')
              )
                return Q;
              (C &&
                ((r = r.slice(0, -1 * C * 2)), (u = u.slice(0, -1 * C)), (t = t.slice(0, -1 * C))),
...
` +
        ...
        next: o(function () {
          ...
          for (var u = this._currentRules(), t = 0; t < u.length; t++)
            if (
              ((r = this._input.match(this.rules[u[t]])), r && (!n || r[0].length > n[0].length))
            ) {
              if (((n = r), (a = t), this.options.backtrack_lexer)) {
                if (((i = this.test_match(r, u[t])), i !== !1)) return i;
                if (this._backtrack) {
                  n = !1;
                  continue;
                } else return !1;
          ...
          return n
            ? ((i = this.test_match(n, u[a])), i !== !1 ? i : !1)
            : this._input === ''
              ? this.EOF
              : this.parseError(
                  'Lexical error on line ' +
...
` +
        ...
        performAction: o(function (n, r, a, u) {
          switch (a) {
            case 0:
...
var xe = $,
  ...
  Oe = o((e, h, p, s, d) => {
    const _ = H();
    let b = _.mindmap?.padding ?? K.mindmap.padding;
    switch (s) {
      case y.ROUNDED_RECT:
      case y.RECT:
      case y.HEXAGON:
...
` + e,
    ...
    b.htmlLabels = !1;
    const l = fe(h);
    for (const f of _.nodes) f.domId = `${h}-${f.id}`;
    const D = l.append('g');
    D.attr('class', 'sections');
    const I = l.append('g');
    I.attr('class', 'items');
    const g = _.nodes.filter((f) => f.isGroup);
    let w = 0;
    const k = 10,
      G = [];
    let N = 25;
    ...
    for (const f of g) {
      ...
      for (const i of Y) {
        ...
        ((i.y = T + r.height / 2), await be(i), (T = i.y + r.height / 2 + k / 2));
      }
      const B = A.cluster.select('rect'),
        O = Math.max(T - U + 3 * k, 50) + (N - 25);
      B.attr('height', O);
    }
    _e(
      void 0,
...
`,
  ...
  Ue = Ge,
  Ke = { db: Ve, renderer: je, parser: xe, styles: Ue };
