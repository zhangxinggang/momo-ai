...
class f0 {
  constructor(e, t, a, n, l, u, h, c) {
    ...
    (v && this.classes.push(v + '_fallback'),
      /[îïíì]/.test(this.text) && (this.text = la[this.text]));
  }
  hasClass(e) {
    return this.classes.includes(e);
  }
...
class P0 {
  ...
  toNode() {
    ...
    return (
      this.alternate ? t.setAttribute('d', this.alternate) : t.setAttribute('d', Qt[this.pathName]),
      t
    );
  }
  toMarkup() {
...
for (var Y0 = 0; Y0 < 10; Y0++) {
  var H0 = Y0.toString();
  ((R = String.fromCharCode(55349, 57294 + Y0)),
    i(s, o, E, H0, R),
    i(w, o, p, H0, R),
    (R = String.fromCharCode(55349, 57314 + Y0)),
    i(s, o, E, H0, R),
    i(w, o, p, H0, R),
    (R = String.fromCharCode(55349, 57324 + Y0)),
    i(s, o, E, H0, R),
    i(w, o, p, H0, R),
    (R = String.fromCharCode(55349, 57334 + Y0)),
    i(s, o, E, H0, R),
    i(w, o, p, H0, R));
}
var gt = 'ÐÞþ';
...
var Ne = function (e) {
  ...
  a0 = function (e, t, a, n) {
    ...
    if (e.length === 1) {
      ...
      g.type === 'sizing'
        ...
        : g.type === 'styling' && (v = t.havingStyle(Sa[g.style]));
    }
    ...
    return (
      yt(
        ...
        (M, T) => {
          ...
          C === 'mbin' && ka.has(q)
            ? (T.classes[0] = 'mord')
            : q === 'mbin' && wa.has(C) && (M.classes[0] = 'mord');
        },
        { node: b },
        y,
        x,
  ...
  Gr = function (e) {
    return e instanceof ae || e instanceof Oe || (e instanceof ne && e.hasClass('enclosing'))
      ? e
      : null;
  },
  xt = function (e, t) {
  ...
  for (var l = [], u = [], h = 0; h < a.length; h++)
    if (
      ...
      a[h].hasClass('newline') &&
        (u.pop(), u.length > 0 && (l.push(Ae(u, e)), (u = [])), l.push(a[h]));
    ...
    function a() {
      ...
      if (Ea.has(c)) {
        ...
        if (g > 5)
          ...
          var M = [1, 1, 2, 2, 3, 3][g];
          c === 'widehat' || c === 'widecheck'
            ? ((h = [0, 1062, 2364, 2364, 2364][M]),
              (b = [0, 239, 300, 360, 420][M]),
              (x = [0, 0.24, 0.3, 0.3, 0.36, 0.42][M]),
              (y = c + M))
            : ((h = [0, 600, 1033, 2339, 2340][M]),
              (b = [0, 260, 286, 306, 312][M]),
              (x = [0, 0.26, 0.286, 0.3, 0.306, 0.34][M]),
              (y = 'tilde' + M));
        }
        var T = new P0(y),
          C = new D0([T], {
  ...
  for (var a = [], n = [a], l = 0; l < e.length; l++) {
    for (var u = e[l], h = ur(), c = 0; c < u.length; c++)
      if (!or(u[c])) h.body.push(u[c]);
        ...
        var M = Ha(v, g, r),
          T = { type: 'styling', body: [M], mode: 'math', style: 'display' };
        (a.push(T), (h = ur()));
      }
...
B({
  ...
  handler(r, e) {
    for (
      var { parser: t } = r, a = H(e[0], 'ordgroup'), n = a.body, l = '', u = 0;
      u < n.length;
      u++
    ) {
      var h = H(n[u], 'textord');
...
B({
  ...
  htmlBuilder(r, e) {
    var t = k(['mspace'], [], e);
    return (
      r.newLine && (t.classes.push('newline'), r.size && (t.style.marginTop = A(K(r.size, e)))),
      t
    );
  },
  mathmlBuilder(r, e) {
...
B({
  ...
  handler(r) {
    ...
    if (St[a.text])
      return (
        (t === '\\global' || t === '\\\\globallong') && (a.text = St[a.text]),
...
var ue = function (e, t, a) {
  ...
  nt = function (e, t, a) {
    var n = k0['Size4-Regular'][e.charCodeAt(0)]
      ...
      l = new P0('inner', ta(e, Math.round(1e3 * t))),
      u = new D0([l], {
        width: A(n),
        height: A(t),
        style: 'width:' + A(n),
...
B({
  ...
  htmlBuilder: (r, e) =>
    r.delim === '.' ? k([r.mclass]) : i1(r.delim, r.size, e, r.mode, [r.mclass]),
  mathmlBuilder: (r) => {
    var e = [];
...
B({
  ...
  htmlBuilder: (r, e) => {
    mr(r);
    for (
      var t = a0(r.body, e, !0, ['mopen', 'mclose']), a = 0, n = 0, l = !1, u = 0;
      u < t.length;
      u++
    )
    ...
    var h;
    if (
      (r.left === '.' ? (h = me(e, ['mopen'])) : (h = ut(r.left, a, n, e, r.mode, ['mopen'])),
      t.unshift(h),
      l)
    )
    ...
    if (a === 'sout')
      ...
      (/box/.test(a)
        ...
        /fbox|boxed|fcolorbox/.test(a)
          ? ((l.style.borderStyle = 'solid'), (l.style.borderWidth = A(q)))
          : a === 'angl' &&
            q !== 0.049 &&
            ((l.style.borderTopWidth = A(q)), (l.style.borderRightWidth = A(q))),
        (u = t.depth + C),
        r.backgroundColor &&
...
var z0 = function (e, t) {
    ...
    var M = e.colSeparationType === 'CD' ? K({ number: 3, unit: 'ex' }, t) : 12 * b,
      T = 3 * b,
      C = e.arraystretch * M,
      q = 0.7 * C,
      I = 0.3 * C,
    ...
    function F(be) {
      for (var ye = 0; ye < be.length; ++ye)
        (ye > 0 && (O += 0.25), v.push({ pos: O, isDashed: be[ye] }));
    }
    for (F(u[0]), a = 0; a < e.body.length; ++a) {
      ...
      var h0 = e.rowGaps[a],
        i0 = 0;
      (h0 && ((i0 = K(h0, t)), i0 > 0 && ((i0 += I), P < i0 && (P = i0), (i0 = 0))),
    ...
    for (n = 0, R0 = 0; n < h || R0 < X0.length; ++n, ++R0) {
      for (var se, x0 = X0[R0], fe = !0; ((Vt = x0) == null ? void 0 : Vt.type) === 'separator'; ) {
        ...
        if (
          (fe ||
            ((y0 = k(['arraycolsep'], [])),
            (y0.style.width = A(t.fontMetrics().doubleRuleSep)),
            m0.push(y0)),
          x0.separator === '|' || x0.separator === ':')
        ) {
          var M1 = x0.separator === '|' ? 'solid' : 'dashed',
            K0 = k(['vertical-separator'], [], t);
          ((K0.style.height = A(O)),
            (K0.style.borderRightWidth = A(g)),
            (K0.style.borderRightStyle = M1),
      ...
      if (!(n >= h)) {
        ...
        if (n > 0 || e.hskipBeforeAndAfter) {
          ...
          ((J0 = (Yt = (Wt = x0) == null ? void 0 : Wt.pregap) != null ? Yt : y),
            J0 !== 0 && ((y0 = k(['arraycolsep'], [])), (y0.style.width = A(J0)), m0.push(y0)));
        }
        var $t = [];
        for (a = 0; a < l; ++a) {
          var ve = c[a],
          ...
          if (pe) {
            ...
            ((pe.depth = ve.depth),
              (pe.height = ve.height),
              $t.push({ type: 'elem', elem: pe, shift: T1 }));
          }
        }
    ...
    if (v.length > 0) {
      for (
        var C1 = te('hline', t, g),
          q1 = te('hdashline', t, g),
          Ke = [{ type: 'elem', elem: ge, shift: 0 }];
        v.length > 0;
      ) {
        var Kt = v.pop(),
          Jt = Kt.pos - t0;
        Kt.isDashed
          ? Ke.push({ type: 'elem', elem: q1, shift: Jt })
          : Ke.push({ type: 'elem', elem: C1, shift: Jt });
      }
  ...
  A0 = function (e, t) {
    ...
    if (e.cols && e.cols.length > 0) {
      var M = e.cols,
        ...
        q = 0,
        I = M.length;
      (M[0].type === 'separator' && ((y += 'top '), (q = 1)),
        M[M.length - 1].type === 'separator' && ((y += 'bottom '), (I -= 1)));
      for (var O = q; O < I; O++) {
        var F = M[O];
        F.type === 'align'
  ...
  h1 = function (e, t) {
    ...
    for (var M = 0; M < c; ++M) {
      var T = 'r',
        C = 0;
      (M % 2 === 1 ? (T = 'l') : M > 0 && x && (C = 1),
        (a[M] = { type: 'align', align: T, pregap: C, postgap: 0 }));
    }
...
S0({
  ...
  handler(r) {
    ...
    var l = V0(r.parser, a, Ft(r.envName)),
...
var Qa = (r, e) => {
    ...
    r.hasBarLine
      ? (r.barSize
          ? ((b = K(r.barSize, e)), (g = te('frac-line', e, b)))
          : (g = te('frac-line', e)),
        (b = g.height),
        (y = g.height))
    ...
    t.size === N.DISPLAY.size
      ...
      : (b > 0 ? ((x = e.fontMetrics().num2), (M = y)) : ((x = e.fontMetrics().num3), (M = 3 * y)),
        (T = e.fontMetrics().denom2));
    var C;
    if (g) {
      var I = e.fontMetrics().axisHeight;
      (x - u.depth - (I + 0.5 * b) < M && (x += M - (x - u.depth - (I + 0.5 * b))),
        I - 0.5 * b - (v.height - T) < M && (T += M - (I - 0.5 * b - (v.height - T))));
      var O = -(I - 0.5 * b);
      C = G({
        positionType: 'individualShift',
        children: [
    ...
    return (
      r.leftDelim == null
        ? (V = me(e, ['mopen']))
        : (V = At(r.leftDelim, F, !0, e.havingStyle(t), r.mode, ['mopen'])),
      r.continued
        ? (L = k([]))
        : r.rightDelim == null
          ? (L = me(e, ['mclose']))
          : (L = At(r.rightDelim, F, !0, e.havingStyle(t), r.mode, ['mclose'])),
...
B({
  ...
  htmlBuilder: (r, e) => {
    ...
    var a = k(['fix'], []),
      ...
      l = k(['strut']);
    return (
      (l.style.height = A(n.height + n.depth)),
      n.depth && (l.style.verticalAlign = A(-n.depth)),
...
var v1 = (r, e, t, a, n, l, u) => {
    ...
    if (v && c) {
      ...
      y = G({
        ...
        children: [
          ...
          { type: 'elem', elem: c.elem, marginLeft: A(-l) },
          { type: 'kern', size: c.kern },
          { type: 'elem', elem: r },
          { type: 'kern', size: v.kern },
          { type: 'elem', elem: v.elem, marginLeft: A(l) },
          { type: 'kern', size: a.fontMetrics().bigOpSpacing5 },
        ],
      });
    } else if (c) {
  ...
  le = (r, e) => {
    var t,
      ...
      l;
    r.type === 'supsub'
      ? ((t = r.sup), (a = r.sub), (l = H(r.base, 'op')), (n = !0))
      : (l = H(r, 'op'));
    var u = e.style,
      h = !1;
...
B({
  ...
  mathmlBuilder(r, e) {
    ...
    (u.setAttribute('mathbackground', l),
      u.setAttribute('width', A(t)),
      u.setAttribute('height', A(a)));
...
B({
  ...
  htmlBuilder(r, e) {
    ...
    if (r.index) {
      var M = e.havingStyle(N.SCRIPTSCRIPT),
        T = U(r.index, M, e),
...
$0({
  ...
  htmlBuilder(r, e) {
    ...
    if (l) {
      ...
      ((c = U(l, M, e)),
        y || (b = u.depth + (M.fontMetrics().subDrop * M.sizeMultiplier) / e.sizeMultiplier));
    }
    var T;
...
$0({
  ...
  mathmlBuilder(r, e) {
    var t = new z('mtable', [
      new z('mtr', [xr(), new z('mtd', [U0(r.body, e)]), xr(), new z('mtd', [U0(r.tag, e)])]),
    ]);
...
B({
  ...
  htmlBuilder(r, e) {
    for (var t = zr(r), a = [], n = e.havingStyle(e.style.text()), l = 0; l < t.length; l++) {
      var u = t[l];
      (u === '~' && (u = '\\textasciitilde'),
        a.push(s0(u, 'Typewriter-Regular', r.mode, n, ['mord', 'texttt'])));
    }
...
m('\\dots', function (r) {
  ...
  return (
    t in Tr
      ? (e = Tr[t])
      : (t.slice(0, 4) === '\\not' || (t in $.math && v4.has($.math[t].group))) && (e = '\\dotsb'),
    e
  );
});
var Pt = {
...
m(
  '\\LaTeX',
  '\\textrm{\\html@mathml{' +
    ('L\\kern-.36em\\raisebox{' + w1 + '}{\\scriptstyle A}') +
    '\\kern-.15em\\TeX}{LaTeX}}',
);
m(
  '\\KaTeX',
  '\\textrm{\\html@mathml{' +
    ('K\\kern-.17em\\raisebox{' + w1 + '}{\\scriptstyle A}') +
    '\\kern-.15em\\TeX}{KaTeX}}',
);
          ...
          if (l === '-' && u.text === '-') {
            ...
            a + 1 < t && h && h.type === 'textord' && h.text === '-'
              ? (e.splice(a, 3, {
                ...
                (t -= 2))
              : (e.splice(a, 2, { type: 'textord', mode: 'text', loc: c0.range(n, u), text: '--' }),
                (t -= 1));
          }
          (l === "'" || l === '`') &&
            u.text === l &&
            (e.splice(a, 2, { type: 'textord', mode: 'text', loc: c0.range(n, u), text: l + l }),
            (t -= 1));
        }
      }
    }
...
var g4 = function (e, t) {
  ...
  x4 = '0.16.45',
  w4 = { Span: ne, Anchor: Oe, SymbolNode: f0, SvgNode: D0, PathNode: P0, LineNode: pt },
  k4 = {
    version: x4,
    render: z1,
    renderToString: g4,
