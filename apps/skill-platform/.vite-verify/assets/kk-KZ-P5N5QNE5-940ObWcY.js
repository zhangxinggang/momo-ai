...
var u = {
  ...
  e = { noItems: '', hint_emptyLibrary: '', hint_emptyPrivateLibrary: '' },
  a = {
    clearReset: '',
    exportJSON: '',
    exportImage: '',
  ...
  i = { canvasActions: '', selectedShapeActions: '', shapes: '' },
  l = {
    canvasPanning: '',
    linearElement: '',
    freeDraw: '',
  ...
  n = { cannotShowPreview: '', canvasTooBig: '', canvasTooBigTip: '' },
  s = {
    headingMain: '',
    clearCanvasMessage: '',
    clearCanvasCaveat: '',
  ...
  b = { title: '', content: '' },
  A = { resetLibrary: '', removeItemsFromLib: '' },
  E = {
    header: '',
    label: {
      withBackground: '',
