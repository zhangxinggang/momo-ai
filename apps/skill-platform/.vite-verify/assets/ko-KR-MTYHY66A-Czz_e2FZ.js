...
var u = {
    ...
    lineEditor: { edit: '선 수정하기', exit: '선 편집기 종료' },
    elementLock: {
      lock: '잠금',
      unlock: '잠금 해제',
      lockAll: '모두 잠금',
...
변경 사항들이 저장되지 않습니다!`,
  ...
  E = { canvasActions: '캔버스 동작', selectedShapeActions: '선택된 모양 동작', shapes: '모양' },
  r = {
    canvasPanning:
...
Alt를 누르고 클릭해서 새로운 꼭짓점 추가하기`,
  ...
  d = {
    ...
    errors: { required: '필수사항', website: '유효한 URL을 입력하세요' },
    noteDescription:
  ...
  c = { resetLibrary: '라이브러리 리셋', removeItemsFromLib: '선택한 항목을 라이브러리에서 제거' },
  m = {
    header: '이미지 내보내기',
    label: {
      withBackground: '배경',
    ...
    button: { exportToPng: 'PNG', exportToSvg: 'SVG', copyPngToClipboard: '클립보드로 복사' },
  },
  b = {
