import { G as y } from './graph-ccH1oO3f.js';
import {
  W as $,
  a3 as _,
  a4 as C,
  ...
  V as x,
  a0 as xe,
} from './markdown-vendor-DldLOD9R.js';
class Pe {
  constructor() {
    var n = {};
...
function Ce(e, n) {
  ...
  var r = je(e, n || _e),
    t = Te(r.graph, r.buckets, r.zeroIdx);
  return P(
    w(t, function (a) {
...
function Te(e, n, r) {
  for (var t = [], a = n[n.length - 1], o = n[0], i; e.nodeCount(); ) {
    for (; (i = o.dequeue()); ) V(e, n, r, i);
    for (; (i = a.dequeue()); ) V(e, n, r, i);
    if (e.nodeCount()) {
      for (var d = n.length - 2; d > 0; --d)
        if (((i = n[d].dequeue()), i)) {
          t = t.concat(V(e, n, r, i, !0));
          break;
        }
    }
  }
...
function je(e, n) {
  ...
  (f(e.nodes(), function (d) {
    ...
    f(e.edges(), function (d) {
      var u = r.edge(d.v, d.w) || 0,
        s = n(d),
        c = u + s;
      (r.setEdge(d.v, d.w, c),
        (a = Math.max(a, (r.node(d.v).out += s))),
        (t = Math.max(t, (r.node(d.w).in += s))));
    }));
  ...
  function n(r) {
    ...
    if ((t.length && f(t, n), Object.prototype.hasOwnProperty.call(a, 'minRank'))) {
      ...
      for (var o = a.minRank, i = a.maxRank + 1; o < i; ++o)
        (Q(e, 'borderLeft', '_bl', r, a, o), Q(e, 'borderRight', '_br', r, a, o));
    }
  }
  f(e.children(), n);
}
function Q(e, n, r, t, a, o) {
...
function qe(e) {
  (f(e.nodes(), function (n) {
    ...
    f(e.edges(), function (n) {
      var r = e.edge(n);
      (f(r.points, F), Object.prototype.hasOwnProperty.call(r, 'y') && F(r));
    }));
}
function F(e) {
  e.y = -e.y;
...
function Ue(e, n) {
  ...
  if (o !== t + 1) {
    ...
    for (l = 0, ++t; t < o; ++l, ++t)
      ((d.points = []),
        (s = { width: 0, height: 0, edgeLabel: d, edgeObj: n, rank: t }),
        (c = O(e, 'edge', s, '_d')),
        t === u &&
          ((s.width = d.width),
          (s.height = d.height),
          (s.dummy = 'edge-label'),
          (s.labelpos = d.labelpos)),
        e.setEdge(r, c, { weight: d.weight }, i),
...
function fe(e) {
  var n = new y({ directed: !1 }),
    r = e.nodes()[0],
    t = e.nodeCount();
  n.setNode(r, {});
  for (var a, o; Je(n, e) < t; )
    ((a = Ze(n, e)), (o = n.hasNode(a.v) ? I(e, a) : -I(e, a)), Ke(n, e, o));
  return n;
}
function Je(e, n) {
  function r(t) {
...
function Ze(e, n) {
  return W(n.edges(), function (r) {
    if (e.hasNode(r.v) !== e.hasNode(r.w)) return I(n, r);
  });
}
function Ke(e, n, r) {
...
function k(e) {
  ...
  var n = fe(e);
  (U(n), X(n, e));
  for (var r, t; (r = pe(n)); ) ((t = we(n, e, r)), be(n, e, r, t));
}
function X(e, n) {
  var r = en(e, e.nodes());
  ...
  ((t = t.slice(1)),
    f(t, function (a) {
      var o = e.node(a).parent,
        ...
        d = !1;
      (i || ((i = n.edge(o, a)), (d = !0)),
        (n.node(a).rank = n.node(o).rank + (d ? i.minlen : -i.minlen)));
    }));
}
function an(e, n, r) {
  ...
  (e.setParent(u, i),
    ...
    f(d, function (l) {
      ...
      var h = e.node(l),
        ...
        b = h.borderTop ? t : 2 * t,
        N = v !== p ? 1 : a - o[i] + 1;
      (e.setEdge(u, v, { weight: b, minlen: N, nestingEdge: !0 }),
...
function vn(e, n, r) {
  var t = pn(e),
    a = new y({ compound: !0 }).setGraph({ root: t }).setDefaultNodeLabel(function (o) {
      return e.node(o);
    });
  return (
    f(e.nodes(), function (o) {
...
function pn(e) {
  for (var n; e.hasNode((n = $('_root'))); );
  return n;
}
function wn(e, n) {
  for (var r = 0, t = 1; t < n.length; ++t) r += bn(e, n[t - 1], n[t]);
  return r;
}
function bn(e, n, r) {
  for (
  ...
  return (
    f(
      a.forEach(function (s) {
        var c = s.pos + o;
        d[c] += s.weight;
        for (var l = 0; c > 0; ) (c % 2 && (l += d[c + 1]), (c = (c - 1) >> 1), (d[c] += s.weight));
        u += s.weight * l;
      }),
    ),
    u
    ...
    if (t.length) {
      var a = j(
        ...
        function (o, i) {
          var d = e.edge(i),
            u = e.node(i.v);
          return { sum: o.sum + d.weight * u.order, weight: o.weight + d.weight };
        },
        { sum: 0, weight: 0 },
      );
...
function kn(e) {
  ...
  function r(o) {
    return function (i) {
      i.merged ||
        ((m(i.barycenter) || m(o.barycenter) || i.barycenter >= o.barycenter) && xn(o, i));
    };
  }
  function t(o) {
    return function (i) {
...
function ye(e, n, r, t) {
  ...
  f(s, function (p) {
    if (e.children(p.v).length) {
      var b = ye(e, p.v, r, t);
      ((u[p.v] = b), Object.prototype.hasOwnProperty.call(b, 'barycenter') && Ln(p, b));
    }
  });
  var c = gn(s, r);
  Nn(c, u);
  var l = En(c, t);
  if (i && ((l.vs = P([i, l.vs, d])), e.predecessors(i).length)) {
    var h = e.node(e.predecessors(i)[0]),
      v = e.node(e.predecessors(d)[0]);
...
function In(e) {
  var n = ue(e),
    r = ae(e, x(1, n + 1), 'inEdges'),
    t = ae(e, x(n - 1, -1, -1), 'outEdges'),
    a = mn(e);
  ie(e, a);
...
function Rn(e) {
  ...
  f(e.graph().dummyChains, function (r) {
    for (
      ...
      if (((t = e.node(r)), c)) {
        for (; (s = i[u]) !== d && e.node(s).maxRank < t.rank; ) u++;
        s === d && (c = !1);
      }
      if (!c) {
        for (; u < i.length - 1 && e.node((s = i[u + 1])).minRank <= t.rank; ) u++;
        s = i[u];
      }
...
function _n(e, n, r, t) {
  var a = [],
    ...
    s;
  u = r;
  do ((u = e.parent(u)), a.push(u));
  while (u && (n[u].low > i || d > n[u].lim));
  for (s = u, u = t; (u = e.parent(u)) !== s; ) o.push(u);
...
function Tn(e, n) {
  ...
  function t(a, o) {
    ...
    return (
      f(o, function (c, l) {
        var h = Sn(e, c),
          v = h ? e.node(h).order : u;
        (h || c === s) &&
          (f(o.slice(d, l + 1), function (p) {
            f(e.predecessors(p), function (b) {
              var N = e.node(b),
                H = N.order;
              (H < i || v < H) && !(N.dummy && e.node(p).dummy) && ge(r, b, p);
            });
          }),
          (d = l + 1),
          (i = v));
...
function Fn(e, n, r, t, a) {
  var o = {},
    i = Bn(e, n, r, a),
    d = a ? 'borderLeft' : 'borderRight';
  function u(l, h) {
    for (var v = i.nodes(), p = v.pop(), b = {}; p; )
  ...
  function c(l) {
    var h = i.outEdges(l).reduce(function (p, b) {
        return Math.min(p, o[b.w] - i.edge(b));
      }, Number.POSITIVE_INFINITY),
      v = e.node(l);
    h !== Number.POSITIVE_INFINITY && v.borderType !== d && (o[l] = Math.max(o[l], h));
  }
  return (
    u(s, i.predecessors.bind(i)),
    u(c, i.successors.bind(i)),
    f(t, function (l) {
      o[l] = o[r[l]];
    }),
    o
...
function Gn(e) {
  ...
  f(['u', 'd'], function (i) {
    ((a = i === 'u' ? n : E(n).reverse()),
      f(['l', 'r'], function (d) {
        ...
        var u = (i === 'u' ? e.predecessors : e.successors).bind(e),
          s = Vn(e, a, r, u),
          c = Fn(e, a, s.root, s.align, d === 'r');
        (d === 'r' &&
          (c = S(c, function (l) {
            return -l;
          })),
  ...
  var o = Yn(e, t);
  return (An(t, o), Dn(t, e.graph().align));
}
function $n(e, n, r) {
...
function Xn(e, n) {
  (n('    makeSpaceForEdgeLabels', () => ar(e)),
    n('    removeSelfEdges', () => hr(e)),
    n('    acyclic', () => Se(e)),
    n('    nestingGraph.run', () => sn(e)),
    n('    rank', () => on(de(e))),
    n('    injectEdgeLabelProxies', () => ir(e)),
    n('    removeEmptyRanks', () => Ye(e)),
    n('    nestingGraph.cleanup', () => ln(e)),
    n('    normalizeRanks', () => Be(e)),
    n('    assignRankMinMax', () => or(e)),
    n('    removeEdgeLabelProxies', () => dr(e)),
    n('    normalize.run', () => Xe(e)),
    n('    parentDummyChains', () => Rn(e)),
    n('    addBorderSegments', () => Ge(e)),
    n('    order', () => In(e)),
    n('    insertSelfEdges', () => vr(e)),
    n('    adjustCoordinateSystem', () => $e(e)),
    n('    position', () => qn(e)),
    n('    positionSelfEdges', () => pr(e)),
    n('    removeBorderNodes', () => lr(e)),
    n('    normalize.undo', () => He(e)),
    n('    fixupEdgeLabelCoords', () => fr(e)),
    n('    undoCoordinateSystem', () => We(e)),
    n('    translateGraph', () => ur(e)),
    n('    assignNodeIntersects', () => sr(e)),
    n('    reversePoints', () => cr(e)),
    n('    acyclic.undo', () => Ve(e)));
}
function Un(e, n) {
  (f(e.nodes(), function (r) {
...
var Hn = ['nodesep', 'edgesep', 'ranksep', 'marginx', 'marginy'],
  Jn = { ranksep: 50, edgesep: 20, nodesep: 50, rankdir: 'tb' },
  Zn = ['acyclicer', 'ranker', 'rankdir', 'align'],
  Kn = ['width', 'height'],
  Qn = { width: 0, height: 0 },
  er = ['minlen', 'weight', 'width', 'height', 'labeloffset'],
  nr = { minlen: 1, weight: 1, width: 0, height: 0, labeloffset: 10, labelpos: 'r' },
  rr = ['labelpos'];
function tr(e) {
  var n = new y({ multigraph: !0, compound: !0 }),
    r = A(e.graph());
  return (
    n.setGraph(D({}, Jn, Y(r, Hn), C(r, Zn))),
    f(e.nodes(), function (t) {
      var a = A(e.node(t));
      (n.setNode(t, Ie(Y(a, Kn), Qn)), n.setParent(t, e.parent(t)));
    }),
    f(e.edges(), function (t) {
      var a = A(e.edge(t));
      n.setEdge(t, D({}, nr, Y(a, er), C(a, rr)));
    }),
    n
  );
}
...
function sr(e) {
  f(e.edges(), function (n) {
    var r = e.edge(n),
      ...
      i;
    (r.points
      ? ((o = r.points[0]), (i = r.points[r.points.length - 1]))
      : ((r.points = []), (o = a), (i = t)),
      r.points.unshift(Z(t, o)),
      r.points.push(Z(a, i)));
  });
}
function fr(e) {
  ...
  (f(e.nodes(), function (n) {
    if (e.children(n).length) {
      var r = e.node(n),
        ...
        o = e.node(T(r.borderLeft)),
        i = e.node(T(r.borderRight));
