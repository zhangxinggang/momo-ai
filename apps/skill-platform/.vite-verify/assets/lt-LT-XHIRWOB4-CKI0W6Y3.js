...
var i = {
    ...
    elementLock: { lock: 'Užrakinti', unlock: 'Atrakinti', lockAll: '', unlockAll: '' },
    statusPublished: '',
    sidebarLock: '',
...
(Jei nori išlaikyti lokalų piešinį, tiesiog uždaryk naršyklės skirtuką.)`,
  ...
  l = { cannotShowPreview: '', canvasTooBig: '', canvasTooBigTip: '' },
  n = {
    headingMain: '',
    clearCanvasMessage: '',
    clearCanvasCaveat: '',
  ...
  b = {
    ...
    errors: { required: 'Privalomas', website: 'Įveskite teisingą nuorodą (URL)' },
    noteDescription:
  ...
  P = { mostUsedCustomColors: '', colors: '', shades: '', hexCode: '', noShades: '' },
  w = {
    action: {
  ...
  x = { title: '', button: '', description: '', syntax: '', preview: '' },
  C = {
    labels: i,
    library: a,
    buttons: e,
