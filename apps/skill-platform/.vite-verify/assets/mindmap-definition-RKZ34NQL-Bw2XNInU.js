import { s as he } from './chunk-2J33WTMH-CGvQ9bSc.js';
import { g as le } from './chunk-55IACEB6-BTq3bZL5.js';
import { i as fe, h as me, j as ye } from './markdown-it-vendor-DL4wSELR.js';
...
function xe(t, e, a) {
  return ie.randomUUID && !t ? ie.randomUUID() : Se(t);
}
var J = (function () {
  var t = h(function (L, s, i, o) {
    ...
    R = [1, 25],
    g = [6, 7, 11],
    A = [1, 6, 13, 15, 16, 19, 22],
    K = [1, 33],
    Q = [1, 34],
    $ = [1, 6, 7, 11, 13, 15, 16, 19, 22],
    H = {
      ...
      performAction: h(function (s, i, o, c, p, r, U) {
        var u = r.length - 1;
        switch (p) {
          case 6:
          case 7:
          ...
          case 25:
            (c.getLogger().trace('node found ..', r[u - 2]),
              (this.$ = { id: r[u - 1], descr: r[u - 1], type: c.getType(r[u - 2], r[u]) }));
            break;
          case 26:
          ...
          case 27:
            (c.getLogger().trace('node found ..', r[u - 3]),
              (this.$ = { id: r[u - 3], descr: r[u - 1], type: c.getType(r[u - 2], r[u]) }));
            break;
        }
      }, 'anonymous'),
      table: [
        ...
        t(E, [2, 4]),
        t(E, [2, 5]),
        { 1: [2, 6], 6: a, 12: 21, 13: l, 14: 14, 15: n, 16: d, 17: 17, 18: 18, 19: f, 22: y },
        { 6: a, 9: 22, 12: 11, 13: l, 14: 14, 15: n, 16: d, 17: 17, 18: 18, 19: f, 22: y },
        { 6: b, 7: v, 10: 23, 11: R },
        t(g, [2, 22], { 17: 17, 18: 18, 14: 27, 15: [1, 28], 16: [1, 29], 19: f, 22: y }),
        t(g, [2, 18]),
        t(g, [2, 19]),
        t(g, [2, 20]),
        t(g, [2, 21]),
        ...
        { 20: [1, 31] },
        { 6: b, 7: v, 10: 32, 11: R },
        { 1: [2, 7], 6: a, 12: 21, 13: l, 14: 14, 15: n, 16: d, 17: 17, 18: 18, 19: f, 22: y },
        t(A, [2, 14], { 7: K, 11: Q }),
        t($, [2, 8]),
        t($, [2, 9]),
        t($, [2, 10]),
      ...
      parse: h(function (s) {
        ...
        function te() {
          ...
          return (
            (S = c.pop() || m.lex() || ee),
            typeof S != 'number' &&
              (S instanceof Array && ((c = S), (S = c.pop())), (S = i.symbols_[S] || S)),
            S
          );
        }
        h(te, 'lex');
        for (var k, O, x, X, I = {}, V, D, ne, F; ; ) {
          if (
            ((O = o[o.length - 1]),
            this.defaultActions[O]
              ? (x = this.defaultActions[O])
              : ((k === null || typeof k > 'u') && (k = te()), (x = U[O] && U[O][k])),
            typeof x > 'u' || !x.length || !x[0])
          ) {
            var Y = '';
            F = [];
            for (V in U[O]) this.terminals_[V] && V > re && F.push("'" + this.terminals_[V] + "'");
            (m.showPosition
              ? (Y =
                  'Parse error on line ' +
                  (M + 1) +
...
Expecting ` +
              ...
              : (Y =
                  ...
                  (M + 1) +
                  ': Unexpected ' +
                  (k == ee ? 'end of input' : "'" + (this.terminals_[k] || k) + "'")),
              this.parseError(Y, {
                text: m.match,
          ...
          if (x[0] instanceof Array && x.length > 1)
            throw new Error(
              'Parse Error: multiple actions possible at state: ' + O + ', token: ' + k,
            );
          switch (x[0]) {
            case 1:
              (o.push(k),
            ...
            case 2:
              if (
                ...
                ae && (I._$.range = [r[r.length - (D || 1)].range[0], r[r.length - 1].range[1]]),
                (X = this.performAction.apply(I, [u, Z, M, T.yy, x[1], p, r].concat(oe))),
                typeof X < 'u')
              )
                return X;
              (D &&
                ((o = o.slice(0, -1 * D * 2)), (p = p.slice(0, -1 * D)), (r = r.slice(0, -1 * D))),
                o.push(this.productions_[x[1]][0]),
                p.push(I.$),
                r.push(I._$),
                (ne = U[o[o.length - 2]][o[o.length - 1]]),
                o.push(ne));
              break;
            case 3:
              return !0;
...
` +
        ...
        next: h(function () {
          ...
          for (var p = this._currentRules(), r = 0; r < p.length; r++)
            if (
              ((o = this._input.match(this.rules[p[r]])), o && (!i || o[0].length > i[0].length))
            ) {
...
` +
        ...
        performAction: h(function (i, o, c, p) {
          switch (c) {
            case 0:
    ...
    ((w = class {
      ...
      addNode(e, a, l, n) {
        ...
        const E = {
          ...
          b = this.getParent(e);
        if (b) (b.children.push(E), this.nodes.push(E));
      ...
      getData() {
        ...
        (this.flattenNodes(e, f),
          ...
          C.debug(`getData: processed ${f.length} nodes and ${y.length} edges`));
        const E = new Map();
        for (const b of f)
          E.set(b.id, { shape: b.shape, width: b.width, height: b.height, padding: b.padding });
        return {
          nodes: f,
          edges: y,
          config: d,
...
` + t,
    ...
    (d.nodes.forEach((g) => {
      g.shape === 'rounded'
        ? ((g.radius = 15), (g.taper = 15), (g.stroke = 'none'), (g.width = 0), (g.padding = 15))
        : g.shape === 'circle'
          ? (g.padding = 10)
          : g.shape === 'rect'
    ...
    const { themeVariables: E } = ue(),
      { useGradient: b, gradientStart: v, gradientStop: R } = E;
    if (b && v && R) {
      const g = f.attr('id'),
        A = f
          .append('defs')
          ...
          .attr('x2', '100%')
          .attr('y2', '0%');
      (A.append('stop').attr('offset', '0%').attr('stop-color', v).attr('stop-opacity', 1),
        A.append('stop').attr('offset', '100%').attr('stop-color', R).attr('stop-opacity', 1));
    }
    he(
      f,
