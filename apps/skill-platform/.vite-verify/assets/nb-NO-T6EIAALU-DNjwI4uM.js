...
var e = {
    ...
    elementLock: { lock: 'Lås', unlock: 'Lås opp', lockAll: 'Lås alle', unlockAll: 'Lås opp alle' },
  ...
  t = {
    ...
    hint_emptyLibrary:
      'Velg et objekt på lerretet for å legge det til her, eller installer et bibliotek fra den offentlige samlingen under.',
  ...
  i = {
    ...
    loadSceneOverridePrompt:
      'Å laste inn ekstern tegning vil erstatte det eksisterende innholdet. Ønsker du å fortsette?',
...
(Hvis du ønsker å beholde din lokale tegning, bare lukk nettleserfanen i stedet.)`,
    ...
    invalidSceneUrl:
      'Kunne ikke importere scene fra den oppgitte URL-en. Den er enten ødelagt, eller inneholder ikke gyldig Excalidraw JSON-data.',
...
Endringer dine vil ikke bli lagret!`,
  ...
  n = {
    ...
    cannotResolveCollabServer:
      'Kunne ikke koble til samarbeidsserveren. Vennligst oppdater siden og prøv på nytt.',
    importLibraryError: 'Kunne ikke laste bibliotek',
    collabSaveFailed:
      'Kan ikke lagre i backend-databasen. Hvis problemer vedvarer, bør du lagre filen lokalt for å sikre at du ikke mister arbeidet.',
    collabSaveFailed_sizeExceeded:
      'Kunne ikke lagre til backend-databasen, lerretet ser ut til å være for stort. Du bør lagre filen lokalt for å sikre at du ikke mister arbeidet ditt.',
    ...
    brave_measure_text_error: {
      ...
      line3:
        'Vi anbefaler på det sterkeste å deaktivere denne innstillingen. Du kan følge <link>disse trinnene</link> om hvordan du gjør det.',
      line4:
        'Hvis deaktivering av denne innstillingen ikke fikser visningen av tekstelementer, vennligst åpne en <issueLink>sak</issueLink> på vår GitHub, eller skriv oss på <discordLink>Discord</discordLink>',
    },
  ...
  o = {
    canvasPanning:
      'For å flytte lerretet, hold musehjulet eller mellomromstasten mens du drar, eller bruk hånd-verktøyet',
...
hold ALT for å endre størrelse fra midten`,
    ...
    lineEditor_info:
      'Hold Ctrl/Cmd og dobbelklikk eller trykk Ctrl/Cmd + Enter for å endre punkter',
    lineEditor_pointSelected:
      'Trykk på Slett for å fjerne punktet, Ctrl / Cmd+D for å duplisere, eller dra for å flytte',
...
eller hold Alt og klikk for å legge til nye punkter`,
    ...
    firefox_clipboard_write:
      'Denne funksjonen kan sannsynligvis aktiveres ved å sette "dom.events.asyncClipboard.clipboardItem" flagget til "true". For å endre nettleserens flagg i Firefox, besøk "about:config"-siden.',
    disableSnapping: '',
  },
  s = {
  ...
  d = {
    ...
    openIssueMessage:
      'Vi er veldig nøye med å ikke inkludere dine scene-opplysninger i feilen. Hvis din scene ikke er privat, vurder å følge opp i vårt <button>feilrapporteringssystem.</button> Ta med opplysningene nedenfor ved å kopiere og lime inn i GitHub-saken.',
    sceneContent: 'Scene-innhold:',
  },
  k = {
    desc_intro: 'Du kan invitere personer til scenen din for å samarbeide med deg.',
    desc_privacy:
      'Ta det med ro, sesjonen bruker ende-til-ende-kryptering, så alt du tegner forblir privat. Ikke en gang serveren vår kan se hva du lager.',
    ...
    desc_exitSession:
      'Dersom du avslutter sesjonen blir du frakoblet rommet, men du kan fortsette å arbeide med scenen lokalt. Vær oppmerksom på at dette ikke vil påvirke andre personer, og de vil fortsatt ha mulighet til å samarbeide på deres versjon.',
  ...
  u = {
    ...
    placeholder: {
      ...
      githubHandle:
        'Github-brukernavn (valgfritt), slik at du kan redigere biblioteket når du har sendt inn for gjennomgang',
      twitterHandle:
        'Twitter-brukernavn (valgfritt), slik at vi vet hvem vi skal kreditere når promotert på Twitter',
      website: 'Lenke til din personlige nettside eller et annet sted (valgfritt)',
    },
    errors: { required: 'Påkrevd', website: 'Angi en gyldig nettadresse' },
    noteDescription:
      'Send inn biblioteket ditt som skal inkluderes i <link>kildekode for offentlig bibliotek</link>for andre å bruke dem i tegninger.',
    noteGuidelines:
      'Biblioteket må godkjennes manuelt først. Les <link>retningslinjene</link> før innsending. Du vil trenge en GitHub-konto for å kommunisere og gjøre endringer hvis ønsket, men det er ikke påkrevd.',
    noteLicense:
      'Ved å sende inn godtar du at biblioteket blir publisert under <link>MIT-lisens, </link>som kortfattet betyr at andre kan bruke dem uten begrensninger.',
    noteItems:
      'Hvert bibliotek må ha sitt eget navn, så det er filtrerbart. Følgende bibliotekselementer vil bli inkludert:',
    atleastOneLibItem: 'Vennligst velg minst ett bibliotek for å komme i gang',
    republishWarning:
      'Merk: noen av de valgte elementene er merket som allerede publisert/sendt. Du bør kun sende inn elementer på nytt når du oppdaterer et eksisterende bibliotek eller innlevering.',
  },
  x = {
...
eller lim inn i en eksisterende tekstbehandler`,
    unableToEmbed:
      'Innbygging av denne nettadressen er ikke tillatt. Oppret en sak på GitHub for å be om url-hvitelisting',
    unrecognizedLinkFormat:
      'Linken du bygget inn samsvarer ikke med det forventede formatet. Prøv å lime inn "bygg inn"-strengen fra kildesiden',
  },
  h = {
  ...
  L = {
    ...
    modal: {
      loadFromFile: {
        ...
        description:
          'Å laste fra en fil vil <bold>erstatte ditt eksisterende innhold</bold>.<br></br>Du kan sikkerhetskopiere tegningen din først ved å bruke en av valgene under.',
      },
      shareableLink: {
        title: 'Last inn fra lenke',
        button: 'Erstatt innholdet mitt',
        description:
          'Lasting av ekstern tegning vil <bold>erstatte ditt eksisterende innhold</bold>.<br></br>Du kan sikkerhetskopiere tegningen din først ved å bruke en av valgene nedenfor.',
      },
    },
  },
  T = { title: '', button: '', description: '', syntax: '', preview: '' },
  B = {
    labels: e,
    library: t,
    buttons: r,
