...
(Als je de lokale tekening wilt behouden, sluit je in plaats daarvan het browsertabblad)`,
    ...
    imageDoesNotContainScene:
      'Deze afbeelding lijkt geen scène gegevens te bevatten. Heb je scène embedding tijdens het exporteren ingeschakeld?',
    cannotRestoreFromImage: 'Scène kan niet worden hersteld vanuit dit afbeeldingsbestand',
    invalidSceneUrl:
      'Kan scène niet importeren vanuit de opgegeven URL. Het is onjuist of bevat geen geldige Excalidraw JSON-gegevens.',
...
gebruik ALT om vanuit het midden te vergroten/verkleinen`,
  ...
  d = {
    ...
    openIssueMessage:
      'We waren voorzichtig om je scène-informatie niet in de fout toe te voegen. Als je scène niet privé is, overweeg dan alstublieft het opvolgen op onze <button>bugtracker.</button> Kopieer de informatie hieronder naar de GitHub issue.',
    sceneContent: 'Scène-inhoud:',
  },
  g = {
    desc_intro: 'Je kunt mensen uitnodigen om met je samen te werken.',
    desc_privacy:
      'Geen zorgen, de sessie gebruikt end-to-end encryptie, dus wat je tekent blijft privé. Zelfs onze server zal niet kunnen zien wat je tekent.',
...
Pas op: dit heeft geen invloed op andere mensen en dat zij nog steeds in staat zullen zijn om samen te werken aan hun versie.`,
  ...
  u = { title: 'Bibliotheek ingediend', content: '<link>Hier</link>' },
  h = {
...
of plak in een bestaande teksteditor`,
  ...
  E = { mostUsedCustomColors: '', colors: '', shades: '', hexCode: '', noShades: '' },
  T = {
    action: {
