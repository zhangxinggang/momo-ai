...
var e = {
  ...
  i = {
    ...
    uploadedSecurly:
      'Opplastinga er kryptert og er ikkje mogleg å lese av Excalidraw-serveren eller tredjepartar.',
    loadSceneOverridePrompt:
      'Innlasting av ekstern teikning erstattar ditt eksisterande innhald. Ynskjer du å fortsette?',
...
(Ønsker du å halde fram med denne? Då er det berre å lukke denne fana.)`,
    ...
    imageDoesNotContainScene:
      'Dette biletet ser ikkje ut til å ha noko scenedata. Har du skrutt på innbygging av scene medan eksporteringa heldt på?',
    cannotRestoreFromImage: 'Scena kunne ikkje gjenopprettast frå denne biletfila',
    invalidSceneUrl:
      'Kunne ikkje hente noko scene frå den URL-en. Ho er anten øydelagd eller inneheld ikkje gyldig Excalidraw JSON-data.',
  ...
  a = {
    ...
    cannotResolveCollabServer:
      'Kunne ikkje kople til samarbeidsserveren. Ver vennleg å oppdatere inn sida og prøv på nytt.',
    importLibraryError: '',
    collabSaveFailed: '',
...
eller hald inne Alt og klikk for å legge til nye punkt`,
  ...
  s = {
    ...
    canvasTooBigTip:
      'Tips: prøv å flytte elementa som er lengst frå kvarandre, litt nærare kvarandre.',
  },
  d = {
    ...
    openIssueMessage:
      'Vi er veldig nøye med å ikkje inkludere scene-opplysingane dine i feilmeldinga. Viss scena di ikkje er privat kan du vurdere å følge opp i <button>feilrapporteringssystemet vårt.</button> Ta med opplysingane nedanfor ved å kopiere og lime inn i GitHub-saka.',
    sceneContent: 'Scene-innhald:',
  },
  k = {
    desc_intro: 'Du kan invitere personar til scena di for å samarbeide med deg.',
    desc_privacy:
      'Ta det med ro; økta brukar ende-til-ende-kryptering, så alt du teiknar held fram med å vere privat. Ikkje ein gong serveren vår kan sjå kva du lagar.',
    ...
    desc_exitSession:
      'Dersom du avsluttar økta blir du kopla frå rommet, men du kan halde fram med å arbeide med scena lokalt. Ver merksam på at dette ikkje vil påverke andre personar, og desse vil framleis ha moglegheit til å samarbeide på deira eigen versjon.',
  ...
  u = {
    ...
    placeholder: {
      ...
      githubHandle:
        'GitHub-brukarnamn (valfritt), slik at du kan redigere bibiloteket når det er sendt inn til vurdering',
    ...
    noteGuidelines:
      'Biblioteket må godkjennast manuelt fyrst. Ver vennleg å lese <link>retningslinjene</link> før du sender inn. Du kjem til å trenge ein GitHub-konto for å kommunisere og gjere endringar dersom kravt, men det er ikkje strengt naudsynt.',
    noteLicense:
      'Ved å sende inn godkjenner du at biblioteket vert publisert under <link>MIT-lisensen, </link>som kort sagt betyr at kven som helst kan bruke det utan avgrensingar.',
    noteItems:
      'Kvart bibliotekselement må ha eit eige namn, slik at det er mogleg å filtrere. Dei følgande bibliotekselementa blir inkludert:',
  ...
  c = {
    ...
    content:
      'Tusen takk {{authorName}}! Biblioteket ditt har blitt sendt inn til gjennomgang. Du kan halde styr på status<link>her</link>',
  },
  x = {
  ...
  E = {
    tooltip:
      'Teikningane dine er ende-til-ende-krypterte slik at Excalidraw sine serverar aldri får sjå dei.',
