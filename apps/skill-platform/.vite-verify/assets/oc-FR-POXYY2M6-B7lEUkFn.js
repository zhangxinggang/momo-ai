...
var a = {
    ...
    lineEditor: { edit: 'Modificar la linha', exit: 'Sortir de l’editor de linha' },
    elementLock: {
      lock: 'Verrolhar',
      unlock: 'Desverrolhar',
  ...
  e = {
    ...
    hint_emptyLibrary:
      'Seleccionatz un element d’apondre aquí, o installatz una bibliotèca del depaus public, çai-jos.',
  ...
  i = {
    ...
    couldNotCreateShareableLinkTooBig:
      'Creacion impossibla del ligam de partatge : la scèna es tròp granda',
    ...
    uploadedSecurly:
      'Lo telecargament es estat securizat amb un chiframent del cap a la fin, significa que los servidors d’Excalidraw o que quina tèrça part que siá pòdon pas legir lo contengut.',
    loadSceneOverridePrompt:
      'Cargar un dessenh extèrn remplaçarà vòstre contengut existent. Volètz contunhar ?',
...
(Se volètz gardar vòstre dessenh local, tampatz simplament l’onglet del navegador a la plaça)`,
    ...
    imageDoesNotContainScene:
      'Aqueste imatge sembla pas conténer cap de donadas de scèna. Avètz activat l’integracion de scèna pendent l’exportacion ?',
    cannotRestoreFromImage: 'Restauracion impossibla de la scèna a partir del fichièr imatge',
    invalidSceneUrl:
      'Importacion impossibla de la scèna a partir de l’URL provesida. Es siá mal formatada o siá conten pas cap de donada JSON Excalidraw valida.',
    ...
    invalidEncryptionKey:
      'La clau de chiframent deu conténer 22 caractèrs. La collaboracion en dirèct es desactivada.',
...
Vòstras modificacions seràn pas salvadas !`,
  ...
  t = {
    ...
    cannotResolveCollabServer:
      'Connexion impossibla al servidor collab. Mercés de recargar la pagina e tornar ensajar.',
...
quichatz ALT per retalhar a partir del centre`,
    ...
    lineEditor_info:
      'Tenètz quichat Ctrl o Cmd e doble clic o quichatz Ctrl o Cmd + Entrada per modificar los ponches',
...
o manténer Alt e clicar per n’apondre de novèls`,
  ...
  c = {
    ...
    trackedToSentry:
      'Error amb l’identificant {{eventId}} es estada enregistrada sus nòstre sistèma.',
    openIssueMessage:
      'Èrem plan prudents per inclure pas d’informacions de la scèna vòstra sus l’error. Se vòstra scèna es pas privada, volgatz considerar de perseguir sus nòstre <button>traçadors d’avarias.</button> Volgatz inclure las informacions çai-jos en las copiant e pegant a l’issue GitHub.',
    sceneContent: 'Contengut de la scèna :',
  },
  d = {
    desc_intro: 'Podètz convidar lo monde a vòstra scèna actuala per participar amb vos.',
    desc_privacy:
      'Vos en fagatz pas, la session utiliza lo chiframent del cap a la fin, çò que dessenetz demorarà privat. Mai nòstres servidors poiràn pas veire vòstra creacion.',
    ...
    desc_exitSession:
      'Arrestar la session vos desconnectarà de la sala, mas poiretz contunhar de trabalhar a la scèna, en local. Notatz qu’aquò afectarà pas los autres, e poiràn collaborar a lor version.',
  ...
  E = {
    ...
    placeholder: {
      ...
      libraryDesc:
        'Descripcion de vòstra bibliotèca per ajudar lo monde a comprendre son utilizacion',
      githubHandle:
        'GitHub handle(opcional), per poder modificar la bibliotèca un còp enviada per repassa',
      twitterHandle:
    ...
    noteDescription:
      'Enviatz vòstra bibliotèca per èsser compresa al <link>repertòri public de bibliotèca</link>per que los autres l’utilizen dins lor dessenhs.',
    noteGuidelines:
      'Qualqu’un deu aprovar la bibliotèca manualament per començar. Volgatz legir las <link>linhas directrises</link> abans de sometre. Vos farà mestièr un compte GitHub per comunicar e realizar de modificacions se demandadas, mas es pas complètament obligatòri.',
    noteLicense:
      'En sometent, acceptatz que la bibliotèca siá publicada sota la <link>Licéncia MIT, </link>que significa en brèu que qual que siá pòt l’utilizar sens cap de restriccion.',
    noteItems:
      'Cada element de bibliotèca deu aver un nom pròpri per èsser filtrable. Los elements de bibliotèca seguentas seràn incluses :',
    atleastOneLibItem: 'Volgatz seleccionar almens un element de bibliotèca per començar',
    republishWarning:
      'Nòta : d’unes elements seleccionats son marcats ja coma publicats/enviats. Deuriatz sonque tornar enviar los elements pendent l’actualizacion d’una bibliotèca existenta o un mandadís.',
  },
  b = {
    title: 'Bibliotèca somesa',
    content:
      'Mercés {{authorName}}. Vòstre bibliotèca es estada somesa per repassa. Podètz seguir l’avançament<link>aquí</link>',
  },
  g = {
    resetLibrary: 'Reïnicializar la bibliotèca',
  ...
  v = {
    tooltip:
      'Vòstres dessenhs son chifrats del cap a la fin en consequéncia los servidors d’Excalidraw los veiràn pas jamai.',
  ...
  A = {
    action: {
      ...
      saveToDisk: {
        ...
        description:
          'Exportar las donadas de la scèna cap a un fichièr que podètz importar mai tard.',
      },
      excalidrawPlus: {
        title: 'Excalidraw+',
