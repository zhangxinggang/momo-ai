import { ak as T } from './markdown-it-vendor-DL4wSELR.js';
import { g as X } from './ui-vendor-C-FKu2uc.js';
function N(H, Y) {
    ...
    if (typeof I != 'string' && !Array.isArray(I)) {
      for (const G in I)
        if (G !== 'default' && !(G in H)) {
          ...
          v && Object.defineProperty(H, G, v.get ? v : { enumerable: !0, get: () => I[G] });
        }
    }
  }
  return Object.defineProperty(H, Symbol.toStringTag, { value: 'Module' });
}
var W = { exports: {} };
var z;
function Z() {
          ...
          })()(
            {
              1: [
                function (d, I, G) {
                  ...
                  (v(a, o),
                    (a.prototype.resizeAndUnsharp = function (e, i) {
                ...
                { './mm_resize': 4, './mm_unsharp_mask': 9, inherits: 19, multimath: 20 },
              ],
              2: [
                function (d, I, G) {
                  function v(n) {
                  ...
                  function o(n, a, t, e, i, h) {
                    ...
                    for (E = 0; E < e; E++) {
                      for (m = 0, R = 0; R < i; R++) {
                        for (
                          w = h[m++], B = h[m++], y = (F + w * 4) | 0, c = f = _ = p = 0;
                          B > 0;
                          B--
                        )
                          ((b = h[m++]),
                  ...
                  I.exports = { convolveHorizontally: o, convolveVertically: A };
                },
                {},
              ],
              3: [
              ...
              5: [
                function (d, I, G) {
                  var v = d('./resize_filter_gen'),
                    o = d('./convolve').convolveHorizontally,
                    A = d('./convolve').convolveVertically;
                  function n(a, t, e) {
                    for (var i = 3, h = (t * e * 4) | 0; i < h; ) ((a[i] = 255), (i = (i + 4) | 0));
                  }
                  I.exports = function (t) {
                    var e = t.src,
                      ...
                      c = t.toWidth,
                      f = t.toHeight,
                      _ = t.scaleX || t.toWidth / t.width,
                      p = t.scaleY || t.toHeight / t.height,
                      m = t.offsetX || 0,
                      w = t.offsetY || 0,
                      B = t.dest || new Uint8Array(c * f * 4),
                      y = typeof t.quality > 'u' ? 3 : t.quality,
                      E = t.alpha || !1,
                      R = v(y, i, c, _, m),
                      b = v(y, h, f, p, w),
                ...
                function (d, I, G) {
                  ...
                  I.exports = function (a, t, e, i, h) {
                    ...
                    for (m = 0; m < e; m++) {
                      for (
                        w = (m + 0.5) * f + h,
                          B = Math.max(0, Math.floor(w - p)),
                          y = Math.min(t - 1, Math.ceil(w + p)),
                          E = y - B + 1,
                      ...
                      for (j = 0, x = 0; x < R.length; x++)
                        ((k = R[x] / F), (j += k), (b[x] = A(k)));
                      for (b[e >> 1] += A(1 - j), r = 0; r < b.length && b[r] === 0; ) r++;
                      if (r < b.length) {
                        for (u = b.length - 1; u > 0 && b[u] === 0; ) u--;
                        if (((s = B + r), (l = u - r + 1), (M[C++] = s), (M[C++] = l), !Q))
                          (M.set(b.subarray(r, u + 1), C), (C += l));
                        else for (x = r; x <= u; x++) M[C++] = b[x];
                      } else ((M[C++] = 0), (M[C++] = 0));
                    }
                    return M;
                  };
                ...
                function (d, I, G) {
                  I.exports = [
                    ...
                    },
                    {
                      ...
                      filter: function (o) {
                        if (o <= -1 || o >= 1) return 0;
                        if (o > -11920929e-14 && o < 11920929e-14) return 1;
                        var A = o * Math.PI;
              ...
              8: [
                function (d, I, G) {
                  var v = d('./resize_filter_gen');
                  function o(t, e, i) {
                    for (var h = 3, c = (e * i * 4) | 0; h < c; ) ((t[h] = 255), (h = (h + 4) | 0));
                  }
                  function A(t) {
                  ...
                  I.exports = function (e) {
                    var i = e.src,
                      ...
                      f = e.toWidth,
                      _ = e.toHeight,
                      p = e.scaleX || e.toWidth / e.width,
                      m = e.scaleY || e.toHeight / e.height,
                      w = e.offsetX || 0,
                      B = e.offsetY || 0,
                      y = e.dest || new Uint8Array(f * _ * 4),
                      ...
                      S = this.__align(x + c * f * 4),
                      j = this.__align(S + b.byteLength),
                      k = j + F.byteLength,
                      r = this.__instance('resize', k),
                    ...
                    return (
                      M.set(new Uint32Array(this.__memory.buffer, 0, _ * f)),
                      R || o(y, f, _),
                      y
                    );
                  };
                ...
                function (d, I, G) {
                  ...
                  I.exports = function (n, a, t, e, i, h) {
                    ...
                    if (!(e === 0 || i < 0.5)) {
                      ...
                      v(B, a, t, i);
                      for (
                        var y = ((e / 100) * 4096 + 0.5) | 0, E = h << 8, R = a * t, b = 0;
                        b < R;
                        b++
                      )
                        ((c = w[b]),
                          ...
                          Math.abs(p) >= E &&
                            ...
                            (m = b * 4),
                            (n[m] = (n[m] * _ + 2048) >> 12),
                            (n[m + 1] = (n[m + 1] * _ + 2048) >> 12),
                            (n[m + 2] = (n[m + 2] * _ + 2048) >> 12)));
                    }
                  };
                },
                { 'glur/mono16': 18 },
                  ...
                  I.exports = function (o, A, n, a, t, e) {
                    if (!(a === 0 || t < 0.5)) {
                      ...
                      var i = A * n,
                        ...
                        E = y + f,
                        R = E + _,
                        b = this.__instance('unsharp_mask', h + c + f * 2 + _ + p, {
                          exp: Math.exp,
                        }),
              ...
              14: [
                function (d, I, G) {
                  ...
                  I.exports = function (A, n, a, t, e, i) {
                    ...
                    for (var p = [], m = 0; m < _; m++) {
                      var w = Math.round(
                          Math.pow(Math.pow(A, _ - m - 1) * Math.pow(a, m + 1), 1 / _),
                        ),
                        B = Math.round(
                          Math.pow(Math.pow(n, _ - m - 1) * Math.pow(t, m + 1), 1 / _),
                        );
                      p.push([w, B]);
                    }
                    return p;
              ...
              15: [
                function (d, I, G) {
                  ...
                  I.exports = function (a) {
                    var t = a.toWidth / a.width,
                      e = a.toHeight / a.height,
                      i = o(a.srcTileSize * t) - 2 * a.destTileBorder,
                      h = o(a.srcTileSize * e) - 2 * a.destTileBorder;
                    if (i < 1 || h < 1)
                      throw new Error(
                    ...
                    for (p = 0; p < a.toHeight; p += h)
                      for (_ = 0; _ < a.toWidth; _ += i)
                        ((c = _ - a.destTileBorder),
                          c < 0 && (c = 0),
                          (m = _ + i + a.destTileBorder - c),
                          c + m >= a.toWidth && (m = a.toWidth - c),
                          (f = p - a.destTileBorder),
                          f < 0 && (f = 0),
                          (w = p + h + a.destTileBorder - f),
                          f + w >= a.toHeight && (w = a.toHeight - f),
                          (y = {
                            toX: c,
                            toY: f,
                            toWidth: m,
                  ...
                  ((I.exports.isCanvas = function (A) {
                    ...
                    (I.exports.worker_offscreen_canvas_support = function () {
                      return new Promise(function (A, n) {
                        ...
                        var t = btoa('('.concat(a.toString(), ')(self);')),
                          e = new Worker('data:text/javascript;base64,'.concat(t));
                    ...
                    onmessage = function (n) {
                      ...
                      if (!a.src && a.srcBitmap) {
                        var t = new OffscreenCanvas(a.width, a.height),
                          e = t.getContext('2d', { alpha: !!a.alpha });
                        (e.drawImage(a.srcBitmap, 0, 0),
                          (a.src = e.getImageData(0, 0, a.width, a.height).data),
                          (t.width = t.height = 0),
                          (t = null),
                          a.srcBitmap.close(),
                          (a.srcBitmap = null));
                ...
                function (d, I, G) {
                  ...
                  function h(_) {
                    ...
                    return (
                      ...
                      (e = (v + o) / (1 - a - t)),
                      (i = (A + n) / (1 - a - t)),
                      new Float32Array([v, o, A, n, a, t, e, i])
                    );
                  }
                  ...
                  function f(_, p, m, w) {
                    if (w) {
                      var B = new Uint16Array(_.length),
                        y = new Float32Array(Math.max(p, m)),
                        E = h(w);
              ...
              20: [
                function (d, I, G) {
                  var v = d('object-assign'),
                    o = d('./lib/base64decode'),
                    A = d('./lib/wa_detect'),
                    n = { js: !0, wasm: !0 };
                  function a(t) {
                  ...
                  ((a.prototype.has_wasm = A),
                      ...
                      return (
                        (this.__init_promise = Promise.all(
                          Object.keys(t.__modules).map(function (e) {
                            var i = t.__modules[e];
                            return !t.options.wasm || !t.has_wasm() || !i.wasm_fn || t.__wasm[e]
                              ? null
                              : WebAssembly.compile(t.__base64decode(i.wasm_src)).then(
                                  function (h) {
                                    t.__wasm[e] = h;
                                  },
                                );
                    ...
                    (a.prototype.__base64decode = o),
                    (a.prototype.__reallocate = function (e) {
                      if (!this.__memory)
                        return (
                ...
                { './lib/base64decode': 21, './lib/wa_detect': 22, 'object-assign': 23 },
              ],
              21: [
                function (d, I, G) {
                  ...
                  I.exports = function (A) {
                    for (
                      ...
                      (h % 4 === 0 &&
                        h &&
                        ((t[i++] = (e >> 16) & 255), (t[i++] = (e >> 8) & 255), (t[i++] = e & 255)),
                        (e = (e << 6) | v.indexOf(n.charAt(h))));
                    var c = (a % 4) * 6;
                    return (
                      c === 0
                        ? ((t[i++] = (e >> 16) & 255),
                  ...
                  I.exports = a()
                    ...
                    : function (t, e) {
                        for (var i, h = n(t), c, f = 1; f < arguments.length; f++) {
                          ...
                          for (var _ in i) o.call(i, _) && (h[_] = i[_]);
                          if (v) {
                            c = v(i);
                ...
                function (d, I, G) {
                  ...
                  I.exports = function (a, t) {
                    ...
                    if (!e) {
                      ...
                      o[e] = ['function(require,module,exports){' + a + '(self); }', p];
                    }
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
                  ...
                  function n(r, u) {
                    ...
                    for (var s = 0, l = new Array(u); s < u; s++) l[s] = r[s];
                    return l;
                  }
                  function a(r, u) {
                    var s =
                    ...
                    if (s != null) {
                      ...
                      try {
                        for (
                          s = s.call(r);
                          !(g = (C = s.next()).done) && (l.push(C.value), !(u && l.length === u));
                          g = !0
                        );
                      } catch (U) {
                        ((M = !0), (Q = U));
                      ...
                      destroy: function () {
                        if ((this.value.terminate(), typeof window < 'u')) {
                          ...
                          u &&
                            ...
                            u.revokeObjectURL(this.value.objectURL);
                        }
                      },
                    };
                  }
                  function k(r) {
                    ...
                    ((this.__limit = w[u] || f.limiter(this.options.concurrency)),
                      w[u] || (w[u] = this.__limit),
                  ...
                  ((k.prototype.init = function () {
                    ...
                    if (
                      (u.indexOf('all') >= 0 && (u = ['cib', 'wasm', 'js', 'ww']),
                      (this.__requested_features = u),
                      (this.__mathlib = new h(u)),
                      u.indexOf('ww') >= 0 && typeof window < 'u' && 'Worker' in window)
                    )
                      try {
                        ...
                        w[l]
                          ? (this.__workersPool = w[l])
                          : ((this.__workersPool = new c(j, this.options.idle)),
                            (w[l] = this.__workersPool));
                      } catch {}
                    var g = this.__mathlib.init().then(function (U) {
                      ...
                      M;
                    (F
                      ? (M = f.cib_support(this.options.createCanvas).then(function (U) {
                      ...
                      : (M = Promise.resolve(!1)),
                      (D = f.can_use_canvas(this.options.createCanvas)));
                    var C;
                    (F && b && u.indexOf('ww') !== -1
                      ? (C = f.worker_offscreen_canvas_support())
                      : (C = Promise.resolve(!1)),
                      (C = C.then(function (U) {
                        x = U;
                      })));
                    ...
                    return (
                      (this.__initPromise = Promise.all([g, M, C, Q]).then(function () {
                        return r;
                      })),
                      this.__initPromise
                    );
                        ...
                        Promise.resolve().then(function () {
                          return s.features.ww
                            ? new Promise(function (l, g) {
                                ...
                                var C = [];
                                (r.src && C.push(r.src.buffer),
                                  r.srcBitmap && C.push(r.srcBitmap),
                                  M.value.postMessage(
                                    {
                                      opts: r,
                    ...
                    (k.prototype.__extractTileData = function (r, u, s, l, g) {
                      if (this.features.ww && x && (f.isCanvas(u) || S))
                        return (
                      ...
                      if (f.isCanvas(u))
                        return (
                          l.srcCtx || (l.srcCtx = u.getContext('2d', { alpha: !!s.alpha })),
                          this.debug('Get tile pixel data'),
                          (g.src = l.srcCtx.getImageData(r.x, r.y, r.width, r.height).data),
                          g
                        );
                      this.debug('Draw tile imageBitmap/image to temporary canvas');
                      var M = this.options.createCanvas(r.width, r.height),
                      ...
                      return (
                        ...
                        this.debug('Get tile pixel data'),
                        (g.src = C.getImageData(0, 0, r.width, r.height).data),
                        (M.width = M.height = 0),
                        g
                      );
                    }),
                    (k.prototype.__landTileData = function (r, u, s) {
                      ...
                      if (b)
                        ...
                        l.data.set(u.data);
                      else for (var g = l.data.length - 1; g >= 0; g--) l.data[g] = u.data[g];
                      return (
                    ...
                    (k.prototype.__tileAndResize = function (r, u, s) {
                            ...
                            return (
                              ...
                              Promise.resolve(U)
                                ...
                                .then(function (O) {
                                  return s.canceled
                                    ? s.cancelToken
                                    : ((g.srcImageData = null), l.__landTileData(Q, O, g));
                                })
                            );
                          });
                        };
                      return Promise.resolve()
                        .then(function () {
                          if (((g.toCtx = u.getContext('2d', { alpha: !!s.alpha })), f.isCanvas(r)))
                            return null;
                    ...
                    (k.prototype.__processStages = function (r, u, s, l) {
                      ...
                      return (
                        ...
                        this.__tileAndResize(u, O ? s : P, l)
                          .then(function () {
                            return O
                              ? s
                              : ((l.width = Q), (l.height = U), g.__processStages(r, P, s, l));
                          })
                          .then(function (q) {
                    ...
                    (k.prototype.__resizeViaCreateImageBitmap = function (r, u, s) {
                      var l = this,
                        g = u.getContext('2d', { alpha: !!s.alpha });
                      return (
                    ...
                    (k.prototype.resize = function (r, u, s) {
                      ...
                      if (
                        ...
                        (g.toWidth = u.width),
                        (g.toHeight = u.height),
                        (g.width = r.naturalWidth || r.width),
                        (g.height = r.naturalHeight || r.height),
                        u.width === 0 || u.height === 0)
                      )
                        return Promise.reject(
                          new Error('Invalid output size: '.concat(u.width, 'x').concat(u.height)),
                        );
                      ...
                      var M = 3;
                      return (
                        (g.__destTileBorder = Math.ceil(Math.max(M, (2.5 * g.unsharpRadius) | 0))),
                        this.init().then(function () {
                          if (g.canceled) return g.cancelToken;
                          if (l.features.cib) return l.__resizeViaCreateImageBitmap(r, u, g);
                          if (!D) {
                            var C = new Error(
                    ...
                    (k.prototype.toBlob = function (r, u, s) {
                      return (
                        ...
                        new Promise(function (l) {
                          ...
                          if (r.convertToBlob) {
                            l(r.convertToBlob({ type: u, quality: s }));
                            return;
                          }
                          for (
                            var g = atob(r.toDataURL(u, s).split(',')[1]),
                              M = g.length,
                              C = new Uint8Array(M),
                              Q = 0;
                            Q < M;
