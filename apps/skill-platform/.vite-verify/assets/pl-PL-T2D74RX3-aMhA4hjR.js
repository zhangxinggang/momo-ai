...
var e = {
    ...
    lineEditor: { edit: 'Edytuj linię', exit: 'Wyjdź z edytora linii' },
    elementLock: {
      lock: 'Zablokuj',
      unlock: 'Odblokuj',
  ...
  o = {
    ...
    hint_emptyLibrary:
      'Wybierz element na płótnie, aby go tutaj dodać, lub zainstaluj bibliotekę z poniższego publicznego repozytorium.',
  ...
  i = {
    ...
    uploadedSecurly:
      'By zapewnić Ci prywatność, udostępnianie projektu jest zabezpieczone szyfrowaniem end-to-end, co oznacza, że poza tobą i osobą z którą podzielisz się linkiem, nikt nie ma dostępu do tego co udostępniasz.',
...
(Jeśli chcesz zachować swój lokalny rysunek, po prostu zamknij zakładkę przeglądarki.)`,
    ...
    invalidEncryptionKey:
      'Klucz szyfrowania musi składać się z 22 znaków. Współpraca na żywo jest wyłączona.',
...
Twoje zmiany nie zostaną zapisane!`,
  ...
  u = {
    ...
    cannotResolveCollabServer:
      'Nie można połączyć się z serwerem współpracy w czasie rzeczywistym. Proszę odświeżyć stronę i spróbować ponownie.',
    ...
    brave_measure_text_error: {
      ...
      line4:
        'Jeśli wyłączenie tego ustawienia nie naprawia wyświetlania elementów tekstowych, zgłoś <issueLink>problem</issueLink> na naszym GitHubie lub napisz do nas na <discordLink>Discordzie</discordLink>',
    },
  ...
  r = { canvasActions: 'Narzędzia', selectedShapeActions: 'Wybrane narzędzie', shapes: 'Kształty' },
  t = {
    canvasPanning:
      'Aby przesunąć płótno, przytrzymaj kółko myszy lub spację podczas przeciągania, albo użyj narzędzia ręki',
...
lub przytrzymaj Alt i kliknij, aby dodać nowe punkty`,
  ...
  l = {
    ...
    clearCanvasMessage:
      'Jeśli odświeżenie strony nie zadziałało, spróbuj <button>usunąć wszystko z dokumentu.</button>',
  ...
  d = {
    ...
    desc_privacy:
      'By zapewnić Ci prywatność, sesja współpracy na żywo jest zabezpieczona szyfrowaniem end-to-end, co oznacza, że poza tobą i osobami z którymi podzielisz się linkiem, nikt nie ma dostępu do tego co będziecie tworzyć.',
    ...
    desc_exitSession:
      'Zakończenie sesji spowoduje odłączenie ciebie od pokoju, ale nadal będziesz mógł lokalnie kontynuować pracę. Zauważ, że osoby z którymi współpracowałeś nadal będą mogły współpracować.',
    shareTitle: 'Dołącz do sesji współpracy na żywo w Excalidraw',
  },
  z = { title: 'Wystąpił błąd' },
  y = {
  ...
  k = {
    ...
    errors: { required: 'Wymagane', website: 'Wprowadź prawidłowy adres URL' },
    ...
    noteLicense:
      'Wysyłając zgadzasz się, że biblioteka zostanie opublikowana pod <link>Licencja MIT, </link>w skrócie, każdy może z nich korzystać bez ograniczeń.',
    noteItems:
    ...
    republishWarning:
      'Uwaga: niektóre z wybranych elementów są oznaczone jako już opublikowane/wysłane. Powinieneś ponownie przesłać elementy tylko wtedy, gdy aktualizujesz istniejącą bibliotekę lub zgłoszenie.',
  },
  p = {
...
Zwiększy to rozmiar eksportowanego pliku.`,
    ...
    button: { exportToPng: 'PNG', exportToSvg: 'SVG', copyPngToClipboard: 'Skopiuj do schowka' },
  },
  j = {
    tooltip:
...
lub wklej do istniejącego edytora tekstu`,
    unableToEmbed:
      'Osadzenie tego linku jest obecnie niedozwolone. Zgłoś propozycję na portalu GitHub, aby dodać go do listy dozwolonych wyjątków',
    unrecognizedLinkFormat:
      'Osadzony link ma niewłaściwy format. Spróbuj wkleić całą zawartość pola "embed" z oryginalnej strony.',
  },
  F = {
  ...
  S = {
    ...
    button: 'Wstaw',
    description:
      'Obecnie wspierane są jedynie <flowchartLink>proste grafy</flowchartLink>, <sequenceLink>sekwencje</sequenceLink> i <classLink>diagramy klas</classLink>. Pozostałe typy będą wyświetlane jako obrazy w Excalidraw.',
