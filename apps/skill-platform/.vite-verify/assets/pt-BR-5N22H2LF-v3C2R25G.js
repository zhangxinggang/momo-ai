...
var e = {
  ...
  a = {
    ...
    hint_emptyLibrary:
      'Selecione um item na tela para adicioná-lo aqui, ou instale uma biblioteca do repositório público, abaixo.',
  ...
  r = {
    ...
    couldNotCreateShareableLinkTooBig:
      'Não foi possível criar um link compartilhável: a cena é muito grande',
    ...
    loadSceneOverridePrompt:
      'Carregar um desenho externo substituirá o seu conteúdo existente. Deseja continuar?',
...
(Se você deseja manter seu desenho local, simplesmente feche a aba do navegador.)`,
    ...
    imageDoesNotContainScene:
      'Esta imagem parece não conter dados de cenas. Você ativou a incorporação da cena durante a exportação?',
    cannotRestoreFromImage: 'Não foi possível restaurar a cena deste arquivo de imagem',
    invalidSceneUrl:
      'Não foi possível importar a cena da URL fornecida. Ela está incompleta ou não contém dados JSON válidos do Excalidraw.',
    ...
    invalidEncryptionKey:
      'A chave de encriptação deve ter 22 caracteres. A colaboração ao vivo está desabilitada.',
...
Suas alterações não serão salvas!`,
  ...
  i = {
    ...
    cannotResolveCollabServer:
      'Não foi possível conectar-se ao servidor colaborativo. Por favor, recarregue a página e tente novamente.',
    importLibraryError: 'Não foi possível carregar a biblioteca',
    collabSaveFailed:
      'Não foi possível salvar no banco de dados do servidor. Se os problemas persistirem, salve o arquivo localmente para garantir que não perca o seu trabalho.',
    collabSaveFailed_sizeExceeded:
      'Não foi possível salvar no banco de dados do servidor, a tela parece ser muito grande. Se os problemas persistirem, salve o arquivo localmente para garantir que não perca o seu trabalho.',
    imageToolNotSupported: '',
    brave_measure_text_error: {
      line1:
        'Parece que você está usando o navegador Brave com a configuração <bold>Bloquear Impressões Digitais</bold> no modo agressivo.',
      line2: 'Isso pode acabar quebrando <bold>Elementos de Texto</bold> em seus desenhos.',
      line3:
        'Recomendamos fortemente desativar essa configuração. Você pode acessar o <link>passo a passo</link> sobre como fazer isso.',
      line4:
        'Se desativar essa configuração não corrigir a exibição de elementos de texto, por favor abra uma <issueLink>issue</issueLink> em nosso GitHub, ou mande uma mensagem em nosso <discordLink>Discord</discordLink>',
    },
...
Ctrl/Cmd+D para duplicar ou arraste para mover`,
    lineEditor_nothingSelected:
      'Selecione um ponto para editar (segure SHIFT para selecionar vários) ou segure Alt e clique para adicionar novos pontos',
    placeImage:
    ...
    firefox_clipboard_write:
      'Esse recurso pode ser ativado configurando a opção "dom.events.asyncClipboard.clipboardItem" como "true". Para alterar os sinalizadores do navegador no Firefox, visite a página "about:config".',
    disableSnapping: '',
  },
  l = {
  ...
  d = {
    ...
    clearCanvasMessage:
      'Se recarregar a página não funcionar, tente <button>limpando a tela.</button>',
    ...
    openIssueMessage:
      'Fomos muito cautelosos para não incluir suas informações de cena no erro. Se sua cena não for privada, por favor, considere seguir nosso <button>rastreador de bugs.</button> Por favor, inclua informações abaixo, copiando e colando para a issue do GitHub.',
    sceneContent: 'Conteúdo da cena:',
  },
  c = {
    desc_intro: 'Você pode convidar pessoas para sua cena atual para colaborar com você.',
    desc_privacy:
      'Não se preocupe, a sessão usa criptografia de ponta a ponta; portanto, o que você desenhar permanecerá privado. Nem mesmo nosso servidor poderá ver o que você cria.',
    ...
    desc_exitSession:
      'Interrompendo a sessão você irá se desconectar da sala, mas você poderá continuar trabalhando com a cena localmente. Observe que isso não afetará outras pessoas, e elas ainda poderão colaborar em suas versões.',
  ...
  E = {
    ...
    placeholder: {
      ...
      githubHandle:
        'Identificador do GitHub (opcional), para que você possa editar a biblioteca depois de enviar para revisão',
      twitterHandle:
        'Nome de usuário do Twitter (opcional), para que saibamos quem deve ser creditado se promovermos no Twitter',
      website: 'Link para o seu site pessoal ou outro lugar (opcional)',
    },
    errors: { required: 'Obrigatório', website: 'Informe uma URL válida' },
    noteDescription:
      'Envie sua biblioteca para ser incluída no <link>repositório de biblioteca pública</link>para outras pessoas usarem em seus desenhos.',
    noteGuidelines:
      'A biblioteca precisa ser aprovada manualmente primeiro. Por favor leia o <link>orientações</link> antes de enviar. Você precisará de uma conta do GitHub para se comunicar e fazer alterações quando solicitado, mas não é estritamente necessário.',
    noteLicense:
      'Ao enviar, você concorda que a biblioteca será publicada sob a <link>Licença MIT, </link>o que, em suma, significa que qualquer pessoa pode utilizá-los sem restrições.',
    noteItems:
      'Cada item da biblioteca deve ter seu próprio nome para que seja filtrável. Os seguintes itens da biblioteca serão incluídos:',
    atleastOneLibItem: 'Por favor, selecione pelo menos um item da biblioteca para começar',
    republishWarning:
      'Nota: alguns dos itens selecionados estão marcados como já publicado/enviado. Você só deve reenviar itens ao atualizar uma biblioteca existente ou submissão.',
  },
  b = {
    title: 'Biblioteca enviada',
    content:
      'Obrigado {{authorName}}. Sua biblioteca foi enviada para análise. Você pode acompanhar o status<link>aqui</link>',
  },
  v = {
    resetLibrary: 'Redefinir biblioteca',
...
Isso aumentará o tamanho do arquivo exportado.`,
  ...
  h = {
    tooltip:
      'Seus desenhos são criptografados de ponta a ponta, então os servidores do Excalidraw nunca os verão.',
  ...
  S = {
    ...
    copyToClipboardAsPng:
      '{{exportSelection}} copiado para a área de transferência como PNG ({{exportColorScheme}})',
  ...
  q = {
    ...
    modal: {
      loadFromFile: {
        ...
        description:
          'Carregar de um arquivo irá <bold> substituir o conteúdo existente</bold>.<br></br>Você pode salvar seu desenho primeiro usando uma das opções abaixo.',
      },
      shareableLink: {
        title: 'Carregar de um link',
        button: 'Substituir meu conteúdo',
        description:
          'Carregar um desenho externo irá <bold> substituir seu conteúdo existente</bold>.<br></br>Você pode salvar seu desenho antes utilizando uma das opções abaixo.',
      },
    },
  },
  y = { title: '', button: '', description: '', syntax: '', preview: '' },
  L = {
    labels: e,
    library: a,
    buttons: o,
