...
var e = {
  ...
  a = {
    ...
    hint_emptyLibrary:
      'Seleccione um item na tela para adicioná-lo aqui, ou então instale uma biblioteca do repositório público abaixo.',
  ...
  r = {
    ...
    couldNotCreateShareableLinkTooBig:
      'Não foi possível criar um link partilhável: a cena é muito grande',
    ...
    loadSceneOverridePrompt:
      'Se carregar um desenho externo substituirá o conteúdo existente. Quer continuar?',
...
(Caso queira manter o último desenho, simplesmente feche a janela do navegador.)`,
    ...
    imageDoesNotContainScene:
      'Esta imagem parece não conter dados de cenas. Ativou a incorporação da cena durante a exportação?',
    cannotRestoreFromImage: 'Não foi possível restaurar a cena deste ficheiro de imagem',
    invalidSceneUrl:
      'Não foi possível importar a cena a partir do URL fornecido. Ou está mal formado ou não contém dados JSON do Excalidraw válidos.',
    ...
    invalidEncryptionKey:
      'Chave de encriptação deve ter 22 caracteres. A colaboração ao vivo está desativada.',
...
As suas alterações não serão salvas!`,
  ...
  i = {
    ...
    cannotResolveCollabServer:
      'Não foi possível fazer a ligação ao servidor colaborativo. Por favor, volte a carregar a página e tente novamente.',
    importLibraryError: 'Não foi possível carregar a biblioteca',
    collabSaveFailed:
      'Não foi possível guardar na base de dados de backend. Se os problemas persistirem, guarde o ficheiro localmente para garantir que não perde o seu trabalho.',
    collabSaveFailed_sizeExceeded:
      'Não foi possível guardar na base de dados de backend, o ecrã parece estar muito grande. Deve guardar o ficheiro localmente para garantir que não perde o seu trabalho.',
  ...
  s = {
    canvasPanning:
      'Para mover a tela, carregue na roda do rato ou na barra de espaço enquanto arrasta, ou use a ferramenta da mão',
...
mantenha pressionada a tecla ALT para redimensionar do centro`,
    ...
    lineEditor_info:
      'Pressione CtrlOrCmd e faça um duplo-clique ou pressione CtrlOrCmd + Enter para editar pontos',
...
ou carregue em Alt e clique para acrescentar novos pontos`,
    ...
    deepBoxSelect:
      'Mantenha a tecla CtrlOrCmd carregada para selecção profunda, impedindo o arrastamento',
    eraserRevert: 'Carregue também em Alt para reverter os elementos marcados para serem apagados',
    firefox_clipboard_write:
      'Esta função pode provavelmente ser ativada definindo a opção "dom.events.asyncClipboard.clipboardItem" como "true". Para alterar os sinalizadores do navegador no Firefox, visite a página "about:config".',
    disableSnapping: '',
  },
  l = {
  ...
  d = {
    ...
    clearCanvasMessage:
      'Se a recarga não funcionar, tente <button>a limpar a área de desenho.</button>',
    ...
    openIssueMessage:
      'Fomos muito cautelosos para não incluir suas informações de cena no erro. Se sua cena não for privada, por favor, considere seguir nosso <button>rastreador de bugs.</button> Por favor, inclua informações abaixo, copiando e colando no relatório de erros no GitHub.',
  ...
  c = {
    ...
    desc_exitSession:
      'Interrompendo a sessão irá desconectar-se da sala, mas poderá continuar a trabalhar com a cena localmente. Note que isso não afetará outras pessoas e elas ainda poderão colaborar nas versões deles.',
  ...
  E = {
    ...
    placeholder: {
      ...
      libraryDesc:
        'Descrição da sua biblioteca para ajudar as pessoas a entender a utilização dela',
      githubHandle:
        'Identificador do GitHub (opcional), para que possa editar a biblioteca depois desta ser enviada para revisão',
      twitterHandle:
        'Nome do Twitter (opcional), para que saibamos quem merece os créditos na promoção via Twitter',
      website: 'Ligação para a sua página pessoal ou qualquer outra (opcional)',
    },
    errors: { required: 'Obrigatório', website: 'Introduza um URL válido' },
    noteDescription:
      'Envie a sua biblioteca para ser incluída no <link>repositório de bibliotecas públicas</link>para outras pessoas a poderem usar nos seus próprios desenhos.',
    noteGuidelines:
      'A biblioteca precisa ser aprovada manualmente primeiro. Por favor, leia <link>orientações</link> antes de enviar. Vai precisar de uma conta no GitHub para comunicar e fazer alterações se solicitado, mas não é estritamente necessária.',
    noteLicense:
      'Ao enviar, concorda que a biblioteca será publicada sob a <link>Licença MIT, </link>o que significa, de forma resumida, que qualquer pessoa pode utilizá-la sem restrições.',
    noteItems:
      'Cada item da biblioteca deve ter o seu próprio nome para que este seja pesquisável com filtros. Os seguintes itens da biblioteca serão incluídos:',
    atleastOneLibItem: 'Por favor, seleccione pelo menos um item da biblioteca para começar',
    republishWarning:
      'Nota: alguns dos itens seleccionados estão marcados como já publicados/enviados. Só deve reenviar itens ao actualizar uma biblioteca existente ou submissão.',
  },
  b = {
    title: 'Biblioteca enviada',
    content:
      'Obrigado {{authorName}}. A sua biblioteca foi enviada para análise. Pode acompanhar o status<link>aqui</link>',
  },
  g = {
    resetLibrary: 'Repor a biblioteca',
  ...
  h = {
    tooltip:
      'Os seus desenhos são encriptados de ponta-a-ponta, por isso os servidores do Excalidraw nunca os verão.',
...
ou colar num editor de texto existente`,
  ...
  F = { mostUsedCustomColors: '', colors: 'Cores', shades: 'Tons', hexCode: '', noShades: '' },
  y = {
    action: {
      exportToImage: { title: '', button: '', description: '' },
      saveToDisk: { title: 'Guardar no disco', button: 'Guardar no disco', description: '' },
