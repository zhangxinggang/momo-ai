function u(e) {
  const g = e.regex,
    ...
    s = { className: 'subst', begin: /\{/, end: /\}/, keywords: r, illegal: /#/ },
    o = { begin: /\{\{/, relevance: 0 },
    c = {
      className: 'string',
      ...
      variants: [
        ...
        },
        {
          ...
          contains: [e.BACKSLASH_ESCAPE, n, o, s],
        },
        {
          begin: /([fF][rR]|[rR][fF]|[fF])"""/,
          end: /"""/,
    ...
    p = {
      ...
      variants: [
        { className: '', begin: /\(\s*\)/, skip: !0 },
        {
          ...
          excludeEnd: !0,
          keywords: r,
          contains: ['self', n, l, c, e.HASH_COMMENT_MODE],
        },
      ],
    };
  return (
    (s.contains = [c, l, n]),
    {
      ...
      contains: [
        ...
        _,
        e.HASH_COMMENT_MODE,
        { match: [/\bdef/, /\s+/, i], scope: { 1: 'keyword', 3: 'title.function' }, contains: [p] },
        {
          variants: [
        ...
        { className: 'meta', begin: /^[\t ]*@/, end: /(?=#)|$/, contains: [l, p, c] },
      ],
    }
  );
}
