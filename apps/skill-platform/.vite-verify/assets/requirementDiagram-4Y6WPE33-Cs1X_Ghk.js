import { s as Xe } from './chunk-2J33WTMH-CGvQ9bSc.js';
import { g as Ge } from './chunk-55IACEB6-BTq3bZL5.js';
...
var Ce = (function () {
  var e = f(function ($, i, l, o) {
    ...
    R = [1, 39],
    g = [1, 40],
    E = [5, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 77, 89, 90],
    P = [1, 61],
    X = [89, 90],
    Ae = [
    ...
    Se = {
      ...
      performAction: f(function (i, l, o, s, d, t, de) {
        var c = t.length - 1;
        switch (d) {
          case 4:
      ...
      table: [
        { 3: 1, 4: 2, 6: n, 9: u, 11: h, 13: r },
        { 1: [3] },
        { 3: 8, 4: 2, 5: [1, 7], 6: n, 9: u, 11: h, 13: r },
        { 5: [1, 9] },
        { 10: [1, 10] },
        { 12: [1, 11] },
        e(a, [2, 6]),
        { 3: 12, 4: 2, 6: n, 9: u, 11: h, 13: r },
        { 1: [2, 2] },
        {
          4: 17,
          5: m,
        ...
        e(E, [2, 19]),
        e(E, [2, 20]),
        { 30: 60, 33: 62, 75: P, 89: R, 90: g },
        { 30: 63, 33: 62, 75: P, 89: R, 90: g },
        { 30: 64, 33: 62, 75: P, 89: R, 90: g },
        e(X, [2, 29]),
        e(X, [2, 30]),
        e(X, [2, 31]),
        e(X, [2, 32]),
        ...
        e(Ee, [2, 85]),
        e(Ee, [2, 86]),
        { 62: 69, 65: Ve, 66: ve, 67: Le, 68: xe, 69: Oe, 70: we, 71: De },
        { 62: 77, 65: Ve, 66: ve, 67: Le, 68: xe, 69: Oe, 70: we, 71: De },
        { 30: 78, 33: 62, 75: P, 89: R, 90: g },
        {
          73: 79,
          75: ee,
          76: U,
        ...
        { 30: 94, 33: 62, 75: P, 76: U, 89: R, 90: g },
        { 5: [1, 95] },
        { 30: 96, 33: 62, 75: P, 89: R, 90: g },
        { 5: [1, 97] },
        { 30: 98, 33: 62, 75: P, 89: R, 90: g },
        { 63: [1, 99] },
        e(Y, [2, 50]),
        e(Y, [2, 51]),
        e(Y, [2, 52]),
      ...
      parse: f(function (i) {
        ...
        function Ue() {
          ...
          return (
            (I = s.pop() || _.lex() || Pe),
            typeof I != 'number' &&
              (I instanceof Array && ((s = I), (I = s.pop())), (I = l.symbols_[I] || I)),
            I
          );
        }
        f(Ue, 'lex');
        for (var b, G, N, ke, J = {}, ye, F, Ye, _e; ; ) {
          if (
            ((G = o[o.length - 1]),
            this.defaultActions[G]
              ? (N = this.defaultActions[G])
              : ((b === null || typeof b > 'u') && (b = Ue()), (N = de[G] && de[G][b])),
...
Expecting ` +
              ...
              : (Te =
                  ...
                  (ge + 1) +
                  ': Unexpected ' +
                  (b == Pe ? 'end of input' : "'" + (this.terminals_[b] || b) + "'")),
              this.parseError(Te, {
                text: _.match,
          ...
          if (N[0] instanceof Array && N.length > 1)
            throw new Error(
              'Parse Error: multiple actions possible at state: ' + G + ', token: ' + b,
            );
          switch (N[0]) {
            case 1:
              (o.push(b),
            ...
            case 2:
              if (
                ...
                (ke = this.performAction.apply(J, [c, $e, ge, z.yy, N[1], d, t].concat(We))),
                typeof ke < 'u')
              )
                return ke;
              (F &&
                ((o = o.slice(0, -1 * F * 2)), (d = d.slice(0, -1 * F)), (t = t.slice(0, -1 * F))),
                o.push(this.productions_[N[1]][0]),
                d.push(J.$),
                t.push(J._$),
                (Ye = de[o[o.length - 2]][o[o.length - 1]]),
                o.push(Ye));
              break;
            case 3:
              return !0;
      ...
      var $ = {
        ...
        unput: f(function (i) {
          ...
          return (
            ...
            this.options.ranges && (this.yylloc.range = [d[0], d[0] + this.yyleng - l]),
...
` +
        ...
        next: f(function () {
          ...
          for (var d = this._currentRules(), t = 0; t < d.length; t++)
            if (
              ((o = this._input.match(this.rules[d[t]])), o && (!l || o[0].length > l[0].length))
            ) {
          ...
          return l
            ? ((i = this.test_match(l, d[s])), i !== !1 ? i : !1)
            : this._input === ''
              ? this.EOF
              : this.parseError(
                  'Lexical error on line ' +
...
` +
        ...
        performAction: f(function (l, o, s, d) {
          switch (s) {
            case 0:
              return 'title';
            case 1:
...
var ot = Ce,
  ...
  ht =
    ((Z = class {
      ...
      addRequirement(n, u) {
        return (
          this.requirements.has(n) ||
            this.requirements.set(n, {
              name: n,
              type: u,
      ...
      getData() {
        ...
        for (const r of this.requirements.values()) {
          const a = r;
          ((a.id = r.name),
            (a.cssStyles = r.cssStyles),
            (a.cssClasses = r.classes.join(' ')),
            (a.shape = 'requirementBox'),
            (a.look = n.look),
            (a.colorIndex = u.length),
            u.push(a));
        }
  ...
  ut = f((e) => {
    const n = Be(),
      { themeVariables: u, look: h } = n,
      { bkgColorArray: r, borderColorArray: a } = u;
    if (!a?.length) return '';
    let m = '';
  ...
  ft = f((e) => {
    const n = Be(),
      { look: u, themeVariables: h } = n,
      { requirementEdgeLabelBackground: r } = h;
    return `
  ${ut(e)}
  marker {
...
`;
  ...
  Qe = {};
nt(Qe, { draw: () => dt });
var dt = f(async function (e, n, u, h) {
    (qe.info('REF0:'), qe.info('Drawing requirement diagram (unified)', n));
    const { securityLevel: r, state: a, layout: m, look: p } = Ne(),
      y = h.db.getData(),
      S = Ge(n, r);
    ((y.type = h.type),
      (y.layoutAlgorithm = at(m)),
