...
var e = {
    ...
    lineEditor: { edit: 'Editare linie', exit: 'Părăsire editor de linii' },
    elementLock: {
      lock: 'Blocare',
      unlock: 'Deblocare',
  ...
  a = {
    ...
    hint_emptyLibrary:
      'Selectează un element de pe pânză pentru a-l adăuga aici sau instalează o bibliotecă din depozitul public, de mai jos.',
  ...
  r = {
    ...
    uploadedSecurly:
      'Încărcarea a fost securizată prin criptare integrală, însemnând că serverul Excalidraw și terții nu pot citi conținutul.',
    loadSceneOverridePrompt:
      'Încărcarea desenului extern va înlocui conținutul existent. Dorești să continui?',
...
(Dacă vrei să păstrezi desenul local, pur și simplu închide fila navigatorului în schimb.)`,
    ...
    imageDoesNotContainScene:
      'Această imagine nu pare să conțină date de scenă. Ai activat încorporarea scenei în timpul exportului?',
    ...
    invalidEncryptionKey:
      'Cheia de criptare trebuie să aibă 22 de caractere. Colaborarea în direct este dezactivată.',
...
Modificările nu vor fi salvate!`,
  ...
  t = {
    ...
    cannotResolveCollabServer:
      'Nu a putut fi realizată conexiunea la serverul de colaborare. Reîncarcă pagina și încearcă din nou.',
    importLibraryError: 'Biblioteca nu a putut fi încărcată',
    collabSaveFailed:
      'Nu s-a putut salva în baza de date la nivel de server. Dacă problemele persistă, ar trebui să salvezi fișierul la nivel local pentru a te asigura că nu îți pierzi munca.',
    collabSaveFailed_sizeExceeded:
      'Nu s-a putut salva în baza de date la nivel de server, întrucât se pare că pânza este prea mare. Ar trebui să salvezi fișierul la nivel local pentru a te asigura că nu îți pierzi munca.',
    ...
    brave_measure_text_error: {
      ...
      line3:
        'Îți recomandăm ferm să dezactivezi această setare. Poți urma <link>acești pași</link> pentru a face acest lucru.',
      line4:
  ...
  o = {
    canvasPanning:
      'Pentru a muta pânză, ține apăsată rotița mausului sau bara de spațiu sau folosește instrumentul în formă de mână',
    linearElement:
...
sau ține apăsată tasta Alt și dă clic pentru a adăuga puncte noi`,
    ...
    deepBoxSelect:
      'Ține apăsată tasta Ctrl sau Cmd pentru a efectua selectarea de adâncime și pentru a preveni glisarea',
    eraserRevert: 'Ține apăsată tasta Alt pentru a anula elementele marcate pentru ștergere',
    firefox_clipboard_write:
      'Această caracteristică poate fi probabil activată prin setarea preferinței „dom.events.asyncClipboard.clipboardItem” ca „true”. Pentru a schimba preferințele navigatorului în Firefox, accesează pagina „about:config”.',
  ...
  c = {
    ...
    clearCanvasMessage:
      'Dacă reîncărcarea nu funcționează, încearcă <button>să ștergi pânza</button>.',
    ...
    openIssueMessage:
      'Am luat măsuri de precauție pentru a nu include informații despre scenă în eroare. Dacă scena nu este privată, oferă-ne mai multe informații în <button>monitorul nostru pentru erori</button>. Include informațiile de mai jos copiindu-le și lipindu-le în tichetul cu problemă de pe GitHub.',
    sceneContent: 'Conținutul scenei:',
  },
  s = {
    desc_intro: 'Poți invita alte persoane pentru a colabora la scena actuală.',
    desc_privacy:
      'Nu te îngrijora. Sesiunea utilizează criptarea integrală, astfel încât orice desenezi va rămâne privat. Nici măcar serverul nostru nu va putea vedea pe ce ai lucrat.',
    ...
    desc_exitSession:
      'Oprirea sesiunii te va deconecta de la sală, însă vei putea lucra în continuare, pe plan local, cu scena. Reține că această opțiune nu va afecta alte persoane, iar acestea vor putea să colaboreze în continuare pe versiunea lor.',
  ...
  x = {
    ...
    placeholder: {
      ...
      libraryDesc:
        'Descrierea bibliotecii tale pentru a ajuta oamenii să înțeleagă utilizarea acesteia',
      githubHandle:
    ...
    noteDescription:
      'Trimite-ți biblioteca pentru a fi inclusă în <link>depozitul de biblioteci publice</link> în vederea utilizării de către alte persoane în desenele lor.',
    noteGuidelines:
      'Biblioteca trebuie aprobată manual mai întâi. Citește <link>orientările</link> înainte de trimitere. Vei avea nevoie de un cont GitHub pentru a comunica și efectua modificări, dacă este cazul, însă nu este strict necesar.',
    noteLicense:
      'Prin trimiterea bibliotecii, ești de acord că aceasta va fi publicată sub <link>Licența MIT, </link>care, pe scurt, înseamnă că oricine o poate folosi fără restricții.',
    noteItems:
      'Fiecare element din bibliotecă trebuie să aibă propriul nume astfel încât să fie filtrabil. Următoarele elemente din bibliotecă vor fi incluse:',
    atleastOneLibItem: 'Selectează cel puțin un element din bibliotecă pentru a începe',
    republishWarning:
      'Observație: unele dintre elementele selectate sunt marcate ca fiind deja publicate/trimise. Ar trebui să retrimiți elemente numai atunci când actualizezi o trimitere sau o bibliotecă existentă.',
  },
  b = {
    title: 'Bibliotecă trimisă',
    content:
      'Îți mulțumim, {{authorName}}. Biblioteca a fost trimisă spre revizuire. Poți urmări starea <link>aici</link>',
  },
  g = {
    resetLibrary: 'Resetare bibliotecă',
...
sau insera într-un editor de text existent`,
    unableToEmbed:
      'Încorporarea acestui URL nu este permisă momentan. Deschideți un tichet cu probleme pe GitHub pentru a solicita adăugarea acestui URL în lista albă',
    unrecognizedLinkFormat:
      'URL-ul pe care l-ai încorporat nu coincide cu formatul așteptat. Încearcă să lipești șirul „de încorporat” furnizat de pagina sursă',
  },
  z = {
  ...
  L = {
    ...
    modal: {
      loadFromFile: {
        ...
        description:
          'Încărcarea dintr-un fișier va <bold>înlocui conținutul existent</bold>.<br></br>Poți face mai întâi o copie de rezervă a desenului folosind una dintre opțiunile de mai jos.',
      },
      shareableLink: {
        title: 'Încărcare din lnk',
        button: 'Înlocuiește conținutul meu',
        description:
          'Încărcarea unui desen extern va <bold>înlocui conținutul existent</bold>.<br></br>Poți face mai întâi o copie de rezervă a desenului folosind una dintre opțiunile de mai jos.',
      },
    },
  },
  y = {
    ...
    button: 'Introducere',
    description:
      'În prezent, numai <flowchartLink>Organigramele</flowchartLink>, <sequenceLink>Diagramele de secvență</sequenceLink> și <classLink>Diagramele de clasă</classLink> sunt acceptate. Celelalte tipuri vor fi redate ca imagine în Excalidraw.',
