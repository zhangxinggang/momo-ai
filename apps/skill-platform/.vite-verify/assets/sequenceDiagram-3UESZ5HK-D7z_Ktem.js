import { e as ae, g as dt, a as Er, b as re, f as se, d as ur } from './chunk-ND2GUHAM-TMCKCFt-.js';
import { I as fr } from './chunk-QZHKN3VN-BdOwWt8C.js';
import { d as Ve, s as Vt } from './markdown-it-vendor-DL4wSELR.js';
...
var jt = (function () {
  var e = g(function (ut, w, v, k) {
    ...
    Gt = {
      ...
      performAction: g(function (w, v, k, y, z, o, St) {
        var T = o.length - 1;
        switch (z) {
          case 3:
      ...
      table: [
        ...
        { 5: [1, 132], 52: [1, 131] },
        { 5: [1, 134], 52: [1, 133] },
        e(Ut, me, { 74: 135, 75: [1, 136] }),
        { 5: [1, 138], 52: [1, 137] },
        { 5: [1, 140], 52: [1, 139] },
        { 5: [1, 141] },
        { 23: 145, 70: [1, 142], 71: [1, 143], 72: [1, 144], 73: Y },
        {
          69: 146,
          78: m,
          79: D,
      ...
      parseError: g(function (w, v) {
        if (v.recoverable) this.trace(w);
        else {
          var k = new Error(w);
          throw ((k.hash = v), k);
        }
      ...
      parse: g(function (w) {
        ...
        function Pe() {
          ...
          return (
            (nt = y.pop() || J.lex() || Ne),
            typeof nt != 'number' &&
              (nt instanceof Array && ((y = nt), (nt = y.pop())), (nt = v.symbols_[nt] || nt)),
            nt
          );
        }
        g(Pe, 'lex');
        for (var rt, xt, ct, Zt, Ot = {}, Ct, Tt, ke, Mt; ; ) {
          if (
            ...
            this.defaultActions[xt]
              ? (ct = this.defaultActions[xt])
              : ((rt === null || typeof rt > 'u') && (rt = Pe()), (ct = St[xt] && St[xt][rt])),
            typeof ct > 'u' || !ct.length || !ct[0])
          ) {
            var Qt = '';
            Mt = [];
            for (Ct in St[xt])
...
Expecting ` +
              ...
              : (Qt =
                  ...
                  (vt + 1) +
                  ': Unexpected ' +
                  (rt == Ne ? 'end of input' : "'" + (this.terminals_[rt] || rt) + "'")),
              this.parseError(Qt, {
                text: J.match,
          ...
          if (ct[0] instanceof Array && ct.length > 1)
            throw new Error(
              'Parse Error: multiple actions possible at state: ' + xt + ', token: ' + rt,
            );
          switch (ct[0]) {
            case 1:
              (k.push(rt),
            ...
            case 2:
              if (
                ...
                (Zt = this.performAction.apply(Ot, [T, we, vt, gt.yy, ct[1], z, o].concat($e))),
                typeof Zt < 'u')
              )
                return Zt;
              (Tt &&
                ...
                (z = z.slice(0, -1 * Tt)),
                (o = o.slice(0, -1 * Tt))),
                k.push(this.productions_[ct[1]][0]),
                z.push(Ot.$),
                o.push(Ot._$),
                (ke = St[k[k.length - 2]][k[k.length - 1]]),
                k.push(ke));
              break;
            case 3:
              return !0;
...
` +
        ...
        next: g(function () {
          ...
          for (var z = this._currentRules(), o = 0; o < z.length; o++)
            if (
              ...
              if (((v = k), (y = o), this.options.backtrack_lexer)) {
                if (((w = this.test_match(k, z[o])), w !== !1)) return w;
                if (this._backtrack) {
                  v = !1;
                  continue;
                } else return !1;
          ...
          return v
            ? ((w = this.test_match(v, z[y])), w !== !1 ? w : !1)
            : this._input === ''
              ? this.EOF
              : this.parseError(
                  'Lexical error on line ' +
...
` +
        ...
        ((i = l?.type ?? i),
          l?.alias && (!r || r.text === a) && (r = { text: l.alias, wrap: r?.wrap, type: i }));
      ...
      parseBoxData(t) {
        ...
        let r = a?.[1] ? a[1].trim() : 'transparent',
          i = a?.[2] ? a[2].trim() : void 0;
        if (window?.CSS) window.CSS.supports('color', r) || ((r = 'transparent'), (i = t.trim()));
        else {
          const l = new Option().style;
          ((l.color = r), l.color !== r && ((r = 'transparent'), (i = t.trim())));
        }
        const { wrap: n, cleanedText: s } = this.extractWrap(i);
        return { text: s ? Bt(s, $()) : void 0, color: r, wrap: n };
      }
      addNote(t, a, r) {
...
`;
  ...
  Lr = g(function (e, t, a, r, i) {
    ...
    if (
      (u.attr('class', 'actorPopupMenuPanel' + c),
      u.attr('x', l.x),
      u.attr('y', l.height),
      u.attr('fill', l.fill),
      ...
      for (let _ in n) {
        var p = d.append('a'),
          f = Ve.sanitizeUrl(n[_]);
        (p.attr('xlink:href', f),
          p.attr('target', '_blank'),
          Gr(r)(_, p, l.x + 10, l.height + O, x, 20, { class: 'actor' }, r),
          (O += 30));
      }
    }
  ...
  Kt = g(async function (e, t, a = null) {
    ...
    if (
      ...
      (r.attr('x', Math.round(l + Math.abs(l - E) / 2 - s.width / 2)),
        t.class === 'loopText'
  ...
  br = g(function (e, t, a, r, i) {
    const n = r ? t.stopy : t.starty,
      s = t.x + t.width / 2,
      l = n + t.height,
      { look: E, theme: d, themeVariables: c } = a,
      { bkgColorArray: x, borderColorArray: u } = c,
      O = e.append('g').lower();
    var p = O;
    r ||
      (M++,
      Object.keys(t.links || {}).length &&
        !a.forceMenus &&
        p.attr('onclick', qt(`actor${M}_popup`)).attr('cursor', 'pointer'),
      p
        .append('line')
        .attr('id', 'actor' + M)
        .attr('x1', s)
      ...
      (p = O.append('g')),
      (t.actorCnt = M),
      t.links != null && p.attr('id', 'root-' + M),
      E === 'neo' && p.attr('data-look', 'neo'));
    const f = dt();
    var _ = 'actor';
    (t.properties?.class ? (_ = t.properties.class) : (f.fill = '#eaeaea'),
      r ? (_ += ` ${_t}`) : (_ += ` ${ft}`),
      (f.x = t.x),
      (f.y = n),
      (f.width = t.width),
  ...
  mr = g(function (e, t, a, r, i) {
    ...
    if (
      (pt.has(d) &&
        ...
        b.style('fill', x[A % u.length]),
        S.style('stroke', u[A % u.length]),
        S.style('fill', x[A % u.length])),
      t.properties?.icon)
    ) {
      const B = t.properties.icon.trim();
      B.charAt(0) === '@'
        ? ae(p, f.x + f.width - 20, f.y + 10, B.substr(1))
        : se(p, f.x + f.width - 20, f.y + 10, B);
    }
    Et(a, Q(t.description))(
      t.description,
      p,
  ...
  `;
    (b.append('path').attr('d', A),
      ...
      S.attr('transform', `translate(${f.width - L}, ${-f.height / 2})`),
      (t.rectData = f),
      E === 'neo' && b.attr('filter', 'url(#drop-shadow)'));
    const N = i.get(t.name) ?? 0;
    if (
      (pt.has(d) &&
        (b.style('stroke', u[N % u.length]),
        b.style('fill', x[N % u.length]),
        S.style('stroke', u[N % u.length]),
        S.style('fill', x[N % u.length])),
      t.properties?.icon)
    ) {
  ...
  Sr = g(function (e, t, a, r, i, n) {
    const s = r ? t.stopy : t.starty,
      l = t.x + t.width / 2,
      E = s + 75,
      { look: d, theme: c, themeVariables: x } = a,
    ...
    (I.append('defs')
      ...
      I.append('line')
        ...
        .attr('transform', `translate(${S}, ${A - N})`));
    const B = n.get(t.name) ?? 0;
    pt.has(c)
      ? (I.style('stroke', O[B % O.length]), I.style('fill', u[B % O.length]))
      : (I.style('stroke', p), I.style('fill', f));
    const V = I.node().getBBox();
    return (
      (t.height = V.height + 2 * (a?.sequence?.labelBoxHeight ?? 0)),
      Et(a, Q(t.description))(
        t.description,
        I,
        b.x,
  ...
  Nr = g(function (e, t, a, r, i) {
    const n = r ? t.stopy : t.starty,
      s = t.x + t.width / 2,
      l = n + t.height + 2 * a.boxTextMargin,
      { theme: E, themeVariables: d, look: c } = a,
    ...
    r ||
      ...
      Object.keys(t.links || {}).length &&
        !a.forceMenus &&
        f.attr('onclick', qt(`actor${M}_popup`)).attr('cursor', 'pointer'),
      f
        .append('line')
        .attr('id', 'actor' + M)
        .attr('x1', s)
      ...
      (f = p.append('g')),
      (t.actorCnt = M),
      t.links != null && f.attr('id', 'root-' + M),
      c === 'neo' && f.attr('data-look', 'neo'));
    const _ = dt();
    let I = 'actor';
    (t.properties?.class ? (I = t.properties.class) : (_.fill = '#eaeaea'),
      r ? (I += ` ${_t}`) : (I += ` ${ft}`),
      (_.x = t.x),
      (_.y = n),
      (_.width = t.width),
...
`;
    ...
    (pt.has(E)
      ? (N.style('stroke', u[V % u.length]), N.style('fill', x[V % u.length]))
      : N.style('stroke', O),
      N.attr('transform', `translate(${L}, ${A})`),
      (t.rectData = _),
      Et(a, Q(t.description))(
        t.description,
        f,
  ...
  Pr = g(function (e, t, a, r, i) {
    const n = r ? t.stopy : t.starty,
      ...
      E = 22,
      d = e.append('g').lower(),
      { look: c, theme: x, themeVariables: u } = a,
    ...
    return (
      (t.height = S.height + (a.sequence.labelBoxHeight ?? 0)),
      Et(a, Q(t.description))(
        t.description,
        _,
        L.x,
  ...
  kr = g(function (e, t, a, r, i) {
    const n = r ? t.stopy : t.starty,
      ...
      l = n + 80,
      { look: E, theme: d, themeVariables: c } = a,
      { bkgColorArray: x, borderColorArray: u, actorBorder: O } = c,
      p = e.append('g').lower();
    r ||
      (M++,
      p
    ...
    return (
      pt.has(d)
        ? (f.style('stroke', u[N % u.length]), f.style('fill', x[N % u.length]))
        : f.style('stroke', O),
      Et(a, Q(t.description))(
        t.description,
        f,
  ...
  Dr = g(async function (e, t, a, r, i, n, s) {
    const l = s ?? new Map([...n.db.getActors().values()].map((E, d) => [E.name, d]));
    switch (t.type) {
      case 'actor':
  ...
  Mr = g(function (e, t, a, r, i, n, s) {
    const { theme: l, themeVariables: E } = r,
      { bkgColorArray: d, borderColorArray: c, mainBkg: x } = E,
      u = dt(),
      O = t.anchored,
      p = t.actor;
    ((u.x = t.startx),
      ...
      for (const [_, I] of Object.entries(t.sectionTitles))
        if (I.message) {
          ((p.text = I.message),
            ...
            (p.fontWeight = x),
            (p.wrap = t.wrap),
            Q(p.text) ? ((t.starty = t.sections[_].y), await Kt(u, p, t)) : mt(u, p));
          let L = Math.round(
  ...
  Et = (function () {
    ...
    async function r(n, s, l, E, d, c, x, u) {
      const O = await Nt(n, Wt()),
        p = s.append('switch'),
        _ = p
          .append('foreignObject')
          .attr('x', l + d / 2 - O.width / 2)
          .attr('y', E + c / 2 - O.height / 2)
          .attr('width', O.width)
    ...
    g(r, 'byKatex');
    function i(n, s) {
      for (const l in s) s.hasOwnProperty(l) && n.attr(l, s[l]);
    }
    return (
      g(i, '_setTextAttrs'),
      function (n, s = !1) {
  ...
  R = {
    ...
    updateBounds: g(function (e, t, a, r) {
      ...
      function s(l) {
        return g(function (d) {
          ...
          (i.updateVal(d, 'starty', t - c * h.boxMargin, Math.min),
            i.updateVal(d, 'stopy', r + c * h.boxMargin, Math.max),
            i.updateVal(R.data, 'startx', e - c * h.boxMargin, Math.min),
            i.updateVal(R.data, 'stopx', a + c * h.boxMargin, Math.max),
            l !== 'activation' &&
              (i.updateVal(d, 'startx', e - c * h.boxMargin, Math.min),
              i.updateVal(d, 'stopx', a + c * h.boxMargin, Math.max),
              i.updateVal(R.data, 'starty', t - c * h.boxMargin, Math.min),
              i.updateVal(R.data, 'stopy', r + c * h.boxMargin, Math.max)));
        }, 'updateItemBounds');
      }
      (g(s, 'updateFn'),
    ...
    insert: g(function (e, t, a, r) {
      ...
      (this.updateVal(R.data, 'startx', i, Math.min),
        ...
        this.updateVal(R.data, 'stopy', l, Math.max),
        this.updateBounds(i, s, n, l));
    }, 'insert'),
    newActivation: g(function (e, t, a) {
      const r = a.get(e.from),
        i = Ht(e.from).length || 0,
  ...
  $r = g(async function (e, t, a) {
    ...
    ((s.x = t.startx),
      ...
      (s.valign = 'center'));
    const l = Q(s.text) ? await Kt(i, s) : mt(i, s),
      E = Math.round(l.map((d) => (d._groups || d)[0][0].getBBox().height).reduce((d, c) => d + c));
...
async function qe(e, t) {
  ...
  const { startx: a, stopx: r, message: i } = t,
    ...
    s = Q(i),
    l = s ? await Nt(i, $()) : Z.calculateTextDimensions(i, Rt(h));
  if (!s) {
    const x = l.height / n;
...
var jr = g(async function (e, t, a, r, i, n) {
    ...
    ((p.x = Math.min(s, l)),
      ...
      (p.tspan = !1),
      Q(p.text) ? await Kt(e, p, { startx: s, stopx: l, starty: a }) : mt(e, p));
    const f = O.width;
    let _;
    if (s === l) {
      ...
      (h.rightAngles
        ? (_ = e
            .append('path')
            .attr('d', `M  ${A},${a} H ${s + P.getMax(h.width / 2, f / 2)} V ${a + 25} H ${s}`))
        : (_ = e
            .append('path')
            .attr(
              'd',
      ...
      ((_ = e.append('line')),
        ...
        _.attr('y2', a),
        $t(i, r) && ve(e, i, t, r, s, l, a));
    (c === r.db.LINETYPE.DOTTED ||
    c === r.db.LINETYPE.DOTTED_CROSS ||
    c === r.db.LINETYPE.DOTTED_POINT ||
    c === r.db.LINETYPE.DOTTED_OPEN ||
    c === r.db.LINETYPE.BIDIRECTIONAL_DOTTED ||
    c === r.db.LINETYPE.SOLID_TOP_DOTTED ||
    c === r.db.LINETYPE.SOLID_BOTTOM_DOTTED ||
    c === r.db.LINETYPE.STICK_TOP_DOTTED ||
    c === r.db.LINETYPE.STICK_BOTTOM_DOTTED ||
    ...
    if (
      ...
      _.attr('stroke', 'none'),
      _.style('fill', 'none'),
      (c === r.db.LINETYPE.SOLID_TOP || c === r.db.LINETYPE.SOLID_TOP_DOTTED) &&
        _.attr('marker-end', 'url(' + I + '#' + n + '-solidTopArrowHead)'),
      (c === r.db.LINETYPE.SOLID_BOTTOM || c === r.db.LINETYPE.SOLID_BOTTOM_DOTTED) &&
        _.attr('marker-end', 'url(' + I + '#' + n + '-solidBottomArrowHead)'),
      (c === r.db.LINETYPE.STICK_TOP || c === r.db.LINETYPE.STICK_TOP_DOTTED) &&
        _.attr('marker-end', 'url(' + I + '#' + n + '-stickTopArrowHead)'),
      (c === r.db.LINETYPE.STICK_BOTTOM || c === r.db.LINETYPE.STICK_BOTTOM_DOTTED) &&
        _.attr('marker-end', 'url(' + I + '#' + n + '-stickBottomArrowHead)'),
      (c === r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE ||
        c === r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE_DOTTED) &&
        _.attr('marker-start', 'url(' + I + '#' + n + '-solidBottomArrowHead)'),
      (c === r.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE ||
        c === r.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE_DOTTED) &&
        _.attr('marker-start', 'url(' + I + '#' + n + '-solidTopArrowHead)'),
      (c === r.db.LINETYPE.STICK_ARROW_TOP_REVERSE ||
        c === r.db.LINETYPE.STICK_ARROW_TOP_REVERSE_DOTTED) &&
        _.attr('marker-start', 'url(' + I + '#' + n + '-stickBottomArrowHead)'),
      (c === r.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE ||
        c === r.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE_DOTTED) &&
        _.attr('marker-start', 'url(' + I + '#' + n + '-stickTopArrowHead)'),
      (c === r.db.LINETYPE.SOLID || c === r.db.LINETYPE.DOTTED) &&
        _.attr('marker-end', 'url(' + I + '#' + n + '-arrowhead)'),
      (c === r.db.LINETYPE.BIDIRECTIONAL_SOLID || c === r.db.LINETYPE.BIDIRECTIONAL_DOTTED) &&
        (_.attr('marker-start', 'url(' + I + '#' + n + '-arrowhead)'),
        _.attr('marker-end', 'url(' + I + '#' + n + '-arrowhead)')),
      (c === r.db.LINETYPE.SOLID_POINT || c === r.db.LINETYPE.DOTTED_POINT) &&
        _.attr('marker-end', 'url(' + I + '#' + n + '-filled-head)'),
      (c === r.db.LINETYPE.SOLID_CROSS || c === r.db.LINETYPE.DOTTED_CROSS) &&
        _.attr('marker-end', 'url(' + I + '#' + n + '-crosshead)'),
      u || h.showSequenceNumbers)
    ) {
      const L = c === r.db.LINETYPE.BIDIRECTIONAL_SOLID || c === r.db.LINETYPE.BIDIRECTIONAL_DOTTED,
        b =
          c === r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE ||
          c === r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE_DOTTED ||
          c === r.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE ||
      ...
      L
        ? (s < l
            ...
            : ((N = s - S + (A ? -5 : 0)),
              (N +=
                i?.centralConnection === r.db.LINETYPE.CENTRAL_CONNECTION_DUAL ||
                i?.centralConnection === r.db.LINETYPE.CENTRAL_CONNECTION_REVERSE
                  ? -7.5
                  : 0)),
          _.attr('x1', N))
        : b
      ...
      q
        ? (V = t.fromBounds + 1)
        : b
          ? (V = U ? t.toBounds - 1 : t.fromBounds + 1)
          : (V = U ? t.fromBounds + 1 : t.toBounds - 1);
      let G = '12px';
  ...
  ee = g(async function (e, t, a, r, i, n, s) {
    if (r) {
      ...
      for (const E of a) {
        ...
        const c = await F.drawActor(e, d, h, !0, i, n, s);
        l = P.getMax(l, c);
      }
  ...
  He = g(function (e, t, a, r) {
    let i = 0,
      n = 0;
    for (const s of a) {
      const l = t.get(s),
        E = ra(l),
        d = F.drawPopup(e, l, E, h, h.forceMenus, r);
...
function ht(e, t, a, r, i) {
  ...
  if (t.id && t.message && e[t.id]) {
    const s = e[t.id].width,
      l = Rt(h);
    ((t.message = Z.wrapLabel(`[${t.message}]`, s - 2 * h.wrapPadding, l)),
      (t.width = s),
      (t.wrap = !0));
    const E = Z.calculateTextDimensions(t.message, l),
...
function Ue(e, t, a, r, i, n, s) {
  function l(c, x) {
    c.x < i.get(e.from).x
      ? (R.insert(t.stopx - x, t.starty, t.startx, t.stopy + c.height / 2 + h.noteMargin),
        (t.stopx = t.stopx + x))
      : (R.insert(t.startx, t.starty, t.stopx + x, t.stopy + c.height / 2 + h.noteMargin),
        (t.stopx = t.stopx - x));
  }
  g(l, 'receiverAdjustment');
  function E(c, x) {
    c.x < i.get(e.to).x
      ? (R.insert(t.startx - x, t.starty, t.stopx, t.stopy + c.height / 2 + h.noteMargin),
        (t.startx = t.startx + x))
      : (R.insert(t.stopx, t.starty, t.startx + x, t.stopy + c.height / 2 + h.noteMargin),
        (t.startx = t.startx - x));
  }
  ...
  if (n.get(e.to) == r) {
    const c = i.get(e.to),
      x = d.includes(c.type) ? It / 2 + 3 : c.width / 2 + 3;
...
var ea = g(async function (e, t, a, r) {
  ...
  let l;
  i === 'sandbox' && (l = Vt('#i' + t));
  const E = i === 'sandbox' ? Vt(l.nodes()[0].contentDocument.body) : Vt('body'),
    d = i === 'sandbox' ? l.nodes()[0].contentDocument : document;
  (R.init(), at.debug(r.db));
  const c = i === 'sandbox' ? E.select(`[id="${t}"]`) : Vt(`[id="${t}"]`),
    x = r.db.getActors(),
  ...
  const _ = r.db.getMessages(),
    ...
    S = await Ge(x, _, r);
  if (
    ((h.height = await Xe(x, S, p)),
    F.insertComputerIcon(c, t),
    F.insertDatabaseIcon(c, t),
    F.insertClockIcon(c, t),
  ...
  const A = new Map(f.map((m, D) => [x.get(m)?.name ?? m, D]));
  ta(c, x, u, f, 0, _, !1);
  const N = await ca(_, x, S, r);
  (F.insertArrowHead(c, t),
    F.insertArrowCrossHead(c, t),
    F.insertArrowFilledHead(c, t),
    F.insertSequenceNumber(c, t),
    F.insertSolidTopArrowHead(c, t),
    F.insertSolidBottomArrowHead(c, t),
    F.insertStickTopArrowHead(c, t),
    F.insertStickBottomArrowHead(c, t),
    s === 'neo' && F.insertDropShadow(c, h));
  function B(m, D) {
    const lt = R.endActivation(m);
    (lt.starty + 18 > D && ((lt.starty = D - 6), (D += 12)),
      F.drawActivation(c, lt, D, h, Ht(m.from).length, r, A),
  ...
  for (const m of _) {
    ...
    switch (m.type) {
      ...
      case r.db.LINETYPE.LOOP_START:
        ht(N, m, h.boxMargin, h.boxMargin + h.boxTextMargin, (W) => R.newLoop(W));
        break;
      case r.db.LINETYPE.LOOP_END:
        ((D = R.endLoop()),
          await F.drawLoop(c, D, 'loop', h, m),
          R.bumpVerticalPos(D.stopy - R.getVerticalPos()),
          R.models.addLoop(D));
        break;
      case r.db.LINETYPE.RECT_START:
        ht(N, m, h.boxMargin, h.boxMargin, (W) => R.newLoop(void 0, W.message));
        break;
      ...
      case r.db.LINETYPE.ALT_ELSE:
        ht(N, m, h.boxMargin + h.boxTextMargin, h.boxMargin, (W) => R.addSectionToLoop(W));
        break;
      case r.db.LINETYPE.ALT_END:
        ((D = R.endLoop()),
          await F.drawLoop(c, D, 'alt', h, m),
          R.bumpVerticalPos(D.stopy - R.getVerticalPos()),
          R.models.addLoop(D));
        break;
      ...
      case r.db.LINETYPE.AUTONUMBER:
        ((V = m.message.start || V),
          (q = m.message.step || q),
          m.message.visible ? r.db.enableSequenceNumbers() : r.db.disableSequenceNumbers());
        break;
      ...
      case r.db.LINETYPE.CRITICAL_END:
        ((D = R.endLoop()),
          await F.drawLoop(c, D, 'critical', h, m),
          R.bumpVerticalPos(D.stopy - R.getVerticalPos()),
          R.models.addLoop(D));
        break;
      ...
      case r.db.LINETYPE.BREAK_END:
        ((D = R.endLoop()),
          await F.drawLoop(c, D, 'break', h, m),
          R.bumpVerticalPos(D.stopy - R.getVerticalPos()),
          R.models.addLoop(D));
        break;
      default:
        try {
          ((et = m.msgModel),
            (et.starty = R.getVerticalPos()),
            (et.sequenceIndex = V),
            (et.sequenceVisible = r.db.showSequenceNumbers()),
            (et.id = m.id),
            (et.from = m.from),
            (et.to = m.to));
          const W = await qe(c, et);
          (Ue(m, et, W, X, x, u, O),
            U.push({ messageModel: et, lineStartY: W, msg: m }),
            R.models.addMessage(et));
        } catch (W) {
    ...
    ].includes(m.type) && (V = Math.round((V + q) * 100) / 100),
      X++);
  }
  (at.debug('createdActors', u), at.debug('destroyedActors', O), await ee(c, x, f, !1, t, r, A));
  for (const m of U) await jr(c, m.messageModel, m.lineStartY, r, m.msg, t);
  (h.mirrorActors && (await ee(c, x, f, !0, t, r, A)),
    G.forEach((m) => F.drawBackgroundRect(c, m)),
    We(c, x, f, h));
  for (const m of R.models.boxes) {
    ...
    ((m.startx = m.x - D),
      (m.starty = m.y - D * 0.25),
      (m.stopx = m.startx + m.width + 2 * D),
      (m.stopy = m.starty + m.height + D * 0.75),
      (m.stroke = 'rgb(0,0,0, 0.5)'),
      F.drawBox(c, m, h));
  }
  L && R.bumpVerticalPos(h.boxMargin);
  const j = He(c, x, f, d),
    { bounds: H } = R.getBounds();
  (H.startx === void 0 && (H.startx = 0),
    H.starty === void 0 && (H.starty = 0),
    H.stopx === void 0 && (H.stopx = 0),
    H.stopy === void 0 && (H.stopy = 0));
  ...
  (I &&
    c
      .append('text')
      .text(I)
      .attr('x', (H.stopx - H.startx) / 2 - 2 * h.diagramMarginX)
      .attr('y', -25),
    rr(c, tt, Y, h.useMaxWidth));
  const C = I ? 40 : 0,
  ...
  for (const i of t)
    if (e.get(i.to) && e.get(i.from)) {
      ...
      const s = i.placement !== void 0,
        ...
        x =
          (Q(d) ? await Nt(i.message, $()) : Z.calculateTextDimensions(d, E)).width +
          2 * h.wrapPadding;
      l && i.from === n.nextActor
        ? (r[i.to] = P.getMax(r[i.to] || 0, x))
        : l && i.from === n.prevActor
...
async function Xe(e, t, a) {
  ...
  for (const n of e.keys()) {
    ...
    const l = Q(s.description)
      ? await Nt(s.description, $())
      : Z.calculateTextDimensions(s.description, te(h));
    ((s.width = s.wrap ? h.width : P.getMax(h.width, l.width + 2 * h.wrapPadding)),
      (s.height = s.wrap ? P.getMax(l.height, h.height) : h.height),
  ...
  return (
    a.forEach((n) => {
      ...
      ((l += E),
        (l -= 2 * h.boxTextMargin),
        n.wrap && (n.name = Z.wrapLabel(n.name, l - 2 * h.wrapPadding, s)));
...
var aa = g(async function (e, t, a) {
    ...
    let E = Q(e.message)
      ? await Nt(e.message, $())
      : Z.calculateTextDimensions(l ? Z.wrapLabel(e.message, h.width, Lt(h)) : e.message, Lt(h));
    const d = {
    ...
    return (
      ...
      l && (d.message = Z.wrapLabel(e.message, d.width - 2 * h.wrapPadding, Lt(h))),
      at.debug(
  ...
  ia = g(function (e, t, a) {
    ...
    let l = 0;
    return (
      (e.centralConnection === r || e.centralConnection === i) && (l += sa),
  ...
  Je = g(function (e, t) {
    ...
    return [a, r, i, n, s, l, E, d].includes(e.type);
  }, 'isReverseArrowType'),
  na = g(function (e, t) {
    ...
    for (const d of e) {
        ...
        case r.db.LINETYPE.ACTIVE_START:
          {
            const x = t.get(d.from ? d.from : d.to.actor),
              u = Ht(d.from ? d.from : d.to.actor).length,
      ...
      d.placement !== void 0
        ? ((l = await aa(d, t, r)),
          ...
          n.forEach((x) => {
            ((s = x),
              (s.from = P.getMin(s.from, l.startx)),
              (s.to = P.getMax(s.to, l.startx + l.width)),
  ...
  la = { bounds: R, drawActors: ee, drawActorsPopup: He, setConf: ze, draw: ea },
  fa = {
    parser: _r,
    get db() {
      return new yr();
