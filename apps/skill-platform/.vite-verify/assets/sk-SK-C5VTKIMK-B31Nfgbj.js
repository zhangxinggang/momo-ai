...
var e = {
    ...
    lineEditor: { edit: 'Upraviť čiaru', exit: 'Ukončiť editovanie čiary' },
    elementLock: {
      lock: 'Zamknúť',
      unlock: 'Odomknúť',
  ...
  o = {
    ...
    hint_emptyLibrary:
      'Vyberte položku z plátna pre jej pridanie do knižnice alebo použite knižnicu z verejného zoznamu knižníc nižšie.',
  ...
  n = {
    ...
    couldNotCreateShareableLinkTooBig:
      'Nepodarilo sa vytvoriť odkaz na zdieľanie: scéna je príliš veľká',
    ...
    uploadedSecurly:
      'Nahratie je zabezpečené end-to-end šifrovaním, takže Excalidraw server a tretie strany nedokážu prečítať jeho obsah.',
    loadSceneOverridePrompt:
      'Nahratie externej kresby nahradí existujúci obsah. Prajete si pokračovať?',
...
(Ak si chcete ponechať lokálnu scénu, jednoducho iba zavrite kartu prehliadača.)`,
    ...
    imageDoesNotContainScene:
      'Tento obrázok neobsahuje žiadne údaje scény. Zvolili ste možnosť zahrnúť scénu počas exportu?',
    cannotRestoreFromImage: 'Nepodarilo sa obnoviť scénu z tohto obrázkového súboru',
    invalidSceneUrl:
      'Nepodarilo sa načítať scénu z poskytnutej URL. Je nevalidná alebo neobsahuje žiadne validné Excalidraw JSON dáta.',
...
Vaše zmeny nebudú uložené!`,
  ...
  i = {
    ...
    cannotResolveCollabServer:
      'Nepodarilo sa pripojiť ku kolaboračnému serveru. Prosím obnovte stránku a skúste to znovu.',
    importLibraryError: 'Nepodarilo sa načítať knižnicu',
    collabSaveFailed:
      'Uloženie do databázy sa nepodarilo. Ak tento problém pretrváva uložte si váš súbor lokálne aby ste nestratili vašu prácu.',
    collabSaveFailed_sizeExceeded:
      'Uloženie do databázy sa nepodarilo, pretože veľkosť plátna je príliš veľká. Uložte si váš súbor lokálne aby ste nestratili vašu prácu.',
    imageToolNotSupported: 'Obrázky sú vypnuté.',
    brave_measure_text_error: {
      line1:
        'Vyzerá to, že používate prehliadač Brave so zapnutým nastavením pre <bold>agresívne blokovanie</bold>.',
      line2: 'To môže spôsobiť nesprávne zobrazenie <bold>textových prvkov</bold> vo vašej kresbe.',
      line3:
        'Dôrazne odporúčame vypnutie toho nastavenia. Môžete tak spraviť vykonaním <link>týchto krokov</link>.',
      line4:
        'Ak vypnutie toho nastavenia nevyrieši problém so zobrazením textových prvkov, prosím ohláste <issueLink>problém</issueLink> na našom GitHub-e alebo nám napíšte na náš <discordLink>Discord</discordLink>',
    },
  ...
  t = {
    canvasPanning:
      'Pre pohyb plátna podržte koliesko myši alebo medzerník počas ťahania, alebo použite nástroj ruka',
    ...
    resize:
      'Počas zmeny veľkosti zachováte proporcie podržaním SHIFT,\\npodržaním ALT meníte veľkosť so zachovaním stredu',
    ...
    lineEditor_info:
      'Podržte CtrlOrCmd a kliknite dva krát alebo stlačte CtrlOrCmd + Enter pre editáciu bodov',
    lineEditor_pointSelected:
      'Stačte Delete na vymazanie bodu (bodov), CtrlOrCmd+D na duplikovanie, alebo potiahnite na presunutie',
    lineEditor_nothingSelected:
      'Zvoľte bod na upravovanie (podržte SHIFT pre zvolenie viacerých bodov) alebo podržte Alt a kliknite na pridanie nového bodu',
    ...
    firefox_clipboard_write:
      'Táto sa funkcionalita sa dá zapnúť nastavením "dom.events.asyncClipboard.clipboardItem" na "true". Pre zmenu nastavení vo Firefox-e otvorte stránku "about:config".',
  ...
  x = {
    ...
    clearCanvasMessage:
      'Ak obnovenie stránky nepomáha, vyskúšajte <button>vyčistiť plátno.</button>',
    ...
    openIssueMessage:
      'Boli sme veľmi opatrní, aby informácie vašej scény neboli v chybe zaznamenané. Ak vaša scéna nie je súkromná, prosím zvážte pokračovanie na naše <button>hlásenie chýb.</button> Prosím zahrňte informácie nižšie pomocou kopírovania a prilepenia do GitHub issue.',
    sceneContent: 'Obsah scény:',
  },
  s = {
    desc_intro: 'Pozvite niekoho do svojej aktuálnej scény a pracujte spoločne.',
    desc_privacy:
      'Nemajte obavy, schôdza používa end-to-end šifrovanie, takže všetko čo nakreslíte je súkromné. Dokonca, ani náš server dedokáže prečítať, čo ste vytvorili.',
    ...
    desc_exitSession:
      'Ukončenie schôdze vás odpojí z miestnosti, avšak naďalej budete môcť pokračovať v práci na scéne lokálne. Toto neovplyvní ostatných spolupracovníkov a stále budú môcť spolupracovať na ich verzii.',
  ...
  k = {
    ...
    placeholder: {
      ...
      githubHandle:
        'GitHub užívateľské meno (nepovinné), aby ste mohli robiť úpravy po tom, čo bude knižnica uverejnená na schválenie',
      twitterHandle:
        'Twitter užívateľské meno (nepovinné), aby sme vedeli komu pripísať zásluhu pri propagovaní cez Twitter',
      website: 'Odkaz na vašu osobnú webovú stránku alebo niekam inam (nepovinné)',
    },
    errors: { required: 'Povinné', website: 'Zadajte platnú adresu URL' },
    noteDescription:
      'Uverejnite vašu knižnicu vo <link>verejnom zozname knižníc</link>aby ju aj ostatní mohli použiť v ich náčrtoch.',
    noteGuidelines:
      'Knižnica musí byť najprv manuálne schválená. Prosím prečítajte si <link>pokyny</link> pred uverejnením. Budete potrebovať Github účet na komunikáciu a vykonanie zmien, ak budú potrebné, avšak nie je to úplne povinné.',
    noteLicense:
      'Potvrdením súhlasíte, že knižnica bude zverejnená s <link>MIT licenciou, </link>čo v skratke znamená, že ju môže použiť hocikto bez obmedzení.',
    noteItems:
      'Každá položka v knižnici musí mať svoje vlastné meno, aby sa dala vyhľadať. Súčasťou knižnice budú nasledujúce položky:',
    atleastOneLibItem: 'Začnite prosím zvolením aspoň jednej položky z knižnice',
    republishWarning:
      'Poznámka: Niektoré z vybraných položiek sú už označené ako zverejnené. Ich znovu uverejnenie by ste mali vykovať iba vtedy ak aktualizujete už existujúcu knižnicu alebo požiadavku na uverejnenie.',
  },
  c = {
    title: 'Knižnica uverejnená',
    content:
      'Ďakujeme vám {{authorName}}. Vaša knižnica bola uverejnená na posúdenie. Stav môžete skontrolovať<link>tu</link>',
  },
  b = {
    resetLibrary: 'Obnoviť knižnicu',
...
Bude to mať za následok zvýšenie veľkosti súboru.`,
    ...
    button: { exportToPng: 'PNG', exportToSvg: 'SVG', copyPngToClipboard: 'Kopírovať do schránky' },
  },
  D = {
    tooltip:
      'Vaše kresby používajú end-to-end šifrovanie, takže ich Excalidraw server nedokáže prečítať.',
...
({{exportColorScheme}})`,
    ...
    pasteAsSingleElement:
      'Použitím {{shortcut}} vložte ako samostatný prvok alebo vložte do existujúceho editovaného textu',
    unableToEmbed:
      'Zapustenie tejto URL nie je povolené. Vytvorte issue na GitHub-e a požiadajte povolenie tejto URL',
    unrecognizedLinkFormat:
      "Odkaz, ktorý sa snažíte zapustiť nie je v očakávanom formáte. Prosím skúste vložiť 'odkaz na zdieľanie' poskytnutý zdrojovou webovou stránkou",
  },
  F = {
  ...
  g = {
    ...
    modal: {
      loadFromFile: {
        ...
        description:
          'Načítanie zo súboru <bold>nahradí váš existujúci obsah</bold>.<br></br>Vašu kresbu môžete zálohovať jednou z nižšie uvedených možností.',
      },
      shareableLink: {
        title: 'Načítať z odkazu',
        button: 'Nahradiť môj obsah',
        description:
          'Načítanie externej kresby <bold>nahradí váš existujúci obsah</bold>.<br></br>Vašu kresbu môžete zálohovať jednou z nižšie uvedených možností.',
      },
    },
  },
  A = {
    ...
    button: 'Vložiť',
    description:
      'Aktuálne sú podporované iba <flowchartLink>vývojové diagramy</flowchartLink>, <sequenceLink>sekvenčné diagramy</sequenceLink> a <classLink>diagramy tried</classLink>. Ostatné typy budú v Excalidraw vykreslené ako obrázky.',
