...
var e = {
    ...
    elementLock: { lock: 'Lås', unlock: 'Lås upp', lockAll: 'Lås alla', unlockAll: 'Lås upp alla' },
  ...
  a = {
    ...
    hint_emptyLibrary:
      'Välj ett objekt på canvasen för att lägga till det här, eller installera ett bibliotek från det publika arkivet, nedan.',
  ...
  r = {
    ...
    uploadedSecurly:
      'Uppladdning har säkrats med kryptering från ände till ände. vilket innebär att Excalidraw server och tredje part inte kan läsa innehållet.',
    loadSceneOverridePrompt:
      'Laddning av extern skiss kommer att ersätta ditt befintliga innehåll. Vill du fortsätta?',
...
(Om du vill behålla din lokala skiss, stäng bara webbläsarfliken istället.)`,
    ...
    confirmAddLibrary:
      'Detta kommer att lägga till {{numShapes}} form(er) till ditt bibliotek. Är du säker?',
    imageDoesNotContainScene:
      'Den här bilden verkar inte innehålla någon skissdata. Har du aktiverat inbäddning av skiss under export?',
    cannotRestoreFromImage: 'Skiss kunde inte återställas från denna bildfil',
    invalidSceneUrl:
      'Det gick inte att importera skiss från den angivna webbadressen. Antingen har den fel format, eller så innehåller den ingen giltig Excalidraw JSON data.',
...
Dina ändringar kommer inte att sparas!`,
  ...
  i = {
    ...
    cannotResolveCollabServer:
      'Det gick inte att ansluta till samarbets-servern. Ladda om sidan och försök igen.',
    importLibraryError: 'Kunde inte ladda bibliotek',
    collabSaveFailed:
      'Det gick inte att spara i backend-databasen. Om problemen kvarstår bör du spara filen lokalt för att se till att du inte förlorar ditt arbete.',
    collabSaveFailed_sizeExceeded:
      'Det gick inte att spara till backend-databasen, whiteboarden verkar vara för stor. Du bör spara filen lokalt för att du inte ska förlora ditt arbete.',
    imageToolNotSupported: 'Bilder är inaktiverade.',
    brave_measure_text_error: {
      line1:
        'Det ser ut som om du använder Brave-webbläsaren med <bold>Aggressivt Blockera fingeravtryck</bold> inställningen aktiverad.',
      line2: 'Detta kan resultera i trasiga <bold>Textelement</bold> i dina ritningar.',
      line3:
        'Vi rekommenderar starkt att du inaktiverar den här inställningen. Du kan följa <link>dessa steg</link> för att inaktivera den.',
      line4:
        'Om inaktivering av denna inställning inte åtgärdar visningen av textelement, öppna ett <issueLink>ärende</issueLink> på vår GitHub, eller skriv till oss på <discordLink>Discord</discordLink>',
    },
  ...
  o = {
    canvasPanning:
      'För att flytta whiteboarden, håll mushjulet eller mellanslagstangenten medan du drar eller använd handverktyget',
...
håll ALT för att ändra storlek från mitten`,
    ...
    lineEditor_info:
      'Håll Ctrl/Cmd och dubbelklicka eller tryck på Ctrl/Cmd + Enter för att redigera punkter',
    lineEditor_pointSelected:
      'Tryck på Ta bort för att ta bort punkt(er), Ctrl + D eller Cmd + D för att duplicera, eller dra för att flytta',
...
eller håll ned Alt och klicka för att lägga till nya punkter`,
    placeImage:
      'Klicka för att placera bilden, eller klicka och dra för att ställa in dess storlek manuellt',
    ...
    firefox_clipboard_write:
      'Denna funktion kan sannolikt aktiveras genom att ställa in "dom.events.asyncClipboard.clipboardItem" flaggan till "true". För att ändra webbläsarens flaggor i Firefox, besök "about:config" sidan.',
  ...
  d = {
    ...
    openIssueMessage:
      'Vi var mycket försiktiga med att inte inkludera din skissinformation om felet. Om din skiss inte är privat, vänligen överväga att följa upp på vår <button>buggspårare.</button> Vänligen inkludera information nedan genom att kopiera och klistra in i GitHub-problemet.',
    sceneContent: 'Skissinnehåll:',
  },
  x = {
    desc_intro: 'Du kan bjuda in personer till din nuvarande skiss för att samarbeta med dig.',
    desc_privacy:
      'Oroa dig inte, sessionen använder kryptering från ände till ände, så vad du än ritar kommer att förbli privat. Inte ens vår server kommer att kunna se vad du skissar.',
    ...
    desc_exitSession:
      'Att avbryta sessionen kommer att koppla bort dig från rummet, men du kommer att kunna fortsätta arbeta med skissen, lokalt. Observera att detta inte påverkar andra människor, och de kommer fortfarande att kunna samarbeta på deras version.',
  ...
  b = {
    ...
    placeholder: {
      ...
      libraryDesc:
        'Beskrivning av ditt bibliotek för att hjälpa människor att förstå dess användning',
      githubHandle:
        'Github-användarnamn (valfritt), så att du kan redigera biblioteket när du har skickat in det för granskning',
      twitterHandle:
        'Twitter-användarnamn (valfritt), så vi vet vem att kreditera när du marknadsför på Twitter',
    ...
    noteDescription:
      'Skicka ditt bibliotek för att inkluderas i <link>det offentliga bibliotekets arkiv</link>för andra människor att använda i sina skisser.',
    noteGuidelines:
      'Biblioteket måste godkännas manuellt först. Vänligen läs <link>riktlinjerna</link> innan du skickar in. Du behöver ett GitHub-konto för att kommunicera och göra ändringar om så önskas, men det krävs inte.',
    noteLicense:
      'Genom att skicka in godkänner du att biblioteket kommer att publiceras under <link>MIT-licens, </link>vilket kort sagt betyder att vem som helst kan använda det utan restriktioner.',
    noteItems:
      'Varje objekt måste ha sitt eget namn så att det är filtrerbart. Följande objekt kommer att inkluderas:',
    atleastOneLibItem: 'Välj minst ett biblioteksobjekt för att komma igång',
    republishWarning:
      'Obs: några av de markerade objekten är redan markerade som publicerade/skickade. Du bör endast skicka objekt igen när du uppdaterar ett befintligt bibliotek eller inlämning.',
  },
  p = {
    title: 'Bibliotek inskickat',
    content:
      'Tack {{authorName}}. Ditt bibliotek har skickats för granskning. Du kan följa status<link>här</link>',
  },
  c = {
    resetLibrary: 'Återställ bibliotek',
...
Kommer att öka exporterad filstorlek.`,
    ...
    button: { exportToPng: 'PNG', exportToSvg: 'SVG', copyPngToClipboard: 'Kopiera till urklipp' },
  },
  v = {
    tooltip:
      'Dina skisser är krypterade från ände till ände så Excalidraws servrar kommer aldrig att se dem.',
...
eller klistra in i en befintlig textredigerare`,
    unableToEmbed:
      'Att bädda in denna webbadress är för närvarande inte tillåtet. Skapa en problemrapport på GitHub för att begära att webbadressen vitlistas.',
    unrecognizedLinkFormat:
      "Länken du bäddade in matchar inte det förväntade formatet. Försök klistra in 'embed'-strängen som tillhandahålls av källwebbplatsen",
  },
  h = {
  ...
  w = {
    ...
    modal: {
      loadFromFile: {
        ...
        description:
          'Laddar från en fil kommer <bold>ersätta ditt befintliga innehåll</bold>.<br></br>Du kan säkerhetskopiera din ritning först med hjälp av ett av alternativen nedan.',
      },
      shareableLink: {
        title: 'Läs in från länk',
        button: 'Ersätt mitt innehåll',
        description:
          'Inläsning av en extern ritning kommer <bold>ersätta ditt befintliga innehåll</bold>.<br></br>Du kan säkerhetskopiera din ritning först genom att använda ett av alternativen nedan.',
      },
    },
  },
  T = {
    ...
    button: 'Infoga',
    description:
      'För närvarande stöds endast <flowchartLink>Flödesdiagram</flowchartLink>,<sequenceLink> Sekvensdiagram </sequenceLink> och <classLink>Klassdiagram</classLink>. De andra typerna kommer att återges som bild i Excalidraw.',
