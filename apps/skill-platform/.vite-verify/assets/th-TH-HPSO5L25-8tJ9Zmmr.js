...
var u = {
    ...
    lineEditor: { edit: 'แก้ไขเส้น', exit: '' },
    elementLock: {
      lock: 'ล็อก',
      unlock: 'ปลดล็อก',
      lockAll: 'ล็อกทั้งหมด',
  ...
  t = { canvasActions: '', selectedShapeActions: '', shapes: 'รูปร่าง' },
  i = {
    canvasPanning: '',
    linearElement: '',
    freeDraw: '',
...
กด Ctrl หรือ Cmd + D เพื่อทำซ้ำหรือลากเพื่อเคลื่อนย้าย`,
  ...
  m = { title: '', content: '' },
  p = { resetLibrary: '', removeItemsFromLib: '' },
  g = {
    header: '',
    label: {
      withBackground: '',
    ...
    button: { exportToPng: 'PNG', exportToSvg: 'SVG', copyPngToClipboard: 'คัดลอกไปยังคลิปบอร์ด' },
  },
  b = { tooltip: '', link: '' },
  C = {
    angle: '',
