...
var e = {
    ...
    lineEditor: { edit: 'Çizgiyi düzenle', exit: 'Çizgi düzenlemeden çık' },
    elementLock: {
      lock: 'Kilitle',
  ...
  a = {
    ...
    hint_emptyLibrary:
      'Öğelerden birini eklemek için öğeyi seçiniz veya aşağıdaki genel kütüphaneden öğeleri ekleyin.',
  ...
  u = {
    ...
    uploadedSecurly:
      'Yükleme uçtan uca şifreleme ile korunmaktadır. Excalidraw sunucusu ve üçüncül şahıslar içeriği okuyamayacaktır.',
    loadSceneOverridePrompt:
      'Harici çizimler yüklemek mevcut olan içeriği değiştirecektir. Devam etmek istiyor musunuz?',
...
(Yerel çiziminizi kaybetmemek için tarayıcı sekmesini kapatabilirsiniz.)`,
    ...
    imageDoesNotContainScene:
      'Bu görüntü herhangi bir sahne verisi içermiyor gibi görünüyor. Dışa aktarma sırasında sahne yerleştirmeyi etkinleştirdiniz mi?',
    cannotRestoreFromImage: 'Sahne bu resim dosyasından geri yüklenemedi',
    invalidSceneUrl:
      'Verilen bağlantıdan çalışma alanı yüklenemedi. Dosya bozuk olabilir veya geçerli bir Excalidraw JSON verisi bulundurmuyor olabilir.',
  ...
  l = {
    ...
    cannotResolveCollabServer:
      'İş birliği sunucusuna bağlanılamıyor. Lütfen sayfayı yenileyip tekrar deneyin.',
    importLibraryError: 'Kütüphane yüklenemedi',
    collabSaveFailed:
      'Backend veritabanına kaydedilemedi. Eğer problem devam ederse, çalışmanızı korumak için dosyayı yerel olarak kaydetmelisiniz.',
    collabSaveFailed_sizeExceeded:
      'Backend veritabanına kaydedilemedi; tuval çok büyük. Çalışmanızı korumak için dosyayı yerel olarak kaydetmelisiniz.',
...
merkezden yeniden boyutlandırmak için ALT tuşunu basılı tutun`,
    resizeImage:
      "SHIFT'e basılı tutarak serbestçe yeniden boyutlandırabilirsiniz, merkezden yeniden boyutlandırmak için ALT tuşunu basılı tutun",
    rotate: 'Döndürürken SHIFT tuşuna basılı tutarak açıları koruyabilirsiniz',
    lineEditor_info:
      'Puanları düzenlemek için ctrl veya cmd tuşuna basılı tutup çift tıklayın veya enter tuşuna basın',
...
veya Alt tuşunu basılı tutun ve yeni noktalar eklemek için tıklayın`,
    placeImage:
      'Resmi yerleştirmek için tıklayın ya da boyutunu manuel olarak ayarlamak için tıklayıp sürükleyin',
  ...
  d = {
    ...
    clearCanvasMessage:
      'Yenileme sonrası sorun devam ediyorsa, lütfen <button>çizim alanını temizlemeyi deneyin.</button>',
    ...
    openIssueMessage:
      'Sahne bilginizi hata mesajına yansıtmamak için oldukça dikkatli davrandık. Eğer sahneniz gizli değilse hatayı lütfen şuradan takip edin <button>hata takibi.</button> Lütfen aşağıya GitHub sorununa kopyalayarak ve yapıştırarak bilgi ekleyin.',
    sceneContent: 'Sahne içeriği:',
  },
  s = {
    desc_intro:
      'Çalışma alanınıza, sizinle birlikte çalışabilmeleri için başkalarını da ekleyebilirsiniz.',
    desc_privacy:
      'Çalışma ortamında yaptıklarınız ve çizimleriniz uçtan uca şifrelemeyle saklanmaktadır. Sunucularımız dahi bu verileri şifrelenmemiş haliyle göremez.',
    ...
    desc_exitSession:
      'Çalışma ortamını kapattığınızda ortak çalışmadan ayrılmış olursunuz ancak kendi versiyonunuzda çalışmaya devam edebilirsiniz. Bu durumda ortak çalıştığınız diğer kişiler etkilenmeyecek, çalışma ortamındaki versiyon üzerinden çalışmaya devam edebilecekler.',
  ...
  y = {
    ...
    placeholder: {
      ...
      libraryDesc:
        'İnsanların kullanımını anlamasına yardımcı olmak için kitaplığınızın açıklaması',
      githubHandle:
        'Github bağlantısı ( tercihe bağlı), kütüphane gözden geçirme için onaylandığında düzenleyebiliesiniz diye',
      twitterHandle:
        'Twitter kullanıcı adı ( tercihe bağlı), bu sayede Twitter üzerinde paylaşıren çalışmanızı size atfedebiliriz',
      website: 'Kişisel web sayfanızı ya da başka bir yeri bağlayın (tercihe bağlı)',
    },
    errors: { required: 'Gerekli', website: 'Geçerli bir URL girin' },
    noteDescription:
      'Submit your library to be included in the <link>genel kütüphane reposu</link>diğer insanlar çizimlerinde kullanabilsin diye.',
    noteGuidelines:
      'Önce kütüphane elle onaylanmalı. şunu okuyun <link>yönergeler</link> onaylamadan önce. gerekli olması halinde iletişim kurmak için ve değişiklik için Github hesabı gerekli, ama çok da illaki olmalı değil.',
    noteLicense:
      'Bunu onaylayarak, kütüğhanenin şu lisansla yayınlanmasını onaylıyorsunuz <link>MIT Lisans, </link>ki bu kısaca herkesin onu kısıtlama olmaksızın kullanabileceği anlamına gelmektedir.',
    noteItems:
      'Her kütüphane kendi ismine sahip olmalı ki tarama yapabilelim. Şu kütüphane ögeleri dahil edilecek:',
    atleastOneLibItem: 'Lütfen başlamak için en az bir tane kütüphane ögesi seçin',
    republishWarning:
      'Not: seçilen ögelerden bir kısmı zaten yayınlanmış/gönderilmiş. Yalnızca mevcut kütüphane ve gönderileri güncellerken yeniden gönderme işlemi yapmalısınız.',
  },
  c = {
    title: 'Kütüphane gönderildi',
    content:
      'Teşekkürler {{authorName}}. Kütüphaneniz gözden geçirme için alındı. Durumu takip edebilirsiniz<link>burada</link>',
  },
  b = {
    resetLibrary: 'Kütüphaneyi sıfırla',
  ...
  p = {
    ...
    tooltip: {
      embedScene:
        'Sahne verisi, sahnenin geri yüklenebilmesi için dışarı aktarılan PNG/SVG dosyasına kaydedilecektir. Bu, dışa aktarılan dosya boyutunu arttıracaktır.',
    },
    title: {
    ...
    button: { exportToPng: 'PNG', exportToSvg: 'SVG', copyPngToClipboard: 'Panoya kopyala' },
  },
  E = {
...
({{exportColorScheme}}) kopyalandı`,
    ...
    pasteAsSingleElement:
      'Tekil obje olarak yapıştırmak için veya var olan bir metin editörüne yapıştırmak için {{shortcut}} kullanın',
    unableToEmbed: '',
