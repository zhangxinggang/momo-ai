...
var u = {
    ...
    lineEditor: { edit: 'Редагувати лінію', exit: 'Закінчити редагування лінії' },
    elementLock: {
      lock: 'Блокувати',
      unlock: 'Розблокувати',
  ...
  E = {
    ...
    hint_emptyLibrary:
      "Виберіть об'єкт на полотні, щоб додати його сюди або встановіть бібліотеку з публічного репозиторію, що нижче.",
  ...
  e = {
    ...
    couldNotCreateShareableLinkTooBig:
      'Не вдалося створити посилання для обміну: сцена занадто велика',
    ...
    uploadedSecurly:
      'Це завантаження було захищене наскрізним шифруванням, а це означає що сервер Excalidraw та інші не зможуть прочитати вміст.',
    loadSceneOverridePrompt:
      'Завантаження зовнішнього креслення замінить ваш наявний контент. Продовжити?',
...
(Якщо ви хочете зберегти локальний малюнок, просто закрийте замість нього вкладку браузера.)`,
    ...
    confirmAddLibrary:
      'Це призведе до додавання {{numShapes}} фігур до вашої бібліотеки. Ви впевнені?',
    imageDoesNotContainScene:
      'Виглядає ніби зображення не містить корисної інформації. Ви увімкнули вбудовування сцени при експорті?',
    cannotRestoreFromImage: 'Сцена не може бути відновлена з цього файлу зображення',
    invalidSceneUrl:
      'Не вдалося імпортувати сцену з наданого URL. Він або недоформований, або не містить дійсних даних Excalidraw JSON.',
    ...
    invalidEncryptionKey:
      'Ключ шифрування повинен бути довжиною до 22 символів. Спільну роботу вимкнено.',
...
Ваші зміни не будуть збережені!`,
  ...
  F = {
    ...
    cannotResolveCollabServer:
      'Не вдалося приєднатися до сервера. Перезавантажте сторінку та повторіть спробу.',
    importLibraryError: 'Не вдалося завантажити бібліотеку',
    collabSaveFailed:
      'Не вдалося зберегти у базу даних сервера. Якщо проблеми не зникнуть, Вам слід зберегти файл локально, щоб не втратити роботу.',
    collabSaveFailed_sizeExceeded:
      'Полотно завелике! Не вдалося зберегти у базу даних сервера. Вам слід зберегти файл локально, щоб не втратити свою роботу.',
    imageToolNotSupported: '',
    brave_measure_text_error: {
      line1:
        'Ви використовуєте браузер Brave з увімкненим налаштуванням <bold>Агресивного Блокування Розпізнавання Пристрою</bold>.',
      line2: 'Це може нашкодити <bold>текстовим елементам</bold> у ваших малюнках.',
      line3:
        'Ми наполегливо рекомендуємо вимкнути це налаштування. Виконайте наступні <link>кроки</link>, щоб виправити це.',
      line4:
        "Якщо вимкнення цього параметра не вирішує показ текстових елементів, тоді створіть, будь ласка, <issueLink>запит на розв'язання проблеми</issueLink> на нашому GitHub або напишіть нам у <discordLink>Discord</discordLink>",
    },
  ...
  o = {
    canvasPanning:
      'Щоб перемістити полотно, утримуйте коліщатко миші або пробіл під час перетягування, або скористайтеся інструментом Рука',
...
утримуйте ALT для змінення розміру від центру`,
    resizeImage:
      'Ви можете змінювати розміри утримуючи клавішу SHIFT, втримуйте клавішу ALT щоб змінювати розмір відносно центру',
    rotate: 'Ви можете обмежити кути, утримуючи SHIFT під час обертання',
    lineEditor_info:
      'Утримуйте CtrlOrCmd і двічі клацніть або натисніть CtrlOrCmd + Enter, щоб редагувати цятки',
    lineEditor_pointSelected:
      'Натисніть Delete для видалення точку (точок), або Ctrl/Cmd+D для дублювання, перетаскування працює як звично',
    lineEditor_nothingSelected:
      'Виберіть точку для редагування (втримуйте клавішу SHIFT для вибору кількох точок), або клавішу Alt для додавання нових точок',
    placeImage:
      'Клацніть, щоб розмістити зображення, або натисніть та потягніть щоб змінити його розмір',
    ...
    firefox_clipboard_write:
      'Цю функцію можна ввімкнути, встановивши значення "true" для налаштування "dom.events.asyncClipboard.clipboardItem". Перейдіть на сторінку «about:config», щоб змінити налаштування браузера у Firefox.',
    disableSnapping: '',
  },
  t = {
  ...
  C = {
    ...
    clearCanvasMessage:
      'Якщо перезавантаження не допоможе, спробуйте <button>очистити полотно.</button>',
    ...
    openIssueMessage:
      'Ми були дуже обережні, щоб не включати інформацію про ваші сцени в текст помилки. Якщо ваша сцена не була приватна, будь ласка, розгляньте можливість продовження на нашому <button>трекер помилок.</button> Будь ласка, додайте інформацію нижче, скопіюючи і вставляючи у GitHub issue.',
    sceneContent: 'Вміст сцени:',
  },
  B = {
    desc_intro: 'Ви можете запросити людей для спільної роботи.',
    desc_privacy:
      'Не хвилюйтеся, сесія захищена наскрізним шифруванням, тому ваше креслення залишиться приватним. Навіть наш сервер не побачить вашу роботу.',
    ...
    desc_exitSession:
      'Зупинка сесії відключить вас від кімнати, але ви зможете продовжити роботу з полотном локально. Зверніть увагу, що це не вплине на інших людей, і вони все одно зможуть працювати над їх версією.',
  ...
  s = {
    ...
    placeholder: {
      ...
      githubHandle:
        "Ім'я користувача в GitHub (необов'язково), щоб ви могли редагувати бібліотеку під час перевірки",
      twitterHandle:
        "Ім'я користувача у Twitter (необов'язково), щоб ми могли згадати вас під час промоції у Twitter",
      website: 'Посилання на ваш особистий сайт або інший сайт (опціонально)',
    },
    errors: { required: 'Обов’язково', website: 'Введіть дійсну URL-адресу' },
    noteDescription:
      'Подати бібліотеку, щоб вона була включена до <link>публічного репозиторія бібліотек</link>для інших людей, для використання у їхніх полотнах.',
    noteGuidelines:
      "Спочатку бібліотека повинна бути підтверджена. Будь ласка, прочитайте <link>настанови</link> перед відправкою. Вам знадобиться обліковий запис на GitHub, щоб колаборувати та вносити зміни, але це не обов'язково.",
    noteLicense:
      'Публікуючи, ви погоджуєтеся, що бібліотека буде опублікована під <link>Ліцензія MIT, </link>, простими словами, це означає що нею зможе користуватися будь-хто без обмежень.',
    noteItems:
      "Кожен об'єкт в бібліотеці повинен мати назву, це потрібно для пошуку та фільтрування. Наступні об'єкти бібліотеки будуть включені:",
    atleastOneLibItem: 'Будь ласка, виберіть принаймні один елемент бібліотеки, щоб почати',
    republishWarning:
      'Зауважте, деякі з вибраних елементів позначені як вже опубліковані/надіслані. Ви повинні повторно надсилати елементи тільки при оновленні вже опублікованої бібліотеки чи при публікації бібліотеки.',
  },
  d = {
    title: 'Бібліотека відправлена',
    content:
      'Дякуємо, {{authorName}}. Ваша бібліотека була відправлена для розгляду. Ви можете відстежувати статус<link>тут</link>',
  },
  c = {
    resetLibrary: 'Очистити бібліотеку',
  ...
  m = {
    ...
    tooltip: {
      embedScene:
        'Дані сцени будуть збережені в експортований файл PNG/SVG. Ця сцена може бути відновлена з нього, однак це збільшить розмір експортованого файлу.',
    },
    title: {
  ...
  b = {
    tooltip:
      'Ваші креслення захищені наскрізним шифруванням — сервери Excalidraw ніколи їх не побачать.',
...
({{exportColorScheme}})`,
    ...
    pasteAsSingleElement:
      'Використайте {{shortcut}} для вставки самостійного зразка або використайте в текстовому редакторі',
    unableToEmbed:
      'Вбудування цієї url на даний час не допускається. Підніміть питання на GitHub, щоб попросити внести URL-адресу до білого списку',
    unrecognizedLinkFormat:
      'Посилання, яке ви вставили, не відповідає очікуваному формату. Будь ласка, спробуйте вставити рядок "embed", наданий сайтом-джерелом',
  },
  h = {
  ...
  x = {
    ...
    modal: {
      loadFromFile: {
        ...
        description:
          'Завантаження з файлу <bold>замінить наявний вміст</bold>.<br></br>Ви можете спочатку створити резервну копію малюнка, скориставшись одним із наведених нижче способів.',
      },
      shareableLink: {
        title: 'Завантажити з посилання',
        button: 'Замінити мій контент',
        description:
          'Завантаження зовнішнього малюнка <bold>замінить ваш наявний вміст</bold>.<br></br>Ви можете спочатку створити резервну копію малюнка, скориставшись одним із наведених нижче способів.',
      },
    },
  },
  v = { title: '', button: '', description: '', syntax: '', preview: '' },
  P = {
    labels: u,
    library: E,
    buttons: D,
