...
var u = {
    ...
    lineEditor: { edit: '编辑线条', exit: '退出线条编辑' },
    elementLock: { lock: '锁定', unlock: '解除锁定', lockAll: '全部锁定', unlockAll: '全部解锁' },
    statusPublished: '已发布',
    sidebarLock: '侧边栏常驻',
...
您的改动将不会被保存！`,
  ...
  C = { canvasActions: '画布动作', selectedShapeActions: '选定形状操作', shapes: '形状' },
  a = {
...
或按住 Alt 并点击以添加新点`,
  ...
  s = {
    ...
    errors: { required: '必填', website: '输入一个有效的URL' },
    noteDescription:
  ...
  c = { resetLibrary: '重置素材库', removeItemsFromLib: '从素材库中删除选中的项目' },
  m = {
    header: '导出图片',
    label: {
      withBackground: '背景',
...
将会增加导出文件的大小。`,
    ...
    button: { exportToPng: 'PNG', exportToSvg: 'SVG', copyPngToClipboard: '复制到剪贴板' },
  },
  b = {
