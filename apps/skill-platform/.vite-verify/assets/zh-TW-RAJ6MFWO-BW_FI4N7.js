...
var u = {
    ...
    lineEditor: { edit: '編輯線條', exit: '結束線條編輯' },
    elementLock: { lock: '鎖定', unlock: '解鎖', lockAll: '全部鎖定', unlockAll: '全部解鎖' },
    statusPublished: '已發布',
    sidebarLock: '側欄維持開啟',
...
變更無法儲存！`,
  ...
  D = { canvasActions: 'canvas 動作', selectedShapeActions: '選取圖形動作', shapes: '形狀' },
  B = {
...
若要變更 Firefox 瀏覽器的此設定值，請至 "about:config" 頁面。`,
  ...
  s = {
    ...
    errors: { required: '必填', website: '請輸入有效的 URL' },
    noteDescription:
  ...
  c = { resetLibrary: '重設資料庫', removeItemsFromLib: '從資料庫移除所選的項目' },
  m = {
    header: '匯出圖片',
    label: {
      withBackground: '背景',
...
會增加輸出的檔案大小。`,
    ...
    button: { exportToPng: 'PNG', exportToSvg: 'SVG', copyPngToClipboard: '複製至剪貼簿' },
  },
  b = {
