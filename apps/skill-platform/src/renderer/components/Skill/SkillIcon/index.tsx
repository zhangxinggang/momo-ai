...
export function SkillIcon({
  ...
  if (iconUrl && !imgError) {
    return (
      <div
        className={`${sizeConfig.container} flex items-center justify-center overflow-hidden rounded-xl ${containerClass} ${className}`}
  ...
  if (iconEmoji) {
    return (
      <div
        className={`${sizeConfig.container} flex items-center justify-center rounded-xl ${containerClass} ${className}`}
        style={containerStyle}>
  ...
  if (name) {
    return (
      <div
        className={`${sizeConfig.container} flex items-center justify-center rounded-xl font-bold ${containerClass} ${className}`}
        style={containerStyle}>
  ...
  return (
    <div
      className={`${sizeConfig.container} flex items-center justify-center rounded-xl ${hasCustomBackground ? 'bg-transparent' : 'bg-primary/10 text-primary'} ${className}`}
      style={containerStyle}>
