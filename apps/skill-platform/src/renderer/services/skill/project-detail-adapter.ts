...
export interface IProjectDetailSkillContext {
  ...
  importedSkill?: ISkill | null;
  projectName: string;
}

export function buildProjectDetailSkill(context: IProjectDetailSkillContext): ISkill {
  ...
  return {
    ...
    content: importedSkill?.content || importedSkill?.instructions || scannedSkill.instructions,
