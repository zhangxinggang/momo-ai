  ...
  return (
    <header className='page-header'>
      <section className='container'>
        ...
        <p className='header-actions'>
          <button className='btn btn-header' onClick={() => props.onPreviewChange('default')}>
            default
          </button>
          <button className='btn btn-header' onClick={() => props.onPreviewChange('cyanosis')}>
            cyanosis
          </button>
          <button className='btn btn-header' onClick={() => props.onPreviewChange('github')}>
            github
          </button>
          <button className='btn btn-header' onClick={() => props.onPreviewChange('mk-cute')}>
            mk-cute
          </button>
          <button className='btn btn-header' onClick={() => props.onPreviewChange('smart-blue')}>
            smart-blue
          </button>
          <button className='btn btn-header' onClick={() => props.onPreviewChange('vuepress')}>
            vuepress
          </button>
        </p>
        <p className='header-actions'>
