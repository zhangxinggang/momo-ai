...
declare const _default: import("react").MemoExoticComponent<({ tocItem, mdHeadingId, onActive, onClick, scrollElementOffsetTop, }: IProps) => import("react/jsx-runtime").JSX.Element>;
