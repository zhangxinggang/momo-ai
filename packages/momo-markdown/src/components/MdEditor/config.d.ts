import { ICodeCss, IGlobalConfig, IStaticTextDefault, TConfig, TFooters, TMdHeadingId, TToolbarNames } from './type';
...
export declare const highlightUrl = "https://unpkg.com/@highlightjs/cdn-assets@11.11.1/highlight.min.js";
