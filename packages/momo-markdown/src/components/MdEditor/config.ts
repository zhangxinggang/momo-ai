...
// 当前版本的值
export const editorExtensionsAttrs: IGlobalConfig['editorExtensionsAttrs'] = {
  highlight: {
    js: {
...
// 所有的编辑器功能点
export const allToolbar: Array<TToolbarNames> = [
  'bold',
  'underline',
  'italic',
  'strikeThrough',
...
export const allFooter: Array<TFooters> = ['markdownTotal', '=', 'scrollSwitch'];

export const staticTextDefault: IStaticTextDefault = {
  'zh-CN': {
    toolbarTips: {
      bold: '加粗',
      underline: '下划线',
...
export const config: TConfig = (option) => {
