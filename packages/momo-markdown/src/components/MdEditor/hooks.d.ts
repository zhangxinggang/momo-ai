...
import { IEditorProps, IInnerError, IMdPreviewProps, ISettingType, IStaticProps, IStaticTextDefaultValue, TUpdateSetting } from './type';
/**
 * 键盘监听
 *
 * @param props
 ...
 * @param onError
 */
export declare const useErrorCatcher: (editorId: string, onError: (err: IInnerError) => void) => void;
/**
 * 上传图片事件
 * @param props
 * @param staticProps
...
export declare const useMdPreviewConfig: (props: IMdPreviewProps) => readonly [{
    js: {
        ...
        addEventListener?: {
            <K extends keyof HTMLElementEventMap>(type: K, listener: (this: HTMLScriptElement, ev: HTMLElementEventMap[K]) => any, options?: boolean | AddEventListenerOptions): void;
            (type: string, listener: EventListenerOrEventListenerObject, options?: boolean | AddEventListenerOptions): void;
        } | undefined;
        removeEventListener?: {
            <K extends keyof HTMLElementEventMap>(type: K, listener: (this: HTMLScriptElement, ev: HTMLElementEventMap[K]) => any, options?: boolean | EventListenerOptions): void;
 ...
 */
export declare const useExpose: (editorRef: ForwardedRef<unknown>, staticProps: IStaticProps, catalogVisible: boolean, setting: ISettingType, updateSetting: TUpdateSetting, codeRef: MutableRefObject<IContentExposeParam | undefined>) => void;
