...
export const createCommands = (
  ...
  const CtrlB: KeyBinding = {
    ...
    mac: 'Cmd-b',
    run: () => {
      bus.emit(id, REPLACE, 'bold' as TToolDirective);
      return true;
    },
  };
  ...
  const CtrlS: KeyBinding = {
    ...
    shift: () => {
      bus.emit(id, REPLACE, 'strikeThrough' as TToolDirective);
      return true;
    },
  };
  ...
  const CtrlU: KeyBinding = {
    ...
    run: () => {
      // ctrl+u触发下划线
      bus.emit(id, REPLACE, 'underline' as TToolDirective);
      return true;
    },
    shift: () => {
      // ctrl+shift+u触发无需列表
      bus.emit(id, REPLACE, 'unorderedList' as TToolDirective);
      return true;
    },
  };
  ...
  const CtrlI: KeyBinding = {
    ...
    preventDefault: true,
    run: () => {
      bus.emit(id, REPLACE, 'italic' as TToolDirective);
      return true;
    },
    shift: () => {
      // ctrl+shift+i触发图片链接
  ...
  const Ctrl1: KeyBinding = {
    ...
    mac: 'Cmd-1',
    run: () => {
      bus.emit(id, REPLACE, 'h1' as TToolDirective);
      return true;
    },
  };
  ...
  const Ctrl2: KeyBinding = {
    ...
    mac: 'Cmd-2',
    run: () => {
      bus.emit(id, REPLACE, 'h2' as TToolDirective);
      return true;
    },
  };
  const Ctrl3: KeyBinding = {
    ...
    mac: 'Cmd-3',
    run: () => {
      bus.emit(id, REPLACE, 'h3' as TToolDirective);
      return true;
    },
  };
  const Ctrl4: KeyBinding = {
    ...
    mac: 'Cmd-4',
    run: () => {
      bus.emit(id, REPLACE, 'h4' as TToolDirective);
      return true;
    },
  };
  const Ctrl5: KeyBinding = {
    ...
    mac: 'Cmd-5',
    run: () => {
      bus.emit(id, REPLACE, 'h5' as TToolDirective);
      return true;
    },
  };
  const Ctrl6: KeyBinding = {
    ...
    mac: 'Cmd-6',
    run: () => {
      bus.emit(id, REPLACE, 'h6' as TToolDirective);
      return true;
    },
  };
  ...
  const CtrlArrowUp: KeyBinding = {
    ...
    mac: 'Cmd-ArrowUp',
    run: () => {
      bus.emit(id, REPLACE, 'sup' as TToolDirective);
      return true;
    },
  };
  ...
  const CtrlArrowDown: KeyBinding = {
    ...
    mac: 'Cmd-ArrowDown',
    run: () => {
      bus.emit(id, REPLACE, 'sub' as TToolDirective);
      return true;
    },
  };
  ...
  //   mac: 'Cmd-q',
  //   run: () => {
  //     bus.emit(id, REPLACE, 'quote' as TToolDirective);
  //     return true;
  //   }
  // };
  ...
  const CtrlO: KeyBinding = {
    ...
    mac: 'Cmd-o',
    run: () => {
      bus.emit(id, REPLACE, 'orderedList' as TToolDirective);
      return true;
    },
  };
  ...
  const CtrlC: KeyBinding = {
    ...
    shift: () => {
      // ctrl+shift+c触发块级代码
      bus.emit(id, REPLACE, 'code' as TToolDirective);
      return true;
    },
    any(_view, e) {
      if ((e.ctrlKey || e.metaKey) && e.altKey && e.code === 'KeyC') {
        // ctrl+alt+c触发行内代码
        bus.emit(id, REPLACE, 'codeRow' as TToolDirective);
        return true;
      }
