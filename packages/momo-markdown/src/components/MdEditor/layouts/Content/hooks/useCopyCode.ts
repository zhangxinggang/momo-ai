...
const useCopyCode = (props: IContentPreviewProps, html: string, key: string) => {
  const { editorId, usedLanguageText, customIcon, rootRef, setting } = useContext(EditorContext);
