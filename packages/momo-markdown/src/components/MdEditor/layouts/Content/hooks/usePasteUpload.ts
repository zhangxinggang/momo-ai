 ...
 * 处理粘贴板
 */
const usePasteUpload = (props: IContentProps, codeMirrorUt: RefObject<CodeMirrorUt | null>) => {
  ...
  const pasteHandler = useCallback(
    (e: ClipboardEvent) => {
      ...
      if (props.maxLength && targetValue.length + props.modelValue.length > props.maxLength) {
