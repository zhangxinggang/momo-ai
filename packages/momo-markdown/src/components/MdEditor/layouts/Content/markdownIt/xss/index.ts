...
export interface IXssPluginType {
...
export const XSSPlugin = (md: markdownit, options: IXssPluginType) => {
  ...
  if (typeof xssOption === 'function') {
    ...
    keys.forEach((key) => {
      ...
      whiteList[key] = [...new Set([...xssWhiteItem, ...innerWhiteItem, ...userDefWhiteItem])];
    });
