...
import { type MdItInstance, type MdPluginWithParams, type MdToken } from '~~/types/markdown-it-compat';
...
export interface IStaticTextDefault {
    'zh-CN': IStaticTextDefaultValue;
    'en-US': IStaticTextDefaultValue;
}
export type TStaticTextDefaultKey = keyof IStaticTextDefault;
export type TToolbarNames = keyof IToolbarTips | number;
 ...
 */
export type TPreviewThemes = string;
export interface IPreviewRendererProps {
    html: string;
    id: string;
    className: string;
}
export type TPreviewRendererComponent = ComponentType<IPreviewRendererProps>;
/**
 * 自定义标题ID
 */
export type TMdHeadingId = (options: {
    text: string;
    level: number;
    index: number;
    currentToken?: MdToken;
...
export interface IMdPreviewProps {
     ...
     * html变化事件
     */
    onHtmlChanged?: THtmlChangedEvent;
    /**
     * 获取目录结构
     */
    onGetCatalog?: TGetCatalogEvent;
    /**
     * 编辑器唯一标识
     *
...
export type TTableShapeType = [number, number] | [number, number, number, number];
export interface IEditorProps extends IMdPreviewProps {
    /**
     * 保存事件
     */
    onSave?: TSaveEvent;
...
export interface IContextType {
    ...
    showCodeRowNumber: boolean;
    usedLanguageText: IStaticTextDefaultValue;
    theme: TThemes;
    language: string;
    previewTheme: TPreviewThemes;
 ...
 * ^6.0.0
 */
export interface ICodeMirrorExtension {
    /**
     * 仅用来提供开发者分别不同扩展的依据
     */
    type: string;
...
export interface IGlobalConfig {
    ...
    editorConfig: {
         ...
         */
        languageUserDefined?: {
            [key: string]: IStaticTextDefaultValue;
        };
        /**
         * 自定义内部mermaid模块
         */
        mermaidTemplate?: IMermaidTemplate;
        /**
         * 输入渲染延迟（ms）
         */
        renderDelay?: number;
     ...
     */
    codeMirrorExtensions: (extensions: Array<ICodeMirrorExtension>, options: {
        editorId: string;
        theme: TThemes;
        keyBindings: Array<KeyBinding>;
    }) => Array<ICodeMirrorExtension>;
    /**
     * 自定义markdown-it核心库扩展、属性等
     */
    markdownItConfig: (md: MdItInstance, options: {
        editorId: string;
    }) => void;
    /**
     ...
     * @returns plugins
     */
    markdownItPlugins: (plugins: Array<IMarkdownItConfigPlugin>, options: {
        editorId: string;
    }) => Array<IMarkdownItConfigPlugin>;
    /**
     * mermaid配置项
     *
     * @param base
 ...
 */
export type TConfig = (options: Partial<IGlobalConfig>) => void;
/**
 * 编辑器操作潜在的错误
 */
...
export interface ICodeCss {
    [key: string]: {
        light: string;
        dark: string;
    };
}
export interface ICodeCssAttrs {
    [key: string]: {
        light: Partial<HTMLElementTagNameMap['link']>;
        dark: Partial<HTMLElementTagNameMap['link']>;
    };
}
export interface IMdPreviewStaticProps {
    editorId: string;
    noMermaid: boolean;
    noKatex: boolean;
    noHighlight: boolean;
}
export interface IStaticProps extends IMdPreviewStaticProps {
    noPrettier: boolean;
    noUploadImg: boolean;
}
...
export type TUploadImgCallBackParam = string[] | Array<{
    url: string;
    alt: string;
    title: string;
}>;
export type TUploadImgCallBack = (urls: TUploadImgCallBackParam) => void;
export type TUploadImgEvent = (files: Array<File>, callBack: TUploadImgCallBack) => void;
export type THtmlChangedEvent = (h: string) => void;
export type TGetCatalogEvent = (list: IHeadList[]) => void;
 ...
 * 插入的内容的构造函数
 */
export type TInsertContentGenerator = (selectedText: string) => IInsertParam;
/**
 * 插入内容的通用函数类型
 */
export type TInsert = (generate: TInsertContentGenerator) => void;
export type TFocusOption = 'start' | 'end' | {
    rangeAnchor?: number;
    rangeHead?: number;
    cursorPos: number;
};
export interface IExposeParam {
    /**
     * 添加事件监听
     *
     ...
     * @param handlers
     */
    domEventHandlers(handlers: TDOMEventHandlers): void;
    /**
     * 执行内部插入命令
     *
     * @param direct
     */
    execCommand(direct: TToolDirective): void;
    /**
     * 获取编辑器实例
     */
    getEditorView(): EditorView | undefined;
}
export type IExposePreviewParam = Pick<IExposeParam, 'rerender'>;
export type ICustomStrIcon = {
    copy?: string;
