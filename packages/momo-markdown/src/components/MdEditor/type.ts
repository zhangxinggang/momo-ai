...
import {
  type MdItInstance,
  type MdPluginWithParams,
  type MdToken,
} from '~~/types/markdown-it-compat';
...
export interface IGlobalConfig {
  ...
  editorConfig: {
     ...
     * 自定义提示语言
     */
    languageUserDefined?: { [key: string]: IStaticTextDefaultValue };
    /**
     * 自定义内部mermaid模块
     */
  ...
  codeMirrorExtensions: (
    extensions: Array<ICodeMirrorExtension>,
    options: {
      editorId: string;
      theme: TThemes;
   ...
   */
  markdownItPlugins: (
    plugins: Array<IMarkdownItConfigPlugin>,
    options: {
      editorId: string;
    },
...
export type TUploadImgCallBackParam = string[] | Array<{ url: string; alt: string; title: string }>;
