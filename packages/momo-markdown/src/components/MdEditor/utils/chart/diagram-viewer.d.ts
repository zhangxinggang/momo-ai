 ...
 * 为图表容器绑定拖拽移动与滚轮缩放
 */
export declare const bindDiagramPanZoom: (
  viewport: HTMLElement,
  content: HTMLElement,
) => IDiagramPanZoomHandle;
/** 为图表容器挂载操作栏（复制 / 全屏 / 下载） */
export declare const prepareDiagramActionBars: (
 ...
 */
export declare const bindDiagramActionsDelegation: (
 ...
 */
export declare const copyMermaid: (
  containers: NodeListOf<HTMLElement> | undefined,
  options: {
    customIcon: ICustomIcon;
  },
