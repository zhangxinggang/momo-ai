...
export declare function mountMarkdownExportPreview(options: IMarkdownPreviewExportOptions): IExportMountResult;
...
/** 挂载预览、等待渲染并执行回调 */
export declare function withMarkdownExportPreview<T>(options: IMarkdownPreviewExportOptions, run: () => Promise<T>): Promise<T>;
export {};
