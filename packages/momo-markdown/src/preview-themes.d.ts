...
export declare const MD_PREVIEW_THEMES: readonly [
  'cyanosis',
  'default',
  'github',
  'mk-cute',
...
export declare function useMdPreviewTheme(
  initialTheme?: TMdPreviewThemeId,
): readonly [
  'github' | 'cyanosis' | 'default' | 'mk-cute' | 'smart-blue' | 'vuepress' | 'arknights',
