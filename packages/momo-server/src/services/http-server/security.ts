...
import type { IDiffieHellmanKeys } from '../../types/http-server/security';
import NKDiffieHellman from './diffieHellman';

const keys = NKDiffieHellman as IDiffieHellmanKeys;
