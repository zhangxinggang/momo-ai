...
import url from 'url';
import type { IRequestOptions } from '../types/utils/request';

class Request {
  constructor(options: string | IRequestOptions) {
    return new Promise((resolve, reject) => {
      ...
      const assignKeys: Array<keyof IRequestOptions> = ['hostname', 'port', 'path', 'auth'];
      assignKeys.map((item) => {
